            ...
            <div id="error_content">
                <div id="error_content_second_column">
                    <div id="error_sign_in_button">
                        <p class="error_signin_button"><button title="__MSG__SIGN_IN__" title="__MSG__SIGN_IN__">__MSG__SIGN_IN__</button></p>
                        <p>__MSG__NO_ACCOUNT__ <a class="s3d-regular-links s3d-bold" href="/register" title="__MSG__SIGN_UP__">__MSG__SIGN_UP__</a></p>
                    </div>
                        ...
                        <div id="error_content_second_column_box_container">
                            <div class="error_content_second_column_box_item_container">
                                <div class="error_content_second_column_box_item_content">
                                    <a class="s3d-regular-links s3d-bold" href="/search#l=content" title="__MSG__CONTENT__">__MSG__CONTENT__</a>
                                </div>
                            </div>
                            <hr class="s3d-split-line fl-push" />
                            <div class="error_content_second_column_box_item_container">
                                <div class="error_content_second_column_box_item_content">
                                    <a class="s3d-regular-links s3d-bold" href="/search#l=people" title="__MSG__PEOPLE__">__MSG__PEOPLE__</a>
                                </div>
                            </div>
                            <hr class="s3d-split-line fl-push" />
                            ...
                            {for w in worlds}
                                <div class="error_content_second_column_box_item_container">
                                    <div class="error_content_second_column_box_item_content">
                                        <a class="s3d-regular-links s3d-bold" href="/search#l=\${w.id}" title="\${w.label}">\${w.label}</a>
                                    </div>
                                </div>
                                {if !w.last}
                                    <hr class="s3d-split-line fl-push" />
                    ...
                    <div class="error_content_second_column_box browse_cats">
                        ...
                        <div id="error_content_second_column_box_browse_container">
                            <div class="error_content_second_column_box_item_container">
                                <div class="error_content_second_column_box_item_content">
                                    <p>__MSG__YOU_CAN_BROWSE_THIS_INSTITUTION__ <a href="/categories" title="__MSG__CATEGORIES_LC__><span class="error_browse_cats"><span id="error_browse_category_number"></span> __MSG__CATEGORIES_LC__</span></a> __MSG__WHERE_YOU_CAN_CONNECT_WITH_PEOPLE_VIEW_COURSE_DETAILS_SEARCH_FOR_CONTENT_AND_JOIN_GROUPS__</p>
                                </div>
                            </div>
                         <div class="error_content_second_column_box_footer">
                            <a href="/categories" id="error_browse_categories_button" title="__MSG__BROWSE_CATEGORIES__">
                                <button class="s3d-button s3d-overlay-button" title="__MSG__BROWSE_CATEGORIES__">__MSG__BROWSE_CATEGORIES__</button>
                            </a>
                         </div>
                        </div>
                    </div>
                        ...
                        <div id="error_page_links_template" style="display:none"><!--
                            <ul>
                                {for w in links.whatToDo}
                                    <li><a class="s3d-regular-links s3d-bold" href="\${w.url}" title="\${sakai.api.i18n.General.getValueForKey(w.title)}">\${sakai.api.i18n.General.getValueForKey(w.title)}</a></li>
                                {/for}
                                <li><a href="{if document.referrer === ""}/{else}\${document.referrer}{/if}" class="s3d-regular-links s3d-bold" title="__MSG__GO_BACK_BY_USING_YOUR_BROWSER_BACK_BUTTON__">__MSG__GO_BACK_BY_USING_YOUR_BROWSER_BACK_BUTTON__</a></li>
                            </ul>
                            ...
                            {if links.getInTouch && links.getInTouch.length > 0}
                                ...
                                <ul>
                                    {for g in links.getInTouch}
                                        <li><a class="s3d-regular-links s3d-bold" href="\${g.url}" title="\${sakai.api.i18n.General.getValueForKey(g.title)}">\${sakai.api.i18n.General.getValueForKey(g.title)}</a></li>
                                    {/for}
                                </ul>
                            {/if}
                        --></div>
