            ...
            <div id="error_content">
                <div id="error_content_second_column">
                    <div id="error_sign_in_button">
                        <p class="error_signin_button"><button title="__MSG__SIGN_IN__">__MSG__SIGN_IN__</button></p>
                    ...
                    <div class="error_content_second_column_box browse_cats">
                        ...
                        <div id="error_content_second_column_box_browse_container">
                            <div class="error_content_second_column_box_item_container">
                                <div class="error_content_second_column_box_item_content">
                                    <p>__MSG__YOU_CAN_BROWSE_THIS_INSTITUTION__ <a href="/categories" title="0 __MSG__CATEGORIES_LC__"><span class="error_browse_cats"><span id="error_browse_category_number">0</span> __MSG__CATEGORIES_LC__</span></a> __MSG__WHERE_YOU_CAN_CONNECT_WITH_PEOPLE_VIEW_COURSE_DETAILS_SEARCH_FOR_CONTENT_AND_JOIN_GROUPS__</p>
                                </div>
                            </div>
