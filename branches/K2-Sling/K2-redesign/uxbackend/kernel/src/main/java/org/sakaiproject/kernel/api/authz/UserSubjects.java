...
/**
 * A user may have a number of subjectsm this object represents the subjects
 * that the user has. A group is an example of a subject.
 */
public interface UserSubjects {
   ...
   */
  SubjectPermissions getSubjectPermissions(String subjectToken);
   ...
   *         present.
   */
  boolean hasSubject(String groupToken);
