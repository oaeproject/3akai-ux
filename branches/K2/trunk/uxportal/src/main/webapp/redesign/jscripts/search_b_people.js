...
$(document).ready(function() { 
	...
	// Pager Init
	$(".jq_pager").pager({ pagenumber: 1, pagecount: 15, buttonClickCallback: pager_click_handler });
...
var pager_click_handler = function(pageclickednumber) {
            $(".jq_pager").pager({ pagenumber: pageclickednumber, pagecount: 15, buttonClickCallback: pager_click_handler });
            alert('Clicked page: '+pageclickednumber);
        }
