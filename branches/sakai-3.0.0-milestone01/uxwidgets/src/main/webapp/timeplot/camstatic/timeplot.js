...
Timeplot.createPlotInfo = function(params) {
	...
	valuesColour:	   ("valuesColour" in params) ? params.valuesColour : "#ffe57f", 
	valuesBorder:	   ("valuesBorder" in params) ? params.valuesBorder : "#ffb02d",
	valuesText:	   ("valuesText" in params) ? params.valuesText : "#000000",
	valuesRight:	   ("valuesRight" in params) ? params.valuesRight : true,
	showLabel:         ("showLabel" in params) ? params.showLabel : false
    };
};
...
Timeplot._Impl.prototype = {
    ...
    removeDiv: function(id) {
      ...
      if (div) {
        this._containerDiv.firstChild.removeChild(div);
      }
    },
