...
var loadTimeplot = function() {
        ...
        var timeplotURLPrefix = (local) ? "http://www.ensemble.ac.uk/projects/camstatic/timeplot/api/1.0/" : Timeplot.urlPrefix;
 ...
 var canvas = document.createElement("canvas");
        ...
        window.SimileAjax_onLoad = function() {
            if (local && window.console && window.console.open) window.console.open();
    ...
    var loadTimeline = function() {
        if (typeof Timeline != "undefined") {
            ...
            var timelineURL = (local) ? "http://www.ensemble.ac.uk/projects/camstatic/timeline/api-2.0/timeline-api.js?bundle=false" : "http://static.simile.mit.edu/timeline/api-2.0/timeline-api.js";
    ...
    if (typeof SimileAjax == "undefined") {
        ...
        var url = local ?
            "http://www.ensemble.ac.uk/projects/camstatic/ajax/api-2.0/simile-ajax-api.js?bundle=false" :
