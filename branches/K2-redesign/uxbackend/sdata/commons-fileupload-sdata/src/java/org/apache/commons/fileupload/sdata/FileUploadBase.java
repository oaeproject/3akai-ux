...
import org.apache.commons.fileupload.sdata.util.Closeable;
import org.apache.commons.fileupload.sdata.util.LimitedInputStream;
 ...
 * {@link org.apache.commons.fileupload.sdata.FileItem}s associated with a given
 * HTML widget.
 * </p>
 * 
 * <p>
 ...
 * 
 * @version $Id: FileUploadBase.java 57997 2009-02-12 13:06:08Z ian@caret.cam.ac.uk $
 */
public abstract class FileUploadBase {
   ...
   */
  public List<FileItem> /* FileItem */parseRequest(HttpServletRequest req)
      throws FileUploadException {
   ...
   * @throws FileUploadException
   *           if an error occurs.
   * @deprecated This method is no longer used in favour of internally created
   ...
   */
  protected Map<String, String> /* String, String */parseHeaders(
      String headerPart) {
  ...
  private class FileItemIteratorImpl implements FileItemIterator {
    ...
    private class FileItemStreamImpl implements FileItemStream {
      ...
      FileItemStreamImpl(String pName, String pFieldName, String pContentType,
          boolean pFormField, Map<String, String> pHeaders) {
        name = pName;
            ...
            protected void raiseError(long pSizeMax, long pCount)
              ...
              FileUploadException e = new FileSizeLimitExceededException(
                  "The field " + fieldName + " exceeds its maximum permitted "
                      + " size of " + pSizeMax + " characters.", pCount,
                  pSizeMax);
    ...
    FileItemIteratorImpl(RequestContext ctx) throws FileUploadException,
      ...
      notifier = new MultipartStream.ProgressNotifier(listener, ctx
          .getContentLength());
        ...
        if (currentFieldName == null) {
          ...
          if (fieldName != null) {
            ...
            currentItem = new FileItemStreamImpl(fileName, fieldName,
                getHeader(headers, CONTENT_TYPE), fileName == null, headers);
            notifier.noteItem();
            itemValid = true;
            return true;
          }
          ...
          if (fileName != null) {
            currentItem = new FileItemStreamImpl(fileName, currentFieldName,
                getHeader(headers, CONTENT_TYPE), false, null);
            notifier.noteItem();
            itemValid = true;
            return true;
          }
  ...
  protected abstract static class SizeException extends FileUploadException {
     ...
     * 
     */
    private static final long serialVersionUID = 3515629512732092186L;
  ...
  /**
   * Thrown to indicate that the request size is not specified. In other words,
   * it is thrown, if the content-length header is missing or contains the value
   * -1.
   * 
   * @deprecated As of commons-fileupload 1.2, the presence of a content-length
