...
define(['jquery', 'underscore', 'oae.core'], ($, _, oae) => {
    ...
    return function(uid) {
         ...
         */
        var createRequestJoinGroup = function() {

            oae.api.group.createRequestJoinGroup(widgetData.contextProfile.id, function(err, data) {
                if (err) {
         ...
         * @param  {Object}         callback.err        Error object containing error code and error message
         */
        var cancelRequestJoinGroup = function() {

            oae.api.group.cancelRequestJoinGroup(widgetData.contextProfile.id, function(err, data) {
                if (err) {
                    oae.api.util.notification(
        ...
        var addBinding = function() {
            ...
            $rootel.on('click', '#joingroup-remove', function() {
        ...
        var renderAlert = function() {
            oae.api.util.template().render($('#joingroup-action-template', $rootel), {
