...
<div id="admin-skinning-container"><!-- --></div>
...
<div id="admin-skinning-template"><!--
    ...
    <form id="admin-skinning-form" class="form-horizontal">
                    ...
                    {for variable in subsection.variables}
                        <div class="form-group">
                            ...
                            <div class="col-xs-2 col-sm-1">
                                <button type="button" class="btn btn-link pull-right admin-skinning-revert" title="__MSG__REVERT_TO_ORIGINAL_VALUE__">
                                    <i class="icon-undo"><span class="oae-aural-text">__MSG__REVERT_TO_ORIGINAL_VALUE__</span></i>
                                </button>
                            </div>
                        </div>
                    {/for}
        ...
        <div id="admin-skinning-actions">
            <button type="submit" class="btn btn-primary">__MSG__SAVE_SKIN__</button>
        </div>
    </form>
--></div>
