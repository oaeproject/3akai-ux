...
define(['jquery', 'oae.core', 'jquery.spectrum'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var refreshActiveSkin = function() {
            $('#skinning-form input').each(function(i, input) {
         ...
         *
         * @return {Object}  nonDefaultValues    The skinning values that have been changed (i.e. are different to the default skin)
         * @return {Object}  revertedValues      The skinning values that should be reverted to the default skin values
         */
