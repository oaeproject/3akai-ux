...
define(['jquery', 'oae.core', 'jquery.spectrum'], function($, oae) {
    return function(uid, showSettings, widgetData) {
                    ...
                    if (saveSkinErr || revertSkinErr) {
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__SKIN_NOT_SAVED__',
                                'skinning',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__SKIN_COULD_NOT_BE_SAVED__',
                                'skinning',
                            ),
                            'error',
                        );
                        ...
                        oae.api.util.notification(
                            ...
                            oae.api.i18n.translate(
                                '__MSG__SKIN_SUCCESSFULLY_SAVED__',
                                'skinning',
                            ),
                        );
                    }
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (widgetData.configuration['oae-ui'].skin.variables) {
                        configuredSkin =
                            widgetData.configuration['oae-ui'].skin.variables;
                    }
                    ...
                    $.each(data.results, function(
                        ...
                        $.each(configSection.subsections, function(
                            configSubsectionIndex,
                            configSubsection,
                        ) {
                            $.each(configSubsection.variables, function(
                                variableIndex,
                                variable,
                            ) {
                                variable.value =
                                    configuredSkin[variable.name] ||
                                    variable.defaultValue;
                                defaultSkin[variable.name] =
                                    variable.defaultValue;
                    ...
                    oae.api.util
                        .template()
                        .render(
                            $('#skinning-template', $rootel),
                            data,
                            $('#skinning-container', $rootel),
                        );
        ...
        var uploadLogo = function(e) {
            ...
            var extension = $('#skinning-logo-upload')[0]
                .files[0].name.split('.')
                .pop();
            ...
            if (!validType) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        saveSkin(
                            { 'institutional-logo-url': "'" + data.url + "'" },
                            function(err) {
                                if (err) {
                                    oae.api.util.notification(
                                        oae.api.i18n.translate(
