    ...
    return function(uid, showSettings) {
        ...
        var setUpValidation = function() {
            var validateOpts = {
                ...
                'messages': {
                    ...
                    'emailDomain': {
                        'hostname': oae.api.i18n.translate('__MSG__PLEASE_ENTER_A_VALID_EMAIL_DOMAIN__')
                    }
                },
                'methods': {
                    'hostname': {
        ...
        var createTenant = function() {
            ...
            if (values.emailDomain) {
                opts.emailDomain = values.emailDomain;
            }
        ...
        var init = function() {
            ...
            $('#createtenant-modal', $rootel).on('shown.bs.modal', function () {
                ...
                // Render the country select list
                var countries = _.chain(iso3166.data)
                    .map(function(countryInfo, countryCode) {
                        return {
                            'code': countryCode,
