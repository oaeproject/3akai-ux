...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var bindListeners = function() {
            ...
            $rootel.on('click', '#submit-download-btn', function(event) {
                // Avoid the reload
            ...
            $rootel.on('keydown', '#download-log-input', function(e) {
                // Allow: backspace, delete, tab, escape, enter, left arrow and right arrow
                if ($.inArray(e.keyCode, [46, 8, 9, 27, 13, 110, 37, 39]) !== -1 ||
                    // Allow: Ctrl/cmd+A
                    ...
                    // Allow: numpad 
                    (e.keyCode >= 96 && e.keyCode <= 120 && e.shiftKey) ||
                    // Allow: 0-9 
        ...
        var downloadLog = function(callback) {
            // Get the form values
            var submittedValues = $('#downloadlog-form').serializeObject();
            ...
            if (lastConnection) {
                ...
                var numberMonth = submittedValues.months ? submittedValues.months : 0;
