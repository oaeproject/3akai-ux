...
COLLABORATIVE_DOCUMENTS = Documents
...
REPROCESS_CONTENT_PREVIEWS = Reprocess content previews
REPROCESS_EVERYTHING_IN_DATE_RANGE = Reprocess everything in date range
REPROCESS_FAILED_CONTENT_PREVIEWS = Reprocess failed content previews
REPROCESS_FOR_USER = Reprocess for a specific user
REPROCESS_PREVIEWS_FAILED = The previews could not be processed.
