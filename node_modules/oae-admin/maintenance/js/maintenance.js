...
define(['jquery', 'oae.core', 'bootstrap.datepicker'], function($, oae) {
    ...
    return function(uid) {
        ...
        var setUpMaintenance = function() {
            ...
            oae.api.tenants.getTenants(function(err, data) {
                if (!err) {
                    oae.api.util.template().render($('#maintenance-reprocess-tenants-template', $rootel), {
                        'tenants': _.values(data)
                    }, $('#maintenance-reprocess-tenants-form', $rootel));
                }
            });
        ...
        var addBinding = function() {
            ...
            // Reprocess previews
            $rootel.on('submit', '#maintenance-reprocess-tenants-form', reprocessTenants);
