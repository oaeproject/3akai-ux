...
define(['jquery', 'oae.core', './mimeTypes.js', 'bootstrap.datepicker'], function($, oae, mimeTypeConstants) {
    ...
    return function(uid) {
        ...
        /**
         * Handle the result of starting reprocessing reviews by showing a success or failure notification
         *
        ...
        var setUpMaintenance = function() {
            ...
            oae.api.util.template().render($('#maintenance-contentpreviews-template', $rootel), {
                'previewMimetypes': mimeTypeConstants.previewMimetypes
            }, $('#maintenance-contentpreviews-container', $rootel));

            oae.api.util.template().render($('#maintenance-search-template', $rootel), null, $('#maintenance-search-container', $rootel));
        };
