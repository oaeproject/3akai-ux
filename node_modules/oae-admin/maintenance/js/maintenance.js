...
define(['jquery', 'oae.core', 'bootstrap.datepicker'], function($, oae) {
    ...
    return function(uid) {
            ...
            if (err) {
                oae.api.util.notification(
                    oae.api.i18n.translate(
                        '__MSG__REPROCESS_PREVIEWS_NOT_STARTED__',
                        'maintenance',
                    ),
                    oae.api.i18n.translate(
                        '__MSG__REPROCESS_PREVIEWS_FAILED__',
                        'maintenance',
                    ),
                    'error',
                );
                ...
                oae.api.util.notification(
                    oae.api.i18n.translate(
                        '__MSG__REPROCESS_PREVIEWS_STARTED__',
                        'maintenance',
                    ),
                    oae.api.i18n.translate(
                        '__MSG__REPROCESS_PREVIEWS_PROGRESS__',
                        'maintenance',
                    ),
                );
            }
        ...
        var reprocessDateRange = function() {
            var data = {
                revision_createdAfter: $(
                    '#maintenance-reprocess-daterange-from',
                    $rootel,
                )
                    .datepicker('getDate')
                    .getTime(),
                revision_createdBefore: $(
        ...
        var selectAllMimetypes = function() {
            ...
            var chkContainer = $(this)
                .parents('.checkbox')
                .next();
            $.each($(chkContainer).find('input[type="checkbox"]'), function(
                i,
                chk,
            ) {
        ...
        var reindexSearch = function() {
            oae.api.admin.reindexSearch(function(err) {
                if (err) {
                    oae.api.util.notification(
                        oae.api.i18n.translate(
                            '__MSG__REINDEX_SEARCH_NOT_STARTED__',
                            'maintenance',
                        ),
                        oae.api.i18n.translate(
                            '__MSG__REINDEX_SEARCH_FAILED__',
                            'maintenance',
                        ),
                        'error',
                    );
                    ...
                    oae.api.util.notification(
                        oae.api.i18n.translate(
                            '__MSG__REINDEX_SEARCH_STARTED__',
                            'maintenance',
                        ),
                        oae.api.i18n.translate(
                            '__MSG__REINDEX_SEARCH_PROGRESS__',
                            'maintenance',
                        ),
                    );
                }
        ...
        var setUpMaintenance = function() {
            oae.api.util
                .template()
                .render(
                    $('#maintenance-list-header-template', $rootel),
                    null,
                    $('#maintenance-list-header', $rootel),
                );
        ...
        var setUpValidation = function() {
            oae.api.util
                .validation()
                .validate($('#maintenance-reprocess-daterange-form', $rootel), {
                    methods: {
                        isolderdate: {
                            ...
                            text: oae.api.i18n.translate(
                                '__MSG__SELECT_A_DATE_AFTER_FROM_DATE__',
                                'maintenance',
                            ),
                        },
                    },
        ...
        var addBinding = function() {
            ...
            $rootel.on(
                'submit',
                '#maintenance-reprocess-mimetypes-form',
                reprocessMimeTypes,
            );
            $rootel.on(
                'submit',
                '#maintenance-reprocess-contenttypes-form',
                reprocessContentTypes,
            );
            $rootel.on('click', '#maintenance-reprocess-all', reprocessFailed);
            $rootel.on('click', '#maintenance-reprocess-user', reprocessUser);
            $rootel.on(
                'change',
                '.maintenance-reprocess-selectall',
                selectAllMimetypes,
            );
        };
