    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 id="manageuser-modal-title">__MSG__MANAGE_USER__</h3>
            </div>
            <div id="manageuser-tab-container" class="modal-body">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#manageuser-priviliges-form" data-toggle="tab">__MSG__PRIVILIGES__</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-content">
                ...
                <form id="manageuser-priviliges-form" class="tab-pane form-horizontal" role="form">
                    <div class="modal-body"><!-- --></div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-link pull-left" data-dismiss="modal">__MSG__CANCEL__</button>
                        <button type="submit" class="btn btn-primary pull-right">__MSG__SAVE__</button>
...
<div id="manageuser-priviliges-template"><!--
    <div class="checkbox">
        <label>
            {if context.isGlobalAdminServer}
                <input id="manageuser-priviliges-isadmin" type="checkbox" {if userProfile.isGlobalAdmin} checked="checked"{/if}> __MSG__GLOBAL_ADMIN__
            {else}
                <input id="manageuser-priviliges-isadmin" type="checkbox" {if userProfile.isTenantAdmin} checked="checked"{/if}> __MSG__TENANT_ADMIN__
            {/if}
        </label>
    </div>
--></div>
