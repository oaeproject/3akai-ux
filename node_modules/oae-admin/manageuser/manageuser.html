        ...
        <div class="modal-content">
            ...
            <div id="manageuser-tab-container" class="modal-body">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li id="manageuser-actions-tab">
                        <a href="#manageuser-actions" data-toggle="tab">__MSG__ACTIONS__</a>
                    </li>
                    <li>
            ...
            <div class="tab-content">
                <form id="manageuser-editprofile-form" class="active tab-pane form-horizontal" role="form">
                    <div id="manageuser-editprofile" class="modal-body"><!-- --></div>
                ...
                <form id="manageuser-email-form" class="tab-pane form-horizontal" role="form">
                    <div id="manageuser-email" class="modal-body"><!-- --></div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-link" data-dismiss="modal">__MSG__CANCEL__</button>
                        <button type="submit" class="btn btn-primary">__MSG__SAVE__</button>
                    </div>
                ...
                <div id="manageuser-actions" class="tab-pane">
                    <form id="manageuser-actions-main-form" class="form-horizontal" role="form">
                        <div id="manageuser-actions-main" class="modal-body"><!-- --></div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-link" data-dismiss="modal">__MSG__CANCEL__</button>
                            <button type="submit" class="btn btn-primary">__MSG__SAVE__</button>
                        </div>
                    ...
                    <form id="manageuser-actions-deleteuser-form" class="tab-pane form-horizontal hide" role="form">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-link manageuser-deleteuser-cancel">__MSG__CANCEL__</button>
                            <button type="submit" class="btn btn-primary btn-danger manageuser-deleteuser-confirm">__MSG__DELETE_ACCOUNT__</button>
                        </div>
                    </form>
                </div>
...
<div id="manageuser-actions-main-template"><!--
...
<div id="manageuser-become-user-form-container-template"><!--
