            ...
            <div class="tab-content">
                ...
                <form id="manageuser-actions-form" class="tab-pane form-horizontal" role="form">
                    <div class="modal-body">
                        <div class="manageuser-actions-main"><!-- --></div>
                        <div class="manageuser-actions-deleteuser"><!-- --></div>
                    </div>
                    <div class="modal-footer">
                        <div class="manageuser-actions-main">
                            <button type="button" class="btn btn-link" data-dismiss="modal">__MSG__CANCEL__</button>
                            <button type="submit" class="btn btn-primary">__MSG__SAVE__</button>
                        </div>
                        <div class="manageuser-actions-deleteuser"><!-- --></div>
...
<div id="manageuser-actions-body-main-template"><!--
    ...
    {/if}
    <h4>__MSG__DELETE_USER__</h4>
    <button type="button" id="manageuser-delete-user" class="btn btn-primary btn-danger">
...
<div id="manageuser-actions-body-deleteuser-template"><!--
    {var displayName = oae.api.util.security().encodeForHTML(userProfile.displayName)}
    <h4>__MSG__ARE_YOU_SURE_YOU_WANT_TO_DELETE_USER_NAME__</h4>
--></div>

<div id="manageuser-actions-footer-deleteuser-template"><!--
    <button type="button" class="btn btn-link manageuser-deleteuser-cancel">__MSG__CANCEL__</button>
    <button type="button" class="btn btn-primary btn-danger manageuser-deleteuser-confirm">__MSG__DELETE__</button>
--></div>
