        ...
        var editEmailPreference = function() {
            ...
            oae.api.admin.updateUser(widgetData.userId, profile, function(err) {
                ...
                if (err) {
                    // Show a generic failure notification
                    oae.api.util.notification(
                        oae.api.i18n.translate('__MSG__EMAIL_PREFERENCE_NOT_UPDATED__', 'manageuser'),
                        oae.api.i18n.translate('__MSG__THE_EMAIL_PREFERENCE_UPDATE_FAILED__', 'manageuser'),
                        'error'
                    );
                } else {
                    // Hide the modal after saving
                    ...
                    // Show a success notification
                    oae.api.util.notification(
                        oae.api.i18n.translate('__MSG__EMAIL_PREFERENCE_UPDATED__', 'manageuser'),
                        oae.api.i18n.translate('__MSG__THE_EMAIL_PREFERENCE_SUCCESSFULLY_UPDATED__', 'manageuser')
                    );
                }
            });
