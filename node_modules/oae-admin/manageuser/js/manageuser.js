...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var deleteUser = function() {
            ...
            $('#manageuser-modal', $rootel).modal('lock');
            $('#manageuser-actions-deleteuser-form .manageuser-deleteuser-confirm').prop('disabled', true);

            oae.api.admin.deleteUser(widgetData.userProfile.id, function(err) {
                // When the delete request finishes re-enable the form
                $('#manageuser-modal', $rootel).modal('unlock');
                $('#manageuser-actions-deleteuser-form .manageuser-deleteuser-confirm').prop('disabled', false);
        ...
        var setUpActionsForm = function() {
            ...
            oae.api.util.template().render($('#manageuser-actions-main-template', $rootel), data,
                $('#manageuser-actions-main', $rootel));
        };
        ...
        var showActionsPanel = function(panel) {
            // Hide all action form panels
            $('#manageuser-actions > form').hide();

            // Show just the specified actions form
            $('#manageuser-actions-' + panel + '-form').show();
        };
        ...
        var addBinding = function() {
            $rootel.on('click', '#manageuser-actions-main-form button.manageuser-become-user', function() {
                oae.api.admin.getSignedBecomeRequestInfo(widgetData.userProfile.id, function(err, data) {
                    if (err) {
                        ...
                        oae.api.util.template().render($('#manageuser-become-user-form-container-template', $rootel), data, $('#manageuser-become-user-form-container', $rootel));
            ...
            $rootel.on('click', '#manageuser-actions-main-form button.manageuser-delete-user', function() {
                showActionsPanel('deleteuser');
            });

            // Delete the user when the user accepts the deleteuser confirmation
            $rootel.on('click', '#manageuser-actions-deleteuser-form .manageuser-deleteuser-confirm', deleteUser);

            // Switch back to the main panel when the user clicks the "Cancel" button in the
            // deleteuser confirmation panel
            $rootel.on('click', '#manageuser-actions-deleteuser-form .manageuser-deleteuser-cancel', function() {
                showActionsPanel('main');
            });

            $rootel.on('submit', '#manageuser-actions-main-form', editPrivileges);
