...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var reset = function() {
            ...
            // Show the first tab
            $('#manageuser-modal .tab-pane').removeClass('active');
            $('#manageuser-modal .tab-pane:first-child').addClass('active');
        };
        ...
        var editProfile = function() {
            ...
            oae.api.admin.updateUser(widgetData.userProfile.id, params, function (err, data) {
        ...
        var editPriviliges = function() {
            // Lock the modal so it cannot be closed while editing the priviliges
            $('#manageuser-modal', $rootel).modal('lock');

            oae.api.admin.editUserPriviliges(widgetData.userProfile.id, $('#manageuser-priviliges-isadmin', $rootel).is(':checked'), widgetData.context.isGlobalAdminServer, function(err) {
                // Unlock the modal
                $('#manageuser-modal', $rootel).modal('unlock');
        ...
        var setUpActionsForm = function() {
            oae.api.util.template().render($('#manageuser-actions-template', $rootel), {
                'context': widgetData.context,
                'userProfile': widgetData.userProfile
            }, $('#manageuser-actions-form .modal-body', $rootel));
        };
        ...
        var addBinding = function() {
            $rootel.on('click', '#manageuser-become-user', function() {
                oae.api.admin.becomeUser(widgetData.userProfile.id);
            });

            $rootel.on('submit', '#manageuser-actions-form', editPriviliges);
        ...
        var setUpManageUserModal = function() {
            $(document).on('oae.trigger.manageuser', function(ev, data) {
                ...
                oae.api.user.getUser(widgetData.userId, function(err, userProfile) {
                    ...
                    // Render the widget tabs
                    oae.api.util.template().render($('#manageuser-tab-template', $rootel), {
                        'context': widgetData.context
                    }, $('#manageuser-tab-container', $rootel));
            ...
            // Reset the widget after it closes
