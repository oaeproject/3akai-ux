...
define(['jquery', 'oae.core'], function($, oae) {
    return function(uid, showSettings) {
        ...
        var reset = function() {
            ...
            // Show the first tab
            $(
                '#manageuser-modal .tab-pane, #manageuser-modal .nav-tabs li',
            ).removeClass('active');
            $(
                '#manageuser-modal .tab-pane:first-child, #manageuser-modal .nav-tabs li:first-child',
            ).addClass('active');
        };
        ...
        var editProfile = function() {
            ...
            var params = {
                displayName: $.trim(
                    $('#manageuser-editprofile-name', $rootel).val(),
                ),
                email: $.trim(
                    $('#manageuser-editprofile-email', $rootel).val(),
                ),
                visibility: $(
                    '#manageuser-editprofile-form .oae-large-options-container input[type="radio"]:checked',
                    $rootel,
                ).val(),
            };

            oae.api.admin.updateUser(
                widgetData.userProfile.id,
                params,
                    ...
                    if (!err) {
                        ...
                        oae.api.util.notification(
                            ...
                            oae.api.i18n.translate(
                                '__MSG__PROFILE_DETAILS_EDIT_USER_SUCCESS__',
                                'manageuser',
                            ),
                        );

                        // Let other widgets know that the user's details have been edited
                        $(document).trigger('oae.manageuser.done', {
                            updated: updatedUser,
                        });
                    } else {
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__PROFILE_NOT_EDITED__',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__PROFILE_DETAILS_EDIT_USER_FAIL__',
                                'manageuser',
                            ),
                            'error',
                        );
        ...
        var setUpEditProfileValidation = function() {
            ...
            oae.api.util
                .validation()
                .validate(
                    $('#manageuser-editprofile-form', $rootel),
                    validateOpts,
                );
        };
        ...
        var setUpEditProfileForm = function() {
            oae.api.util.template().render(
                $('#manageuser-editprofile-template', $rootel),
                {
        ...
        var editPrivileges = function() {
            ...
            var isAdmin = $('#manageuser-privileges-isadmin', $rootel).is(
                ':checked',
            );
            oae.api.admin.editPrivileges(
                widgetData.userProfile.id,
                isAdmin,
                ...
                function(err) {
                    ...
                    if (err) {
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__PRIVILEGES_NOT_EDITED__',
                                'manageuser',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__PRIVILEGES_EDIT_FAILED__',
                                'manageuser',
                            ),
                            'error',
                        );
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__PRIVILEGES_EDITED__',
                                'manageuser',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__PRIVILEGES_EDIT_SUCCESS__',
                                'manageuser',
                            ),
                        );
                    }
        ...
        var deleteUser = function() {
            ...
            oae.api.admin.deleteUser(widgetData.userProfile.id, function(err) {
                ...
                if (err) {
                    ...
                    oae.api.util.notification(
                        oae.api.i18n.translate(
                            '__MSG__ACCOUNT_NOT_DELETED__',
                            'manageuser',
                        ),
                        oae.api.i18n.translate(
                            '__MSG__ACCOUNT_DELETE_FAIL__',
                            'manageuser',
                        ),
                        'error',
                    );
                    ...
                    $(document).trigger('oae.manageuser.done', {
                        deleted: widgetData.userProfile,
                    });

                    // Show a success notification
                    oae.api.util.notification(
                        oae.api.i18n.translate(
                            '__MSG__ACCOUNT_DELETED__',
                            'manageuser',
                        ),
                        oae.api.i18n.translate(
                            '__MSG__ACCOUNT_DELETE_SUCCESS__',
                            'manageuser',
                        ),
                    );
                }
        ...
        var setUpActionsForm = function() {
            ...
            oae.api.util
                .template()
                .render(
                    $('#manageuser-actions-template', $rootel),
                    data,
        ...
        var setUpAuthenticationForm = function() {
            ...
            oae.api.util.template().render(
                $('#manageuser-authentication-template', $rootel),
                {
                    ...
                    if (err) {
                        if (err.code === 400) {
                            ...
                            oae.api.util.notification(
                                ...
                                oae.api.i18n.translate(
                                    '__MSG__THE_PASSWORD_CANNOT_BE_CHANGED_HERE__',
                                    'manageuser',
                                ),
                                'error',
                            );
                            ...
                            oae.api.util.notification(
                                ...
                                oae.api.i18n.translate(
                                    '__MSG__THE_PASSWORD_UPDATE_FAILED__',
                                    'manageuser',
                                ),
                                'error',
                            );
                        ...
                        oae.api.util.notification(
                            ...
                            oae.api.i18n.translate(
                                '__MSG__THE_PASSWORD_SUCCESSFULLY_UPDATED__',
                                'manageuser',
                            ),
                        );
                    }
        ...
        var setUpChangePasswordValidation = function() {
            oae.api.util
                .validation()
                .validate($('#manageuser-authentication-form', $rootel), {
                    rules: {
                    ...
                    messages: {
                        'manageuser-new-password': {
                            required: oae.api.i18n.translate(
                                '__MSG__PLEASE_ENTER_THE_NEW_PASSWORD__',
                                'manageuser',
                            ),
                            minlength: oae.api.i18n.translate(
                                '__MSG__THE_PASSWORD_SHOULD_BE_AT_LEAST_SIX_CHARACTERS_LONG__',
                            ),
                        },
                        'manageuser-retype-password': {
                            required: oae.api.i18n.translate(
                                '__MSG__PLEASE_REPEAT_THE_NEW_PASSWORD__',
                                'manageuser',
                            ),
        ...
        var editEmailPreference = function() {
            ...
            var profile = {
                emailPreference: $(
                    '#manageuser-email-form .oae-large-options-container input[type="radio"]:checked',
                    $rootel,
                ).val(),
            };
            ...
            oae.api.admin.updateUser(widgetData.userId, profile, function(err) {
                ...
                if (err) {
                    ...
                    oae.api.util.notification(
                        oae.api.i18n.translate(
                            '__MSG__EMAIL_PREFERENCES_NOT_UPDATED__',
                            'manageuser',
                        ),
                        oae.api.i18n.translate(
                            '__MSG__THE_EMAIL_PREFERENCES_UPDATE_FAILED__',
                            'manageuser',
                        ),
                        'error',
                    );
                    ...
                    oae.api.util.notification(
                        oae.api.i18n.translate(
                            '__MSG__EMAIL_PREFERENCES_UPDATED__',
                            'manageuser',
                        ),
                        oae.api.i18n.translate(
                            '__MSG__THE_EMAIL_PREFERENCES_SUCCESSFULLY_UPDATED__',
                            'manageuser',
                        ),
                    );
                }
        ...
        var setUpEmailForm = function() {
            oae.api.util.template().render(
                $('#manageuser-email-template', $rootel),
                {
                    context: widgetData.context,
                    userProfile: widgetData.userProfile,
                },
        ...
        var addBinding = function() {
            $rootel.on(
                'click',
                '#manageuser-actions-form button.manageuser-become-user',
                function() {
                    oae.api.admin.getSignedBecomeRequestInfo(
                        widgetData.userProfile.id,
                        function(err, data) {
                            if (err) {
                                oae.api.util.notification(
                                    ...
                                    oae.api.i18n.translate(
                                        '__MSG__COULD_NOT_BECOME_USER_NAME__',
                                        'manageuser',
                                        {
                                            displayName: oae.api.util
                                                .security()
                                                .encodeForHTML(
                                                    widgetData.userProfile
                                                        .displayName,
                                                ),
                                        },
                                    ),
                                ...
                                oae.api.util
                                    ...
                                    .render(
                                        $(
                                            '#manageuser-become-user-form-template',
                                            $rootel,
                                        ),
                                        data,
                                        $(
                                            '#manageuser-become-user-form-container',
                                            $rootel,
                                        ),
                                    );
            ...
            $rootel.on(
                'click',
                '#manageuser-actions-form button.manageuser-delete-user',
                function() {
            ...
            $rootel.on(
                ...
                function() {
                    var $optionsContainer = $(this).closest(
        ...
        var setUpManageUserModal = function() {
            $(document).on('oae.trigger.manageuser', function(ev, data) {
                ...
                oae.api.user.getUser(widgetData.userId, function(
                    err,
                    userProfile,
                ) {
                    ...
                    oae.api.authentication.getAuthLoginIds(
                        widgetData.userProfile.id,
                        function(err, loginIds) {
                            ...
                            oae.api.util.template().render(
                                $(
                                    '#manageuser-editprofile-header-template',
                                    $rootel,
                                ),
                                {
                                ...
                                $(
                                    '#manageuser-editprofile-header-container',
                                    $rootel,
                                ),
                            );
