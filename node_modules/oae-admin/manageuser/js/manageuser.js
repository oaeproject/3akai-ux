...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var editPriviliges = function() {
            $.ajax({
                'url': '/api/user/' + widgetData.userProfile.id + '/admin',
                'type': 'POST',
                'data': {
                    'admin': $('#manageuser-priviliges-istenantadmin', $rootel).is(':checked')
                },
                'success': function() {
                ...
                'error': function() {
                    ...
                    oae.api.util.notification(
                        ...
                        oae.api.i18n.translate('__MSG__PRIVILIGES_EDIT_FAIL__', 'manageuser'),
                        'error');
                }
            });
        ...
        var setUpEditPriviligesForm = function() {
            ...
            $rootel.on('submit', '#manageuser-priviliges-form', editPriviliges);
        };
        ...
        var editProfile = function() {
            ...
            oae.api.user.updateUser(widgetData.userProfile.id, params, function (err, data) {
                if (!err) {
                    ...
                    // Show a success notification
                    oae.api.util.notification(
                        oae.api.i18n.translate('__MSG__PROFILE_EDITED__', 'manageuser'),
                        oae.api.i18n.translate('__MSG__PROFILE_DETAILS_EDIT_SUCCESS__', 'manageuser'));
                } else {
                    // Show an error notification
                    oae.api.util.notification(
                        oae.api.i18n.translate('__MSG__PROFILE_NOT_EDITED__', 'manageuser'),
                        oae.api.i18n.translate('__MSG__PROFILE_DETAILS_EDIT_FAIL__', 'manageuser'),
                        'error');
                }
            });
        ...
        var setUpManageUserModal = function() {
            ...
            $('#manageuser-modal').on('show.bs.modal', function() {
