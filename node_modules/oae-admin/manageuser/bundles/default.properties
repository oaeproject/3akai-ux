...
ARE_YOU_SURE_YOU_WANT_TO_DELETE_USER_NAME = Are you sure you want to delete <strong>${displayName}?</strong>
BECOME_USER = Become user
BECOME_USER_NAME = Become ${displayName}
COULD_NOT_BECOME_USER_NAME = Could not become ${displayName}.
COULD_NOT_DELETE_USER_NAME = Could not delete ${displayName}.
