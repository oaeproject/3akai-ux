...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        /**
         * Log out of the administration UI
         */
        var setUpLogout = function() {
            $rootel.on('click', '#adminheader-user-logout', function() {
         ...
         *
         * @param  {Object}    currentContext    Information on the current context
         */
