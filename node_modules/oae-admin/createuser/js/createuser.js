...
define(['jquery', 'oae.core'], function($, oae) {
    return function(uid, showSettings) {
        ...
        var isUserNameAvailable = function(username, callback) {
            var url =
                '/api/auth/' + currentContext.alias + '/exists/' + username;
            // The tenant alias is not needed in the URL on a tenant server
            if (
                !currentContext.isGlobalAdminServer &&
                !currentContext.isTenantOnGlobalAdminServer
            ) {
        ...
        var setUpValidation = function() {
                ...
                messages: {
                    firstName: {
                        required: oae.api.i18n.translate(
                            '__MSG__PLEASE_ENTER_FIRST_NAME__',
                            'createuser',
                        ),
                    },
                    lastName: {
                        required: oae.api.i18n.translate(
                            '__MSG__PLEASE_ENTER_LAST_NAME__',
                            'createuser',
                        ),
                    },
                    email: {
                    ...
                    username: {
                        required: oae.api.i18n.translate(
                            '__MSG__PLEASE_ENTER_USERNAME__',
                            'createuser',
                        ),
                    ...
                    password: {
                        required: oae.api.i18n.translate(
                            '__MSG__PLEASE_ENTER_PASSWORD__',
                            'createuser',
                        ),
                        minlength: oae.api.i18n.translate(
                    ...
                    password_repeat: {
                        required: oae.api.i18n.translate(
                            '__MSG__PLEASE_REPEAT_PASSWORD__',
                            'createuser',
                        ),
                    ...
                    usernameavailable: {
                        method: function(value, element) {
                            ...
                            isUserNameAvailable(value, function(available) {
                                ...
                                if (available) {
                                    $('#createuser-username-available', $rootel)
            ...
            oae.api.util
                .validation()
                .validate($('#createuser-form', $rootel), validateOpts);
        };
        ...
        var createUser = function() {
                ...
                if (err) {
                    ...
                    oae.api.util.notification(
                        oae.api.i18n.translate(
                            '__MSG__USER_NOT_CREATED__',
                            'createuser',
                        ),
                        oae.api.i18n.translate(
                            '__MSG__USER_CREATED_FAIL__',
                            'createuser',
                        ),
                        'error',
                    );
                    ...
                    oae.api.util.notification(
                        oae.api.i18n.translate(
                            '__MSG__USER_CREATED__',
                            'createuser',
                        ),
                        oae.api.i18n.translate(
                            '__MSG__USER_CREATED_SUCCESS__',
                            'createuser',
                        ),
                    );
            ...
            if (currentContext.isGlobalAdminServer) {
                oae.api.admin.createGlobalAdminUser(
                    values.username,
                    values.password,
                    displayName,
                    email,
                ...
                oae.api.admin.createTenantAdminUser(
                    tenantAlias,
                    values.username,
                    values.password,
                    displayName,
