...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
         ...
         * The ajax request in this function executes synchronously to allow a username to be checked for existence before
         * the user is created.
         *
        ...
        var createUser = function() {
            ...
            // If we're creating a user on a regular tenant we check the checkbox value
                ...
                additionalOptions.isTenantAdmin = $('#createuser-tenantadmin', $rootel).is(':checked');
            }
            ...
            oae.api.admin.createUser(values.username, values.password, displayName, additionalOptions, tenantAlias, function(err, createdUser) {
                if (err) {
        ...
        var initCreateUser = function() {
            $(document).on('oae.trigger.createuser', function(ev, data) {
                ...
                // If we're looking at an individual tenant add the option to create a tenant admin
                if (!currentContext.isGlobalAdminServer) {
