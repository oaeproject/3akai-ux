...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
         ...
         * This function executes synchronously to allow a username to be checked for existence before
         * the user is created.
         *
            ...
            var validateOpts = {
                ...
                'messages': {
                    ...
                    'password': {
                        ...
                        'minlength': oae.api.i18n.translate('__MSG__THE_PASSWORD_SHOULD_BE_AT_LEAST_SIX_CHARACTERS_LONG__', 'createuser')
                    },
                    'password_repeat': {
        ...
        var createUser = function() {
            ...
            oae.api.user.createUser(values.username, values.password, displayName, additionalOptions, null, null, tenantAlias, function(err, createdUser) {
                if (err) {
                    // Unlock the `create user` button
                    $('button, input', $rootel).prop('disabled', false);
                    // Show the error message
                    oae.api.util.notification(
                        oae.api.i18n.translate('__MSG__CREATE_USER_FAILED__', 'createuser'),
                        oae.api.i18n.translate('__MSG__COULD_NOT_SUCCESSFULLY_CREATE_A_NEW_USER__', 'createuser'),
                        'error');
                } else {
                    // Creating the user succeeded
                    $('#createuser-modal', $rootel).modal('hide');
                    oae.api.util.notification(
                        oae.api.i18n.translate('__MSG__CREATED_USER__', 'createuser'),
                        oae.api.i18n.translate('__MSG__SUCCESSFULLY_CREATED_THE_NEW_USER__', 'createuser'));
