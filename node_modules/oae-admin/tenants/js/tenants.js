...
define(['jquery', 'oae.core', 'jquery.jeditable'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var stopTenantHandler = function() {
            var tenantDisplayName = oae.api.util.security().encodeForHTML($(this).attr('data-displayName'));
        ...
        /**
         * Start a single tenant and shows a confirmation message
         */
        ...
        /**
         * Start all tenants in the system up, no exceptions, and shows a confirmation dialog.
         */
        ...
        var sortTenantsOnDisplayName = function() {
        ...
        var renderTenants = function() {
            ...
            // Sort the array based on the tenant name
