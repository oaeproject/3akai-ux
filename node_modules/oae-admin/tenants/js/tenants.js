    ...
    return function(uid, showSettings, widgetData) {
        ...
        var stopTenantHandler = function() {
            ...
            $(document).trigger('oae.trigger.confirmdialog', {
                ...
                'cancel': oae.api.i18n.translate('__MSG__CANCEL__'),
        ...
        var deleteTenantHandler = function() {
            ...
            var tenantAlias = $(this).attr('data-alias');
            $(document).trigger('oae.trigger.confirmdialog', {
                'title': oae.api.i18n.translate('__MSG__DELETE_TENANT__', 'tenants', {'displayName': tenantDisplayName}),
                'message': oae.api.i18n.translate('__MSG__DELETE_TENANT_DESCRIPTION__', 'tenants', {'displayName': tenantDisplayName}),
                'cancel': oae.api.i18n.translate('__MSG__CANCEL__'),
                'confirm': oae.api.i18n.translate('__MSG__DELETE_TENANT_CONFIRM__', 'tenants', {'displayName': tenantDisplayName}),
                ...
                'confirmed': function() {
                    deleteTenants([tenantAlias], function(err) {
                        ...
                        if (err) {
                            oae.api.util.notification(
                                oae.api.i18n.translate('__MSG__TENANT_NOT_DELETED__', 'tenants'),
                                oae.api.i18n.translate('__MSG__TENANT_COULD_NOT_BE_DELETED__', 'tenants'),
                                'error');
                        } else {
                            oae.api.util.notification(
                                oae.api.i18n.translate('__MSG__TENANT_DELETED__', 'tenants'),
                                oae.api.i18n.translate('__MSG__TENANT_DELETED_SUCCESSFULLY__', 'tenants', {'displayName': tenantDisplayName}));
                        }
                    });
                }
            });
            ...
            getToken(tenantAlias, function(err, token) {
                if (err) {
                    oae.api.util.notification(
                        ...
                        oae.api.i18n.translate('__MSG__COULD_NOT_RETRIEVE_TOKEN__', 'tenants'),
                        'error');
                } else {
            ...
            $.ajax({
                ...
                'success': function(tenant) {
                    oae.api.util.notification(
                        ...
                        oae.api.i18n.translate('__MSG__TENANT_SUCCESSFULLY_CREATED__', 'tenants', {'displayName': tenant.displayName}));
                ...
                'error': function(jqXHR, textStatus) {
                    oae.api.util.notification(
                        oae.api.i18n.translate('__MSG__TENANT_NOT_CREATED__', 'tenants'), jqXHR.responseText, 'error');
                }
            });
            return false;
        };
