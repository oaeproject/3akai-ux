...
define(['jquery', 'underscore', 'oae.core', 'iso3166', 'jquery.jeditable', 'jquery.history'], function($, _, oae, iso3166) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var isValidCountryCode = function(str) {
            return (!_.isEmpty(iso3166.country(str)));
        };
        ...
        var enableInlineEdit = function($el) {
            ...
            $el.find('.jeditable-field').editable(function(value) {
                ...
                // Trim the new and old value
                var revert = $.trim(inlineEdit.revert);
                value = $.trim(value);
                ...
                if (field === 'displayName') {
                    ...
                    if (value && !oae.api.util.validation().isValidHost(value)) {
                        oae.api.util.notification(
                            ...
                            oae.api.i18n.translate('__MSG__PLEASE_ENTER_A_VALID_EMAIL_DOMAIN__'),
                            'error');
                        return revert;
                    }
                } else if (field === 'countryCode') {
                    if (value && !isValidCountryCode(value)) {
                        oae.api.util.notification(
                            oae.api.i18n.translate('__MSG__INVALID_COUNTRY_CODE__', 'tenants'),
                            oae.api.i18n.translate('__MSG__PLEASE_ENTER_A_VALID_COUNTRY_CODE__'),
                            'error');
                        return revert;
                    }
                }
