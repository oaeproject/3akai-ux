...
define(['jquery', 'underscore', 'oae.core', 'iso3166', 'jquery.jeditable', 'jquery.history'], function($, _, oae, iso3166) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        // Variable used to cache the full list of country code options for
        // jeditable
        ...
        var createFlagHtml = function(countryCode) {
            if (countryCode) {
                return $('<img />')
                    .attr('src', '/shared/vendor/img/flags/' + countryCode + '.png')
                    .get(0)
                    .outerHTML;
            } else {
                return '';
        ...
        var init = function() {
            ...
            countryOptions = _.chain(iso3166.data)
                .map(function(iso3166Country, countryCode) {
                    return {
                        'code': countryCode,
                        'name': iso3166Country.name
                    };
                })
                .sortBy('name')
