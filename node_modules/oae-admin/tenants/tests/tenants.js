...
casper.test.begin('Widget - Tenants', function(test) {
    ...
    var verifyStartTenant = function(tenantID) {
        casper.waitForSelector(
            '.tenants-start[data-alias="' + tenantID + '"]',
            function() {
                test.assertExists(
                    '.tenants-start[data-alias="' + tenantID + '"]',
                    "The 'Start' button is present",
                );
                ...
                casper.waitForSelector('#confirmdialog-modal.in', function() {
                    test.assertExists(
                        '#confirmdialog-modal.in',
                        'A confirmation modal shows to confirm stopping the tenant',
                    );
    ...
    var verifyStopTenant = function(tenantID) {
        casper.waitForSelector(
            '.tenants-stop[data-alias="' + tenantID + '"]',
            function() {
                test.assertExists(
                    '.tenants-stop[data-alias="' + tenantID + '"]',
    ...
    var verifyRenameTenant = function(tenantID) {
        casper.waitForSelector(
            '.jeditable-container .jeditable-field[data-field="displayName"][data-alias="' +
                tenantID +
                '"]',
            function() {
                test.assertExists(
                    '.jeditable-container .jeditable-field[data-field="displayName"][data-alias="' +
                        tenantID +
                        '"]',
                    'The editable tenant name field is present',
                );
                casper.click(
                    '.jeditable-container .jeditable-field[data-field="displayName"][data-alias="' +
                        tenantID +
                ...
                test.assertExists(
                    '.jeditable-container .jeditable-field[data-field="displayName"][data-alias="' +
                        tenantID +
                        '"] form',
                    'The tenant name form is present after click',
                );
                casper.fill(
                    '.jeditable-container .jeditable-field[data-field="displayName"][data-alias="' +
                        tenantID +
                    ...
                    function() {
                        test.assertSelectorHasText(
                            '.jeditable-container .jeditable-field[data-field="displayName"][data-alias="' +
                                ...
                                '"]',
                            'New tenant name',
                            'The tenant name has been successfully changed',
                        );
                    },
                );
            },
    ...
    var verifyCreateNewTenant = function(callback) {
        ...
        test.assertExists(
            ...
            'The create tenant form is present',
        );
        ...
        casper.waitForSelector(
            ...
            function() {
                test.assertDoesntExist(
                    '#oae-notification-container .alert.alert-error',
                    'New tenant ' + tenantID + ' successfully created',
                );
                casper.click('#oae-notification-container .close');
    ...
    var verifyCreateTenantValidation = function() {
        casper.waitForSelector('#tenants-create-form', function() {
            ...
            test.assertExists(
                '#tenants-container .admin-table-striped-toggle',
                'The create tenant toggle is present',
            );
            ...
            test.assertExists(
                '#alias-error',
                'Create tenant form successfully validated empty form - alias',
            );
            test.assertExists(
                '#displayName-error',
                'Create tenant form successfully validated empty form - displayName',
            );
            test.assertExists(
                '#host-error',
                'Create tenant form successfully validated empty form - host',
            );
            ...
            test.assertExists(
                '#alias-error',
                'Create tenant form successfully validated form with missing alias',
            );
            ...
            test.assertExists(
                '#displayName-error',
                'Create tenant form successfully validated form with missing displayName',
            );
            ...
            test.assertExists(
                '#host-error',
                'Create tenant form successfully validated form with missing host',
            );
        });
    };
