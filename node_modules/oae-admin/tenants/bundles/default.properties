...
EMAIL_DOMAIN_COLON = Email Domain:
HOST = Host
HOST_COLON = Host:
...
PLEASE_ENTER_A_VALID_EMAIL_DOMAIN = Please enter a valid email domain.
PLEASE_ENTER_A_VALID_HOST_NAME = Please enter a valid host name.
RUNNING = Running
START = Start
START_ALL = Start all
START_ALL_TENANTS = Start all tenants
START_ALL_TENANTS_CONFIRM = Yes, start all tenants
START_ALL_TENANTS_DESCRIPTION = Are you sure you want to start ALL tenants?
...
STOP = Stop
STOP_ALL = Stop all
STOP_ALL_TENANTS = Stop all tenants
STOP_ALL_TENANTS_CONFIRM = Yes, stop all tenants
STOP_ALL_TENANTS_DESCRIPTION = Are you sure you want to stop ALL tenants?
...
TENANT_EMAIL_DOMAIN_FAILED = Tenant email domain failed.
TENANT_EMAIL_DOMAIN_FAILED_TO_UPDATE = The tenant email domain failed to update.
TENANT_EMAIL_DOMAIN_SUCCESSFULLY_UPDATED = The tenant email domain has been successfully updated.
TENANT_EMAIL_DOMAIN_UPDATED = Tenant email domain updated.
TENANT_HOST_FAILED = Tenant host failed.
TENANT_HOST_FAILED_TO_UPDATE = The tenant host failed to update.
TENANT_HOST_SUCCESSFULLY_UPDATED = The tenant host has been successfully updated.
TENANT_HOST_UPDATED = Tenant host updated.
TENANT_NAME_FAILED = Tenant name failed.
TENANT_NAME_FAILED_TO_UPDATE = The tenant name failed to update.
TENANT_NAME_SUCCESSFULLY_UPDATED = The tenant name has been successfully updated.
