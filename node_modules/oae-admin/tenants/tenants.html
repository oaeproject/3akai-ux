                ...
                <div class="createtenant-container clearfix hide">
                    <form method="POST" id="createtenant-form" class="form-horizontal col-sm-7" role="form">
                        <div class="form-group">
                            <label for="createtenant-alias" class="col-xs-12 col-sm-3 control-label">__MSG__ALIAS_COLON__</label>
                            <div class="col-xs-12 col-sm-9">
                                <input type="text" name="alias" id="createtenant-alias" placeholder="__MSG__ALIAS__" class="form-control required nospaces"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="createtenant-displayName" class="col-xs-12 col-sm-3 control-label">__MSG__NAME_COLON__</label>
                            <div class="col-xs-12 col-sm-9">
                                <input type="text" name="displayName" id="createtenant-displayName" placeholder="__MSG__NAME__" class="form-control required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="createtenant-host" class="col-xs-12 col-sm-3 control-label">__MSG__HOST_COLON__</label>
                            <div class="col-xs-12 col-sm-9">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <button type="submit" id="createtenant-submit-button" class="btn btn-primary pull-right">__MSG__CREATE_NEW_TENANT__</button>
                            </div>
                        </div>
                    </form>
                </div>
