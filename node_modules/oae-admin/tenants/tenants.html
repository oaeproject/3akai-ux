...
<div id="tenants-template"><!--
    ...
    {if context.isGlobalAdminServer}
        <div id="tenants-search">
            <form action="." role="search" aria-label="__MSG__SEARCH__">
                <label for="tenants-search-query" class="sr-only">__MSG__NARROW_BY_KEYWORD__</label>
                <input type="text" id="tenants-search-query" class="form-control" title="__MSG__NARROW_BY_KEYWORD__" autofocus placeholder="__MSG__NARROW_BY_KEYWORD__" />
            </form>
        </div>
    {/if}
