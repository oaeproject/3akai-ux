    ...
    function($, oae) {
        return function(uid, showSettings) {
            ...
            var setUpValidation = function() {
                oae.api.util
                    .validation()
                    .validate($('#importusers-form', $rootel), {
            ...
            var importUsers = function() {
                ...
                $('#importusers-csv', $rootel).fileupload('send', {
                    ...
                    success: function() {
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__IMPORT_USERS_STARTED__',
                                'importusers',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__IMPORT_USERS_PROGRESS__',
                                'importusers',
                            ),
                        );
                    },
                    error: function() {
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__IMPORT_USERS_NOT_STARTED__',
                                'importusers',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__IMPORT_USERS_INVALID__',
                                'importusers',
                            ),
                            'error',
                        );
