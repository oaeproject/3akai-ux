...
define(['jquery', 'oae.core', 'underscore'], function($, oae, _) {
    ...
    return function(uid, showSettings, widgetData) {
         ...
         * @param  {Object}     updateResult            An update object indicating if a user was updated or deleted
         * @param  {User}       [updateResult.updated]  If a user profile was updated, we will prepend the item into the search list
         * @param  {User}       [updateResult.deleted]  If a user account was deleted, we will remove them from the search list
         */
        var updateUserList = function(ev, updateResult) {
            if (updateResult.updated) {
                infinityScroll.prependItems({'results': [updateResult.updated]});
