    ...
    return function(uid, showSettings, widgetData) {
        ...
        var setUpListHeader = function() {
            ...
            var listHeaderActions = [{
                'icon': 'fa-download',
                'label': oae.api.i18n.translate('__MSG__DOWNLOAD_LOG__'),
                'trigger': 'downloadLog'
            }];

            // Set up the list header
            oae.api.util.template().render($('#usermanagement-list-header-template', $rootel), {
                'context': widgetData.context,
                'actions': listHeaderActions, 
                'showSearch': true
            }, $('#usermanagement-list-header', $rootel));

            $('.oae-list-selectall').hide();
            $('.downloadLog').removeAttr("disabled");
        };
        ...
        var addBinding = function() {
            ...
            // Trigger the import users dialog and pass the context data to it
            $rootel.on('click', '.downloadLog', function() {
                $(document).trigger('oae.trigger.downloadlog', widgetData);
            });
        };
