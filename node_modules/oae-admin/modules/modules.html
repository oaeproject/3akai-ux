...
<div id="modules-template"><!--
    ...
    <div class="admin-table-striped">
        {for item in schema}
            <div class="row modules-configuration-container">
                {var moduleTitle = oae.api.util.security().encodeForHTMLAttribute(item.module.title)}
                <button type="button" title="__MSG__EDIT_THE_MODULE__" class="btn modules-configuration-toggle-button">
                    <i class="icon-pencil pull-left"></i>
                    ${item.module.title|encodeForHTML}
                </button>
                <div class="modules-configuration-container hide">
