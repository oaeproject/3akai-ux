...
define(['jquery', 'oae.core', 'jquery.jeditable'], function($, oae) {
    return function(uid, showSettings, widgetData) {
        ...
        var renderConfigurationSections = function() {
            ...
            $.each(widgetData.configurationSchema, function(
            ...
            schema.sort(function(a, b) {
                if (
                    a.configurationSection.title > b.configurationSection.title
                ) {
                    return 1;
                }
                if (
            ...
            oae.api.util.template().render(
                $('#configuration-template', $rootel),
                {
                    schema: schema,
                    configuration: widgetData.configuration,
                    context: widgetData.context,
                    languages:
                        widgetData.configurationSchema['oae-principals'].user
                            .elements.defaultLanguage.list,
                },
        ...
        var updateConfiguration = function() {
            ...
            $.each(widgetData.configuration[configurationSection], function(
                option,
                optionValues,
            ) {
                $.each(optionValues, function(element, elementValue) {
                    ...
                    var configPath =
                        configurationSection + '/' + option + '/' + element;
                    if (
                        widgetData.configurationSchema[configurationSection][
                            option
                        ].elements[element].type === 'boolean'
                    ) {
                    ...
                    if (
                        widgetData.configurationSchema[configurationSection][
                            option
                        ].elements[element].type === 'internationalizableText'
                    ) {
                        // Check if the default language changed
                        if (
                            values[configPath + '/default'] !==
                            widgetData.configuration[configurationSection][
                                option
                            ][element]['default']
                        ) {
                            data[configPath + '/default'] =
                                values[configPath + '/default'];
                            widgetData.configuration[configurationSection][
                                option
                            ][element]['default'] =
                        ...
                        $.each(
                            widgetData.configurationSchema['oae-principals']
                                .user.elements.defaultLanguage.list,
                            function(i, i18n) {
                                // Continue if the value has changed
                                if (
                                    values[configPath + '/' + i18n.value] !==
                                    widgetData.configuration[
                                        configurationSection
                                    ][option][element][i18n.value]
                                ) {
                                    // We shouldn't submit empty values
                                    if (
                                        values[
                                            configPath + '/' + i18n.value
                                        ] !== ''
                                    ) {
                                        data[configPath + '/' + i18n.value] =
                                            values[
                                                configPath + '/' + i18n.value
                                            ];
                                        widgetData.configuration[
                    ...
                    if (
                        values[configPath] !== elementValue &&
                        widgetData.configurationSchema[configurationSection][
                            option
                        ].elements[element].type !== 'internationalizableText'
                    ) {
                        data[configPath] = values[configPath];
                        widgetData.configuration[configurationSection][option][
                            element
                        ] =
                            values[configPath];
                    }
            ...
            if (!$.isEmptyObject(data)) {
                $.ajax({
                    ...
                    success: function() {
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__CONFIGURATION_SAVED__',
                                'configuration',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__CONFIGURATION_SUCCESSFULLY_SAVED__',
                                'configuration',
                            ),
                        );
                    },
                    error: function() {
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__CONFIGURATION_NOT_SAVED__',
                                'configuration',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__CONFIGURATION_COULD_NOT_BE_SAVED__',
                                'configuration',
                            ),
                            'error',
                        );
        ...
        var toggleInternationalizableFieldContainer = function() {
            ...
            var $targetContainer = $(this).parents(
                '.configuration-internationalizable-text-container',
            );
        ...
        var addBinding = function() {
            ...
            $rootel.on(
                'change',
                '.admin-internationalizabletext-language-picker',
                toggleInternationalizableFieldContainer,
            );
        };
