...
<div id="adminlogin-authentication-template"><!--
    ...
    {if hasExternalAuth}
        <div class="row">
            <div id="adminlogin-external" {if hasLocalAuth} class="adminlogin-external-divider"{/if}>
                <ul class="nav">
    ...
    {if hasLocalAuth}
        <div class="row">
            <form id="adminlogin-local" class="form-horizontal" role="form">
                <div class="form-group">
                    <label for="adminlogin-local-username" class="control-label col-xs-12 col-sm-3">__MSG__USERNAME__</label>
                    <div class="col-xs-12 col-sm-9">
                        <input type="text" id="adminlogin-local-username" name="username" class="form-control required" autofocus/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="adminlogin-local-password" class="control-label col-xs-12 col-sm-3">__MSG__PASSWORD__</label>
                    <div class="col-xs-12 col-sm-9">
                        <input type="password" id="adminlogin-local-password" name="password" class="form-control required"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
