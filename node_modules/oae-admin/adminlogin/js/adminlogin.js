    ...
    return function(uid) {
        ...
        var doLogin = function() {
            ...
            if (LDAPEnabled && LocalEnabled) {
                oae.api.authentication.LDAPLogin(username, password, null, function(err) {
                    if (err) {
                        oae.api.authentication.localLogin(username, password, null, finishLogin);
                    } else {
                        finishLogin();
                    }
                });
            // Only LDAP is enabled
                ...
                oae.api.authentication.LDAPLogin(username, password, null, finishLogin);
