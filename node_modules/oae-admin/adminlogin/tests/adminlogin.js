...
casper.test.begin('Widget - Login', function(test) {
    ...
    var verifyLoginValidation = function() {
        casper.waitForSelector('#adminlogin-local', function() {
            ...
            test.assertExists(
                '#adminlogin-local-username-error',
                'Log in form successfully validated empty form - username',
            );
            test.assertExists(
                '#adminlogin-local-password-error',
                'Log in form successfully validated empty form - password',
            );
            ...
            test.assertExists(
                '#adminlogin-local-username-error',
                'Log in form successfully validated empty username field',
            );
            ...
            test.assertExists(
                '#adminlogin-local-password-error',
                'Log in form successfully validated empty password field',
            );
    ...
    casper.start(configUtil.adminUI, function() {
        ...
        casper.then(function() {
            ...
            casper.then(function() {
                test.assertExists(
                    '#adminheader-content #adminheader-logout',
                    'Successfully logged in to the administration interface',
                );
            });
        });
        ...
        casper.then(function() {
            ...
            casper.waitForSelector('#adminlogin-local', function() {
                test.assertExists(
                    '#adminlogin-local',
                    'Successfully logged out of the administration interface',
                );
            });
        });
