...
casper.test.begin('Widget - Login', function(test) {
    ...
    casper.start(configUtil().adminUI, function() {
        ...
        casper.then(function() {
            casper.echo('# Verify logging in to the administration interface', 'GREEN_BAR');
            userUtil().doAdminLogIn(configUtil().adminUsername, configUtil().adminPassword);
            casper.waitForSelector('.oae-lhnavigation ul', function() {
        ...
        // Verify logging out
        casper.then(function() {
            casper.echo('# Verify logging out of the administration interface', 'GREEN_BAR');
            userUtil().doAdminLogOut();
            casper.waitForSelector('#adminlogin-form', function() {
                test.assertExists('#adminlogin-form', 'Successfully logged out of the administration interface');
            });
        });

        // Verify form validation
        casper.then(function() {
            casper.echo('# Verify log in form validation', 'GREEN_BAR');
