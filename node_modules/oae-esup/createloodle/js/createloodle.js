...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var setUpSetPermissions = function() {
            ...
            // Determine the default selection of people and groups the loodle should be shared with
            var preFill = [];
            var ghosts = [];
            ...
            // If the current user is creating the loodle from its personal space,
            // `My Library` is added as a fixed item
            if (contextData.id === oae.data.me.id) {
                preFill.push($.extend({
                    'fixed': true
                }, userItem));
            // If the current user is creating the loodle from within a group,
