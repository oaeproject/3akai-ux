...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        var renderTransferPanel = function() {
            ...
            // Get the TTL of the trantransfer-sfer to informe the user
            timeTransfer = oae.api.config.getValue('oae-transfer', 'TTL', 'value');
            ...
            $('#transfer-generate-code-form', $rootel).on(oae.api.util.getFormChangeEventNames(), function() {
                if (oae.api.util.validation().isValidEmail($('#user-autosuggest').val())) {
                    $('#transfer-generate-code-form button[type="submit"]', $rootel).prop('disabled', false);
                }
                else{
                    $('#transfer-generate-code-form button[type="submit"]', $rootel).prop('disabled', true);
                }                
            });

            $('#transfer-make-transfer-form', $rootel).on(oae.api.util.getFormChangeEventNames(), function() {
                if ($('#code').val().length == 20 && oae.api.util.validation().isValidEmail($('#transfer-original-email-is-valide').val())) {
                    $('#transfer-make-transfer-form button[type="submit"]', $rootel).prop('disabled', false);
                }
                else{
                    $('#transfer-make-transfer-form button[type="submit"]', $rootel).prop('disabled', true);
                }                
            });
        };
