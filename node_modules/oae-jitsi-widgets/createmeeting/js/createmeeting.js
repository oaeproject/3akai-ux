define(['jquery', 'oae.core'], function($, oae) {
    return function(uid) {
        ...
        var createMeeting = function() {
            ...
            var meetingName = $.trim(
                $('#createmeeting-jitsi-name', $rootel).val(),
            );
            var meetingDescription = $.trim(
                $('#createmeeting-jitsi-description', $rootel).val(),
            );
            var meetingChat = $('#createmeeting-jitsi-chat')
                .is(':checked')
                .toString();
            var meetingContactList = $('#createmeeting-jitsi-contact-list')
                .is(':checked')
                .toString();

            // Create the meeting
            oae.api.meetingJitsi.createMeeting(
                meetingName,
                meetingDescription,
                meetingChat,
                meetingContactList,
                ...
                function(err, data) {
                    ...
                    if (!err) {
                        ...
                        // Re-enable the form
                        $('#createmeeting-jitsi-form *', $rootel).prop(
                            'disabled',
                            false,
                        );
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__MEETING_NOT_CREATED__',
                                'createmeeting',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__MEETING_CREATE_FAIL__',
                                'createmeeting',
                            ),
                            'error',
                        );
        ...
        var setUpReset = function() {
            $('#createmeeting-jitsi-modal', $rootel).on(
                'hidden.bs.modal',
                function() {
                    // Reset the form
        ...
        var setUpCreateMeeting = function() {
            ...
            oae.api.util
                .validation()
                .validate(
                    $('#createmeeting-jitsi-form', $rootel),
                    validateOpts,
                );
        };
        ...
        var setUpSetPermissions = function() {
            ...
            var $setPermissionsContainer = $(
                '#createmeeting-jitsi-permissions-container',
                $rootel,
            );
            ...
            $(document).on(
                ...
                function(ev, data) {
                    ...
                    $('#createmeeting-jitsi-permissions', $rootel).html(
                        data.summary,
                    );
        ...
        var setUpCreateMeetingModal = function() {
            $(document).on(
                'click',
                '.oae-trigger-createmeeting-jitsi',
                function() {
