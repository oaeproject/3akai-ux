define(['jquery', 'oae.core'], function($, oae) {
    return function(uid) {
        ...
        var setUpReset = function() {
            $('#editmeeting-jitsi-modal', $rootel).on(
                ...
                function() {
                    ...
                    $('#editmeeting-jitsi-form *', $rootel).prop(
                        'disabled',
                        false,
                    );
                    $(
                        '#editmeeting-jitsi-form button[type="submit"]',
                        $rootel,
                    ).prop('disabled', true);
                },
            );
        ...
        var editMeeting = function() {
            ...
            var params = {
                displayName: $.trim(
                    $('#editmeeting-jitsi-name', $rootel).val(),
                ),
                description: $.trim(
                    $('#editmeeting-jitsi-description', $rootel).val(),
                ),
                chat: $('#editmeeting-jitsi-chat')
                    .is(':checked')
                    .toString(),
                contactList: $('#editmeeting-jitsi-contact-list')
                    .is(':checked')
                    .toString(),
            };

            oae.api.meetingJitsi.updateMeeting(
                meetingProfile.id,
                params,
                function(err, data) {
                    ...
                    if (!err) {
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__MEETING_EDITED__',
                                'editmeeting-jitsi',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__MEETING_EDIT_SUCCESS__',
                                'editmeeting-jitsi',
                            ),
                        );
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__MEETING_NOT_EDITED__',
                                'editmeeting-jitsi',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__MEETING_EDIT_FAIL__',
                                'editmeeting-jitsi',
                            ),
                            'error',
                        );
        ...
        var setUpEditMeeting = function() {
            ...
            oae.api.util.template().render(
                $('#editmeeting-jitsi-template', $rootel),
                {
            ...
            oae.api.util
                .validation()
                .validate($('#editmeeting-jitsi-form', $rootel), validateOpts);
        };
        ...
        var setUpEditMeetingModal = function() {
            ...
            $(document).on('oae.context.send.editmeeting-jitsi', function(
                e,
                data,
            ) {
                meetingProfile = data;
            ...
            $('#editmeeting-jitsi-form', $rootel).on(
