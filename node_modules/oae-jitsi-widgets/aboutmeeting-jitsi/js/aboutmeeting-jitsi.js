    ...
    return function(uid) {
        ...
        var renderMetadata = function(meetingProfile) {
            oae.api.util.template().render(
                $('#aboutmeeting-jitsi-template', $rootel),
                {
        ...
        var setUpAboutMeeting = function() {
            $(document).on('click', '.oae-trigger-aboutmeeting-jitsi', function(
                e,
                data,
            ) {
            ...
            $(document).on('oae.context.send.aboutmeeting-jitsi', function(
                e,
                meetingProfile,
            ) {
