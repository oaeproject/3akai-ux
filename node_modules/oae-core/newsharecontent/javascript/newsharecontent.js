...
require(['jquery', 'sakai/sakai.api.core', 'underscore'], function($, sakai, _) {
    ...
    sakai_global.newsharecontent = function(tuid, showSettings) {
        ...
        var fillShareData = function(hash) {
            ...
            for (var s in svcs) {
                if (s==='twitter') {
                    addThisTitle = sakai.api.i18n.getValueForKey('SHARE_EXT_MSG1','newsharecontent')+shareData.filename.replace(/'/gi,'')+' '+sakai.api.i18n.getValueForKey('SHARE_EXT_MSG2','newsharecontent')+' ' +sakai.api.i18n.getValueForKey('TITLE_PREFIX');
                }
                else{
                    addThisTitle =  shareData.filename.replace(/"/gi,'')+' '+sakai.api.i18n.getValueForKey('SHARE_EXT_MSG2','newsharecontent')+' ' + sakai.api.i18n.getValueForKey('TITLE_PREFIX');
                }
