<!-- CSS -->
<link rel="stylesheet" type="text/css" href="/node_modules/oae-core/newsharecontent/css/newsharecontent.css" />
    ...
    <div id="newsharecontent" class="newsharecontent_dialog">
        ...
        <div class="oae-popover-container clearfix">
            ...
            <form id="newsharecontent_form">
                <div class="oae-popover-inner">
                    <div id="newsharecontent_container">
                        <div id="newsharecontent_canshare_container">
                            <span class="newsharecontent_user_function oae-form-field-wrapper" style="display:none;">
                                <div id="newsharecontent_sharelist_container">
                                    ...
                                    <input type="text" id="newsharecontent_sharelist" name="newsharecontent_sharelist" class="requiredsuggest oae-input-full-width oae-error-autosuggest"/>
                                </div>
                ...
                <button type="submit" id="sharecontent_send_button" class="oae-button oae-header-button oae-header-smaller-button oae-force-right newsharecontent_user_function" style="display:none;">__MSG__SHARE__</button>
                <button id="newsharecontent_cancel" class="jqmClose oae-link-button oae-bold oae-force-right" type="button">__MSG__CANCEL__</button>
            </form>
        </div>
    </div>
</div>
...
<!-- JAVASCRIPT -->
<script type="text/javascript" src="/node_modules/oae-core/newsharecontent/javascript/newsharecontent.js"></script>
