...
define(
    ...
    function ($, oae, timeago, infiniteScroll) {

        return function (uid, showSettings, constants) {
            ...
            var addBinding = function() {
                $('a').bind('click', onItemClickedHandler);
            };

            var onItemClickedHandler = function(e) {
                $(document).trigger(constants.events.activities.detailclicked, e);
            };
