...
define(
    [
        'jquery', 'oae.core',
        'jquery.timeago', 'jquery.infinitescroll',
        '../../../../mobile/js/constants/constants.js'
    ],
    function ($, oae, timeago, infiniteScroll, constants) {
    ...
    return function (uid, showSettings) {
        ...
        var initChildren = function() {
            console.log('[mobileactivity] initChildren');
        };
        ...
        var handleEmptyResultList = function() {
            ...
            console.log('[mobileactivity] handleEmptyResultList');

            oae.api.util.template().render('#mobileactivity-noresults-template', {}, $('.oae-list', $rootel));
        };
        ...
        var constructCommentTree = function(comments) {
            ...
            console.log('[mobileactivity] constructCommentTree');
        ...
        var parseActivity = function(data) {
            ...
            console.log('[mobileactivity] parseActivity');
        ...
        var getActivity = function() {
            ...
            console.log('[mobileactivity] getActivity');
            ...
            var url = '/api/activity/' + oae.data.me.id;
        ...
        /**
         * Initialize this mobileactivity widget
         */
        var init = function () {
            // Init children
            initChildren();
