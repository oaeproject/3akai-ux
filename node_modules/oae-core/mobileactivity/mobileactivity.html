...
<div id="mobileactivity-container">
    ...
    {macro renderCommentBox(actor, comment)}
        ...
        <div class="media-body">
            <h4 class="media-heading">
                {if actor.url}
                    <a href="#" title="${actor.displayName|safeUserInput}__MSG__S_PROFILE__">
        ...
        <div class="activity-item-container well">
            <div class="activity-entity-container">
                ...
                <div class="activity-entity-name oae-threedots oae-bold">
                    {if mainActor.url}
                        <a href="#" title="${mainActor.displayName|safeUserInput}__MSG__S_PROFILE__">${mainActor.displayName|safeUserInput}</a>
                    {else}
                ...
                <div class="activity-entity-name oae-threedots oae-bold">
                    {if activity.object['oae:collection']}
                        {if activity.actor.url}
                            <a href="#" title="${activity.actor.displayName|safeUserInput}__MSG__S_PROFILE__">${activity.actor.displayName|safeUserInput}</a>
                        {else}
    ...
    {macro renderCreateContentActivity(activity)}
        <div class="activity-item-container well">
            ...
            <div class="oae-mobile-tile-content-wrapper">
                ...
                <div class="oae-mobile-tile-bottom">
                    <span class="comments"><span>comments</span></span>
                    <span class="timeago"><span>time ago</span></span>
                </div>
            </div>
        </div>
    {/macro}
