...
<div id="mobileactivity-items-template" class="oae-hidden"><!--
    {macro renderCommentActorThumbnail(mainActor)}
        <a href="#me" title="${entityData.displayName|encodeForHTMLAttribute}">
    ...
    {macro renderSingleBox(entity)}
        <li>
            <div class="oae-tile">
                <a title="${entity.displayName|encodeForHTMLAttribute}" href="#detail:${entity['oae:id']}">
                    <div class="oae-thumbnail oae-thumbnail-large icon-oae-${entity.objectType}">
                        {if entity.image}
                            <img src="${entity.image.url}" alt="${entity.displayName|encodeForHTMLAttribute}"/>
                        {/if}
                    </div>
                </a>
            </div>
    ...
    {macro renderCommentBox(actor, comment)}
        ...
        <div class="media-body">
            <h4 class="media-heading">
                {if actor.url}
                    <a href="#me" title="${actor.displayName|encodeForHTMLAttribute}__MSG__S_PROFILE__">
                        ${actor.displayName|encodeForHTMLAttribute}
                    </a>
                {else}
                    ${actor.displayName|encodeForHTMLAttribute}
                {/if}
            ...
            <div class="activity-entity-container">
                ...
                <div class="activity-entity-name oae-threedots oae-bold">
                    <span class="activity-title">
                        {if mainActor.url}
                            <a href="#me" title="${mainActor.displayName|encodeForHTMLAttribute}__MSG__S_PROFILE__">${mainActor.displayName|encodeForHTMLAttribute}</a>
                        {else}
                            ${mainActor.displayName|encodeForHTMLAttribute}
                        {/if}
                        {if activity.actor['oae:collection']}
                            <span> and ${activity.actor['oae:collection'].length - 1} {if (activity.actor['oae:collection'].length - 1) === 1} __MSG__OTHER__{else} __MSG__OTHERS__{/if} __MSG__COMMENTED_ON__</span> <a href="#detail:${activity.target['oae:id']}" title="${activity.target.displayName|encodeForHTMLAttribute}__MSG__S_PROFILE__">${activity.target.displayName|encodeForHTMLAttribute}</a>
                        {else}
                            <span>__MSG__COMMENTED_ON__</span> <a href="#detail:${activity.target['oae:id']}" title="${activity.target.displayName|encodeForHTMLAttribute}__MSG__S_PROFILE__">${activity.target.displayName|encodeForHTMLAttribute}</a>
                        {/if}
                    </span>
                </div>
            ...
            <div class="activity-entity-container">
                    ...
                    <span class="activity-title">
                        {if activity.object['oae:collection']}
                            {if activity.actor.url}
                                <a href="#me" title="${activity.actor.displayName|encodeForHTMLAttribute}__MSG__S_PROFILE__">${activity.actor.displayName|encodeForHTMLAttribute}</a>
                            {else}
                                ${activity.actor.displayName|encodeForHTMLAttribute}
                            {/if}
                            <span> shared the PDF</span> <a href="#detail:${activity.object['oae:collection'][0].url}" title="${activity.object['oae:collection'][0].displayName|encodeForHTMLAttribute}">${activity.object['oae:collection'][0].displayName|encodeForHTMLAttribute}</a> and ${activity.object['oae:collection'].length - 1} {if (activity.object['oae:collection'].length - 1) === 1} __MSG__OTHER__{else} __MSG__OTHERS__{/if}
                        {else}
                            {if activity.actor.url}
                                <a href="#me" title="${activity.actor.displayName|encodeForHTMLAttribute}__MSG__S_PROFILE__">${activity.actor.displayName|encodeForHTMLAttribute}</a>
                            {else}
                                ${activity.actor.displayName|encodeForHTMLAttribute}
                            {/if}
                            <span> shared the PDF</span> <a href="#detail:${activity.target['oae:id']}" title="${activity.object.displayName|encodeForHTMLAttribute}">${activity.object.displayName|encodeForHTMLAttribute}</a>
                        {/if}
                    </span>
                </div>
                {if activity.target['oae:collection']}
                    <div class="activity-timeago">__MSG__WITH__
                        {if activity.target['oae:collection'][0].url}
                            <a href="#detail:${activity.target['oae:collection'][0].url}" title="${activity.target['oae:collection'][0].displayName|encodeForHTMLAttribute}__MSG__S_PROFILE__">${activity.target['oae:collection'][0].displayName|encodeForHTMLAttribute}</a>
                        {else}
                            ${activity.target['oae:collection'][0].displayName|encodeForHTMLAttribute}
                        {/if}
                ...
                {else}
                    ...
                    {if activity.target.url}
                        <a href="#detail:${activity.target['oae:id']}" title="${activity.target.displayName|encodeForHTMLAttribute}__MSG__S_PROFILE__">${activity.target.displayName|encodeForHTMLAttribute}</a>
                    {else}
                        ${activity.target.displayName|encodeForHTMLAttribute}
                    {/if}
                ...
                <div class="activity-entity-name oae-threedots oae-bold">
                    <span class="activity-title">
                        ...
                        {else}
                            ${activity.actor.displayName|encodeForHTMLAttribute}
                        {/if}
                        <span>__MSG__CREATED__</span> <a href="#detail:${activity.object['oae:id']}" title="${activity.object.displayName|encodeForHTMLAttribute}__MSG__S_PROFILE__">${activity.object.displayName|encodeForHTMLAttribute}</a>
                        {if activity.object['oae:collection']}
    ...
    {macro renderLargeContentPreview(actor, content, comments, withbottom)}
        ...
        <ul class="oae-list oae-list-grid clearfix">
            <li class="oae-tile-large">
                <div class="oae-tile">
                    <a title="${content.displayName|encodeForHTMLAttribute}" href="#detail:${content['oae:id']}">
        ...
        <div class="activity-comment-container">
            {if comments && comments['oae:collection']}
                ...
                <a href="#detail:${content['oae:id']}" title="${content.displayName|encodeForHTMLAttribute}" class="oae-bold activity-read-more text-center">__MSG__SHOW_MORE__...</a>
            {elseif comments}
                <ul class="media-list">
                    <li class="media">
                ...
                <div class="activity-entity-name oae-threedots oae-bold">
                    <span class="activity-title">
                        ...
                        {else}
                            ${activity.actor.displayName|encodeForHTMLAttribute}
                        {/if}
                        <span>__MSG__CREATED_THE_GROUP__</span> <a href="#detail:${activity.object['oae:id']}" title="${activity.object.displayName|encodeForHTMLAttribute}__MSG__S_PROFILE__">${activity.object.displayName|encodeForHTMLAttribute}</a>
                    </span>
                </div>
            </div>
                ...
                <div class="activity-entity-name oae-threedots oae-bold">
                    ...
                    {if activity.object['oae:collection']}
                        {if activity.object['oae:collection'][0].url}
                            <a href="#detail:${activity.object['oae:collection'][0].url}" title="${activity.object['oae:collection'][0].displayName|encodeForHTMLAttribute}__MSG__S_PROFILE__">${activity.object['oae:collection'][0].displayName|encodeForHTMLAttribute}</a>
                        {else}
                            ${activity.object['oae:collection'][0].displayName|encodeForHTMLAttribute}
                        {/if}
                    ...
                    {else}
                        {if activity.object.url}
                            <a href="#detail:${activity.object.url}" title="${activity.object.displayName|encodeForHTMLAttribute}__MSG__S_PROFILE__">${activity.object.displayName|encodeForHTMLAttribute}</a>
                        {else}
                            ${activity.object.displayName|encodeForHTMLAttribute}
                        {/if}
                    {/if}
                    <span>__MSG__TO_THE_GROUP__</span> <a href="#detail:${activity.target['oae:id']}" title="${activity.target.displayName|encodeForHTMLAttribute}__MSG__S_PROFILE__">${activity.target.displayName|encodeForHTMLAttribute}</a>
                </div>
            </div>
