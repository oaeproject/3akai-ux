    ...
    {macro renderPreview(activity)}
        <div class="activity-preview-container clearfix">
            ...
            {if previewObj['oae:wideImage']}
                <ul class="oae-list oae-list-grid activity-wide row">
                    ${listItem(previewObj, null, false, previewObj['oae:wideImage'].url, false)}
                </ul>
            {else}
                ...
                <ul class="oae-list oae-list-grid row">
                    {for largePreview in largePreviews}
                        ${listItem(largePreview, null, false, false, true)}
                    {/for}
                    {if smallPreviews}
