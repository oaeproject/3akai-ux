        ...
        {macro renderVisibilityUpdateActivity(activity)}
            <div class="activity-item-container well">
                <div class="activity-entity-container">
                    ...
                    <div class="activity-entity-name oae-threedots oae-bold">
                    {if activity.actor.url}
                        <a href="${activity.actor.url|encodeForURL}">${activity.actor.displayName|encodeForHTML}</a>
                    {else}
                        ${activity.actor.displayName|encodeForHTML}
                    {/if}
                        <span>
        ...
        {macro renderContentUpdate(activity)}
            <div class="activity-item-container well">
                <div class="activity-entity-container">
                    ...
                    <div class="activity-entity-name oae-threedots oae-bold">
                    {if activity.actor.url}
                        <a href="${activity.actor.url|encodeForURL}" title="${activity.actor.displayName|encodeForHTMLAttribute}">${activity.actor.displayName|encodeForHTML}</a>
                    {else}
                        ${activity.actor.displayName}
                    {/if}
                    <span>__MSG__UPDATED_CONTENT__</span> <a href="${activity.object.url}" title="${activity.object.displayName}">${activity.object.displayName}</a>
