                    ...
                    {for item in activity.latestComments}
                        <li class="media activity-level-${item.level}">
                            ...
                            <div class="media-body">
                                ...
                                ${oae.api.util.security().encodeForHTMLWithLinks(item.comment.content).replace(/\n/g, '<br/>')}
                            </div>
                        </li>
                    {/for}
                    ...
                    {for annotation in activity.latestAnnotations}
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <q>${annotation['oae:annotation'].quote}</q><br />
                                ${oae.api.util.security().encodeForHTMLWithLinks(annotation['oae:annotation'].text)}
                            </div>
                        </li>
                    {/for}
