...
<div class="activity-widget">
    ...
    <div id="activity-items-template" class="oae-hidden"><!--
        {macro renderSingleBox(entity)}
            <li>
                <div class="oae-tile">
                    <a title="${entity.displayName|safeUserInput}" href="${entity.url}">
                    ...
                    <div>
                        <i class="icon-oae-${entity['oae:visibility']} pull-left"></i>
                        <h3 class="oae-threedots">
                            <a href="${entity.url}">${entity.displayName|safeUserInput}</a>
                        </h3>
                        {if entity.objectType === 'content'}
                            <small class="oae-threedots">Other document</small>
                        {elseif entity.objectType === 'group'}
        ...
        {macro renderCommentActivity(activity)}
            ...
            <div class="activity-item-container well">
                <div class="activity-entity-container">
                    ...
                    <div class="activity-timeago">${$.timeago(new Date(activity.published))}</div>
        ...
        {macro renderLargeContentPreview(actor, content, comments)}
            ...
            <ul class="oae-list oae-list-grid clearfix">
                <li class="oae-tile-large">
                    <div class="oae-tile">
                        <a title="${content.displayName|safeUserInput}" href="${content.url}">
                        ...
                        <div>
                            <i class="icon-oae-${content['oae:visibility']} pull-left"></i>
                            <h3 class="oae-threedots">
                                <a href="${content.url}">${content.displayName|safeUserInput}</a>
                            </h3>
                            {if content.objectType === 'content'}
                                <small class="oae-threedots">Other document</small>
                            {elseif content.objectType === 'group'}
                                <small class="oae-threedots">__MSG__GROUP__</small>
                            {/if}
                        </div>
                    </div>
            ...
            <div class="activity-comment-container">
                {if comments && comments['oae:collection']}
                    ...
                    <a href="${content.url}" title="${content.displayName|safeUserInput}" class="oae-bold activity-read-more text-center">__MSG__SHOW_MORE__...</a>
                {elseif comments}
                    <ul class="media-list">
                        <li class="media">
                ...
                <div class="activity-entity-container">
                    ...
                    <div class="activity-entity-name oae-threedots oae-bold">
                        ...
                        {else}
                            ${activity.actor.displayName|safeUserInput}
                        {/if}
                        <span>__MSG__CREATED_THE_GROUP__</span> <a href="${activity.object.url}" title="${activity.object.displayName|safeUserInput}__MSG__S_PROFILE__">${activity.object.displayName|safeUserInput}</a>
                    </div>
                    <div class="activity-timeago">${$.timeago(new Date(activity.published))}</div>
                </div>
