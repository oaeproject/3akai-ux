...
<div id="activity-items-template"><!--
    ...
    {macro renderPreview(activity)}
        ...
        {if activity.summary.i18nKey.indexOf('ACTIVITY_MEETUP_JOIN') > 0}
            {if activity.summary.i18nArguments.object1URL}
                {var groupId = activity.summary.i18nArguments.object1URL.substring(activity.summary.i18nArguments.object1URL.lastIndexOf('/') + 1, activity.summary.i18nArguments.object1URL.length)}
                <div>
                    <a target="_blank" href="http://guest.oae.com/api/meetup/g:guest:${groupId}/end">End Meetup</a>
                </div>
            {/if}
        {/if}
    {/macro}
