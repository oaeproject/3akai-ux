...
<div id="activity-items-template"><!--
    {macro renderSummary(activity)}
        <div class="activity-summary-container clearfix">
            ...
            <div class="activity-summary">
                ...
                <small class="muted"><time datetime=${oae.api.l10n.timeAgo(activity.created)}></time></small>
            </div>
        </div>
    {/macro}
    ...
    {macro renderPreview(activity)}
        <div class="activity-preview-container">
            {if activity.previews.length === 1 && activity.previews[0]['oae:wideImage']}
                <ul class="row oae-list oae-list-grid activity-wide">
                    ${listItem(activity.previews[0], null, false, activity.previews[0]['oae:wideImage'].url, null, 'col-xs-12 col-lg-6')}
                </ul>
            {else}
                <ul class="row oae-list oae-list-grid" data-items="${activity.previews.length}">
                    {for item in activity.previews}
