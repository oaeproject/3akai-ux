...
<div class="activity-widget">
    ...
    <div id="activity-items-template" class="oae-hidden"><!--
        {macro renderSingleBox(entity)}
            <li>
                <div class="oae-tile">
                    <a title="${entity.displayName|encodeForHTMLAttribute}" href="${entity.url}">
                    ...
                    <div>
                        ...
                        <h3 class="oae-threedots">
                            <a href="${entity.url}">${entity.displayName|encodeForHTML}</a>
                        </h3>
        ...
        {macro renderCommentBox(actor, comment)}
            ...
            <div class="media-body">
                <h4 class="media-heading">
                    {if actor.url}
                        <a href="${actor.url}" title="${actor.displayName|encodeForHTML}__MSG__S_PROFILE__">
            ...
            <div class="activity-item-container well">
                <div class="activity-entity-container">
                    ...
                    <div class="activity-entity-name oae-threedots oae-bold">
                        {if mainActor.url}
                            <a href="${mainActor.url}" title="${mainActor.displayName|encodeForHTML}__MSG__S_PROFILE__">${mainActor.displayName|encodeForHTML}</a>
                        {else}
                            ${mainActor.displayName|encodeForHTML}
                        {/if}
                        {if activity.actor['oae:collection']}
                            <span> and ${activity.actor['oae:collection'].length - 1} {if (activity.actor['oae:collection'].length - 1) === 1} __MSG__OTHER__{else} __MSG__OTHERS__{/if} __MSG__COMMENTED_ON__</span> <a href="${activity.target.url}" title="${activity.target.displayName|encodeForHTML}__MSG__S_PROFILE__">${activity.target.displayName|encodeForHTML}</a>
                        {else}
                            <span>__MSG__COMMENTED_ON__</span> <a href="${activity.target.url}" title="${activity.target.displayName|encodeForHTML}__MSG__S_PROFILE__">${activity.target.displayName|encodeForHTML}</a>
                        {/if}
                    </div>
                ...
                <div class="activity-entity-container">
                    ...
                    <div class="activity-entity-name oae-threedots oae-bold">
                        {if activity.object['oae:collection']}
                            {if activity.actor.url}
                                <a href="${activity.actor.url}" title="${activity.actor.displayName|encodeForHTML}__MSG__S_PROFILE__">${activity.actor.displayName|encodeForHTML}</a>
                            {else}
                    ...
                    {if activity.target['oae:collection']}
                        <div class="activity-timeago">__MSG__WITH__
                            {if activity.target['oae:collection'][0].url}
                                <a href="${activity.target['oae:collection'][0].url}" title="${activity.target['oae:collection'][0].displayName|encodeForHTML}__MSG__S_PROFILE__">${activity.target['oae:collection'][0].displayName|encodeForHTML}</a>
                            {else}
                    ...
                    {else}
                        ...
                        {if activity.target.url}
                            <a href="${activity.target.url}" title="${activity.target.displayName|encodeForHTML}__MSG__S_PROFILE__">${activity.target.displayName|encodeForHTML}</a>
                        {else}
            ...
            <div class="activity-item-container well">
                <div class="activity-entity-container">
                    ...
                    {else}
                        ${activity.actor.displayName|encodeForHTML}
                    {/if}
                    <span>__MSG__CREATED__</span> <a href="${activity.object.url}" title="${activity.object.displayName|encodeForHTML}__MSG__S_PROFILE__">${activity.object.displayName|encodeForHTML}</a>
        ...
        {macro renderLargeContentPreview(actor, content, comments)}
            ...
            <ul class="oae-list oae-list-grid clearfix">
                <li class="oae-tile-large">
                    <div class="oae-tile">
                        <a title="${content.displayName|encodeForHTMLAttribute}" href="${content.url}">
                            <div class="oae-thumbnail oae-thumbnail-large icon-oae-${content.objectType} icon-oae-${content['oae:contentType']}">
                                {if content.image}
                                    <img src="${content.image.url}" alt="${content.displayName|encodeForHTMLAttribute}"/>
                                {/if}
                            </div>
                        </a>
                        <div>
                            ...
                            <h3 class="oae-threedots">
                                <a href="${content.url}">${content.displayName|encodeForHTML}</a>
                            </h3>
                ...
                <div class="activity-entity-container">
                    ...
                    <div class="activity-entity-name oae-threedots oae-bold">
                        ...
                        {else}
                            ${activity.actor.displayName|encodeForHTML}
                        {/if}
                        <span>__MSG__CREATED_THE_GROUP__</span> <a href="${activity.object.url}" title="${activity.object.displayName|encodeForHTML}__MSG__S_PROFILE__">${activity.object.displayName|encodeForHTML}</a>
                    </div>
                    <div class="activity-timeago">${$.timeago(new Date(activity.published))}</div>
                </div>
                    ...
                    <div class="activity-entity-name oae-threedots oae-bold">
                        ...
                        {if activity.object['oae:collection']}
                            {if activity.object['oae:collection'][0].url}
                                <a href="${activity.object['oae:collection'][0].url}" title="${activity.object['oae:collection'][0].displayName|encodeForHTML}__MSG__S_PROFILE__">${activity.object['oae:collection'][0].displayName|encodeForHTML}</a>
                            {else}
                        ...
                        {else}
                            {if activity.object.url}
                                <a href="${activity.object.url}" title="${activity.object.displayName|encodeForHTML}__MSG__S_PROFILE__">${activity.object.displayName|encodeForHTML}</a>
                            {else}
                                ${activity.object.displayName|encodeForHTML}
                            {/if}
                        {/if}
                        <span>__MSG__TO_THE_GROUP__</span> <a href="${activity.target.url}" title="${activity.target.displayName|encodeForHTML}__MSG__S_PROFILE__">${activity.target.displayName|encodeForHTML}</a>
                    </div>
                    <div class="activity-timeago">${$.timeago(new Date(activity.published))}</div>
                </div>
