...
<div id="activity-items-template"><!--
    ...
    {macro renderPreview(activity)}
        <div class="activity-preview-container">
            {if activity.thumbnails.length === 1 && activity.thumbnails[0].wideImageUrl}
                <ul class="row oae-list oae-list-grid activity-wide">
                    ${listItem(activity.thumbnails[0], null, false, activity.thumbnails[0].wideImageUrl, null, 'col-xs-12 col-lg-6')}
                </ul>
            {else}
