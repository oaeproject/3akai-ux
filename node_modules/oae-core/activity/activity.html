        ...
        <div class="activity-preview-container">
            ...
            {if previewObj['oae:wideImage']}
                <ul class="row oae-list oae-list-grid activity-wide">
                    ${listItem(previewObj, null, false, previewObj['oae:wideImage'].url, null, 'col-xs-12 col-lg-6')}
                </ul>
            {else}
                {var previewItems = previewObj['oae:collection'] || [previewObj]}

                <ul class="row oae-list oae-list-grid" data-items="${previewItems.length}">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">
                                    {if comment.author['oae:profilePath']}
                                        <a href="${comment.author['oae:profilePath']|replaceProfilePath}">${comment.author.displayName|encodeForHTML}</a>
                                    {else}
