...
define(['jquery', 'underscore', 'oae.core', 'activityadapter'], function(
    $,
    _,
    oae,
    ActivityAdapter,
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var processActivities = function(data) {
            ...
            var adaptedItems = ActivityAdapter.adapt(
            ...
            return {
                ...
                displayOptionsSmall: {
                    additionalClasses:
                        widgetData.context.resourceType === 'group'
                            ? 'col-xs-6 col-sm-3 col-md-4 col-lg-3'
        ...
        var setUpListHeader = function() {
            oae.api.util
                .template()
                .render(
                    $('#activity-list-header-template', $rootel),
                    null,
                    $('#activity-list-header', $rootel),
                );
        };
        ...
        var setUpPushNotifications = function() {
            oae.api.push.subscribe(
                ...
                function(activities) {
                    ...
                    var copiedActivities = _.map(activities, function(
                        activity,
                    ) {
        ...
        var setUpShowAll = function() {
            $rootel.on('click', '.activity-show-all-toggle', function() {
                $(this)
                    .closest('.activity-preview-container')
                    .addClass('activity-show-all');
            });
        };
                ...
                '#activity-items-template',
                {
                    ...
                    postRenderer: function(data, $listItems) {
                        $listItems.find('ul.oae-list').each(function() {
                            var $ul = $(this);
                            var $previewContainer = $ul.closest(
                         ...
                         */
                            var _updateShowAll = function() {
                                ...
                                var isMultiRow =
                                    $ul.position().top !== $li.position().top;
                                if (
                                    $previewContainer.hasClass(
                                        'activity-overflow',
                                    ) &&
                                    !isMultiRow
                                ) {
        ...
        var handleEmptyResultList = function() {
            oae.api.util
                .template()
                .render(
                    $('#activity-noresults-template', $rootel),
                    null,
                    $('.oae-list', $rootel),
                );
        };
