...
define(['jquery', 'oae/api/oae.core', 'jquery-plugins/jquery.timeago'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var handleEmptyResultList = function() {
            oae.api.util.renderTemplate('#activity_noresults_template', {}, $('.oae-list', $rootel));
        };
        ...
        var _sortEntityCollectionByImage = function(one, other) {
            if ((one.image && one['oae:contentType'] === 'file') && !(other.image && other['oae:contentType'] === 'file')) {
                return -1;
            } else if (!(one.image && one['oae:contentType'] === 'file') && (other.image && other['oae:contentType'] === 'file')) {
                return 1;
            }
