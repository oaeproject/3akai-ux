...
define(['jquery', 'underscore', 'oae.core'], function($, _, oae) {
    ...
    // for which the activity stream needs to be rendered will be passed in as the widgetData
        ...
        var constructCommentTree = function(comments) {
            ...
            $.each(comments, function(index, comment) {
                if (comment.inReplyTo) {
                    ...
                    var exists = _.findWhere(orderedTree, {'published': comment.inReplyTo.published});
                ...
                // If the top level comment is already in the structured tree, don't add it again
                var toplevelExists = _.findWhere(orderedTree, {'published': comment.published});
                if (!toplevelExists) {
