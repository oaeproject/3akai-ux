    ...
    return function(uid, showSettings, widgetData) {
        ...
        var processActivities = function(data) {
            ...
            return {
                ...
                'additionalOptionsWide': {
                    'showCheckbox': false,
                    'customImage': null, // Will be overridden with the correct custom image in the template's loop
                    'additionalClasses': 'col-xs-12 col-lg-6'
                },
                'additionalOptionsSmall': {
                    'metadata': null,
                    'showCheckbox': false,
                    'additionalClasses': 'col-xs-6 col-sm-4 col-md-3 col-lg-2'
                }
            };
        };
