...
define(['jquery', 'underscore', 'oae.core'], function($, _, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        /**
         * Render the list options header of the activity feed
         */
        var setUpListOptionsHeader = function() {
            oae.api.util.template().render($('#activity-list-options-template', $rootel), null, $('#activity-list-options', $rootel));
        };
