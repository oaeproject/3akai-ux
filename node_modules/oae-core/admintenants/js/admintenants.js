...
define(['jquery', 'oae.core', 'jquery.jeditable'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var showConfirmationModal = function(data) {
            oae.api.util.template().render($('#admintenants-confirmation-template', $rootel), {'modal': data}, $('#admintenants-confirmation-container', $rootel));
            $('#' + data.id).modal({
                'backdrop': 'static'
            });
        ...
        var renderTenants = function() {
            ...
            oae.api.util.template().render($('#admintenants-template', $rootel), {
                'tenants': tenantsToRender,
                'hasStoppedServer': hasStoppedServer,
                'context': widgetData.context
            }, $('#admintenants-container', $rootel));
            enableInlineEdit();
