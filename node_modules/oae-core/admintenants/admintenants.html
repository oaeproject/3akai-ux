<!-- CSS -->
<link rel="stylesheet" type="text/css" href="css/admintenants.css" />

<div id="admintenants-container"><!-- --></div>

<div id="admintenants-error-container"><!-- --></div>
<div id="admintenants-warning-container"><!-- --></div>
<div id="admintenants-success-container"><!-- --></div>
<div id="admintenants-confirmation-container"><!-- --></div>

<div id="admintenants-template"><!--
...
<div id="admintenants-confirmation-template"><!--
...
<!-- JAVASCRIPT -->
<script type="text/javascript" src="js/admintenants.js"></script>
