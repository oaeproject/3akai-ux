...
define(['jquery', 'oae/api/oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        var handleEmptyResultList = function() {
            oae.api.util.renderTemplate($('#searchpeople_noresults_template'), null, $('#searchpeople_results_container'));
        };
        ...
        var handleResultList = function(data) {
            ...
            oae.api.util.renderTemplate('#searchpeople_template', {
                'data': data
            }, $('.oae-list', $rootel));
        };
        ...
        var search = function(query) {
            ...
            var url = '/api/search/general/user?limit=12';
            if (query) {
                url += '&q=' + query;
            }
