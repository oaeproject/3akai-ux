...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        var handleEmptyResultList = function() {
            oae.api.util.template().render($('#searchpeople_noresults_template'), null, $('#searchpeople_results_container'));
        };
        ...
        var search = function() {
            ...
            infinityScroll = $('#searchpeople_results_container').infiniteScroll('/api/search/general', {
                'limit': 12,
                'resourceTypes': 'user',
                'q': $.bbq.getState('q')
