casper.test.begin('Widget - Content library', function(test) {
    ...
    var verifyContentLibrarySearch = function() {
        ...
        casper.waitForSelector('#contentlibrary-widget .oae-list .alert-info', function() {
            casper.test.assertExists('#contentlibrary-widget .oae-list .alert-info', 'No results are returned for \'snoollab\' and a message is shown');
            ...
            casper.waitForSelector('#contentlibrary-widget .oae-list li', function() {
                casper.test.assertExists('#contentlibrary-widget .oae-list li', '1 result is returned for \'balloons\'');
                casper.test.assertSelectorHasText('#contentlibrary-widget .oae-list li .oae-tile-metadata a', 'balloons.jpg', 'The returned file has the title \'balloons.jpg\'');
                // Reset the form
                casper.fill('form.form-search', {
                    'search-query': ''
                }, false);
