...
casper.test.begin('Widget - Content library', function(test) {
    ...
    var verifyContentLibraryShare = function() {
        ...
        test.assertExists(
            '#contentlibrary-widget .oae-list-header-actions button.oae-trigger-share:disabled',
            'The share button is disabled by default',
        );
        // Select the first content item in the list
        casper.click(
            'li.oae-list-actions + li .oae-list-grid-item input[type="checkbox"]',
        );
        // Verify that the share button is now enabled
        test.assertExists(
            '#contentlibrary-widget .oae-list-header-actions button.oae-trigger-share:not([disabled])',
            'The share button is enabled after checking a content item',
        );
        // Click the share button
        casper.click(
            '#contentlibrary-widget .oae-list-header-actions .oae-trigger-share',
        );
        // Verify that the share popover is shown
        casper.waitForSelector('#share-container', function() {
            test.assertExists(
                '#share-container',
                'The share popover can be triggered from within the list options',
            );
            ...
            test.assertExists(
                '#contentlibrary-widget .oae-list-header-actions button.oae-trigger-share:disabled',
                'The share button is disabled again after unchecking all content items',
            );
        });
    };
    ...
    var verifyContentLibraryDelete = function() {
        casper.waitForSelector(
            ...
            function() {
                ...
                test.assertExists(
                    '#contentlibrary-widget .oae-list-header-actions button.oae-trigger-deleteresources:disabled',
                ...
                casper.waitForSelector(
                    ...
                    function() {
                        ...
                        test.assertExists(
                            '#contentlibrary-widget .oae-list-header-actions button.oae-trigger-deleteresources:not([disabled])',
                            'The delete button is enabled after checking a content item',
                        );
                        // Click the delete button
                        casper.click(
                            '#contentlibrary-widget .oae-list-header-actions button.oae-trigger-deleteresources',
                        );
                        ...
                        casper.waitForSelector(
                            ...
                            function() {
                                test.assertExists(
                                    '#deleteresources-modal',
                                    'The deleteresources modal can be triggered from within the list options',
                                );
                                // Close the modal
                                ...
                                test.assertExists(
                                    '#contentlibrary-widget .oae-list-header-actions button.oae-trigger-deleteresources:disabled',
                                    'The delete button is disabled again after unchecking all content items',
                                );
                            },
                        );
                    },
    ...
    var verifyContentLibrarySearch = function() {
        ...
        casper.waitForSelector(
            '#contentlibrary-widget .oae-list .alert-info',
            function() {
                test.assertExists(
                    '#contentlibrary-widget .oae-list .alert-info',
                    'No results are returned for non-matching search and a message is shown',
                );
                ...
                casper.waitForSelector(
                    '#contentlibrary-widget .oae-list li',
                    function() {
                        test.assertExists(
                            '#contentlibrary-widget .oae-list li',
                            "1 result is returned for 'balloons'",
                        );
                        test.assertSelectorHasText(
                            '#contentlibrary-widget .oae-list li .oae-tile-metadata a',
                            'balloons.jpg',
                            "The returned file has the title 'balloons.jpg'",
                        );
                        // Reset the form
                        casper.fill(
                            'form.form-search',
    ...
    var verifyContentLibraryViewMode = function() {
        ...
        // Verify compact list
        casper.click(
            '#contentlibrary-widget .oae-list-header-actions button[data-type="oae-list-compact"]',
        );
        test.assertExists(
            '.oae-list.oae-list-compact',
            'Content library can be switched to compact view',
        );
        // Verify details list
        casper.click(
            '#contentlibrary-widget .oae-list-header-actions button[data-type="oae-list-details"]',
        );
        test.assertExists(
            '.oae-list.oae-list-details',
            'Content library can be switched to details view',
        );
        // Switch back to grid view
        casper.click(
            '#contentlibrary-widget .oae-list-header-actions button[data-type="oae-list-grid"]',
        );
        test.assertExists(
            '.oae-list.oae-list-grid',
            'Content library can be switched to grid view',
        );
    };
    ...
    var verifyContentLibraryElements = function() {
        ...
        test.assertExists(
            '#contentlibrary-widget .oae-list li:first-child',
            'Initial dummy list item is present',
        );
        // Verify dummy list item has upload button
        test.assertExists(
            '#contentlibrary-widget .oae-list li:first-child .oae-trigger-upload',
            "The first list item has a 'upload' trigger",
        );
        ...
        casper.waitForSelector('#upload-modal', function() {
            test.assertExists(
                ...
                'The upload widget can be triggered from the dummy list item',
            );
            casper.click('#upload-modal .close');
        });
        // Verify dummy list item has new document button
        test.assertExists(
            '#contentlibrary-widget .oae-list li:first-child .oae-trigger-createcollabdoc',
            "The first list item has a 'New document' trigger",
        );
        ...
        casper.waitForSelector('#createcollabdoc-modal', function() {
            test.assertExists(
                '#createcollabdoc-modal #createcollabdoc-modal-title',
                'The createcollabdoc widget can be triggered from the dummy list item',
            );
            casper.click('#createcollabdoc-modal .close');
        });
        // Verify list options are there
        test.assertExists(
            '#contentlibrary-widget .oae-list-header-actions',
            'The list options are present',
        );
        // Verify list options contain a checkbox that selects all
        test.assertExists(
            '#contentlibrary-widget .oae-list-header-actions input[type="checkbox"]',
            "The 'Select all' checkbox is present in the list options",
        );
        // Verify list options contain a share button
        test.assertExists(
            '#contentlibrary-widget .oae-list-header-actions .oae-trigger-share',
            'The share button is present in the list options',
        );
        // Verify list options contain a delete button
        test.assertExists(
            '#contentlibrary-widget .oae-list-header-actions .oae-trigger-deleteresources',
            'The delete button is present in the list options',
        );
        // Verify list options contain a switch view button
        test.assertExists(
            '#contentlibrary-widget .oae-list-header-actions button[data-type="oae-list-compact"]',
            "The 'Compact' list view button is present",
        );
        test.assertExists(
            '#contentlibrary-widget .oae-list-header-actions button[data-type="oae-list-details"]',
            "The 'Details' list view button is present",
        );
        test.assertExists(
            '#contentlibrary-widget .oae-list-header-actions button[data-type="oae-list-grid"]',
            "The 'Grid' list view button is present",
        );
        // Verify list options contain a search field
        test.assertExists(
            '#contentlibrary-widget .oae-list-header-search .oae-list-header-search-query',
            ...
            function() {
                ...
                casper.waitForSelector('#upload-dropzone form', function() {
                    ...
                    casper.wait(configUtil.modalWaitTime, function() {
                        ...
                        casper.waitForSelector(
                            'li.oae-list-actions + li',
                            function() {
                                test.assertExists(
                                    'li.oae-list-actions + li',
                                    'The content library refreshes after file upload',
                                );
                                test.assertSelectorHasText(
                                    'li.oae-list-actions + li .oae-tile-metadata a',
                                    'balloons.jpg',
                                    'The uploaded file shows up in the list correctly',
                                );
                            },
                        );
                    });
    ...
    casper.start(configUtil.tenantUI, function() {
        ...
        userUtil.createUsers(1, function(user1) {
            ...
            casper.then(function() {
                casper.echo(
                    '# Verify content library updates after upload',
                    'INFO',
                );
            ...
            casper.then(function() {
                casper.echo(
                    '# Verify content library elements present',
                    'INFO',
                );
