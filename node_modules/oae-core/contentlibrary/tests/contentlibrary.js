casper.test.begin('Widget - Content library', function(test) {
    ...
    var verifyContentLibraryShare = function() {
        ...
        test.assertExists('#contentlibrary-widget .oae-list-options button.oae-trigger-share:disabled', 'The share button is disabled by default');
        ...
        test.assertExists('#contentlibrary-widget .oae-list-options button.oae-trigger-share:not([disabled])', 'The share button is enabled after checking a content item');
        ...
        casper.waitForSelector('#share-container', function() {
            ...
            test.assertExists('#contentlibrary-widget .oae-list-options button.oae-trigger-share:disabled', 'The share button is disabled again after unchecking all content items');
        });
    };
    ...
    var verifyContentLibraryDelete = function() {
        casper.waitForSelector('li.oae-list-actions + li .oae-list-grid-item input[type="checkbox"]', function() {
            ...
            test.assertExists('#contentlibrary-widget .oae-list-options button.oae-trigger-deleteresources:disabled', 'The delete button is disabled by default');
            // Select the first content item in the list
            casper.click('li.oae-list-actions + li .oae-list-grid-item input[type="checkbox"]');
            // Verify that the delete button is now enabled
            test.assertExists('#contentlibrary-widget .oae-list-options button.oae-trigger-deleteresources:not([disabled])', 'The delete button is enabled after checking a content item');
            ...
            casper.waitForSelector('#deleteresources-modal', function() {
                ...
                test.assertExists('#contentlibrary-widget .oae-list-options button.oae-trigger-deleteresources:disabled', 'The delete button is disabled again after unchecking all content items');
            });
        });
    };
    ...
    var verifyContentLibrarySearch = function() {
        // Search for content that should yield 0 results
        casper.fill('form.form-search', {
            'search-query': 'snoollab'
        }, false);
        ...
        casper.waitForSelector('#contentlibrary-widget .oae-list .alert-info', function() {
            test.assertExists('#contentlibrary-widget .oae-list .alert-info', 'No results are returned for \'snoollab\' and a message is shown');
    ...
    var verifyContentLibraryElements = function() {
        ...
        test.assertExists('#contentlibrary-widget .oae-list-options', 'The list options are present');
        // Verify list options contain a checkbox that selects all
        test.assertExists('#contentlibrary-widget .oae-list-options input[type="checkbox"]', 'The \'Select all\' checkbox is present in the list options');
        // Verify list options contain a share button
        test.assertExists('#contentlibrary-widget .oae-list-options .oae-trigger-share', 'The share button is present in the list options');
        // Verify list options contain a delete button
        test.assertExists('#contentlibrary-widget .oae-list-options .oae-trigger-deleteresources', 'The delete button is present in the list options');
        // Verify list options contain a switch view button
        test.assertExists('#contentlibrary-widget .oae-list-options button[data-type="oae-list-compact"]', 'The \'Compact\' list view button is present');
        test.assertExists('#contentlibrary-widget .oae-list-options button[data-type="oae-list-details"]', 'The \'Details\' list view button is present');
        test.assertExists('#contentlibrary-widget .oae-list-options button[data-type="oae-list-grid"]', 'The \'Grid\' list view button is present');
        // Verify list options contain a search field
        test.assertExists('#contentlibrary-widget .oae-list-options #contentlibrary-search-query', 'The search box is present');
    };
