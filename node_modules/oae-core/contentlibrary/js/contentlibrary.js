...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var getContentLibrary = function() {
            ...
            $('#oae-list-options-search-query', $rootel).val(query);
        ...
        var setUpListOptionsHeader = function() {
            ...
            oae.api.util.template().render($('#contentlibrary-list-options-template', $rootel), {'actions': actions}, $('#contentlibrary-list-options', $rootel));
        };
