    ...
    return function(uid, showSettings, widgetData) {
        ...
        var getContent = function() {
            ...
            if ((widgetData.canAdd || widgetData.canManage) && !query) {
                initialContent = oae.api.util
                    ...
                    .render(
                        $(
                            '#contentlibrary-content-list-actions-template',
                            $rootel,
                        ),
                    );
            }
            ...
            contentInfinityScroll = $(
                '#contentlibrary-content .oae-list',
                $rootel,
            ).infiniteScroll(
                url,
                {
                ...
                '#contentlibrary-content-template',
                {
                    ...
                    emptyListProcessor: function() {
                        oae.api.util.template().render(
                            $(
                                '#contentlibrary-content-noresults-template',
                                $rootel,
                            ),
                            {
                                query: query,
        ...
        var getFolders = function() {
            ...
            if ((widgetData.canAdd || widgetData.canManage) && !query) {
                initialContent = oae.api.util
                    ...
                    .render(
                        $(
                            '#contentlibrary-folders-list-actions-template',
                            $rootel,
                        ),
                    );
            }
            ...
            foldersInfinityScroll = $(
                '#contentlibrary-folders .oae-list',
                $rootel,
            ).infiniteScroll(
                url,
                {
                ...
                '#contentlibrary-folders-template',
                {
                    ...
                    emptyListProcessor: function() {
                        oae.api.util.template().render(
                            $(
                                '#contentlibrary-folders-noresults-template',
                                $rootel,
                            ),
                            {
                                query: query,
        ...
        var setUpListHeader = function() {
            ...
            oae.api.util
                .template()
                .render(
                    $('#contentlibrary-list-header-template', $rootel),
                    { actions: listHeaderActions },
                    $('#contentlibrary-list-header', $rootel),
                );
        };
        ...
        var loadList = function() {
            ...
            if (widgetPath === 'folders') {
                $(
                    '.oae-list-header-actions .oae-trigger-share[data-resourceType=folder]',
                    $rootel,
                ).show();
                $(
                    '.oae-list-header-actions .oae-trigger-deleteresources[data-resourceType=folder]',
                    $rootel,
                ).show();
                getFolders();
            } else {
                $(
                    '.oae-list-header-actions .oae-trigger-share[data-resourceType=content]',
                    $rootel,
                ).show();
                $(
                    '.oae-list-header-actions .oae-trigger-addtofolder',
                    $rootel,
                ).show();
                $(
                    '.oae-list-header-actions .oae-trigger-deleteresources[data-resourceType=content]',
                    $rootel,
                ).show();
                getContent();
            }
        ...
        var addBinding = function() {
            ...
            $('a[data-toggle="tab"]', $rootel).on('shown.bs.tab', function(ev) {
                ...
                var url =
                    History.getState().data.basePath +
                    '/' +
                    newState.widgetPath;
            ...
            $(window).on('done.addcontent.oae', function() {
                if (
                    $rootel.is(':visible') &&
                    $('.nav-tabs li.active a[data-type="content"]', $rootel)
                        .length
                ) {
                    getContent();
                }
            ...
            $(window).on('oae.deleteresources.done', function() {
                if ($rootel.is(':visible')) {
                    if (
                        ...
                        $('.nav-tabs li.active a[data-type="folders"]', $rootel)
                            .length
                    ) {
                        getFolders();
                    }
