...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var getFolders = function() {
            ...
            if (query) {
                url = '/api/folder/folder-library/' + widgetData.context.id;
            }
        ...
        var setUpListHeader = function() {
            ...
            if (!oae.data.me.anon) {
                // If the user is logged in, they have the option to share the content items
                ...
                // If the user is logged in, they have the option to share the folders
                listHeaderActions.push({
                    'icon': 'fa-share-square-o',
                    'label': oae.api.i18n.translate('__MSG__SHARE__'),
                    'trigger': 'oae-trigger-share',
                ...
                if (widgetData.canManage) {
                    // If the user is the manager of the library, they have the option to delete content items
                    listHeaderActions.push({
                        'icon': 'fa-trash-o',
                    ...
                    // If the user is the manager of the library, they have the option to delete folders
                    listHeaderActions.push({
                        'icon': 'fa-trash-o',
                        'label': oae.api.i18n.translate('__MSG__DELETE__'),
                        'trigger': 'oae-trigger-deletefolders'
                    });
                }
            }
        ...
        var loadList = function() {
            ...
            if (widgetPath === 'folders') {
                ...
                $('.oae-list-header-actions .oae-trigger-deletefolders', $rootel).show();
                getFolders();
            } else {
                $('.oae-list-header-actions .oae-trigger-share[data-resourceType=content]', $rootel).show();
                $('.oae-list-header-actions .oae-trigger-deleteresources', $rootel).show();
                getContent();
            }
        };

        /**
         * Reload the content in the library when the content tab is currently active
         */
        ...
        var addBinding = function() {
            ...
            // Reload the content library when new content has been added or content
            // has been removed. The content library will only be reloaded when the
            // content pane is currently active
            $(window).on('done.addcontent.oae', reloadContent);
            $(window).on('oae.deleteresources.done', reloadContent);
        };
