...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var addBinding = function() {
            ...
            $('.oae-list-options button[data-type="oae-list-remove"]', $rootel).on('click', function() {
                $(document).trigger('oae.resources.delete');
            });
            ...
            $(window).on('done.deleteresources.oae', function() {
               // Only re-load the discussions list when the widget is currently visible
                if ($rootel.is(':visible')) {
                    getContentLibrary();
                }
