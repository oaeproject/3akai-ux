...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var getDiscussions = function() {
            ...
            var url = '/api/discussions/library/' + widgetData.principalId;
            if (query) {
                url = '/api/search/discussions-library/' + widgetData.principalId;
            }
        ...
        var addBinding = function() {
            // Set up search event
            $rootel.on('submit', '#discussions-search-form', search);
