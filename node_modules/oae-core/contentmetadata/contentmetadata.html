<!-- CSS -->
<link rel="stylesheet" type="text/css" href="css/contentmetadata.css" />
...
<div id="contentmetadata_description_template" style="display:none;"><!--
    ...
    <span class="contentmetadata_second_column">
        {if jQuery.trim(data.description)}
...
<!-- JAVASCRIPT -->
<script type="text/javascript" src="js/contentmetadata.js"></script>
