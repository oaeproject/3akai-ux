...
<div class="s3d-widget-container" id="contentmetadata_container" role="complementary" aria-labelledby="contentmetadata_aria_label_details">
    <h2 class="s3d-contentpage-title metadata" id="contentmetadata_aria_label_details">__MSG__DETAILS__</h2>
        ...
        {if $.trim(data.link)}
            {if data.isManager || data.isEditor}
                <div class="contentmetadata_url_textarea contentmetadata_edit_input">
                    <a class="s3d-action" target="_blank" href="${data.link}">
                        ${data.link}
                    </a>
                </div>
            {else}
...
<div id="contentmetadata_copyright_template" style="display:none;"><!--
    <span class="contentmetadata_first_column">__MSG__COPYRIGHT:__</span>
    <span class="contentmetadata_second_column">
