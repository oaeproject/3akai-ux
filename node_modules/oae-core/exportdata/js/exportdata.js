            ...
            oae.api.user.exportData(exportType, function(err, data) {
                if (!err) {
                    oae.api.util.notification(
                        oae.api.i18n.translate('__MSG__EXPORT_SUCCESS__'),
                        oae.api.i18n.translate('__MSG__EXPORT_SUCCESSED__', 'export'));
                } else {
                    // If the update failed, enable the form and show an error notification
                    oae.api.util.notification(
                        oae.api.i18n.translate('__MSG__EXPORT_FAIL__'),
                        oae.api.i18n.translate('__MSG__EXPORT_FAILED__', 'export'),
                        'error');
                }
            });
