...
define(['jquery', 'oae.core'], function($, oae) {
    return function(uid) {
        ...
        var setUpEditContent = function() {
            ...
            oae.api.util
                .validation()
                .validate($('#editcontent-form', $rootel), validateOpts);
        };
        ...
        var editContent = function() {
            ...
            var params = {
                ...
                description: $.trim(
                    $('#editcontent-description', $rootel).val(),
                ),
            };
            ...
            oae.api.content.updateContent(contentProfile.id, params, function(
                err,
                data,
            ) {
                ...
                var notificationBody = oae.api.util
                    .template()
                    .render($('#editcontent-notification-template'), {
                        content: contentProfile,
                        err: err,
                    });
                if (!err) {
        ...
        var setUpReset = function() {
            $('#editcontent-modal', $rootel).on(
                ...
                function() {
                    ...
                    $('#editcontent-form *', $rootel).prop('disabled', false);
                    $('#editcontent-form button[type="submit"]', $rootel).prop(
                        'disabled',
                        true,
                    );
                },
