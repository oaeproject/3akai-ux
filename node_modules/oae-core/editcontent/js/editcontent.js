...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        var setUpReset = function() {
            $('#editcontent-modal', $rootel).on('hidden', function (evt) {
                // Reset the form
            ...
            oae.api.content.updateContent(contentProfile.id, params, function (err, data) {
                if (!err) {
                    ...
                    oae.api.util.notification(
                        ...
                        oae.api.i18n.translate('__MSG__DETAILS_EDIT_SUCCESS__', 'editcontent'));
                    $(document).trigger('done.editcontent.oae', data);
                } else {
                    oae.api.util.notification(
                        oae.api.i18n.translate('__MSG__DETAILS_NOT_EDITED__', 'editcontent'),
                        oae.api.i18n.translate('__MSG__DETAILS_EDIT_FAIL__', 'editcontent'),
                        'error');
                        // Enable the form
                        $('#editcontent-form *', $rootel).prop('disabled', false);
                }
        ...
        var setUpEditContentModal = function() {
            ...
            $('#editcontent-modal', $rootel).on('shown', function() {
