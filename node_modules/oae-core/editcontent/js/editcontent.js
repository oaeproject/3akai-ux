...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
         ...
         * events when Bootstrap renders the modal, and those events can
         * "undo" parts of the reset.
         */
        var setUpReset = function() {
            $('#editcontent-modal', $rootel).on('shown.bs.modal hidden.bs.modal', function (evt) {
                // Reset the form
        ...
        /**
         * Renders the edit content form and initializes validation
         */
        ...
        /**
         * Initializes the edit content modal dialog
         */
        var setUpEditContentModal = function() {
            ...
            // Detect changes in the form and enable the submit button. IE9
            // doesn't fire the `input` event when characters are removed, so
            // it requires special treatment.
            var changeEvents = $('html').hasClass('ie-lt10') ? 'change keyup paste' : 'input';
            $('#editcontent-form', $rootel).on(changeEvents, function() {
