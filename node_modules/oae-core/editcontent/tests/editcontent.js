        ...
        casper.then(function() {
            contentUtil().createLink(null, null, null, function(link) {
                casper.thenOpen(configUtil().tenantUI + link.profilePath, function() {
                    casper.then(function() {
                        casper.echo('# Verify open edit content modal', 'GREEN_BAR');
                        verifyOpenEditContentModal();
                    });

                    casper.then(function() {
                        casper.echo('# Verify edit content elements', 'GREEN_BAR');
                        verifyEditContentElements();
                    });

                    casper.then(function() {
                        casper.echo('# Verify edit content form validation', 'GREEN_BAR');
                        verifyEditContentFormValidation();
                    });

                    casper.then(function() {
                        casper.echo('# Verify content can be edited', 'GREEN_BAR');
                        verifyEditContent();
                    });
                });
            });
