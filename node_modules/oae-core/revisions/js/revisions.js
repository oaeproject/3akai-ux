...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        // Caches the collabdoc etherpadHtml, if this is an etherpad document
        var etherpadHtml = {};
        ...
        var getRevisions = function() {
            ...
            infinityScroll = $('.oae-list', $rootel).infiniteScroll(url, {
                ...
                'postProcessor': function(data) {
                    ...
                    // collabdoc revision previews are actually the full revision content. To do that, we
                    // cache the etherpad html for all revisions as we render them so it can be accessed
                    // for the previews
