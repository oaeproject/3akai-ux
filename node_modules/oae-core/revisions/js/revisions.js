...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        /**
         * Removes the selected state from all list items before adding it to the currently selected list item
         *
         * @param  {Object}   li    The list item to select
         */
        var showSelectedRevision = function(li) {
        ...
        var handleKeyboardNavigation = function(ev) {
            ...
            // Highlight the selected revision
            showSelectedRevision($listItem);
            // Render the preview of the revision
            ev.target = $listItem;
            renderPreview(ev);
        };
        ...
        var setUpRevisionsModal = function() {
            ...
            // Render a preview on click or focus on a list item
            $rootel.on('click', '.oae-list li', function(ev) {
                // Highlight the selected revision
                showSelectedRevision(ev.currentTarget);
                // Render the revision preview
                renderPreview(ev);
            });

            // Handle focus and keydown events on list items
            $rootel.on('keyup', '.oae-list li', handleKeyboardNavigation);
