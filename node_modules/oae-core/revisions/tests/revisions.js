casper.test.begin('Widget - Revisions', function(test) {
    ...
    var verifyContentRevisionsElements = function() {
        ...
        casper.waitForSelector('ul#revisions-list li', function() {
            ...
            test.assertDoesntExist('ul#revisions-list li:first-child .revisions-list-actions-restore', 'The current content revision cannot be restored');
            ...
            test.assertExists('#revisions-image-container', 'The content revision preview container is present');
            test.assertExists('#revisions-image-container img', 'The content revision preview image is present');
        });
    };
