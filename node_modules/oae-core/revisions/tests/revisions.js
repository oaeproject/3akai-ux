...
casper.test.begin('Widget - Revisions', function(test) {
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        casper.then(function() {
            casper.echo('# Verify revisions modal', 'GREEN_BAR');
        ...
        casper.then(function() {
            casper.echo('# Verify content revisions elements', 'GREEN_BAR');
            verifyContentRevisionsElements();
        });

        casper.then(function() {
            casper.echo('# Verify restoring content revision', 'GREEN_BAR');
        ...
        casper.then(function() {
            casper.echo('# Verify collabdoc revisions elements', 'GREEN_BAR');
        ...
        casper.then(function() {
            casper.echo('# Verify restoring collabdoc revision', 'GREEN_BAR');
