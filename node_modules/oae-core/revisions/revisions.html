    ...
    {for revision in results}
        ...
        <li class="well" tabindex="0" data-key="${revision.created}" data-revisionid="${revision.revisionId}" data-resourcesubtype="${resourceSubType}" data-mediumurl="${preview}">
            ...
            <div class="revisions-list-actions hide">
                <button type="button" class="revisions-list-actions-restore btn btn-small">
                    <i class="icon-undo"></i> __MSG__RESTORE__
                </button>
                {if resourceSubType === 'file'}
                    <a href="/api/content/${revision.contentId}/download/${revision.revisionId}" class="revisions-list-actions-download btn btn-small">
