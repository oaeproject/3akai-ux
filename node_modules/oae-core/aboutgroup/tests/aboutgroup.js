...
casper.test.begin('Widget - About Group', function(test) {
     ...
     */
    var verifyOpenAboutGroup = function() {
    ...
    /**
     * Open the about group modal without assertions
     */
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        casper.waitFor(function() {
            ...
            casper.then(function() {
                // Create a group
                groupUtil().createGroup(null, null, function(_groupProfile) {
