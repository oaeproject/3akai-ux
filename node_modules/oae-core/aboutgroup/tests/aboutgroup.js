...
casper.test.begin('Widget - About Group', function(test) {
    ...
    var openAboutGroup = function() {
        casper.waitForSelector(
            ...
            function() {
                ...
                test.assertExists(
                    '.oae-trigger-aboutgroup',
                    'About group trigger exists',
                );
                casper.click('.oae-trigger-aboutgroup');
                casper.waitUntilVisible('#aboutgroup-modal', function() {
                    test.assertVisible(
                        '#aboutgroup-modal',
                        'About group pane is showing after trigger',
                    );
                    casper.click(
                        '#group-clip-container .oae-clip-content > button',
                    );
    ...
    var verifyAboutGroupElements = function(groupProfile, user1) {
        test.assertExists(
            '#aboutgroup-modal .modal-header h3',
        ...
        test.assertExists(
            '#aboutgroup-modal .modal-body #aboutgroup-metadata-container #aboutgroup-title',
            'Verify that the modal shows title of the group',
        );
        test.assertSelectorHasText(
            '#aboutgroup-modal .modal-body #aboutgroup-metadata-container #aboutgroup-title',
            groupProfile.displayName,
            'Verify that the correct group title is shown',
        );
        ...
        test.assertExists(
            '#aboutgroup-modal .modal-body #aboutgroup-metadata-container #aboutgroup-description',
            'Verify that the modal shows the description of the group',
        );
        test.assertSelectorHasText(
            '#aboutgroup-modal .modal-body #aboutgroup-metadata-container #aboutgroup-description',
            groupProfile.description,
            'Verify that the correct group description is shown',
        );
    };
