...
casper.test.begin('Widget - Delete comment', function(test) {
    ...
    var openDeleteComment = function() {
        casper.waitForSelector(
            ...
            function() {
                test.assertExists(
                    '.comments-level-0 .media-body .oae-trigger-deletecomment',
                    'Verify the delete comment trigger is present',
                );
                casper.click(
                    '.comments-level-0 .media-body .oae-trigger-deletecomment',
                );
                casper.waitUntilVisible('#deletecomment-modal', function() {
                    test.assertVisible(
                        '#deletecomment-modal',
                        'Delete comment pane is showing after trigger',
                    );
                });
            },
        );
    ...
    var verifyDeleteCommentElements = function() {
        // Verify headers
        test.assertExists(
            '#deletecomment-modal .modal-header h3',
            'Verify that the modal header is present',
        );
        test.assertSelectorHasText(
            '#deletecomment-modal .modal-header h3',
            'Delete comment',
            'Verify that the modal header has the correct title',
        );
        test.assertExists(
            '#deletecomment-modal .modal-body h4',
            'Verify that the modal subheader is present',
        );
        test.assertSelectorHasText(
            '#deletecomment-modal .modal-body h4',
            'Are you sure you want to delete this comment?',
            'Verify that the modal subheader has the correct title',
        );

        // Verify warning
        test.assertExists(
            '#deletecomment-modal .modal-body .alert-danger',
            'Verify that the warning message is present',
        );
        test.assertSelectorHasText(
            '#deletecomment-modal .modal-body .alert-danger',
            'Caution: this action cannot be undone!',
            'Verify that the warning message has the correct message',
        );
