...
define(['jquery', 'oae.core'], function($, oae) {
    return function(uid, showSettings, widgetData) {
                    ...
                    if (err) {
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__COMMENT_NOT_DELETED__',
                                'deletecomment',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__COMMENT_DELETE_FAIL__',
                                'deletecomment',
                            ),
                            'error',
                        );
        ...
        var initDeleteComment = function() {
            $(document).on('click', '.oae-trigger-deletecomment', function(
                ev,
                data,
            ) {
                ...
                $(document).on('oae.context.send.deletecomments', function(
                    ev,
                    contextData,
                ) {
