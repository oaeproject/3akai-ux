...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        /**
         * Delete a comment and send out an event to let other widgets know whether it failed or succeeded.
         */
        var deleteComment = function() {
            oae.api.comment.deleteComment(contextProfile.id, contextProfile.resourceType, commentToDelete, function(err, softDeleted) {
                if (err) {
                    ...
                    oae.api.util.notification(
                        oae.api.i18n.translate('__MSG__COMMENT_DELETED__', 'deletecomment'),
                        oae.api.i18n.translate('__MSG__COMMENT_DELETE_SUCCESS__', 'deletecomment'));
        ...
        /**
         * Initialize the deletecomment widget
         */
