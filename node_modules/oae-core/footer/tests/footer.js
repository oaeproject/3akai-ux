...
casper.test.begin('Widget - Footer', function(test) {
    ...
    var verifyFooter = function() {
        ...
        test.assertExists('#footer-container a[href="http://apereo.org/"]', 'The footer has a link to the Apereo website');
        // Verify that the footer link opens in a new tab
        test.assertExists('#footer-container a[href="http://apereo.org/"][target="_blank"]', 'The footer link opens in a new tab');
    };

    casper.start(configUtil().tenantUI, function() {
        // Verify that the footer is showing
        casper.then(function() {
            casper.echo('# Verify that the footer shows on the page', 'GREEN_BAR');
