...
define(['jquery', 'oae/api/oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var setCopyRightYear = function() {
            $('#footer_date_end').text(new Date().getFullYear());
        };
        ...
        var setLanguageAndLocation = function() {
            ...
            if (!oae.data.me.anon) {
                ...
                $('#footer_language').text(languages[oae.data.me.locale] || oae.data.me.locale);
                // Set the user's location
                $('#footer_location').text(oae.data.me.timezone.name);
                // Show the container
                $('#footer_langloc').show();
            }
        };
        ...
        var setFooterLinks = function() {
            ...
            $('#footer_links').html(oae.api.i18n.translate(oae.api.util.renderTemplate('footer_links_template', {
