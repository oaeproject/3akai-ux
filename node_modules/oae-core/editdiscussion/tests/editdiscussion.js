...
casper.test.begin('Widget - Edit discussion', function(test) {
    ...
    var openEditDiscussion = function() {
        casper.waitForSelector(
            ...
            function() {
                ...
                casper.waitForSelector(
                    'button.oae-trigger-editdiscussion',
                    function() {
                        test.assertVisible(
                            'button.oae-trigger-editdiscussion',
                            'Edit discussion trigger exists',
                        );
                        casper.click('button.oae-trigger-editdiscussion');
                        casper.waitUntilVisible(
                            '#editdiscussion-modal',
                            function() {
                                test.assertVisible(
                                    '#editdiscussion-modal',
                                    'Edit discussion pane is showing after trigger',
                                );
                                casper.click(
                                    '#discussion-clip-container .oae-clip-content > button',
                                );
    ...
    var verifyEditDiscussionFormElements = function() {
        casper.waitForSelector('#editdiscussion-modal', function() {
            test.assertExists(
                'form#editdiscussion-form',
                'The edit discussion form is present',
            );
            test.assertExists(
                'form#editdiscussion-form #editdiscussion-name',
                'The edit discussion name field is present',
            );
            test.assertExists(
                'form#editdiscussion-form #editdiscussion-topic',
                'The edit discussion topic field is present',
            );
            test.assertExists(
                'form#editdiscussion-form button[type="submit"]',
                'The edit discussion form submit button is present',
            );
        });
    };
    ...
    var verifyEditDiscussionFormValidate = function() {
        ...
        test.assertVisible(
            '#editdiscussion-name-error',
            'Verify validating empty form, name-error is visible',
        );
        test.assertVisible(
            '#editdiscussion-topic-error',
            'Verify validating empty form, topic-error is visible',
        );
        ...
        test.assertNotVisible(
            '#editdiscussion-name-error',
            'Verify validating empty topic, name-error is not visible',
        );
        test.assertVisible(
            '#editdiscussion-topic-error',
            'Verify validating empty topic, topic-error is visible',
        );
        ...
        test.assertVisible(
            '#editdiscussion-name-error',
            'Verify validating empty name, name-error is visible',
        );
        test.assertNotVisible(
            '#editdiscussion-topic-error',
            'Verify validating empty name, topic-error is not visible',
        );
    };
        ...
        casper.waitForSelector(
            ...
            function() {
                test.assertDoesntExist(
                    ...
                    'The discussion details were successfully saved',
                );
                test.assertSelectorHasText(
                    '#discussion-clip-container h1',
                    'New discussion name',
                    "The discussion name was successfully renamed to 'New discussion name'",
                );
                test.assertSelectorHasText(
                    '#discussion-topic',
                    'New discussion topic',
                    "The discussion topic was successfully changed to 'New discussion topic'",
                );
            },
        );
    };
