...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        var setUpReset = function() {
            $('#editdiscussion-modal', $rootel).on('hidden', function (evt) {
                // Reset the form
        ...
        var setUpEditDiscussionModal = function() {
            ...
            $('#editdiscussion-modal', $rootel).on('shown', function() {
