...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        /**
         * Renders the edit discussion form and initializes validation
         */
        ...
        var editDiscussion = function() {
            ...
            oae.api.discussion.updateDiscussion(discussionProfile.id, params, function (err, data) {
                // If the update succeeded, trigger the `oae.editdiscussion.done` event and
        ...
        /**
         * Initializes the edit discussion modal dialog
         */
        var setUpEditDiscussionModal = function() {
            ...
            $('#editdiscussion-form', $rootel).on(oae.api.util.getInputChangeEventNames(), function() {
