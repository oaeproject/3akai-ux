    ...
    return function(uid) {
        ...
        var setUpEditDiscussion = function() {
            ...
            oae.api.util.template().render(
                $('#editdiscussion-template', $rootel),
                {
            ...
            oae.api.util
                .validation()
                .validate($('#editdiscussion-form', $rootel), validateOpts);
        };
        ...
        var editDiscussion = function() {
            ...
            oae.api.discussion.updateDiscussion(
                discussionProfile.id,
                params,
                function(err, data) {
                    ...
                    if (!err) {
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__DISCUSSION_EDITED__',
                                'editdiscussion',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__DISCUSSION_EDIT_SUCCESS__',
                                'editdiscussion',
                            ),
                        );
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__DISCUSSION_NOT_EDITED__',
                                'editdiscussion',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__DISCUSSION_EDIT_FAIL__',
                                'editdiscussion',
                            ),
                            'error',
                        );
                        // Enable the form
                        $('#editdiscussion-form *', $rootel).prop(
                            'disabled',
                            false,
                        );
                    }
        ...
        var setUpReset = function() {
            $('#editdiscussion-modal', $rootel).on(
                ...
                function() {
                    ...
                    $(
                        '#editdiscussion-form button[type="submit"]',
                        $rootel,
                    ).prop('disabled', true);
                },
            );
        ...
        var setUpEditDiscussionModal = function() {
            ...
            $(document).on('oae.context.send.editdiscussion', function(
                ev,
                data,
            ) {
