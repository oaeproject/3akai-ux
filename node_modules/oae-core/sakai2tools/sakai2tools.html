<!-- STYLESHEET -->
<link rel="stylesheet" type="text/css" href="/node_modules/oae-core/sakai2tools/css/sakai2tools.css" />
...
<div id="sakai2tools_settings_template"><!--
    <form>
        <div class="sakai2tools_settings_subcontainer">
            ...
            <p>
                <label class="sakai2tools_settings_label_head"></label> <span><br class="oae-push" />
            </p>
            <div id="sakai2tools_settings_preview">

            </div>
            <button type="button" class="oae-button oae-button-primary" id="sakai2tools_settings_advanced_toggle_settings"><span class="oae-button-inner">__MSG__ADVANCED_SETTINGS__ <span id="sakai2tools_settings_advanced_down">&#8595;</span><span id="sakai2tools_settings_advanced_up">&#8593;</span></span></button>
        </div>
        <div id="sakai2tools_settings_advanced" style="display:none;">
            <div class="sakai2tools_settings_subcontainer">
                ...
                <div class="sakai2tools_settings_block">
                    ...
                    <div class="sakai2tools_settings_checkbox">
                        ...
                        <input type="checkbox" id="sakai2tools_settings_release_email" name="release_email" {if release_email}checked="checked"{/if} /><span>&nbsp;</span><br class="oae-push" />
                    </div>
                    <br class="oae-push" />
                </div>
            </div>
            ...
            <div class="sakai2tools_settings_subcontainer">
                ...
                <div class="sakai2tools_settings_block">
                    ...
                    <button type="button" id="sakai2tools_settings_width_unit_px" class="oae-link-button oae-action sakai2tools_settings_width_unit {if width_unit == "px"} sakai2tools_settings_width_unit_selected{/if}"> px</button>
                    <span> or </span>
                    <button type="button" id="sakai2tools_settings_width_unit_percent" class="oae-link-button oae-action sakai2tools_settings_width_unit {if width_unit == "%"} sakai2tools_settings_width_unit_selected{/if}"> %</button>
                    <br />
                    ...
                    <button type="button" class="oae-button oae-button-primary" id="sakai2tools_settings_reset_size"><span class="oae-button-inner">__MSG__RESET_TO_ORIGINAL_SIZE__</span></button>
                    <br class="oae-push" />
                </div>
            </div>
            ...
            <div class="sakai2tools_settings_subcontainer">
                ...
                <div class="sakai2tools_settings_block">
                    ...
                    <input type="text" id="sakai2tools_settings_borders" value="${border_size}" /><span> __MSG__PX__</span><br class="oae-push" />
        ...
        <div class="dialog_buttons">
            <button type="button" class="oae-button oae-button-primary" id="sakai2tools_settings_insert"><span class="oae-button-inner">__MSG__SAVE__</span></button>
            <button type="button" class="oae-button" id="sakai2tools_settings_cancel"><span class="oae-button-inner">__MSG__CANCEL__</span></button>
        </div>
    </form>
--></div>
...
<!-- Template which points people to the settings of the widget -->
<div class="sakai2tools_notification_template"><!--
    <p class="oae-bold">__MSG__PLEASE_CHANGE_THE_SETTINGS_OF_THE_SAKAI2_TOOLS_WIDGET__</p>
--></div>
...
<!-- JAVASCRIPT -->
<script type="text/javascript" src="/node_modules/oae-core/sakai2tools/javascript/sakai2tools.js" />
