<!-- CSS -->
<link rel="stylesheet" type="text/css" href="/node_modules/oae-core/personinfo/css/personinfo.css" />
...
<div id="personinfo_widget" style="display:none">
    ...
    <div id="personinfo" class="personinfo_dialog">
        ...
        <div class="personinfo_outer clearfix">
            <button id="personinfo_close_button" class="personinfo_close oae-link-button" title="__MSG__CLOSE__"><div id="personinfo_close"></div></button>
            <div class="personinfo_inner">
                <div id="personinfo_container"></div>
            </div>
            <button type="button" id="personinfo_message" class="oae-button oae-header-button oae-force-left" style="display:none">__MSG__MESSAGE__</button>
            <button type="button" id="personinfo_invite" class="oae-button oae-header-button oae-force-right" style="display:none">__MSG__ADD_TO_CONTACTS__</button>
            <button type="button" id="personinfo_pending" class="oae-button oae-header-button oae-force-right" style="display:none" disabled="disabled">__MSG__CONNECTION_REQUESTED__</button>
            <button type="button" id="personinfo_invited" class="oae-button oae-header-button oae-force-right" style="display:none">__MSG__ACCEPT_CONNECTION_REQUEST__</button>
        </div>
    </div>
</div>
...
<div id="personinfo_template" style="display:none"><!--
    <div id="personinfo_user">
        ...
        <span id="personinfo_user_info">
            <span id="personinfo_user_name" class="oae-bold oae-regular-links">{if !user.isPrivate}<a href="${user.homePath}">{/if}${user.displayName}{if !user.isPrivate}</a>{/if}</span>
            {if user.counts}
                <span id="personinfo_user_owns" class="oae-regular-links">
            ...
            {for i in user.contentItems.results}
                ...
                <li id="${i["_path"]}">
                    ...
                    <div class="personinfo_content_list_right">
                        <a href="/content#p=${i['_path']|safeURL}/${i["sakai:pooled-content-file-name"]|safeURL}" class="personinfo_content_name oae-regular-links oae-bold" title="${i["sakai:pooled-content-file-name"]}">${i["sakai:pooled-content-file-name"]}</a>
                        ...
                        <span class="personinfo_content_plus">
                            <button type="button" class="oae-button oae-header-button savecontent_trigger" data-entityid="${i['_path']}" title="__MSG__SAVE_CONTENT__">+</button>
                        </span>
                    </div>
                </li>
            {forelse}
...
<!-- JAVASCRIPT -->
<script type="text/javascript" src="/node_modules/oae-core/personinfo/javascript/personinfo.js"></script>
