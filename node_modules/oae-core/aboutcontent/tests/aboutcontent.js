    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        userUtil().createUsers(2, function(user1, user2) {
            ...
            contentUtil().createFile(null, 'Test file description', null, null, null, [user2.id], function(err, contentProfile) {
                // Create a link
                contentUtil().createLink('Test link title', 'Test link description', null, 'http://www.oaeproject.org', null, [user2.id], function(err, linkProfile) {
                    // Create a collaborative document
                    contentUtil().createCollabDoc('Test collabdoc title', 'Test collabdoc description', null, null, [user2.id], function(err, collabdocProfile) {
                        // Log out from user 1
                        userUtil().doLogOut();
