<!-- STYLESHEET -->
<link rel="stylesheet" type="text/css" href="/node_modules/oae-core/basiclti/css/basiclti.css" />
...
<div id="basiclti_settings_template"><!--
    <form id="basiclti_settings_form">
        <div class="basiclti_settings_subcontainer oae-form-field-wrapper">
            <p>
                <label for="basiclti_settings_ltiurl">__MSG__URL__: </label>
                <input type="text" id="basiclti_settings_ltiurl" name="basiclti_settings_ltiurl" value="${ltiurl}" class="required url oae-input-full-width" /><br />
                <label for="basiclti_settings_ltikey">__MSG__KEY__: </label>
                <input type="text" id="basiclti_settings_ltikey" name="basiclti_settings_ltikey" value="${ltikey}" class="required oae-input-full-width" /><br />
                <label for="basiclti_settings_ltisecret">__MSG__SECRET__: </label>
                <input type="text" id="basiclti_settings_ltisecret" name="basiclti_settings_ltisecret" value="${ltisecret}" class="required oae-input-full-width" /><br />
            </p>
            <p>
                <label class="basiclti_settings_label_head"></label> <span><br class="oae-push" />
            </p>
            <div id="basiclti_settings_preview">

            </div>
            <button type="button" class="oae-button oae-header-button oae-force-right" id="basiclti_settings_advanced_toggle_settings">__MSG__ADVANCED_SETTINGS__ <span id="basiclti_settings_advanced_down">&#8595;</span><span id="basiclti_settings_advanced_up">&#8593;</span></button>
        </div>
        <div id="basiclti_settings_advanced" style="display:none;">
            <div class="basiclti_settings_subcontainer">
                ...
                <div class="basiclti_settings_block">
                    ...
                    <div class="basiclti_settings_checkbox">
                        ...
                        <input type="checkbox" id="basiclti_settings_release_email" name="release_email" {if release_email}checked="checked"{/if} /><span>&nbsp;</span><br class="oae-push" />
                    </div>
                    <br class="oae-push" />
                </div>
            </div>
            ...
            <div class="basiclti_settings_subcontainer">
                ...
                <div class="basiclti_settings_block">
                    ...
                    <button type="button" id="basiclti_settings_width_unit_px" class="oae-link-button oae-action basiclti_settings_width_unit {if width_unit == "px"} basiclti_settings_width_unit_selected{/if}"> px</button>
                    <span> or </span>
                    <button type="button" id="basiclti_settings_width_unit_percent" class="oae-link-button oae-action basiclti_settings_width_unit {if width_unit == "%"} basiclti_settings_width_unit_selected{/if}"> %</button>
                    <br />
                    ...
                    <button type="button" class="oae-button oae-header-button" id="basiclti_settings_reset_size">__MSG__RESET_TO_ORIGINAL_SIZE__</button>
                    <br class="oae-push" />
                </div>
            </div>
            ...
            <div class="basiclti_settings_subcontainer">
                ...
                <div class="basiclti_settings_block">
                    ...
                    <input type="text" id="basiclti_settings_borders" value="${border_size}" /><span> __MSG__PX__</span><br class="oae-push" />
                    <div id="basiclti_settings_color_container">
                    </div>
                </div>
            </div>
            <div class="basiclti_settings_subcontainer">
                <label class="basiclti_settings_label_head">__MSG__OTHER__</label><br />
                <div class="basiclti_settings_block">
                    <div class="basiclti_settings_checkbox">
                        <label for="basiclti_settings_debug">__MSG__DEBUG__</label>
                        <input type="checkbox" id="basiclti_settings_debug" name="debug" {if debug}checked="checked"{/if} /><span>&nbsp;</span>
                    </div>
                    <br class="oae-push" />
                </div>
            </div>
        ...
        <div class="dialog_buttons">
            <button type="button" class="oae-link-button oae-bold" id="basiclti_settings_cancel">__MSG__CANCEL__</button>
            <button type="submit" class="oae-button oae-overlay-action-button" id="basiclti_settings_insert">__MSG__SAVE__</button>
        </div>
    </form>
--></div>
...
<div id="basiclti_no_settings" style="display:none;">__MSG__NO_SETTINGS__</div>

<!-- JAVASCRIPT -->
<script type="text/javascript" src="/node_modules/oae-core/basiclti/javascript/basiclti.js" />
