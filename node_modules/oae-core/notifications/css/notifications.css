...
.ie-lt10 #notifications-container {
    padding: 8px;
}
...
#notifications-container .oae-list-details-item {
    width: 496px;
}
...
#notifications-container .oae-listitem.with-target-thumbnail > div.oae-listitem-metadata {
    max-width: 339px;
}
...
@media (max-width: 768px) {
    ...
    /* Hide show the target preview to give more room for the metadata text */
    #notifications-container .oae-listitem > div.notifications-target-thumbnail {
        display: none;
    }
}
