...
define(['jquery', 'underscore', 'oae.core'], function($, _, oae) {
    ...
    return function(uid) {
        ...
        /**
         * Based on the number of unread notifications reported by the me feed, the first items in the notifications
         * list are flagged as unread. This will make it clearer to the end-user as to which notifications he should
         * be paying most attention to.
         */
        var flagUnread = function() {
            var unreadNotifications = oae.data.me.notificationsUnread || 0;

            $('.oae-listitem', $rootel).removeClass('alert-info').each(function(i, el) {
                var $el = $(this);
                if (parseInt($el.attr('data-published'), 10) > oae.data.me.notificationsLastRead) {
        ...
        var removeUnreadCount = function() {
            ...
            // Reset the number of unread notifications in the me feed object
        ...
        /**
         * Subscribe to notification push notifications, allowing for new notifications to be prepended to the
