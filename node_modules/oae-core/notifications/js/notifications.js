...
define(['jquery', 'underscore', 'oae.core'], function($, _, oae) {
    ...
    return function(uid) {
        ...
        var flagUnread = function() {
            ...
            $('.oae-listitem:lt(' + unreadNotifications + ')', $rootel).addClass('alert-info');
        };
        ...
        var markAsRead = function() {
            // Reset the number of unread notification sin the me feed object
            oae.data.me.notificationsUnread = 0;
            // Remove the unread count in the top navigation
            $('#topnavigation-notification-count').remove();
