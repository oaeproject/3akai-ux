...
define(['jquery', 'underscore', 'oae.core'], function($, _, oae) {
    ...
    return function(uid) {
        ...
        var flagUnread = function() {
            ...
            $('#notifications-container > .oae-list > li').each(function() {
        ...
        var handleEmptyResultList = function() {
            ...
            oae.api.util.template().render($('#notifications-noresults-template', $rootel), null, $('#notifications-container > .oae-list'));
        };
