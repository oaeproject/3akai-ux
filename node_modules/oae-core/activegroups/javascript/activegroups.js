    ...
    sakai_global.activegroups = function(tuid, showSettings) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.results.length; i++) {
                        ...
                        group['name'] = sakai.api.Util.applyThreeDots(data.results[i]['sakai:group-title'], $('.activegroups_widget').width() - 80, {max_rows: 1,whole_word: false}, 'oae-bold');
                        groups.push(group);
                    }
        ...
        var doInit = function() {
            if (! sakai.api.Widgets.isOnDashboard(tuid)) {
                ...
                $('#activegroups_widget').addClass('oae-widget oae-widget');
            }
