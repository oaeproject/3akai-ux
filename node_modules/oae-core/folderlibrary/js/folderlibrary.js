    ...
    return function(uid, showSettings, widgetData) {
        ...
        var getFolderLibrary = function() {
            ...
            if ((widgetData.canAddItem || widgetData.canManage) && !query) {
                initialContent = oae.api.util
                    .template()
                    .render($('#folderlibrary-list-actions-template', $rootel));
            }
                ...
                '#folderlibrary-template',
                {
                    ...
                    emptyListProcessor: function() {
                        oae.api.util.template().render(
                            $('#folderlibrary-noresults-template', $rootel),
                            {
                                query: query,
                            },
                            $('.oae-list', $rootel),
        ...
        var setUpListHeader = function() {
            ...
            oae.api.util
                .template()
                .render(
                    $('#folderlibrary-list-header-template', $rootel),
                    { actions: listHeaderActions },
                    $('#folderlibrary-list-header', $rootel),
                );
        };
