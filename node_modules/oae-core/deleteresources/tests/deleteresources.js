...
casper.test.begin('Widget - Delete resources', function(test) {
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        userUtil().createUsers(2, function(user1, user2) {
            ...
            contentUtil().createLink(null, null, null, null, [user2.id], null, function(err, link1Profile) {
                contentUtil().createLink(null, null, null, null, null, null, function(err, link2Profile) {
                    contentUtil().createLink(null, null, null, null, null, null, function(err, link3Profile) {
                        // Open my library
