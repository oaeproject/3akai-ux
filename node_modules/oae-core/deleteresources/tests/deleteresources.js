casper.test.begin('Widget - Delete resources', function(test) {
    ...
    var verifyDeleteResourcesModal = function() {
        casper.waitForSelector('li.oae-list-actions + li .oae-list-grid-item input[type="checkbox"]', function() {
            ...
            casper.waitUntilVisible('#deleteresources-modal', function() {
                casper.test.assertVisible('#deleteresources-modal', 'The delete resources pane is showing after trigger');
                casper.click('li.oae-list-actions + li .oae-list-grid-item input[type="checkbox"]');
            });
        });
    };
    ...
    var verifyDeleteResourcesElements = function() {
        ...
        casper.test.assertExists('#deleteresources-modal .modal-body #deleteresources-manage-delete-library', 'Verify that the button to remove resources from the library only is showing');
        casper.test.assertExists('#deleteresources-modal .modal-body #deleteresources-manage-delete-system', 'Verify that the button to remove resources from the system is showing');
    };
    ...
    var verifyDeleteResourcesFromLibrary = function() {
        casper.waitForSelector('#deleteresources-modal .modal-body #deleteresources-manage-delete-library', function() {
            ...
            casper.waitForSelector('#oae-notification-container .alert', function() {
                casper.test.assertDoesntExist('#oae-notification-container .alert.alert-error', 'Verify that deleting resources from the library with another manager on the content succeeds');
    ...
    var verifyDeleteResourcesFromSystem = function() {
        casper.waitForSelector('#deleteresources-modal .modal-body #deleteresources-manage-delete-library', function() {
            ...
            // Verify that deleting the item succeeded
            casper.waitForSelector('#oae-notification-container .alert', function() {
                casper.test.assertDoesntExist('#oae-notification-container .alert.alert-error', 'Verify that deleting resources from the system succeeds.');
                casper.click('#oae-notification-container .close');
            });
        });
    };
