...
casper.test.begin('Widget - Delete resources', function(test) {
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        casper.waitFor(function() {
            ...
            var link1Profile = null;
            var link2Profile = null;
            var link3Profile = null;

            casper.then(function() {
                contentUtil().createLink(null, [user2.id], null, function(_link1Profile) {
                    link1Profile = _link1Profile;
                    contentUtil().createLink(null, null, null, function(_link2Profile) {
                        link2Profile = _link2Profile;
                        contentUtil().createLink(null, null, null, function(_link3Profile) {
                            link3Profile = _link3Profile;
                        });
                    });
                });
            });
            ...
            casper.waitFor(function() {
                return link1Profile !== null && link2Profile !== null && link3Profile !== null;
            }, function() {
