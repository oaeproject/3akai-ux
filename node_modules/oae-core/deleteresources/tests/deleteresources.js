        ...
        casper.then(function() {
            contentUtil().createLink(null, [user2.id], null, function() {
                ...
                casper.thenOpen(configUtil().tenantUI + '/me/library', function() {
                    ...
                    casper.then(function() {
                        casper.echo('# Verify open delete resources modal', 'GREEN_BAR');
                        verifyDeleteResourcesModal();
                    });

                    // Verify that the delete resources elements are present
                    casper.then(function() {
                        casper.echo('# Verify delete resources elements', 'GREEN_BAR');
                        verifyDeleteResourcesElements();
                    });

                    // Verify that content with another manager can be deleted from my library
                    casper.then(function() {
                        casper.echo('# Verify deleting resources from the library succeeds for content with another manager', 'GREEN_BAR');
                    ...
                    casper.then(function() {
                        contentUtil().createLink(null, null, null, function() {
                            casper.reload(function() {
                                ...
                                casper.then(function() {
                                    casper.echo('# Verify deleting resources from the library fails for content with only me as a manager', 'GREEN_BAR');
                                ...
                                contentUtil().createLink(null, null, null, function() {
                                    casper.reload(function() {
                                        ...
                                        casper.then(function() {
                                            casper.echo('# Verify deleting resources from the system', 'GREEN_BAR');
                                            openDeleteResourcesModal();
