...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        // The principal that owns the library we are looking at
        var principal = null;

        // This array will hold all the resource profiles that should be deleted from the system
        ...
        var gatherProfiles = function() {
            setTitle('__MSG__GATHERING_PROFILES_FOR_SELECTED_ITEMS__');
