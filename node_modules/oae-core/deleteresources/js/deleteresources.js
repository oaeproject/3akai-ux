...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        // Variable that will keep track of the resourceType of the resource(s) being deleted (i.e. `content`, `folder`, `discussion`)
        ...
        var setUpDeleteResourcesModal = function() {
            $(document).on('click', '.oae-trigger-deleteresources', function() {
                ...
                // will tell us what type of resource is being deleted (i.e., `content`, `folder`, `discussion`)
