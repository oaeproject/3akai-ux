...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        var updateProgress = function(progress) {
            ...
            $('.progress-bar', $rootel).attr('aria-valuenow', progress.toFixed(2) + '%');
        };
         ...
         *
         * @param  {Boolean}        hardDeleteManage        Whether or not the resources the user can manage should be deleted from the system. If false, these resources will only be removed from the current library
         */
        var deleteResources = function(hardDeleteManage) {
            ...
            var deletedResource = function(err) {
                ...
                deleteResourceFromLibrary(selectedResourcesMember.pop(), deletedResource);
                    ...
                    finishDeleteResource(count, errCount, hardDeleteManage);
                }
            };
         ...
         * @param  {Boolean}    hardDeleteManage    Whether or not the resources the user can manage have been deleted from the system. If false, these resources were only removed from the current library
         */
        var finishDeleteResource = function(count, errCount, hardDeleteManage) {
            var data = {
                'count': count,
                'errCount': errCount,
                'resourceType': resourceType,
                'resourceSubType': selectedResources[0].resourceSubType,
                'hardDeleteManage': hardDeleteManage
            };
            ...
            // Hide the modal after deleting completes
