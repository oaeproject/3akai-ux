...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
         ...
         */
        var deleteResources(hardDeleteManage) {
        ...
        var deleteResourceFromLibrary = function(resource, callback) {
            if (resource.resourceType === 'content') {
                oae.api.content.removeContentFromLibrary(contextProfile.id, resource.id, callback);
            } else if (resource.resourceType === 'discussion') {
                oae.api.discussion.removeDiscussionFromLibrary(contextProfile.id, resource.id, callback);
            }
        };
