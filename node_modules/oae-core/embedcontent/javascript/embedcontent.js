...
require(['jquery', 'sakai/sakai.api.core'], function($, sakai) {
    ...
    sakai_global.embedcontent = function(tuid, showSettings, widgetData) {
        ...
        var $embedcontent_tabs = $('#embedcontent_settings_container .oae-tabs', $rootel);
        ...
        var $embedcontent_display_previews = $('#embedcontent_display_style div.oae-highlight_area_background', $rootel);
        ...
        var active_tab_class = 'oae-tabs-active';
        ...
        var createDataObject = function(result, name) {
            ...
            var link = sakai.api.Util.encodeForURL(name || result['_path']) + '/' + sakai.api.Util.encodeForURL(result['sakai:pooled-content-file-name']);
            if (dataObj._mimeType === 'x-sakai/link') {
                dataObj.downloadPath = result['sakai:pooled-content-url'];
                dataObj.contentProfileLink = '/content#p=' + link;
            } else {
                dataObj.downloadPath = '/p/' + link;
                dataObj.contentProfileLink = '/content#p=' + link;
            }
        ...
        $uploadContentLink.on('click', function() {
            $(window).trigger('init.addcontent.sakai');
            return false;
        });
        ...
        $(document).off('done.addcontent.sakai').on('done.addcontent.sakai', function(e, data, library) {
