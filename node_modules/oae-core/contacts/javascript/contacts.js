...
require(['jquery', 'sakai/sakai.api.core'], function($, sakai) {
    ...
    sakai_global.contacts = function(tuid, showSettings) {
        ...
        var contactsShowGrid = '.oae-listview-grid';
        var contactsShowList = '.oae-listview-list';
        var $contactsResultCount = $('.oae-search-result-count', $rootel);
        ...
        var getAccepted = function() {
            ...
            infinityScroll = $(contactsContainerList).infinitescroll(url, data, function(items, total) {
                ...
                if (total && contacts.query && contacts.query !== '*') {
                    ...
                    $contactsResultCount.children('.oae-search-result-count-label').text(resultLabel);
                    $contactsResultCount.children('.oae-search-result-count-count').text(total);
                }
        ...
        var handleHashChange = function() {
            ...
            if (contacts.listStyle === 'list') {
                $('#contacts_container div .contacts_list_items', $rootel).removeClass('oae-search-results-grid');
                $(contactsShowList, $rootel).addClass('selected');
                $(contactsShowList, $rootel).children().addClass('selected');
            } else {
                $('#contacts_container div .contacts_list_items', $rootel).addClass('oae-search-results-grid');
