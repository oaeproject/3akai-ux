        ...
        var doRender = function(newjson) {
            ...
            for (var group in newjson.entry) {
                if (newjson.entry.hasOwnProperty(group)) {
                    newjson.entry[group]['sakai:group-title'] = sakai.api.Util.applyThreeDots(newjson.entry[group]['sakai:group-title'], $('.my_groups_widget .oae-widget-content').width() - 50, {max_rows: 1,whole_word: false}, 'oae-bold');
                }
            }
