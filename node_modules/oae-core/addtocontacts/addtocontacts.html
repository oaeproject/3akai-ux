<!-- CSS -->
<link rel="stylesheet" type="text/css" href="/node_modules/oae-core/addtocontacts/css/addtocontacts.css"/>

<!-- DIALOG -->
<div class="oae-dialog oae-dialog-container" id="addtocontacts_dialog">
    <div class="oae-dialog-close jqmClose"></div>
    <h1 class="oae-dialog-header" id="addtocontacts_dialog_title"></h1>
    ...
    <div id="addtocontacts_add">
        ...
        <form id="addtocontacts_form" method="post" action="#">
            ...
            <textarea cols="75" rows="3" id="addtocontacts_form_personalnote" name="addtocontacts_form_personalnote" placeholder="__MSG__ENTER_A_PERSONAL_NOTE_FOR_THE_INVITATION__"></textarea>
        </form>

        <!-- DIALOG BUTTONS -->
        <div class="dialog_buttons addtocontacts_actionbuttons">
            <button type="button" class="oae-link-button oae-bold jqmClose">__MSG__DONT_INVITE__</button>
            <button type="button" id="addtocontacts_form_invite" class="oae-button oae-overlay-action-button">__MSG__INVITE__</button>
        </div>
    </div>
</div>
...
&nbsp;__MSG__I_WOULD_LIKE_TO_INVITE_YOU_TO_BECOME_A_MEMBER_OF_MY_NETWORKS_ON__ __MSG__SAKAI__.
...
<div id="addtocontacts_form_type_template" style="display:none"><!--
    {for type in relationships.contacts}
        <input type="checkbox" name="addtocontacts_form_type" value="${type.name}" id="addtocontacts_checkbox_${type_index}" {if type.selected}CHECKED{/if}/> <label for="addtocontacts_checkbox_${type_index}">${sakai.api.i18n.General.process(type.definition)}</label><br/>
    {/for}
--></div>

<!-- JAVASCRIPT -->
<script type="text/javascript" src="/node_modules/oae-core/addtocontacts/javascript/addtocontacts.js"></script>
