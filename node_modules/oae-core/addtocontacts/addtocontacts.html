...
<div class="s3d-dialog s3d-dialog-container" id="addtocontacts_dialog">
    ...
    <div id="addtocontacts_add">
        ...
        <div class="dialog_buttons addtocontacts_actionbuttons">
            <button type="button" class="s3d-link-button s3d-bold jqmClose">__MSG__DONT_INVITE__</button>
            <button type="button" id="addtocontacts_form_invite" class="s3d-button s3d-overlay-action-button">__MSG__INVITE__</button>
        </div>
    </div>
</div>
