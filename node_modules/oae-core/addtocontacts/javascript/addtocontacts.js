    ...
    sakai_global.addtocontacts = function(tuid, showSettings) {
        ...
        var fillInUserInfo = function(user) {
            if (user) {
                ...
                // Check for picture
                if (user.pictureLink) {
                    $(addToContactsInfoProfilePicture).html('<img alt="' + $('#addtocontacts_profilepicture_alt').html() + '" src="' + user.pictureLink + '" class="oae-icon-50" />');
                } else {
                    $(addToContactsInfoProfilePicture).html('<img alt="' + $('#addtocontacts_profilepicture_alt').html() + '" src="' + sakai.config.URL.USER_DEFAULT_ICON_URL + '" class="oae-icon-50" />');
                }
            }
        };
