    ...
    function($, oae) {
        return function(uid) {
            ...
            var reset = function() {
                ...
                $(document).off(
                    'oae.setpermissions.changed.' + setPermissionsId,
                );
                ...
                // Show the first step
                $(
                    '#upload-modal .modal-body > div:first-child',
                    $rootel,
                ).show();
            ...
            var editableSubmitted = function(value) {
                ...
                if (!value) {
                    ...
                    var fileIndex = $('#upload-selected-container li').index(
                        $listItem,
                    );
            ...
            var showCompleteNotification = function(errCount) {
                ...
                var notificationTitle = oae.api.util
                    .template()
                    .render($('#upload-notification-title-template', $rootel), {
                        context: contextData,
                        errCount: errCount,
                        files: selectedFiles,
                    });
                ...
                var notificationBody = oae.api.util
                    .template()
                    .render($('#upload-notification-body-template', $rootel), {
                        context: contextData,
                        errCount: errCount,
                        files: selectedFiles,
                    });
            ...
            var showDropped = function(dropData) {
                ...
                $('#upload-input', $rootel).fileupload(
                    'add',
                    dropData.data.files,
                );
            ...
            var showPermissions = function() {
                ...
                $(
                    '#upload-modal .modal-body > div#upload-permissions-container',
                    $rootel,
                ).show();
                $('#upload-upload', $rootel).hide();
            };
            ...
            var showOverview = function() {
                ...
                $(
                    '#upload-modal .modal-body > div#upload-overview-container',
                    $rootel,
                ).show();
            ...
            var setUpSetPermissions = function() {
                ...
                var $setPermissionsContainer = $(
                    '#upload-permissions-container',
                    $rootel,
                );
                ...
                if (contextData.id === oae.data.me.id) {
                    visibility = oae.api.config.getValue(
                        'oae-content',
                        'visibility',
                        'files',
                    );
                        ...
                        $.each(selectedFiles, function(index, file) {
                            file.viewers = _.chain(data.selectedPrincipalItems)
                                .filter(function(selectedPrincipalItem) {
                                    return (
                                        selectedPrincipalItem.id !==
                                        oae.data.me.id
                                    );
                                })
                                .pluck('shareId')
                                .value();
                            file.folders = _.pluck(
                ...
                $(document).on(
                    'oae.setpermissions.cancel.' + setPermissionsId,
                    showOverview,
                );
                ...
                var preFill = [
                    {
                        displayName: oae.api.i18n.translate(
                            '__MSG__MY_LIBRARY__',
                        ),
                        id: oae.data.me.id,
                        fixed: true,
                    ...
                    drop: function(ev, data) {
                        ...
                        if (addToSelected(data) > 0) {
                            ...
                            oae.api.util.notification(
                                ...
                                oae.api.i18n.translate(
                                    '__MSG__PLEASE_SELECT_A_VALID_FILE_TO_UPLOAD__',
                                    'upload',
                                ),
                                'error',
                            );
