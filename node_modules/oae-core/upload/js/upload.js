...
define(['jquery', 'underscore', 'oae.core', 'jquery.fileupload', 'jquery.iframe-transport'], function($, _, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var initReset = function() {
            $('#upload-container').on('hidden', doReset);
        };
        ...
        var renderSelected = function() {
            oae.api.util.renderTemplate('#upload-selected-template', {'files': selectedFiles}, $('#upload-selected-container'));
        };
        ...
        var initUpload = function() {
            ...
            $('#upload-doupload').off('click').on('click', function() {
                ...
                var doUpload = function(file) {
                    oae.api.content.createFile(file.displayName, file.description, file.visibility, $('#upload-input'), file.file, [], [], function(error, data) {
                        if (!error) {
                        ...
                        updateProgress((done / selectedFiles.length) * 100);
