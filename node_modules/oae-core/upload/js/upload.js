    ...
    return function(uid) {
        ...
        var setUpDelete = function() {
            $rootel.on('click', '.upload-trash', function(ev) {
                // Fade out the trash button
                // The callback function is called when the animation is complete
                $(ev.currentTarget).fadeOut(250, function() {
                    ...
                    // Also remove it from the UI after it has been faded out
