casper.test.begin('Widget - Upload', function(test) {
    ...
    var verifyRenameSelectedFile = function() {
        ...
        test.assertExists('#upload-modal .upload-selected-name', 'The editable file name field is present');
        test.assertSelectorHasText('#upload-modal .upload-selected-name', 'balloons.jpg', 'Selected file has name \'balloons.jpg\'');
        ...
        casper.waitForSelector('#upload-modal .upload-selected-name form', function() {
            ...
            test.assertExists('#upload-modal .upload-selected-name form', 'The file name form is present after click');
            // fill the form
            ...
            test.assertSelectorHasText('.upload-selected-name', 'Balloons in the sky', 'Renamed file has name \'Balloons in the sky\'');
            // Upload the file
            test.assertExists('button#upload-upload', 'The \'Upload file(s)\' button is present');
            casper.click('button#upload-upload');
            // Verify that the file has been uploaded by going to the content profile provided in the notification
