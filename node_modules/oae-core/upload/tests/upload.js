...
casper.test.begin('Widget - Upload', function(test) {
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        // Open the upload modal
        casper.then(function() {
            casper.echo('# Verify upload modal', 'GREEN_BAR');
            verifyOpenUpload();
        });

        // Verify uploading a file
        casper.then(function() {
            casper.echo('# Verify uploading single file', 'GREEN_BAR');
            verifyUploadSingleFile();
        });

        // Verify uploading multiple files
        casper.then(function() {
            casper.echo('# Verify uploading multiple files', 'GREEN_BAR');
        ...
        casper.then(function() {
            casper.echo('# Verify renaming selected file', 'GREEN_BAR');
            casper.thenOpen(configUtil().tenantUI + '/me', function() {
                casper.then(openUpload);
