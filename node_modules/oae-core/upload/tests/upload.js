...
var verifyOpenUpload = function() {
    ...
    casper.waitForSelector('.oae-trigger-upload', function() {
...
var verifyUploadMultipleFiles = function() {
    ...
    // Select a file to upload
    casper.fill('#upload-dropzone form', {
        'file': ['tests/casperjs/data/balloons.jpg', 'tests/casperjs/data/balloons.jpg', 'tests/casperjs/data/balloons.jpg', 'tests/casperjs/data/balloons.jpg']
    }, false);
