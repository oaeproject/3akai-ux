...
casper.test.begin('Widget - Upload', function(test) {
        ...
        casper.waitForSelector(
            ...
            function() {
                ...
                casper.wait(configUtil.modalWaitTime, function() {
                    test.assertVisible(
                        '#upload-modal',
                        'Upload pane is showing after trigger',
                    );
                    casper.click(
                        '#me-clip-container .oae-clip-content > button',
                    );
    ...
    var verifyUploadSingleFile = function() {
        ...
        test.assertExists(
            'ul#upload-selected-container li',
            'The selected file was rendered in a list',
        );
        // Upload the file
        test.assertExists(
            'button#upload-upload',
            "The 'Upload file(s)' button is present",
        );
            ...
            function() {
                ...
                casper.wait(configUtil.searchWaitTime, function() {
                    test.assertSelectorHasText(
                        ...
                        'balloons.jpg',
                        'The uploaded file has the correct title',
                    );
                });
            },
        );
    ...
    var verifyRenameSelectedFile = function() {
        ...
        test.assertExists(
            '#upload-modal .jeditable-field',
            'The editable file name field is present',
        );
        test.assertSelectorHasText(
            '#upload-modal .jeditable-field',
            'balloons.jpg',
            "Selected file has name 'balloons.jpg'",
        );
        casper.click('.jeditable-field');

        // Wait till the form has been injected into the DOM
        casper.waitForSelector(
            '#upload-modal .jeditable-field form',
            function() {
                // Check if the form is shown after clicking the editable field
                test.assertExists(
                    '#upload-modal .jeditable-field form',
                    'The file name form is present after click',
                );
                // Fill the form
                casper.fill(
                    '#upload-modal .jeditable-field form',
                ...
                test.assertSelectorHasText(
                    '.jeditable-field',
                    'Balloons in the sky',
                    "Renamed file has name 'Balloons in the sky'",
                );
                // Upload the file
                test.assertExists(
                    'button#upload-upload',
                ...
                casper.waitForSelector(
                    ...
                    function() {
                        ...
                        test.assertSelectorHasText(
                            '#oae-notification-container .alert h4 + a',
                            'Balloons in the sky',
                            "Notification link value is 'Balloons in the sky'",
                        );
                        casper.click(
                            '#oae-notification-container .alert h4 + a',
                        );
                        ...
                        casper.wait(configUtil.searchWaitTime, function() {
                            ...
                            test.assertSelectorHasText(
                                '#content-clip-container h1',
                                'Balloons in the sky',
                                'The uploaded file has the correct renamed title',
                            );
                        });
                    },
                );
