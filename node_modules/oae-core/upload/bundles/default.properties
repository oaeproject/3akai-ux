COULD_NOT_FIND_FILE_CONTENT = Could not find file content.
FILE_ADDED_TO_MY_LIBRARY_AND_GROUP_LIBRARY_PLURAL = ${count} files have been added to <a href="/me/library">My Library</a> and <a href="${context1URL}/library">${context1}</a>.
FILE_ADDED_TO_MY_LIBRARY_AND_GROUP_LIBRARY_SINGULAR = The file &quot;<a href="${file1URL}">${file1}</a>&quot; has been added to <a href="/me/library">My Library</a> and <a href="${context1URL}/library">${context1}</a>.
