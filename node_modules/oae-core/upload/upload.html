        ...
        <li class="oae-list-item" tabindex="${file_index}">
            <div class="oae-list-compact-item">
                <div class="oae-listitem oae-listitem-compact">
                    ...
                    <div class="pull-left">
                        <div class="upload-selected-name oae-threedots jeditable-field" rel="tooltip" data-placement="right" data-original-title="__MSG__CLICK_TO_RENAME__" tabindex="0">${file.displayName|safeUserInput}</div>
                    </div>
