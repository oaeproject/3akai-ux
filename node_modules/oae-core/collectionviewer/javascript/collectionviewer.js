    ...
    sakai_global.collectionviewer = function(tuid, showSettings, widgetData) {
        ...
        */
        ...
        var switchListView = function() {
            ...
            collectionviewer.page = $.bbq.getState('lp') || 1;
            $('.oae-listview-options', $rootel).children('.selected').children().removeClass('selected');
            $('.oae-listview-options', $rootel).children('.selected').removeClass('selected');
        ...
        var addBinding = function() {
            ...
            $('.collectionviewer_widget', $rootel).on('click', '#collectionviewer_expanded_content_container .oae-search-result .share_trigger_click, #collectionviewer_expanded_content_container .oae-search-result .savecontent_trigger', function() {
                $(this).parents('.oae-search-result').addClass('hovered');
            });
            ...
            $(window).on('hiding.newsharecontent.sakai hiding.savecontent.sakai', function() {
                $('#collectionviewer_expanded_content_container .oae-search-result.hovered', $rootel).removeClass('hovered');
            });
