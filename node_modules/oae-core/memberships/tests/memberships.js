...
casper.test.begin('Widget - Memberships', function(test) {
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        casper.thenOpen(configUtil().tenantUI + '/me/groups', function() {
            casper.then(function() {
                casper.echo('# Verify memberships elements', 'GREEN_BAR');
                casper.waitForSelector('#memberships-widget .oae-list.oae-list-grid li', verifyMembershipsElements);
            });

            casper.then(function() {
                casper.echo('# Verify memberships view modes', 'GREEN_BAR');
                verifyMembershipsViewMode();
            });

            casper.then(function() {
                casper.echo('# Verify memberships search', 'GREEN_BAR');
            ...
            casper.then(function() {
                casper.echo('# Verify memberships leave group', 'GREEN_BAR');
