casper.test.begin('Widget - Memberships', function(test) {
    ...
    var verifyMembershipsLeave = function() {
        ...
        test.assertExists('#memberships-widget .oae-list-options button.oae-trigger-leavegroup:disabled', 'The leave group button is disabled by default');
        ...
        casper.waitForSelector('li.oae-list-actions + li', function() {
            ...
            test.assertExists('#memberships-widget .oae-list-options button.oae-trigger-leavegroup:not([disabled])', 'The leave group button is enabled after checking a membership item');
            ...
            casper.waitForSelector('#leavegroup-modal', function() {
                ...
                test.assertExists('#memberships-widget .oae-list-options button.oae-trigger-leavegroup:disabled', 'The leave group button is disabled again after unchecking all groups');
            });
        });
    };
    ...
    var verifyMembershipsSearch = function(group) {
        ...
        casper.waitForSelector('.oae-list .alert-info', function() {
            test.assertExists('.oae-list .alert-info', 'No results are returned for \'puorg\' and a message is shown');
    ...
    var verifyMembershipsElements = function() {
        ...
        test.assertExists('#memberships-widget .oae-list-options', 'The list options are present');
        // Verify list options contain a checkbox that selects all
        test.assertExists('#memberships-widget .oae-list-options input[type="checkbox"]', 'The \'Select all\' checkbox is present in the list options');
        // Verify list options contain a leave group button
        test.assertExists('#memberships-widget .oae-list-options .oae-trigger-leavegroup', 'The leave group button is present in the list options');
        // Verify list options contain a switch view button
        test.assertExists('#memberships-widget .oae-list-options button[data-type="oae-list-compact"]', 'The \'Compact\' list view button is present');
        test.assertExists('#memberships-widget .oae-list-options button[data-type="oae-list-details"]', 'The \'Details\' list view button is present');
        test.assertExists('#memberships-widget .oae-list-options button[data-type="oae-list-grid"]', 'The \'Grid\' list view button is present');
        // Verify list options contain a search field
        test.assertExists('#memberships-widget .oae-list-options #memberships-search-query', 'The search box is present');
    };
