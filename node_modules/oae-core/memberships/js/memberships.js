...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        /**
         * Set up the list options header macro with its actions. If the current user can manage the
         * memberships list, they have the option to "leave" groups in the list
         */
        var setUpListOptionsHeader = function() {
            ...
            oae.api.util.template().render($('#memberships-list-options-template', $rootel), {'actions': actions}, $('#memberships-list-options', $rootel));
        };
