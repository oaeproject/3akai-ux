...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var handleEmptyResultList = function() {
            oae.api.util.template().render($('#memberships-noresults-template'), null, $('.oae-list', $rootel));
        };
        ...
        var getMemberships = function() {
            ...
            var url = '/api/user/' + widgetData.principalId + '/memberships';
            if (query) {
                url = '/api/search/memberships/' + widgetData.principalId;
            }
        ...
        var search = function(evt) {
            ...
            var selectedPage = initialState.segment().pop();

            if (evt !== undefined && evt.type === 'submit') {
                History.pushState(newState, null, '/me/' + oae.api.util.security().encodeForURL(selectedPage) + '?q=' + oae.api.util.security().encodeForURL(query));
            } else {
        ...
        /**
         * Extract the search query from the current URL and load the initial memberships list.
        ...
        var initMemberships = function() {
            ...
            if (document.all && document.addEventListener && !window.atob) {
                if (query !== undefined) {
                    History.replaceState( newState, null, 'me/' + oae.api.util.security().encodeForURL(selectedPage) + '?q=' + oae.api.util.security().encodeForURL(query));
                } else {
                    History.replaceState(newState, null, 'me/' + oae.api.util.security().encodeForURL(selectedPage));
                }
            } else {
