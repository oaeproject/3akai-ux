    ...
    return function(uid, showSettings, widgetData) {
        ...
        var getMemberships = function() {
            ...
            if (widgetData.canManage && !query) {
                initialContent = oae.api.util
                    .template()
                    .render($('#memberships-list-actions-template', $rootel));
            }

            var url = '/api/user/' + widgetData.context.id + '/memberships';
            if (query) {
                url =
                    '/api/search/memberships-library/' + widgetData.context.id;
            }
                ...
                '#memberships-template',
                {
                    ...
                    emptyListProcessor: function() {
                        oae.api.util.template().render(
                            $('#memberships-noresults-template', $rootel),
                            {
                                query: query,
                            },
                            $('.oae-list', $rootel),
        ...
        var setUpListHeader = function() {
            ...
            oae.api.util
                .template()
                .render(
                    $('#memberships-list-header-template', $rootel),
                    { actions: listHeaderActions },
                    $('#memberships-list-header', $rootel),
                );
        };
