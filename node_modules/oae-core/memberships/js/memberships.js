...
define(['jquery', 'oae/api/oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        /**
         * Initializes the infinite scroll plugin that fetches and pages a user's memberships
         */
        ...
        var addBinding = function() {
            $rootel.on('submit', '#memberships_search_form', function() {
                $.bbq.pushState({'q': $('#search_query', $(this)).val()});
                getMemberships();
                return false;
            });

            if (widgetData.principalId === oae.data.me.userId) {
                $('#memberships_create').show();
            }
        };
