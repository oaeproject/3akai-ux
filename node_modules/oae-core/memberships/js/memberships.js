...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var getMemberships = function() {
            ...
            $('#memberships-list-options-search-query', $rootel).val(query);
        ...
        var setUpListOptionsHeader = function() {
            ...
            oae.api.util.template().render($('#memberships-header-template', $rootel), {'actions': actions}, $('#memberships-header', $rootel));
        };
         ...
         */
        var search = function() {
            var query = $('#memberships-list-options-search-query', $(this)).val();
        ...
        var addBinding = function() {
            // Set up search event
            $rootel.on('submit', '#memberships-list-options .form-search', search);
