...
<div class="memberships_widget">
    ...
    <div id="results_header" class="oae-left oae-container oae-search-header">
        <h2 class="oae-search-header-type oae-force-left">Memberships (<strong id="memberships_numberFound">0</strong><span class="oae-aural-text"> memberships found</span>)</h2>
        ...
        <li class="oae-list-item">
            ...
            <div class="oae-list-item-banner" style="display: none;">
                <div>
                    ...
                    <a class="oae-threedots" href="/group/${m.id}" title="${m.title}">${m.title}</a>
                </div>
            </div>
            <div class="oae-list-item-left">
                <img src="${thumbnailUrl}" alt="${m.title}" class="oae-list-item-profile-picture grid"/>
                <div class="oae-list-item-left-inner">
                    ...
                    <label for="${m.id}_chk" class="oae-threedots">
                        <img src="${mediumThumbnailUrl}" alt="${m.title}" class="oae-list-item-profile-picture"/>
                        <img src="${smallThumbnailUrl}" alt="${m.title}" class="oae-list-item-small-picture"/>
