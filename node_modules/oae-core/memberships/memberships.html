...
<div class="memberships_widget">
    <div class="row-fluid">
        <div class="span6">
            <button type="button" class="btn btn-link oae-list-options-toggle lead">
                __MSG__MEMBERSHIPS__ <i class="oae-clip-button-icon icon-caret-down"></i>
            </button>
        </div>
        <div class="span6">
    ...
    <div class="row-fluid oae-list-options hide">
        <div class="span6">
            ...
            <button type="button" class="btn"><i class="icon-plus-sign pull-left"></i>__MSG__ADD_TO__</button>
            <button type="button" class="btn"><i class="icon-envelope pull-left"></i>__MSG__MESSAGE__</button>
        </div>
        <div class="span6">
