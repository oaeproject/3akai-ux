casper.test.begin('Widget - Discussion library', function(test) {
    ...
    var verifyDiscussionsLibraryShare = function() {
        ...
        test.assertExists('#discussionslibrary-widget .oae-list-options button.oae-trigger-share:disabled', 'The share button is disabled by default');
        ...
        test.assertExists('#discussionslibrary-widget .oae-list-options button.oae-trigger-share:not([disabled])', 'The share button is enabled after checking a discussion item');
        ...
        casper.waitForSelector('#share-container', function() {
            ...
            test.assertExists('#discussionslibrary-widget .oae-list-options button.oae-trigger-share:disabled', 'The share button is disabled again after unchecking all discussion items');
        });
    };
    ...
    var verifyDiscussionsLibraryDelete = function() {
        casper.waitForSelector('li.oae-list-actions + li .oae-list-grid-item input[type="checkbox"]', function() {
            ...
            test.assertExists('#discussionslibrary-widget .oae-list-options button.oae-trigger-deleteresources:disabled', 'The delete button is disabled by default');
            // Select the first discussion item in the list
            casper.click('li.oae-list-actions + li .oae-list-grid-item input[type="checkbox"]');
            // Verify that the delete button is now enabled
            test.assertExists('#discussionslibrary-widget .oae-list-options button.oae-trigger-deleteresources:not([disabled])', 'The delete button is enabled after checking a discussion item');
            ...
            casper.waitForSelector('#deleteresources-modal', function() {
                ...
                test.assertExists('#discussionslibrary-widget .oae-list-options button.oae-trigger-deleteresources:disabled', 'The delete button is disabled again after unchecking all discussion items');
            });
        });
    };
    ...
    var verifyDiscussionsLibrarySearch = function(discussion) {
        ...
        casper.waitForSelector('.oae-list .alert-info', function() {
            test.assertExists('.oae-list .alert-info', 'No results are returned for \'noissucsid\' and a message is shown');
    ...
    var verifyDiscussionsLibraryElements = function() {
        casper.waitForSelector('#discussionslibrary-widget .oae-list', function() {
            ...
            test.assertExists('#discussionslibrary-widget .oae-list-options', 'The list options are present');
            // Verify list options contain a checkbox that selects all
            test.assertExists('#discussionslibrary-widget .oae-list-options input[type="checkbox"]', 'The \'Select all\' checkbox is present in the list options');
            // Verify list options contain a share button
            test.assertExists('#discussionslibrary-widget .oae-list-options .oae-trigger-share', 'The share button is present in the list options');
            // Verify list options contain a delete button
            test.assertExists('#discussionslibrary-widget .oae-list-options .oae-trigger-deleteresources', 'The delete button is present in the list options');
            // Verify list options contain a switch view button
            test.assertExists('#discussionslibrary-widget .oae-list-options button[data-type="oae-list-compact"]', 'The \'Compact\' list view button is present');
            test.assertExists('#discussionslibrary-widget .oae-list-options button[data-type="oae-list-details"]', 'The \'Details\' list view button is present');
            test.assertExists('#discussionslibrary-widget .oae-list-options button[data-type="oae-list-grid"]', 'The \'Grid\' list view button is present');
            // Verify list options contain a search field
            test.assertExists('#discussionslibrary-widget .oae-list-options #discussionslibrary-search-query', 'The search box is present');
        });
    };
