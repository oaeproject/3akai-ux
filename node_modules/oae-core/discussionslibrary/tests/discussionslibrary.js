    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        casper.thenOpen(configUtil().tenantUI + '/me/discussions', function() {
            discussionUtil().createDiscussion(function(_discussion) {
                ...
                casper.then(function() {
                    casper.echo('# Verify discussion library elements present', 'GREEN_BAR');
                    casper.waitForSelector('li[data-id="discussions"]', verifyDiscussionsLibraryElements);
                });

                casper.then(function() {
                    casper.echo('# Verify discussion library view modes', 'GREEN_BAR');
                    verifyDiscussionsLibraryViewMode();
                });

                casper.then(function() {
                    casper.echo('# Verify discussion library delete', 'GREEN_BAR');
                    verifyDiscussionsLibraryDelete();
                });

                casper.then(function() {
                    casper.echo('# Verify discussion library share', 'GREEN_BAR');
                    verifyDiscussionsLibraryShare();
                });

                casper.then(function() {
                    casper.echo('# Verify discussion library search', 'GREEN_BAR');
