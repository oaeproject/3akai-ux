    ...
    return function(uid, showSettings, widgetData) {
        ...
        var getDiscussionsLibrary = function() {
            ...
            if ((widgetData.canAdd || widgetData.canManage) && !query) {
                initialContent = oae.api.util
                    .template()
                    .render(
                        $('#discussionslibrary-list-actions-template', $rootel),
                    );
            }
                ...
                '#discussionslibrary-template',
                {
                    ...
                    emptyListProcessor: function() {
                        oae.api.util.template().render(
                            $(
                                '#discussionslibrary-noresults-template',
                                $rootel,
                            ),
                            {
                                query: query,
        ...
        var setUpListHeader = function() {
            ...
            oae.api.util
                .template()
                .render(
                    $('#discussionslibrary-list-header-template', $rootel),
                    { actions: listHeaderActions },
                    $('#discussionslibrary-list-header', $rootel),
                );
        };
