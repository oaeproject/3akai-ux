...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        var createLtiTool = function() {
            console.log('in createLtiTool')
            // Disable the form
            $('#createlti-form *', $rootel).prop('disabled', true);

            // Create the lti
            var id = $('#createlti-id', $rootel).val();
            ...
            oae.api.lti.createLtiTool(group.id, id, url, secret, key, displayName, description, function(err, data) {
                if (!err) {
                    var split = group.id.split(';');
