...
casper.test.begin('Widget - Delete resource', function(test) {
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        // Create a file
        casper.then(function() {
            contentUtil().createFile(null, null, null, function(_filePath) {
                filePath = _filePath;
                ...
                contentUtil().createLink(null, null, null, function(link) {
                    ...
                    // Create a discussion
                    discussionUtil().createDiscussion(null, null, function(_discussionData) {
                        discussionPath = _discussionData.profilePath;

                        // Create a collaborative document
                        collabDocUtil().createCollabDoc(null, null, function(_collabdocData) {
