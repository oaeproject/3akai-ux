...
casper.test.begin('Widget - Delete resource', function(test) {
    ...
    var verifyDeleteResourceModal = function() {
        casper.waitForSelector(
            ...
            function() {
                ...
                casper.waitForSelector(
                    'button.oae-trigger-deleteresource',
                    function() {
                        test.assertExists(
                            'button.oae-trigger-deleteresource',
                            'The delete resource trigger is present',
                        );
                        ...
                        casper.waitUntilVisible(
                            ...
                            function() {
                                test.assertVisible(
                                    '#deleteresource-modal',
                                    'Delete resource pane is showing after trigger',
                                );
                                casper.click(
                                    '#content-clip-container .oae-clip-content > button',
                                );
    ...
    var verifyDeleteResourceElements = function() {
        test.assertExists(
            '#deleteresource-modal .modal-body h4',
            'Verify that a warning header is shown',
        );
        test.assertExists(
            '#deleteresource-modal .modal-body .alert.alert-danger',
            'Verify that a warning alert text is shown',
        );
        test.assertExists(
            '#deleteresource-modal .modal-footer button[data-dismiss="modal"]',
            'Verify that the cancel button is shown',
        );
        test.assertExists(
            '#deleteresource-modal .modal-footer button#deleteresource-delete',
            'Verify that the delete button is shown',
        );
    };
                ...
                casper.waitForSelector(
                    ...
                    function() {
                        test.assertDoesntExist(
                            ...
                            'The ' + resourceType + ' was successfully deleted',
                        );
                        ...
                        casper.waitForSelector(
                            ...
                            function() {
                                test.assertExists(
                                    '#me-clip-container',
                                    'User gets redirected to / after the ' +
                                        resourceType +
                                        ' is deleted',
                                );
                            },
                                        ...
                                        contentUtil.createCollabDoc(
                                            ...
                                            function(err, collabdocProfile) {
                                                ...
                                                casper.then(function() {
                                                    ...
                                                    verifyDeletingResource(
                                                        'content',
                                                    );
                                                });

                                                // Verify deleting a link
                                                uiUtil.openLinkProfile(
                                                    linkProfile,
                                                );
                                                casper.then(function() {
                                                    casper.echo(
