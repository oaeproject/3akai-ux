    ...
    return function(uid) {
        ...
        var deleteResource = function() {
            ...
            deleteFunction(contextProfile.id, function(err) {
                ...
                var notificationTitle = oae.api.util
                    ...
                    .render(
                        $(
                            '#deleteresource-notification-title-template',
                            $rootel,
                        ),
                        data,
                    );
                var notificationBody = oae.api.util
                    ...
                    .render(
                        $(
                            '#deleteresource-notification-body-template',
                            $rootel,
                        ),
                        data,
                    );
        ...
        var setUpDeleteResource = function() {
            ...
            oae.api.util.template().render(
                $('#deleteresource-template', $rootel),
                {
                    contextProfile: contextProfile,
                },
        ...
        var setUpDeleteResourceModal = function() {
            ...
            $(document).on('oae.context.send.deleteresource', function(
                ev,
                ctx,
            ) {
                contextProfile = ctx;
