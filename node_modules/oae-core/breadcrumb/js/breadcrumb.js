...
define(['jquery', 'underscore', 'oae.core'], function($, _, oae) {
	...
	return function() {
		...
		var drawBreadcrumb = function(callback) {
			...
			list.append('<li id="breadcrumb-title">You are here: </li>');
	     ...
	     */
		var insertBreadcrumbIntoPage = function(tag, component) {
			tag.prepend(component);
		...
		$(document).on('oae.trigger.breadcrumb', function(ev, data) {
			updateBreadcrumb(data.widgetData, function() {
				drawBreadcrumb(function(err, component) {
					insertBreadcrumbIntoPage(data.tag, component);
				});
			});
		});
