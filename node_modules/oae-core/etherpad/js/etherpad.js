...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, contentObj) {
        ...
        var showViewMode = function() {
            ...
            // Check if the Etherpad document has any real text content.
            var isEmpty = $.trim($('<div>').html(etherpadHTML).text()) ? false : true;
        ...
        /**
         * When the user leaves the page, we automatically publish the pad's content to make sure that the
         * published version is up-to-date with the pad content. This needs to happen synchronously to avoid
        ...
        var publish = function() {
            ...
            // would otherwise break in IE10. (https://github.com/oaeproject/3akai-ux/pull/2918)
        ...
        var setUpEtherpad = function() {
            if (contentObj.isManager) {
                showEditMode();
                // Automatically publish the document when the user leaves the page
