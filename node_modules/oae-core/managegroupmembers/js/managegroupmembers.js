...
require(['jquery', 'sakai/sakai.api.core', 'underscore'], function($, sakai, _) {
    ...
    sakai_global.managegroupmembers = function(tuid, showSettings, widgetData) {
         ...
         * @returns {String} errorMsg A string containing the error message
         */
         ...
         * @returns {Object} returnValue An object containing a list of displayNames and an Array of userID's to be added to the members list
         */
