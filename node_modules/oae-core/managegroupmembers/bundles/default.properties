...
USER_HAS_ADDED_YOU_AS_A_ROLE_TO_THE_EXISTING_GROUP_GROUPNAME = ${user} has added you as a ${role} to the group "${groupName}".
YOU_CAN_FIND_IT_HERE_GROUPURL = You can find it here: ${groupURL}
