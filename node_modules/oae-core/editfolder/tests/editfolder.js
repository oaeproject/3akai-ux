...
casper.test.begin('Widget - Edit folder', function(test) {
    ...
    var verifyOpenEditFolder = function() {
        casper.waitForSelector(
            ...
            function() {
                ...
                casper.waitForSelector(
                    'button.oae-trigger-editfolder',
                    function() {
                        test.assertVisible(
                            'button.oae-trigger-editfolder',
                            'Edit folder trigger exists',
                        );
                        ...
                        casper.waitUntilVisible(
                            ...
                            function() {
                                test.assertVisible(
                                    '#editfolder-modal',
                                    'Edit folder pane is showing after trigger',
                                );
                                casper.click(
                                    '#folder-clip-container .oae-clip-content > button',
                                );
    ...
    var verifyEditFolderFormElements = function() {
        casper.waitForSelector('#editfolder-modal', function() {
            test.assertExists(
                'form#editfolder-form',
                'The edit folder form is present',
            );
            test.assertExists(
                'form#editfolder-form #editfolder-name',
                'The edit folder name field is present',
            );
            test.assertExists(
                'form#editfolder-form #editfolder-description',
                'The edit folder description field is present',
            );
            test.assertExists(
                'form#editfolder-form button[type="submit"]',
                'The edit folder form submit button is present',
            );
        });
    };
        ...
        casper.waitForSelector(
            ...
            function() {
                test.assertDoesntExist(
                    ...
                    'The folder details were successfully updated',
                );
                test.assertSelectorHasText(
                    '#folder-clip-container h1',
                    'New folder name',
                    "The folder name was successfully renamed to 'New folder name'",
                );
            },
        );
    };
    ...
    casper.start(configUtil.tenantUI, function() {
        ...
        userUtil.createUsers(1, function(user1) {
            ...
            // Create a folder
            folderUtil.createFolder(null, null, null, null, null, function(
                err,
                folderProfile,
            ) {
