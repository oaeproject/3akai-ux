...
define(['jquery', 'oae.core'], function($, oae) {
    return function(uid) {
        ...
        var setUpEditFolder = function() {
            ...
            oae.api.util
                .validation()
                .validate($('#editfolder-form', $rootel), validateOpts);
        };
        ...
        var editFolder = function() {
            ...
            var params = {
                ...
                description: $.trim(
                    $('#editfolder-description', $rootel).val(),
                ),
            };

            oae.api.folder.updateFolder(folderProfile.id, params, function(
                err,
                data,
            ) {
                ...
                if (!err) {
                    ...
                    oae.api.util.notification(
                        oae.api.i18n.translate(
                            '__MSG__FOLDER_EDITED__',
                            'editfolder',
                        ),
                        oae.api.i18n.translate(
                            '__MSG__FOLDER_EDIT_SUCCESS__',
                            'editfolder',
                        ),
                    );
                    ...
                    oae.api.util.notification(
                        oae.api.i18n.translate(
                            '__MSG__FOLDER_NOT_EDITED__',
                            'editfolder',
                        ),
                        oae.api.i18n.translate(
                            '__MSG__FOLDER_EDIT_FAIL__',
                            'editfolder',
                        ),
                        'error',
                    );
        ...
        var setUpReset = function() {
            $('#editfolder-modal', $rootel).on(
                ...
                function() {
                    ...
                    $('#editfolder-form *', $rootel).prop('disabled', false);
                    $('#editfolder-form button[type="submit"]', $rootel).prop(
                        'disabled',
                        true,
                    );
                },
