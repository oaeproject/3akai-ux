...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        /**
         * Delete the folder. When specified, all of its content will be deleted at the
         * same time
         *
         * @param  {Boolean}        [deleteContents]           Whether or not the folder contents should be deleted as well
         */
        var deleteFolder = function(deleteContents) {
            // Disable the action buttons
            $('#deletefolder-overview *', $rootel).prop('disabled', true);

            // Delete the folder
            oae.api.folder.deleteFolder(contextProfile.id, deleteContents, function(err, failedContent) {
                if (!err) {
