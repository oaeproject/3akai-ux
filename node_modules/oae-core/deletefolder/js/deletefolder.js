...
define(['jquery', 'oae.core'], function($, oae) {
    return function(uid) {
                    ...
                    if (!err) {
                        ...
                        if (failedContent && failedContent.length > 0) {
                            oae.api.util.template().render(
                                $('#deletefolder-failed-template', $rootel),
                                {
                        ...
                        $('#deletefolder-overview *', $rootel).prop(
                            'disabled',
                            false,
                        );
                    }
        ...
        var addBinding = function() {
            ...
            $rootel.on(
                'click',
                '#deletefolder-delete-folder-contents',
                function() {
                    deleteFolder(true);
                },
            );
