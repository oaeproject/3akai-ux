<!-- CSS -->
<link rel="stylesheet" type="text/css" href="css/addpeoplegroups.css" />
...
<div id="addpeoplegroups_widget" style="display:none">
    ...
    <div id="addpeoplegroups" class="addpeoplegroups_dialog">
        ...
        <div class="addpeoplegroups_outer clearfix">
            ...
            <button type="button" id="addpeoplegroups_save" class="oae-button oae-header-button oae-header-smaller-button oae-force-right">__MSG__ADD__</button>
            <button class="addpeoplegroups_close oae-link-button oae-bold oae-force-right" type="button">__MSG__CANCEL__</button>
        </div>
    </div>
</div>
...
<!-- JAVASCRIPT -->
<script type="text/javascript" src="js/addpeoplegroups.js"></script>
