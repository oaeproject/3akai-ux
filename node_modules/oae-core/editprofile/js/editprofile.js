...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        var isValidProfile = function() {
            return (profile.email && oae.api.util.validation().isValidDisplayName(profile.displayName));
        };
        ...
        var renderEditProfileMainPanel = function() {
            oae.api.user.getEmailVerificationStatus(oae.data.me.id, function(err, email) {
                ...
                if (!oae.api.util.validation().isValidDisplayName(profile.displayName)) {
                ...
                // Switch the view to the edit profile
                $('#editprofile-panel-email-container').hide();
                $('#editprofile-panel-main-container').show();
            });
        };

        var renderEditProfileEmailPanel = function(newEmail) {
            ...
            oae.api.user.updateUser(params, function (err, data) {
                if (!err) {
                    ...
                    if (!isEmailChange) {
                        ...
                        // email inbox
                        renderEditProfileEmailPanel(newEmail);
                    }
                } else {
