...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        var bindEditProfileMainPanelListeners = function() {
            ...
            // When user click on download personal data link, open the download modal
            $rootel.on('click', '#export-personal-data-link', function() {
                closeModal();
                $(document).trigger('oae.trigger.exportdata', profile);
            });
        };
