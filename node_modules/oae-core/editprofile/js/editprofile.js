...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        var isValidProfile = function() {
            return (oae.api.util.validation().isValidEmail(profile.email) && oae.api.util.validation().isValidDisplayName(profile.displayName));
        };
         ...
         *
         * @param  {String}     newEmail    The new unverified email address that the user should be instructed to verify
         */
        ...
        /**
         * Show the edit profile modal and render the "main" panel
         */
