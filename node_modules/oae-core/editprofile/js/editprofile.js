    ...
    return function(uid) {
        ...
        var renderEditProfileMainPanel = function() {
            ...
            if (!isValidDisplayName()) {
                ...
                var tenantVisibility = oae.api.config.getValue(
                    'oae-principals',
                    'user',
                    'visibility',
                );
            ...
            oae.api.util.template().render(
                $('#editprofile-panel-main-template', $rootel),
                {
            ...
            $('#editprofile-form', $rootel).on(
                oae.api.util.getFormChangeEventNames(),
                function() {
                    $(
                        '#editprofile-panel-main-container button[type="submit"]',
                        $rootel,
                    ).prop('disabled', false);
                },
            );
                ...
                methods: {
                    displayname: {
                        ...
                        text: oae.api.i18n.translate(
                            '__MSG__PLEASE_ENTER_A_VALID_NAME__',
                        ),
                    },
                },
            };
            oae.api.util
                .validation()
                .validate($('#editprofile-form', $rootel), validateOpts);
        ...
        var renderEditProfileEmailPanel = function() {
            ...
            oae.api.util.template().render(
                $('#editprofile-panel-email-template', $rootel),
                {
                    isValidProfile: isValidProfile(),
                    profile: profile,
                    unverifiedEmail: unverifiedEmail,
            ...
            oae.api.user.updateUser(params, function(err, data) {
                if (!err) {
                    ...
                    if (!isEmailChange) {
                        ...
                        oae.api.util.notification(
                            ...
                            oae.api.i18n.translate(
                                '__MSG__PROFILE_DETAILS_EDIT_SUCCESS__',
                                'editprofile',
                            ),
                        );
                    } else {
                    ...
                    oae.api.util.notification(
                        ...
                        oae.api.i18n.translate(
                            '__MSG__PROFILE_DETAILS_EDIT_FAIL__',
                            'editprofile',
                        ),
                        'error',
                    );
        ...
        var setUpReset = function() {
            $('#editprofile-modal', $rootel).on(
                'shown.bs.modal',
                showDefaultPanel,
            );
            $('#editprofile-modal', $rootel).on('hidden.bs.modal', function(
                evt,
            ) {
                // Reset the form
                ...
                // Enable the form
                $('#editprofile-form *', $rootel).prop('disabled', false);
                $('#editprofile-form button[type="submit"]', $rootel).prop(
                    'disabled',
                    true,
                );
        ...
        var bindEditProfileMainPanelListeners = function() {
            ...
            $rootel.on(
                'change',
                '#editprofile-panel-main-container .oae-large-options-container input[type="radio"]',
                function() {
                    $(
            ...
            $rootel.on(
                'click',
                '#editprofile-email-verification .editprofile-email-verification-action button',
                function() {
                    // Disable all actions in the modal
                    $('#editprofile-form *', $rootel).prop('disabled', true);
                    oae.api.user.resendEmailToken(oae.data.me.id, function(
                        err,
                    ) {
                        if (!err) {
                            ...
                            oae.api.util.notification(
                                oae.api.i18n.translate(
                                    '__MSG__VERIFICATION_EMAIL_SENT__',
                                    'editprofile',
                                ),
                                oae.api.i18n.translate(
                                    '__MSG__A_VERIFICATION_EMAIL_HAS_BEEN_SENT_TO_UNVERIFIED_EMAIL__',
                                    'editprofile',
                                    {
                                        unverifiedEmail: unverifiedEmail,
                                    },
                            ...
                            oae.api.util.notification(
                                oae.api.i18n.translate(
                                    '__MSG__VERIFICATION_EMAIL_FAILED__',
                                    'editprofile',
                                ),
                                oae.api.i18n.translate(
                                    '__MSG__A_VERIFICATION_EMAIL_FAILED_TO_BE_SENT_TO_UNVERIFIED_EMAIL__',
                                    'editprofile',
                                    {
                                        unverifiedEmail: unverifiedEmail,
                                    },
            ...
            $rootel.on(
                'click',
                '#editprofile-email-verification .editprofile-email-verification-cancel button',
                function(evt) {
                    ...
                    oae.api.user.deletePendingEmailVerification(function(err) {
                        if (!err) {
                            ...
                            $(
                                '#editprofile-email-verification',
                                $rootel,
                            ).slideUp();
                        } else {
                            // If the token failed to resend, show a notification
                            oae.api.util.notification(
                                oae.api.i18n.translate(
                                    '__MSG__CANCEL_EMAIL_VERIFICATION_FAILED__',
                                    'editprofile',
                                ),
                                oae.api.i18n.translate(
                                    '__MSG__AN_ERROR_OCCURRED_WHILE_CANCELLING_THE_EMAIL_VERIFICATION__',
                                    'editprofile',
                                ),
                                'error',
                            );
        ...
        var bindEditProfileEmailPanelListeners = function() {
            ...
            $rootel.on(
                'click',
                '#editprofile-panel-email-container .modal-footer button.btn-primary',
                function() {
                    closeModal();
                },
            );
            ...
            $rootel.on(
                'click',
                '#editprofile-panel-email-container .modal-footer button.btn-link',
                function() {
                    renderEditProfileMainPanel();
                },
            );
