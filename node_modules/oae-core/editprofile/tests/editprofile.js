...
casper.test.begin('Widget - Edit profile', function(test) {
    ...
    var openEditProfile = function() {
        casper.waitForSelector(
            ...
            function() {
                ...
                test.assertExists(
                    '.oae-trigger-editprofile',
                    'Edit profile trigger exists',
                );
                casper.click('.oae-trigger-editprofile');
                casper.waitUntilVisible('#editprofile-modal', function() {
                    test.assertVisible(
                        '#editprofile-modal',
                        'Edit profile pane is showing after trigger',
                    );
                    casper.click(
                        '#me-clip-container .oae-clip-content > button',
                    );
    ...
    var verifyEditProfile = function() {
        ...
        test.assertExists(
            ...
            'The edit profile form is present',
        );
        test.assertExists(
            '#editprofile-name',
            'The edit profile name field is present',
        );
        test.assertExists(
            '#editprofile-email',
            'The edit profile email field is present',
        );
        test.assertExists(
            'input[type="radio"][name="oae-visibility-group"]',
            'The edit profile visibility field is present',
        );
        ...
        test.assertExists(
            ...
            "The 'Edit details' button is present",
        );
    ...
    var verifyEditProfileValidation = function() {
        ...
        test.assertExists(
            '#editprofile-name-error',
            'Edit profile form successfully validated empty form',
        );
        ...
        test.assertExists(
            '#editprofile-name-error',
            'Edit profile form successfully validated empty name',
        );
        ...
        // Verify that an error label is shown
        test.assertExists(
            '#editprofile-email-error',
            'Edit profile form successfully validated empty email',
        );
        ...
        test.assertExists(
            '#editprofile-email-error',
            'Edit profile form successfully validated incorrect email',
        );
    };
