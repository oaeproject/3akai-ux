...
<div id="editprofile-template"><!--
    ...
    {if isDisabled}
        <label for="editprofile-name" class="control-label"><h4>__MSG__NAME__</h4>${oae.data.me.displayName|encodeForHTMLAttribute} </label>
    {/if}
    {if isEnabled}
        <label for="editprofile-name" class="control-label"><h4>__MSG__NAME__</h4>
    ...
    <div class="form-group">
    {if isDisabled}
        <label for="editprofile-email" class="control-label"><h4>__MSG__EMAIL__</h4>${oae.data.me.email|encodeForHTMLAttribute}</label>
    {/if} 
    {if isEnabled}
