...
<div id="editprofile-template"><!--
    <div class="control-group">
        <label for="editprofile-name"><h4>__MSG__NAME__</h4></label>
        <div class="controls">
            <input type="text" id="editprofile-name" class="required" name="editprofile-name" placeholder="__MSG__ENTER_A_NAME__" value="${oae.data.me.displayName|encodeForHTMLAttribute}"/>
        </div>
    </div>
    <div class="control-group">
        <label for="editprofile-email"><h4>__MSG__EMAIL__</h4></label>
        <div class="controls">
            <input type="text" id="editprofile-email" class="required email" name="editprofile-email" placeholder="__MSG__ENTER_AN_EMAIL_ADDRESS__" value="${oae.data.me.email|encodeForHTMLAttribute}"/>
        </div>
    </div>
    <div id="editprofile-publicalias-container" class="control-group {if oae.data.me.visibility === 'public'} hide{/if}">
        <label for="editprofile-publicalias"><h4>__MSG__PUBLIC_ALIAS__</h4></label>
        <div class="controls">
            <input type="text" id="editprofile-publicalias" class="required" name="editprofile-publicalias" placeholder="__MSG__ENTER_A_PUBLIC_ALIAS__" value="${oae.data.me.publicAlias|encodeForHTMLAttribute}"/>
        </div>
    </div>
