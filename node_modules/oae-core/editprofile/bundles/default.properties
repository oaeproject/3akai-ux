...
UPDATED_VERIFICATION_INSTRUCTION = A verification email has been sent to <strong>${unverifiedEmail}</strong> to confirm this address. You must accept this verification before you can begin using your new email address.
