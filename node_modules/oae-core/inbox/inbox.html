...
<div id="inbox_widget">
    ...
    <div class="fl-widget-inbox s3d-widget-inbox s3d-widget-small-inbox">
        <div class="inbox_main">
            <!-- Title -->
            <h1 id="inbox_header" class="inbox-message-list-view s3d-contentpage-title inbox-message-detail-view inbox-new-message-view" style="display:none">
            ...
            <div id="inbox_message_header">
                ...
                <div class="s3d-search-container inbox-message-list-view fl-force-right" style="display:none" role="search" aria-label="__MSG__SEARCH_MESSAGES__">
                    ...
                    <a href="#newmessage=true" data-remove-params="message, reply" class="s3d-no-margin-top s3d-button s3d-margin-top-3 s3d-overlay-button grey inbox-message-list-view inbox-message-detail-view fl-force-right" id="inbox_create_new_message" style="display:none">
            ...
            <div id="inbox_message_list_item_template"><!--
                ...
                {for message in results}
                    <div class="inbox_item fl-container fl-fix inbox_items_container{if !message.read} unread{/if}{if message_index == results.length-1} last{/if}" id="${message.id}">
                        <div class="inbox_items_inner">
                            <div class="inbox_left_col inbox_col">
                                <div class="inbox_placeholder"><input type="checkbox" title="__MSG__SELECT_MESSAGE__ ${message.subject|safeOutput} __MSG__FROM_LC__ ${message.from.name}"/><span class="inbox_item_read_icon">&nbsp;<em class="s3d-aural-text">{if !message.read}__MSG__UNREAD__{else}__MSG__READ__{/if}</em></span></div>
                            ...
                            <div class="inbox_middle_col inbox_col">
                                <div class="inbox_message_data">
                                  ...
                                  <div class="inbox_subject">
                                    <a href="#message=${message.id}" class="s3d-regular-links s3d-bold">${message.subject_short|safeOutput}</a>
                                  </div>
                            ...
                            <div class="inbox_right_col inbox_col">
                                <div class="inbox_delete fl-force-right">
                                    <a href="#message=${message.id}&reply=true" class="s3d-button s3d-header-button s3d-button-no-text inbox_reply_button inbox_action_button" title="__MSG__REPLY__"><span class="s3d-aural-text">__MSG__REPLY_TO_MESSAGE__ ${message.subject|safeOutput}</span><div class="inbox_reply_icon"></div></a>
                                    <button type="button" class="s3d-button s3d-header-button s3d-button-no-text inbox_delete_button inbox_action_button" title="__MSG__DELETE_MESSAGE__"><span class="s3d-aural-text">__MSG__DELETE_MESSAGE__ ${message.subject|safeOutput}</span><div class="inbox_delete_icon"></div></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="fl-container fl-fix" id="inbox_no_messages">
                    <div class="s3d-no-results-container">
                        ...
                        {elseif widgetData.category == "invitation"}
                            ...
                            <p>__MSG__NO_RESULTS_DESCRIPTION_INVITATIONS__ <a href="/search#l=people" class="s3d-regular-links">__MSG__FIND_PEOPLE__</a> __MSG__AND_EXPAND_YOUR_NETWORK__</p>
                        {elseif widgetData.box == "outbox"}
                            <div class="s3d-no-results-icon s3d-no-results-replied"></div>
                            <p>__MSG__NO_RESULTS_DESCRIPTION_OUTBOX__ <a href="#newmessage=true" class="s3d-regular-links">__MSG__COMPOSE_A_MESSAGE__</a></p>
                        {elseif widgetData.box == "inbox"}
                            <div class="s3d-no-results-icon s3d-no-results-people"></div>
                            <p>__MSG__NO_RESULTS_DESCRIPTION_INBOX__ <a href="/search#l=people" class="s3d-regular-links">__MSG__FIND_PEOPLE__</a> __MSG__AND_EXPAND_YOUR_NETWORK__</p>
                        {elseif widgetData.box == "trash"}
                            <div class="s3d-no-results-icon s3d-no-results-trash"></div>
                            <p>__MSG__NO_RESULTS_DESCRIPTION_TRASH__ <a href="/search#l=people" class="s3d-regular-links">__MSG__FIND_PEOPLE__</a> __MSG__AND_EXPAND_YOUR_NETWORK__</p>
                        {/if}
                    </div>
                </div>
            --></div>
                    ...
                    <div class="inbox_show_message_header">
                        <div class="fl-container fl-fix inbox_items_container" id="${message.id}">
                            <div class="inbox_items_inner">
                                ...
                                {if !reply}
                                    <div class="inbox_delete fl-force-right">
                                        <button type="button" class="s3d-button s3d-header-button s3d-button-no-text inbox_delete_button" title="__MSG__DELETE_MESSAGE__"><span class="s3d-aural-text">__MSG__DELETE_MESSAGE__ ${message.subject|safeOutput}</span><div class="inbox_delete_icon"></div></button>
                                    </div>
                                {/if}
                                </div>
                            </div>
