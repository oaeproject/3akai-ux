                    ...
                    <div class="lhnavigation_item_content">
                        ...
                        <div class="lhnavigation_selected_submenu" id="lhnavigtation_submenu_${level._id}" style="display:none;">
                            <button class="lhnavigation_selected_submenu_image" title="__MSG__OPTIONS_FOR__{if contextData.altTitle} ${level._altTitle|safeOutput}{else} ${level._title|safeOutput}{/if}">
                                <span class="s3d-aural-text">__MSG__OPTIONS_FOR__{if contextData.altTitle} ${level._altTitle|safeOutput}{else} ${level._title|safeOutput}{/if}</span>
                                &#9660;
                            </button>
                        </div>
                        <div class="lhnavigation_selected_item_arrow" style="visibility:hidden;"></div>
                                    ...
                                    <div class="lhnavigation_subnav_item_content">
                                        ...
                                        <div class="lhnavigation_selected_submenu lhnavigation_selected_subsubmenu" id="lhnavigtation_submenu_${level._id}/${sublevel._id}" style="display:none;">
                                            <button class="lhnavigation_selected_submenu_image" title="__MSG__OPTIONS_FOR__{if contextData.altTitle} ${sublevel._altTitle|safeOutput}{else} ${sublevel._title|safeOutput}{/if}">
                                                <span class="s3d-aural-text">__MSG__OPTIONS_FOR__{if contextData.altTitle} ${sublevel._altTitle|safeOutput}{else} ${sublevel._title|safeOutput}{/if}</span>
                                                &#9660;
                                            </button>
                                        </div>
                                        <div style="visibility: hidden;" class="lhnavigation_selected_item_arrow lhnavigation_selected_item_arrow_sub"></div>
