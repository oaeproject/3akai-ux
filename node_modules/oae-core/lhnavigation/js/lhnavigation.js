...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
         ...
         * @returns {Object}                 Object representing the page with the provided page id. If no page with the provided page id can be found, the first page will be returned
         */
        ...
        var setUpNavigation = function(baseUrl) {
            ...
            // Extract the currently selected page from the URLby parsing the URL fragment that's
