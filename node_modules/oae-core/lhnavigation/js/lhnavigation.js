...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid) {
         ...
         */
        var setUpNavigation = function(navStructure, baseUrl) {
            // Render the navigation
            var renderedNavigation = oae.api.util.template().render($('#lhnavigation-navigation-template', $rootel), {
                'items': navStructure,
                'baseUrl': baseUrl
            });
            $('.oae-lhnavigation > ul.nav', $rootel).append(renderedNavigation);
        ...
        $(window).on('oae.trigger.lhnavigation', function(ev, lhNavPages, lhNavActions, baseUrl, hasNav) {
            ...
            // If there are clip actions included in the navigation render them first
            if (lhNavActions && lhNavActions.length) {
                setUpNavigation(lhNavActions);
                setUpNavigationActions();
            }

            // Render the navigation pages second
            setUpNavigation(lhNavigationPages, baseUrl);
        });
