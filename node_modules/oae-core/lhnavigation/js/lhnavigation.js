...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        var setUpNavigation = function(baseUrl) {
            ...
            // Extract the currently selected page from the URL. We parse the URL fragment that's 
            // inside of the current History.js state. The expected URL structure is `/me/<pageId>`. 
            ...
            // Replace the current History.js state to have the selected page. This is necessary 
            ...
            // of the page rendering. However, we also need to add a random number to the data object to make
            // sure that the statechange event is triggered after a page reload.
