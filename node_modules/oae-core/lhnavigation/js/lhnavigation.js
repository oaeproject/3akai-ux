...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    return function(uid) {
        ...
        var renderPage = function() {
            ...
            $(
                '.oae-lhnavigation ul li[data-id="' + selectedPage.id + '"]',
                $rootel,
            ).addClass('active');
            ...
            $(
                '.oae-page > div:not(#lhnavigation-toggle-container)',
                $rootel,
            ).hide();
            ...
            if ($cachedPage.length > 0) {
                ...
                $pageContainer.append(
                    oae.api.util
                        .template()
                        .render($('#lhnavigation-page-template'), {
        ...
        var setUpNavigation = function(lhNavPages, lhNavActions, baseUrl) {
            ...
            var renderedNavigation = oae.api.util
                .template()
                .render($('#lhnavigation-navigation-template', $rootel), {
            ...
            var loadedUrlSegments = loadedUrl
                .segment()
                .slice(baseUrlSegments.length);
            ...
            $rootel.on('click', '.oae-lhnavigation ul li[data-id]', function(
                ev,
            ) {
        ...
        var setUpNavigationActions = function() {
            ...
            $rootel.on(
                ...
                function(ev) {
                    $(this)
                        .next('.lhnavigation-collapsed')
                        .toggle({
                            duration: 250,
                            easing: 'linear',
                        });
                    $(this)
                        .find('.lhnavigation-caret-container i')
                        .toggle();
                },
            );
        };
         ...
         */
        $(window).on('oae.trigger.lhnavigation', function(
            ev,
            _lhNavigationPages,
            _lhNavigationActions,
            _baseUrl,
            _baseBrowserTitle,
        ) {
