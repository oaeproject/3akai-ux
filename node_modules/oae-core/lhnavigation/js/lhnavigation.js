...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid) {
        ...
        // Holds the base url of the page that is given when the lhnav is initializedå
        var baseUrl = null;
        ...
        var renderPage = function() {
            ...
            if ($cachedPage.length > 0) {
                ...
                // views, the lhnavigation toggle is provided by the `listOptionsHeader` macro in list.html
