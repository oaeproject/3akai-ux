...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid) {
         ...
         * data.
         *
         * A left hand navigation contains 2 different sections. The first section is a list of action buttons that replace clips when the viewport width is too small to render them.
         * These actions can also be grouped into collapsible sections. An example array required to initiate these action buttons is the following:
         *
         * [{
         ...
         * - `class` is used to define the widget trigger. It can be extended to apply any class to the list item. Multiple classes can be added by separating them with a space.
         * - `children` is an optional Array of lhNavActions that will be rendered as children of the list item it belongs to. Each child item has the same properties as top level items.
         *
         ...
         * Notes:
         *
         * - The example shows a single `dashboard` page.
