...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        var renderPage = function(pageId) {
            ...
            browserState = browserState.split('/').pop();
            var selectedPage = getPage(pageId || browserState);
        ...
        var setUpNavigation = function() {
            ...
            oae.api.util.template().render('#lhnavigation-navigation-template', {
                ...
                // The baseUrl is the first part of the current URL
                'baseUrl': document.location.pathname.split('/').splice(0, 2).join('/')
