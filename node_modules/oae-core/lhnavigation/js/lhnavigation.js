...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        var renderPage = function(pageId) {
            ...
            // otherwise we use the last element of the Browser state hash
            var selectedPage = getPage(pageId || History.getState().hash.split('/').pop());
            ...
            if ($cachedPage.length > 0) {
                ...
                $pageContainer.append(oae.api.util.renderTemplate('#lhnavigation-page-template', selectedPage));
        ...
        var setUpNavigation = function() {
            ...
            oae.api.util.renderTemplate('#lhnavigation-navigation-template', {
                'items': lhNavigationStructure,
                // The baseUrl are the first two parts of the current URL
                'baseUrl': document.location.pathname.split('/').splice(0, 3).join('/')
         ...
         * data.
         */
        $(window).on('oae.trigger.lhnavigation', function(ev, lhNavigation) {
