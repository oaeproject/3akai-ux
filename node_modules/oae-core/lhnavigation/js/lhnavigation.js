...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid) {
        ...
        var getPage = function(pageId) {
            ...
            // Return the dashboard page if no page with the provided id can be found
            return _.findWhere(lhNavigationStructure, {'default': true});
        };
        ...
        var setUpNavigation = function(baseUrl) {
            ...
            oae.api.util.template().render($('#lhnavigation-navigation-template', $rootel), {
                'items': lhNavigationStructure,
                'baseUrl': baseUrl
            }, $('.oae-lhnavigation', $rootel));
            ...
            $rootel.on('click', '.oae-lhnavigation ul li', function(ev) {
                ...
                } else if ($(this).attr('data-id') && !$(this).hasClass('active')) {
            ...
            $rootel.on('click', '.oae-lhnavigation ul li.collapse', function() {
                $(this).find('.lhnavigation-collapsed').toggle({
                    'duration': 250,
                    'easing': 'linear'
                });
         ...
         * data.
         */
        $(window).on('oae.trigger.lhnavigation', function(ev, lhNavigation, baseUrl, hasNav) {
