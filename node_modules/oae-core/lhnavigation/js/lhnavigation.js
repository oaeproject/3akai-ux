...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid) {
        ...
        var setUpNavigation = function(baseUrl) {
            ...
            $rootel.on('click', '#lhnavigation-navigation ul li.collapse', function() {
            ...
            // Set up the left hand navigation toggle
            $rootel.on('click', '.lhnavigation-toggle', function() {
                $('#lhnavigation-navigation > ul').toggleClass('hidden-xs hidden-sm');
                $('#lhnavigation-container > #lhnavigation-page').toggleClass('expanded');
            });
        };
