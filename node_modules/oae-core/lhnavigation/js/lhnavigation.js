...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        var renderPage = function() {
            ...
            var pageId = initialState.segment().pop();
            var selectedPage;
            if (pageId.length) {
                selectedPage = getPage(pageId);
            } else {
                selectedPage = getPage(initialState.attr('host').replace('/',''));
            }
        ...
        var setUpNavigation = function(baseUrl) {
            ...
            // inside of the current History.js hash. The expected URL structure is `/me/<pageId>`.
            ...
            if (selectedPage.length === 0) {
                selectedPage = (initialState.attr('host').replace('/',''));
            }
            ...
            if (document.all && document.addEventListener && !window.atob) {
                if (query !== undefined) {
                    History.replaceState(newState, null, 'me/' + selectedPage + '?q=' + query);
                } else {
                    History.replaceState(newState, null, 'me/' + selectedPage);
                }
            } else {
