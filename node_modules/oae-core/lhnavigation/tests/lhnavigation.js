...
casper.test.begin('Widget - Left hand navigation', function(test) {
    ...
    var verifyMeNavigation = function() {
        casper.waitForSelector('.oae-lhnavigation ul.nav-list li', function() {
            ...
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="dashboard"] a[href="/me/dashboard"]', 'The left hand navigation list item for \'Recent activity\' has a link');
            test.assertSelectorHasText('.oae-lhnavigation ul.nav-list li[data-id="dashboard"] a[href="/me/dashboard"] div', 'Recent activity', 'The left hand navigation list item for \'Recent activity\' has the correct text');
            ...
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="library"] a[href="/me/library"]', 'The left hand navigation list item for \'My library\' has a link');
            test.assertSelectorHasText('.oae-lhnavigation ul.nav-list li[data-id="library"] a[href="/me/library"] div', 'My library', 'The left hand navigation list item for \'My library\' has the correct text');
            ...
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="discussions"] a[href="/me/discussions"]', 'The left hand navigation list item for \'My discussions\' has a link');
            test.assertSelectorHasText('.oae-lhnavigation ul.nav-list li[data-id="discussions"] a[href="/me/discussions"] div', 'My discussions', 'The left hand navigation list item for \'My discussions\' has the correct text');
            ...
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="groups"] a[href="/me/groups"]', 'The left hand navigation list item for \'My groups\' has a link');
            test.assertSelectorHasText('.oae-lhnavigation ul.nav-list li[data-id="groups"] a[href="/me/groups"] div', 'My groups', 'The left hand navigation list item for \'My groups\' has the correct text');
            ...
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="network"] a[href="/me/network"]', 'The left hand navigation list item for my \'My network\' has a link');
            test.assertSelectorHasText('.oae-lhnavigation ul.nav-list li[data-id="network"] a[href="/me/network"] div', 'My network', 'The left hand navigation list item for my \'My network\' has the correct text');
        });
    };
    ...
    var verifyGlobalAdminNavigation = function() {
        casper.waitForSelector('.oae-lhnavigation ul.nav-list li', function() {
            ...
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="modules"]', 'The left hand navigation list item for \'Modules\' is present');
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="modules"] a[href="/modules"]', 'The left hand navigation list item for \'Modules\' has a link');
            test.assertSelectorHasText('.oae-lhnavigation ul.nav-list li[data-id="modules"] a[href="/modules"] div', 'Modules', 'The left hand navigation list item for \'Modules\' has the correct text');
    ...
    var verifyTenantAdminNavigation = function() {
        casper.waitForSelector('.oae-lhnavigation ul.nav-list li', function() {
            ...
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="modules"]', 'The left hand navigation list item for \'Modules\' is present');
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="modules"] a[href="/tenant/' + configUtil().tenantAlias + '/modules"]', 'The left hand navigation list item for \'Modules\' has a link');
            test.assertSelectorHasText('.oae-lhnavigation ul.nav-list li[data-id="modules"] a[href="/tenant/' + configUtil().tenantAlias + '/modules"] div', 'Modules', 'The left hand navigation list item for \'Modules\' has the correct text');
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        // Verify that all global admin navigation is present
        casper.thenOpen(configUtil().adminUI + '/tenant/' + configUtil().tenantAlias, function() {
