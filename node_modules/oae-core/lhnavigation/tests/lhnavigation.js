...
casper.test.begin('Widget - Left hand navigation', function(test) {
    ...
    var verifyMeNavigation = function() {
        casper.waitForSelector('.oae-lhnavigation ul.nav-list li', function() {
            ...
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="library"]', 'The left hand navigation list item for the library is present');
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="library"] a[href="/me/library"]', 'The left hand navigation list item for the library has a link');
            ...
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="discussions"] a[href="/me/discussions"]', 'The left hand navigation list item for discussions has a link');
            ...
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="groups"] a[href="/me/groups"]', 'The left hand navigation list item for groups has a link');
        });
    };
    ...
    var verifyOtherUserNavigation = function(profilePath) {
        casper.waitForSelector('.oae-lhnavigation ul.nav-list li', function() {
            ...
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="library"]', 'The left hand navigation list item for the library is present');
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="library"] a[href="' + profilePath + '/library"]', 'The left hand navigation list item for the library has a link');
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="discussions"]', 'The left hand navigation list item for discussions is present');
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        // Verify that all personal dashboard navigation is present
        casper.then(function() {
            casper.echo('# Verify /me navigation', 'GREEN_BAR');
            verifyMeNavigation();
        });

        // Verify that all personal dashboard navigation is present when viewing another user's profile
        casper.then(function() {
            casper.echo('# Verify /user/:tenantID/:userID navigation', 'GREEN_BAR');
        ...
        // Verify that all group navigation is present
        casper.then(function() {
            casper.echo('# Verify /group/:tenantID/:groupID navigation', 'GREEN_BAR');
