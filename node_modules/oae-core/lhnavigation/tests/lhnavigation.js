...
casper.test.begin('Widget - Left hand navigation', function(test) {
    ...
    var verifyGroupNavigation = function(profilePath) {
        casper.waitForSelector('.oae-lhnavigation ul.nav-list li', function() {
            ...
            test.assertExists('.oae-lhnavigation ul.nav-list li[data-id="members"] a[href="' + profilePath + 'mbers"]', 'The left hand navigation list item for \'Members\' has a link');
            test.assertSelectorHasText('.oae-lhnavigation ul.nav-list li[data-id="members"] a[href="' + profilePath + 'mbers"] div', 'Members', 'The left hand navigation list item for \'Members\' has the correct text');
        });
    };
        ...
        userUtil.createUsers(2, function(user1, user2) {
            ...
            groupUtil.createGroup(null, null, null, null, null, null, function(err, groupProfile) {
                ...
                casper.then(function() {
                    casper.echo('# Verify  navigation', 'INFO');
                    verifyMeNavigation();
                });
