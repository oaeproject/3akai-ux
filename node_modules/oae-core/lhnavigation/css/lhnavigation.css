...
#lhnavigation_container ul {
    margin: 6px 0 0;
}
#lhnavigation_container ul li {
    display: block;
    list-style: none;
}
#lhnavigation_container ul li .lhnavigation_item_content, #lhnavigation_container ul li ul li div.lhnavigation_subnav_item_content {
    padding: 3px 8px 2px 28px;
    position: relative;
}
#lhnavigation_container ul li .lhnavigation_toplevel {
    color: #707e8c;
...
#lhnavigation_container ul li .lhnavigation_selected_subsubmenu {
    margin-left: 124px;
}
#lhnavigation_container .lhnavigation_data_container {
    float: right;
    text-align: right;
    height: 22px;
    margin-top: -26px;
}
#lhnavigation_container ul li .lhnavigation_private {
    background: url("/node_modules/oae-core/lhnavigation/images/lhnav_padlock.png") no-repeat center right transparent;
    height: 16px;
    float: right;
    margin-top: -22px;
    width: 11px;
}
#lhnavigation_container .lhnavigation_data_container .lhnavigation_private {
    margin: 6px 2px;
    float: left;
}
#lhnavigation_container ul li .lhnavigation_has_subnav {
    border-color: transparent transparent transparent #707e8c;
    border-style: solid;
    border-width: 6px;
    height: 0;
    margin-left: -13px;
...
#lhnavigation_container ul li .lhnavigation_has_subnav_opened {
    border-color: #37383e transparent transparent !important;
    margin-left: -16px;
    margin-top: 10px;
}
...
#lhnavigation_container ul li .lhnavigation_levelcount + a {
    width: 124px;
}
#lhnavigation_container ul li .lhnavigation_sublevelcount + a {
    width: 112px;
}
#lhnavigation_container .lhnavigation_change_title {
    margin: 4px 0 5px;
    padding: 2px 10px 2px 0;
    width: 115px;
}
#lhnavigation_container .lhnavigation_change_title_restricted_width {
...
#lhnavigation_container ul li.lhnavigation_selected_item .lhnavigation_private {
    background: url("/node_modules/oae-core/lhnavigation/images/lhnav_padlock.png") no-repeat center left transparent;
}
#lhnavigation_container ul li .lhnavigation_selected_item_arrow {
    background: url("/node_modules/oae-core/lhnavigation/images/lhnav_selected_item_arrow.png") no-repeat scroll left top transparent;
    height: 22px;
    margin-left: 145px;
    margin-top: -23px;
    position: relative;
...
#lhnavigation_container ul li .lhnavigation_selected_item_arrow_sub {
    margin-left: 133px;
}
#lhnavigation_container ul li.lhnavigation_selected_item a {
    color: #fff;
    text-decoration: none;
    font-weight: bold;
}
#lhnavigation_container ul li a {
    display: block;
    padding: 5px 0 7px;
    word-wrap: break-word;
    position: relative;
}
#lhnavigation_container ul li.lhnavigation_hassubnav {
    cursor: pointer;
}

#lhnavigation_container ul .lhnavigation_hoverable_item:hover {
    color: #1e5b85;
    cursor: pointer;
}
#lhnavigation_container ul .lhnavigation_hoverable_item:hover .lhnavigation_has_subnav {
    border-color: transparent transparent transparent #206e95;
}
#lhnavigation_container ul li ul {
    margin: 0;
}
#lhnavigation_container .lhnavigation_subnav {
    margin: 5px 0px;
}
#lhnavigation_container .lhnavigation_subnav li div.lhnavigation_subnav_item_content {
    padding-left: 40px;
}

#lhnavigation_submenu {
    position: absolute;
}

#lhnavigation_container .lhnavigation_move_cursor {
    cursor: move !important;
}
#lhnavigation_container .lhnavigation_page_title_value {
    cursor: pointer;
    cursor: hand;
}
