...
#lhnavigation_container ul li .lhnavigation_private {
    background: url('../img/lhnav_padlock.png') no-repeat center right transparent;
    height: 16px;
    float: right;
    margin-top: -22px;
    width: 11px;
...
#lhnavigation_container ul li.lhnavigation_selected_item .lhnavigation_private {
    background: url('../img/lhnav_padlock.png') no-repeat center left transparent;
}
#lhnavigation_container ul li .lhnavigation_selected_item_arrow {
    background: url('../img/lhnav_selected_item_arrow.png') no-repeat scroll left top transparent;
    height: 22px;
    margin-left: 145px;
    margin-top: -23px;
    position: relative;
