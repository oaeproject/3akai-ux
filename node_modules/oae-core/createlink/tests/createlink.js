casper.test.begin('Widget - Create link', function(test) {
    ...
    var verifyRenameLink = function() {
        ...
        test.assertExists('#createlink-modal .createlink-selected-name', 'The editable link name field is present');
        test.assertSelectorHasText('#createlink-modal .createlink-selected-name', 'http://www.oaeproject.org', 'Selected link has name \'http://www.oaeproject.org\'');
        ...
        casper.waitForSelector('#createlink-modal .createlink-selected-name form', function() {
            test.assertExists('#createlink-modal .createlink-selected-name form', 'The link name form is present after click');
            ...
            test.assertSelectorHasText('.createlink-selected-name', 'OAE Project', 'Renamed link has name \'OAE Project\'');
            // Add the link
            casper.click('button#createlink-create');
