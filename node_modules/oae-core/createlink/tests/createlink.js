...
casper.test.begin('Widget - Create link', function(test) {
        ...
        casper.waitForSelector('#me-clip-container .oae-clip', function() {
            casper.waitForSelector(
                ...
                function() {
                    ...
                    test.assertExists(
                        '.oae-trigger-createlink',
                        'Createlink trigger exists',
                    );
                    ...
                    casper.wait(configUtil.searchWaitTime, function() {
                        test.assertVisible(
                            '#createlink-modal',
                            'Createlink pane is showing after trigger',
                        );
                        casper.click(
                            '#me-clip-container .oae-clip-content > button',
                        );
    ...
    var verifyCreateSingleLink = function() {
        ...
        test.assertExists(
            '#createlink-link-dump',
            'The link dump area is present',
        );
        ...
        // Add the link
        test.assertExists(
            'button#createlink-create',
            "The 'Add link(s)' button is present",
        );
        ...
        casper.waitForSelector(
            ...
            function() {
                ...
                test.assertExists(
                    ...
                    'The link to the content profile is shown in the notification',
                );
                test.assertSelectorHasText(
                    '#oae-notification-container .alert h4 + a',
                    'http://www.oaeproject.org',
                    "Notification link value is 'http://www.oaeproject.org'",
                );
    ...
    var verifyRenameLink = function() {
        ...
        test.assertExists(
            '#createlink-modal .jeditable-field',
            'The editable link name field is present',
        );
        test.assertSelectorHasText(
            '#createlink-modal .jeditable-field',
            'http://www.oaeproject.org',
            "Selected link has name 'http://www.oaeproject.org'",
        );
        casper.click('.jeditable-field');

        casper.waitForSelector(
            '#createlink-modal .jeditable-field form',
            function() {
                test.assertExists(
                    '#createlink-modal .jeditable-field form',
                    'The link name form is present after click',
                );
                ...
                test.assertSelectorHasText(
                    '.jeditable-field',
                    'OAE Project',
                    "Renamed link has name 'OAE Project'",
                );
                // Add the link
                casper.click('button#createlink-create');
                ...
                casper.waitForSelector(
                    ...
                    function() {
                        ...
                        test.assertSelectorHasText(
                            '#oae-notification-container .alert h4 + a',
                            'OAE Project',
                            "Notification link value is 'OAE Project'",
                        );
                        casper.click(
                            '#oae-notification-container .alert h4 + a',
                        );
                        ...
                        casper.waitForSelector(
                            ...
                            function() {
                                ...
                                test.assertSelectorHasText(
                                    '#content-clip-container h1',
                                    'OAE Project',
                                    'The created link has the correct renamed title',
                                );
                            },
                        );
                    },
