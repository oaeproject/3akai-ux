...
define(['jquery', 'oae.core', 'jquery.iframe-transport', 'jquery.jeditable'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var renderSelected = function() {
            oae.api.util.renderTemplate('#createlink-selected-template', {'links': selectedLinks}, $('#createlink-selected-container'));

            // Apply jEditable for inline editing of file names
            $('.jeditable-field').editable(function(value) {
                var prevValue = this.revert;
                var $listItemContainer = $($(this).parents('.oae-list-item-left'));
                if (!value) {
                    return prevValue;
                } else {
