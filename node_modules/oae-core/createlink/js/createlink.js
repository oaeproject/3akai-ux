...
define(['jquery', 'oae.core', 'jquery.jeditable'], function($, oae) {
    return function(uid) {
        ...
        var reset = function() {
            ...
            $(
                '#createlink-modal .modal-content > .modal-footer',
                $rootel,
            ).show();
        ...
        var getValidLinks = function() {
            ...
            var links = $('#createlink-link-dump', $rootel)
                .val()
                .split('\n');
        ...
        var editableSubmitted = function(value) {
            ...
            if (!value) {
                ...
                var linkIndex = $(
                    '#createlink-selected-container li',
                    $rootel,
                ).index($listItem);
        ...
        var showCompleteNotification = function(errCount) {
            ...
            var notificationTitle = oae.api.util
                .template()
                .render($('#createlink-notification-title-template', $rootel), {
                    context: contextData,
                    errCount: errCount,
                    links: addedLinks,
                });
            ...
            var notificationBody = oae.api.util
                .template()
                .render($('#createlink-notification-body-template', $rootel), {
                    context: contextData,
                    errCount: errCount,
                    links: addedLinks,
                });
        ...
        var showPermissions = function() {
            ...
            $(
                '#createlink-modal .modal-body > div#createlink-permissions-container',
                $rootel,
            ).show();
            $('#createlink-create', $rootel).hide();
        };
        ...
        var showOverview = function() {
            ...
            $(
                '#createlink-modal .modal-body > div#createlink-overview-container',
                $rootel,
            ).show();
        ...
        var renderAdded = function() {
            oae.api.util.template().render(
                $('#createlink-selected-template', $rootel),
                {
                    links: addedLinks,
                    displayOptions: {
                        metadata: false,
        ...
        var setUpSetPermissions = function() {
            ...
            var $setPermissionsContainer = $(
                '#createlink-permissions-container',
                $rootel,
            );
                    ...
                    $.each(addedLinks, function(index, link) {
                        link.viewers = _.chain(data.selectedPrincipalItems)
                            .filter(function(selectedPrincipalItem) {
                                return (
                                    selectedPrincipalItem.id !== oae.data.me.id
                                );
                            })
                            .pluck('shareId')
                            .value();
        ...
        var setUpLinkCreation = function() {
            $('#createlink-create', $rootel).on('click', function() {
                ...
                var createLink = function(index) {
                    ...
                    if (link) {
                        var $listItem = $(
                            $('#createlink-selected-container li', $rootel)[
                                index
                            ],
                        );
