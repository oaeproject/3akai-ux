...
define(['jquery', 'oae.core', 'jquery.jeditable'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        // Defaults the visibility for the links
         ...
         * @returns {Boolean|String}          Returns false if the URL is not valid. Returns the URL if it is valid.
         */
        var isValidURL = function(link) {
            // Verify that the link has at least http:// prepended to it, if not prepend it.
         ...
         *
         * @param  {Number}   progress   Number between 0 and 100 indicating the creation progress
         */
        ...
        /**
         * Adds selected link to the list of links.
         *
         ...
         * @returns {String}   value   The value to show in the editable field after editing completed
         */
        ...
        var showPermissions = function() {
            ...
            $('.modal-body > div#createlink-permissions-container', $rootel).show();
            $('#createlink-create', $rootel).hide();
        };

        /**
         * Shows an overview of the selected links
         */
        ...
        var renderAdded = function() {
            ...
            if (!$('#createlink-permissions-container', $rootel).html()) {
        ...
        var setUpSetPermissionsChanged = function() {
            $(document).on('oae.setpermissions.changed', function(ev, data) {
                ...
                // Update the members of the links
            ...
            $(document).on('oae.setpermissions.cancel', function(ev) {
                showOverview();
            });
        };
                        ...
                        oae.api.content.createLink(link.displayName, link.description, visibility, link.link, [], link.viewers, function(error, data) {
                            ...
                            if (done !== addedLinks.length) {
                                ...
                                oae.api.util.notification(
                                    oae.api.i18n.translate('__MSG__LINKS_CREATED__', 'createlink'),
                                    oae.api.i18n.translate('__MSG__LINKS_SUCCESSFULLY_CREATED__', 'createlink')
                                );
                            }
                        });
                    }
