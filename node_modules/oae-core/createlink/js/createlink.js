...
define(['jquery', 'oae.core', 'jquery.jeditable'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        /**
         * Shows a success or failure notification when the links have been created.
         *
        ...
        var showCompleteNotification = function(errCount) {
            ...
            var notification = oae.api.util.template().render($('#createlink-notification-template', $rootel), {
                'context': contextData,
            ...
            var title = oae.api.i18n.translate('__MSG__LINKS_ADDED__', 'createlink');
            if (errCount > 0) {
                title = oae.api.i18n.translate('__MSG__LINKS_NOT_ADDED__', 'createlink');
            }
