...
define(['jquery', 'oae.core', 'jquery.jeditable'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var renderAdded = function() {
            ...
            // Catch the keypress event for `enter` when the editable field has focus
            $('.jeditable-field').on('focus', function() {
            ...
            // Apply jQuery Tooltip to the link description field to show that the fields are editable
        ...
        var setUpLinkCreation = function() {
            $('#createlink-create', $rootel).off('click').on('click', function() {
                var done = 0;
        ...
        var setUpLinkModal = function() {
            $(document).on('click', '.oae-trigger-createlink', function() {
                ...
                $('#createlink-modal').on('shown', function() {
                    // Set focus to the link dump textarea
                    $('#createlink-link-dump').focus();
                });
            });
