  ...
  describe('Document Preview Widget', function(){
    ...
    describe('Document-Specific Style Sheets', function() {
      ...
      before(function(done) {
        docpreview.clear()
          .user('basic')
          .mock({method: 'GET', url: '/api/content/2/revisions/3/previews/base.css?signature=5&expires=6&lastmodified=7', response: [200, {'Content-Type': 'text/css'}, '/* base.css */']})
          .mock({method: 'GET', url: '/api/content/2/revisions/3/previews/fancy.css?signature=5&expires=6&lastmodified=7', response: [200, {'Content-Type': 'text/css'}, '/* fancy.css */']})
          .mock({method: 'GET', url: '/api/content/2/revisions/3/previews/lines.css?signature=5&expires=6&lastmodified=7', response: [200, {'Content-Type': 'text/css'}, '/* lines.css */']})
          .restart()
      ...
      it('should include the base.css stylesheet', function() {
        $('style').filter(function() {return this.textContent === '/* base.css */';}).length.should.be(1);
      })
      it('should include the fancy.css stylesheet', function() {
        $('style').filter(function() {return this.textContent === '/* fancy.css */';}).length.should.be(1);
      })
      it('should include the lines.css stylesheet', function() {
        $('style').filter(function() {return this.textContent === '/* lines.css */';}).length.should.be(1);
      })
    })
