  ...
  describe('Document Preview Widget', function(){
    ...
    describe('Static Rendering', function() {
      ...
      before(function(done) {
        docpreview.clear()
          .user('basic')
          .mock({method: 'GET', url: '/api/content/2/revisions/3/previews/base.css?signature=5&expires=6&lastmodified=7', response: [200, {'Content-Type': 'text/css'}, 'dummy']})
          .mock({method: 'GET', url: '/api/content/2/revisions/3/previews/fancy.css?signature=5&expires=6&lastmodified=7', response: [200, {'Content-Type': 'text/css'}, 'dummy']})
          .mock({method: 'GET', url: '/api/content/2/revisions/3/previews/lines.css?signature=5&expires=6&lastmodified=7', response: [200, {'Content-Type': 'text/css'}, 'dummy']})
          .restart()
