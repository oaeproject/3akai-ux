...
<p>TDB</p>
        ...
        <li id="section-3">
            ...
            <div class="content"><div class='highlight'><pre>    <span class="keyword">var</span> WIDGETCLASS = <span class="string">'documentpreview-container'</span>;</pre></div></div>
...
initialized in the <code>init()</code> function.</p>
            ...
            <div class="content"><div class='highlight'><pre>    <span class="keyword">var</span> rootel,
        container,
        options,
...
Its input is the base URL, and it returns the augmented URL.</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>    <span class="keyword">var</span> signUrl = <span class="keyword">function</span>(baseUrl) {
        <span class="keyword">return</span> baseUrl + <span class="string">'?signature='</span> + options.signature.signature +
                         <span class="string">'&amp;expires='</span> + options.signature.expires +
                         <span class="string">'&amp;lastmodified='</span> + options.signature.lastModified;
    };</pre></div></div>
...
added to the DOM.</p>
            ...
            <div class="content"><div class='highlight'><pre>    <span class="keyword">var</span> addStyleSheet = <span class="keyword">function</span>(styleSheetObj) {
        $.ajax({
...
a widget style sheet given the filename.</p>
        ...
        <span class="keyword">return</span> signUrl(
            <span class="string">'/api/content/'</span> + options.id +
            <span class="string">'/revisions/'</span> + options.latestRevisionId +
...
passed on object creation</p>
            ...
            <div class="content"><div class='highlight'><pre>    <span class="keyword">var</span> init = <span class="keyword">function</span>(uid, widgetData) {</pre></div></div>
        ...
        <li id="section-17">
            <div class="annotation">
              ...
              <p>Save local copies of the inpur parameters</p>

            </div>
            
            <div class="content"><div class='highlight'><pre>        options = _({}).extend({uid: uid}, widgetData);</pre></div></div>
...
attribute.</p>
            ...
            <div class="content"><div class='highlight'><pre>        rootel = document.getElementById(uid);</pre></div></div>
...
document preview widgets on the page.</p>
            ...
            <div class="content"><div class='highlight'><pre>        container = rootel.getElementsByClassName(WIDGETCLASS);</pre></div></div>
...
initialize the widget.</p>
            ...
            <div class="content"><div class='highlight'><pre>            init(uid, widgetData);
        }
