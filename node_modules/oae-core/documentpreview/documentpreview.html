    ...
    <div id="documentpreview-container">
        ...
        <div id="documentpreview-toolbar" class="clearfix row">
            ...
            <div class="col-xs-3 text-right">
                <button type="button" id="documentpreview-toggle-annotator" class="btn btn-link" title="__MSG__TOGGLE_ANNOTATOR__">
                    <i class="fa fa-edit"><div id="documentpreview-annotator-status"></div><span class="sr-only">__MSG__TOGGLE_ANNOTATOR__</span></i>
                </button>
...
<div id="documentpreview-sidebar-view-template"><!--
                ...
                <li class="clearfix" data-id="${annotation.id}">
                    <div class="oae-list-details-item">
                        <div class="oae-listitem">
                            ...
                            <div class="oae-listitem-metadata">
                                <h3 class="oae-threedots"><a href="/me" title="${annotation.createdBy.displayName|encodeForHTMLAttribute}">${annotation.createdBy.displayName|encodeForHTML}</a></h3>
                    ...
                    {if !oae.data.me.anon}
                        <div class="documentpreview-annotation-actions">
                            {if canManage || annotation.createdBy.id === oae.data.me.id}
                                <button type="button" class="btn btn-link pull-right documentpreview-annotation-delete" title="__MSG__DELETE_ANNOTATION__">
                                    <span class="sr-only">__MSG__DELETE_ANNOTATION__</span>
                                    <i class="fa fa-trash-o"></i>
                                </button>
                            {/if}

                            <button type="button" class="btn btn-link pull-left documentpreview-annotation-reply" title="__MSG__REPLY_TO_ANNOTATION__">
                                <span class="sr-only">__MSG__REPLY_TO_ANNOTATION__</span>
    ...
    {else}
        <div class="alert alert-info">__MSG__CREATE_ANNOTATIONS_BY_SELECTING_TEXT__</div>
    {/if}
--></div>
