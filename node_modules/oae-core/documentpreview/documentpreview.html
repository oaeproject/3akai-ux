    ...
    <div id="documentpreview-container">
        ...
        <div id="documentpreview-toolbar" class="clearfix row">
            ...
            <div class="col-xs-3 text-right">
                <button type="button" id="documentpreview-toggle-annotator" class="hide btn btn-link" title="__MSG__TOGGLE_ANNOTATOR__">
                ...
                <li class="clearfix" data-id="${annotation.id}">
                    ...
                    {if !userProfile.anon}
                        <div class="documentpreview-annotation-actions">
                            ...
                            {if contentProfile.isManager || contentProfile.isViewer}
