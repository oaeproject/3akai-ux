...
<div id="documentpreview-widget">
    <div id="documentpreview-container">
        <!-- TOOLBAR -->
        <div class="documentpreview-toolbar well well-small clearfix row">
            ...
            <form class="documentpreview-page-controls text-right col-xs-12 col-sm-6 col-md-6" role="form">
                ...
                <input class="documentpreview-page-num form-control text-center" type="text">
