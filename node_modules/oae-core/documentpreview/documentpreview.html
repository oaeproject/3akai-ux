...
<div id="documentpreview-widget">
    <div id="documentpreview-container">
        ...
        <!-- PROGRESSBAR -->
        <div id="documentpreview-progressbar" class="progressbar" aria-hidden="true" 
...
<div id="documentpreview-content-page-template"><!--
    <div class="documentpreview-content-page" data-page-number="${pageNumber}">
        <div class="documentpreview-content-text-page sr-only"">
            <label for="documentpreview-content-text-page-${pageNumber}">
                __MSG__PAGE_X_OF_Y_PREFIX__ ${pageNumber} __MSG__PAGE_X_OF_Y_MIDDLE__ ${totalPages} __MSG__PAGE_X_OF_Y_SUFFIX__
            </label>
            <textarea readonly id="documentpreview-content-text-page-${pageNumber}">__MSG__LOADING__</textarea>
        </div>
        <div class="documentpreview-content-html-page ${cssScopeClass}" aria-hidden="true">
            <div class="documentpreview-content-html-page-loading text-center">
