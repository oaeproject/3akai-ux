...
<div id="documentpreview-widget">
    <div id="documentpreview-container">
        ...
        <div id="documentpreview-content">
            <div id="documentpreview-sidebar"><!-- --></div>
        ...
        {for annotation in annotations}
            <li data-id="${annotation.id}">
                <div class="oae-list-details-item">
                    <div class="oae-listitem">
                        ...
                        <div class="oae-listitem-metadata">
                            <h3 class="oae-threedots"><a href="/me" title="${annotation.createdBy.displayName}">${annotation.createdBy.displayName}</a></h3>
                ...
                <div class="documentpreview-annotation-container">
                    <p class="documentpreview-annotation-text">${annotation.text}</p>
                </div>

                <button type="button" class="btn btn-link pull-right documentpreview-delete-annotation" title="Delete annotation">
                    <span class="sr-only">Delete annotation</span>
                    <i class="icon-trash"></i>
                </button>

                <button type="button" class="btn btn-link documentpreview-edit-annotation" title="Edit annotation">
