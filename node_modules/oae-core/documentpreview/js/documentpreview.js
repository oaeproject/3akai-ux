    ...
    return function(uid, showSettings, widgetData) {
                    ...
                    if (!initialized) {
                        ...
                        $('body')
                            ...
                            .annotator('addPlugin', 'Permissions', {
                                'showViewPermissionsCheckbox': false, // Hide the 'anyone can view' checkbox
                                'showEditPermissionsCheckbox': false, // Hide the 'anyone can edit' checkbox
                                'user': oae.data.me,
        ...
        var zoomPages = function(pageNumber) {
            ...
            for (; pageIdx < pages.length; pageIdx++) {
                ...
                // Transform the actual page, as the annotator wraps it
                // By transforming the page and not the outer div, the annotator
