...
define(['jquery', 'underscore', 'oae.core', 'lazyload'], function($, _, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var zoomPages = function(pageNumber) {
            // Index into pages array
            var pageIdx = _.isFinite(pageNumber) ? pageNumber - 1 : 0;
            // Amount of margin for current page
            var marginTop = (pageIdx > 0 && pages[pageIdx - 1].nextMargin) ? pages[pageIdx - 1].nextMargin : CONTENT_PAGE_SPACING;
            // Current page
            var page = null;
