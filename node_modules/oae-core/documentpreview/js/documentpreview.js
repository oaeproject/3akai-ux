...
define(['jquery', 'underscore', 'oae.core', 'lazyload'], function($, _, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        // Includes container padding and box shadow size (in pixels)
        ...
        var $horizontalSpacer = $('.documentpreview-content-horizontal-spacer', $rootel);
        ...
        var loadPage = function(page, callback) {
            ...
            $.ajax({
                ...
                'success': function(response) {
                    ...
                    zoomPage(page);
                    // Re-check horizontal spacing with new page added
                    setHorizontalSpacer();
        ...
        /**
         * Adjust spacer to ensure horizontal scrolling includes box shadow
         */
        var setHorizontalSpacer = function() {
            // What's the widest page currently rendered
            var widestPage = _.max($('.documentpreview-content-page', $content), function(el) {
                return el.scrollWidth;
            });
            $horizontalSpacer.css('width',
                $(widestPage).width() < widestPage.scrollWidth ?
