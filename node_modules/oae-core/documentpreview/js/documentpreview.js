...
define(['jquery', 'underscore', 'oae.core', 'lazyload'], function($, _, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var preloadPages = function(pageNumber, callback) {
            ...
            /**
             * Stop the page preloading process when all required pages have
             * been reloaded or when an error has occurred during preloading
             */
            var stopPreloadPages = function() {
                isPreloading = false;
             ...
             */
            var preloadPage = function(err) {
                if (err) {
                    return stopPreloadPages();
                }
        ...
        var activateFullscreen = function() {
            var $viewer = $('#documentpreview-widget', $rootel);
        ...
        var fullScreenChanged = function() {
            $('#documentpreview-widget', $rootel).toggleClass('documentpreview-widget-fullscreen');
        };
        ...
        var loadStyleSheets = function() {
            ...
            LazyLoad.css([constructDocumentPreviewURL('base.css'), constructDocumentPreviewURL('fancy.css'), constructDocumentPreviewURL('lines.css')], function() {
                // Load the first page
                loadPage(pages[0], loadPagesForInfiniteScrolling);
            });
        };
