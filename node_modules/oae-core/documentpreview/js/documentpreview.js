...
define(['jquery', 'underscore', 'oae.core', 'lazyload'], function($, _, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var loadPage = function(page, callback, _isRetryAttempt) {
            ...
            $.ajax({
                ...
                'success': function(response) {
                    ...
                    // fully fits inside of the viewer. We also set the margin top to the
                    // initial constant.
                    if (page.pageNumber === 1) {
                        determineZoomLevel(page);
                        page.marginTop = CONTENT_PAGE_SPACING;
                    // If the page isn't the first, the top margin is stored in the previous page
                    } else {
                        page.marginTop = pages[page.pageNumber-2].nextMargin;
                    }

                    // Adjust the page display to reflect the current zoom level
                    zoomPage(page.marginTop, page);
        ...
        var zoomPages = function() {
            // keep track of how much margin for page
            ...
            _.every(pages, function(page) {
                ...
                if (page.$el) {
                    // Zoom the page
                    zoomPage(marginTop, page);
                    // Retain the next margin to use for next page and spacer
                    marginTop = page.nextMargin;
        ...
        /**
         * Set scale and other properties of a page to effect a zoom
         *
         * @param  {Number}         marginTop           Amount of top margin (pixels) to add to page
         * @param  {Object}         page                Page object representing the page that needs to be scaled
         */
        var zoomPage = function(marginTop, page) {
            // Scale the page
            page.$el.css({
            ...
            // Calculate the margin the next page will require
            page.nextMargin = (page.height * state.zoomLevel - page.height) +
