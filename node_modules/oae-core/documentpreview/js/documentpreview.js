    ...
    return function(uid, showSettings, widgetData) {
        ...
        $pageNumber.on('input', _(function() {
            ...
            if (pagenum !== state.pagenum) {
                ...
                waitForPriorPages(pagenum).done(function() {
        ...
        $pageNumber.on('blur', function() {
             ...
             * state, though, since the page changed handler
        ...
        var loadPage = function(page) {
            ...
            if (page.$el && !page.deferred) {
                 ...
                 * loaded, then the browser may calculate the
        ...
        /**
         * Wait for loading of all pages ahead of a given page
         * @param {integer} number of page to load up to
         */
        var waitForPriorPages = function(num) {
            var deferreds = [];
            _(pages).each(function(page) {
                if (page.num < num) {
                    loadPage(page);
