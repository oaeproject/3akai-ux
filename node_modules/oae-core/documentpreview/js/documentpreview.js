...
define(['jquery', 'underscore', 'oae.core', 'lazyload'], function($, _, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var resetPageLoadProgress = function() {
            $('.progress-bar', $rootel).css('width', '0%');
            $('.progress-bar', $rootel).attr('aria-valuenow', '0%');
        ...
        var updatePageLoadProgress = function(progress) {
            $('.progress-bar', $rootel).css('width', Math.round(progress) + '%');
        ...
        var loadPages = function(pageNumber) {
            ...
            // We need to keep track of the page we started off when loading a batch of pages
            // to accurately update the progress bar
