...
define(['jquery', 'underscore', 'oae.core', 'lazyload'], function($, _, oae) {
    ...
    return function(uid, showSettings, widgetData) {
         ...
         * full screen API.
         * In case we're on a hand-held device, we will not show the full screen icon.
         *
        ...
        var isFullscreenSupported = function() {
            var htmlEl = $('html')[0];
            return !oae.api.util.isHandheldDevice() || htmlEl.requestFullscreen || htmlEl.mozRequestFullScreen || htmlEl.webkitRequestFullscreen;
        };
        ...
        var loadStyleSheets = function() {
            // Remove the stylesheets from any documents that might have been previously loaded, as the styles
            // can conflict
            // TODO Remove this once https://github.com/oaeproject/Hilary/pull/741 has been fixed
