                        ...
                        $(document).trigger('init.joinrequestbuttons.sakai', [
                            ...
                            function(success, id) {
                                ...
                                if (success) {
                                    ...
                                    $('#searchgroups_memberimage_' + groupid).parent().removeClass('oae-actions-addtolibrary');
                            ...
                            function(success, id) {
                                ...
                                if (success) {
                                    ...
                                    $('#searchgroups_memberimage_' + groupid).parent().addClass('oae-actions-addtolibrary');
                                    adjustParticipantCount(groupid, -1);
                                }
                            },
                            group.joinrequests
