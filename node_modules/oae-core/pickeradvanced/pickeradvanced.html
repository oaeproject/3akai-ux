        ...
        <div id="pickeradvanced_header">
            <span class="fl-force-left">
                <form id="pickeradvanced_content_search_form" method="post" action="#">
                    <div class="s3d-search-container"  role="search" aria-label="__MSG__SEARCH_FOR_CONTENT_TO_ADD__">
                        <label for="pickeradvanced_search_query" id="pickeradvanced_search_query_label">__MSG__SEARCH_FOR_CONTENT_TO_ADD__</label> <input type="text" tabindex_none="40" name="pickeradvanced_search_query" id="pickeradvanced_search_query" title="__MSG__SEARCH_FOR_CONTENT_TO_ADD__" class="s3d-search-inputfield"/>
                        <button type="button" class="s3d-button s3d-overlay-button s3d-search-button" id="pickeradvanced_search_button">
        ...
        <div id="pickeradvanced_content" class="s3d-highlight_area_background">
            ...
            <div id="pickeradvanced_content_list" class="fl-force-left">
                <ul id="pickeradvanced_file_filters" style="display:none" class="pickeradvanced_search_content">
                    <li><button type="button" data-search="all" id="pickeradvanced_search_files_all" class="pickeradvanced_search_filter s3d-action s3d-link-button s3d-bold">__MSG__ALL_CONTENT_I_CAN_SEE__</button></li>
                    <li><button type="button" data-search="my" id="pickeradvanced_search_files_mylibrary" class="pickeradvanced_search_filter s3d-action s3d-link-button s3d-bold">__MSG__MY_LIBRARY__</button></li>
                </ul>
            </div>
            ...
            <div class="pickeradvanced_selection_buttons fl-force-right">
                ...
                <button type="button" id="pickeradvanced_add_button" class="s3d-button s3d-overlay-action-button" disabled="disabled">__MSG__ADD_SELECTED__</button>
            </div>
        </div>
