...
<div class="recentchangedcontent_widget">
        ...
        <div class="recentchangedcontent_add_container">
            <div id="recentchangedcontent_no_results_container" style="display:none;">
                <div class="s3d-no-results-container">
                    ...
                    <p>__MSG__NO_RESULTS_DESCRIPTION_RECENTCONTENT__ <a id="mylibrary_addcontent" class="s3d-regular-links sakai_add_content_overlay" href="#">__MSG__ADD_CONTENT__</a></p>
                </div>
            </div>
        </div>
        ...
        <div class="recentchangedcontent_main">
            ...
            ${console.log(item)}
                <div class="recentchangedcontent_related_details">
                    <div class="s3d-draggable-container" data-canshare="${item.canShare}" data-scope="content" data-entityid="${item["_path"]}" {if sakai.api.Content.Collections.isCollection(item)} data-collection="true" {/if}>
                        ...
                        <div class="recentchangedcontent_item_info">
                            <p class="recentchangedcontent_item_title">
                                <a class="recentchangedcontent_item_link s3d-widget-links s3d-bold" href="${item.homePath}" title="${item.name|safeOutput}">
                                    ${item.nameShort}
                                </a>
                    ...
                    <div class="recentchangedcontent_item_related_info s3d-draggable-container" data-canshare="${item.relatedContent.canShare}" data-scope="content" data-entityid="${item.relatedContent["_path"]}" {if sakai.api.Content.Collections.isCollection(item.relatedContent)} data-collection="true" {/if}>
                        ...
                        <div class="recentchangedcontent_item_div">
                            <a class="recentchangedcontent_item_link s3d-widget-links s3d-bold" href="${item.homePath}" title="${item.relatedContent.name|safeOutput}">
    ...
    <div class="s3d-widget-footer">
        <a class="recentchangedcontent_item_link s3d-widget-links" href="/me#l=library">__MSG__SEE_ALL_MY_CONTENT__</a>
    </div>
