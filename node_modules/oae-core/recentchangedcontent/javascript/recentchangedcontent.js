...
require(['jquery', 'sakai/sakai.api.core'], function($, sakai) {
    ...
    sakai_global.recentchangedcontent = function(tuid, showSettings) {
        ...
        var parseDataResult = function(result, isRelatedContent) {
            ...
            item.nameShort = sakai.api.Util.applyThreeDots(item.name, $('.recentchangedcontent').width() - 50, {max_rows: 1,whole_word: false}, 'oae-bold');
            item.nameShorter = sakai.api.Util.applyThreeDots(item.name, $('.recentchangedcontent').width() - 150, {max_rows: 1,whole_word: false}, 'oae-bold');
            item.nameRelatedShort = sakai.api.Util.applyThreeDots(item.name, $('.recentchangedcontent').width() - 100, {max_rows: 1,whole_word: false}, 'oae-bold');
