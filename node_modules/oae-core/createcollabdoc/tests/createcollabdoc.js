...
casper.test.begin('Widget - Create collab doc', function(test) {
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        casper.then(function() {
            casper.echo('# Verify open create collab doc modal', 'GREEN_BAR');
            verifyOpenCreateCollabDoc();
        });

        // Create a collabdoc
        casper.then(function() {
            casper.echo('# Verify create collab doc', 'GREEN_BAR');
        ...
        casper.thenOpen(configUtil().tenantUI + '/me', function() {
            casper.wait(configUtil().searchWaitTime, function() {
                casper.echo('# Verify create collab doc validation', 'GREEN_BAR');
