...
casper.test.begin('Widget - Create collab doc', function(test) {
        ...
        casper.waitForSelector('#me-clip-container .oae-clip', function() {
            casper.waitForSelector(
                ...
                function() {
                    ...
                    test.assertExists(
                        '.oae-trigger-createcollabdoc',
                        'Create collab doc trigger exists',
                    );
                    ...
                    casper.waitForSelector(
                        ...
                        function() {
                            test.assertVisible(
                                '#createcollabdoc-modal',
                                'Create collab doc pane is showing after trigger',
                            );
                            casper.click(
                                '.oae-clip-secondary .oae-clip-content > button',
                            );
    ...
    var verifyCreateCollabDoc = function(user2Id) {
        casper.waitForSelector('form#createcollabdoc-form', function() {
            ...
            test.assertExists(
                'form#createcollabdoc-form',
                'The create collab doc form is present',
            );
            test.assertExists(
                '#createcollabdoc-name',
                'The collab doc name field is present',
            );
            // Fill the form
            casper.fill(
                'form#createcollabdoc-form',
            ...
            test.assertExists(
                '#createcollabdoc-permissions-container #setpermissions-container input[type="radio"]',
                "The 'change permissions' radio button group is present",
            );
            test.assertExists(
                '#createcollabdoc-permissions-container .as-selections input',
                "The 'share' input field is present",
            );
            // Select the public permission
            casper.click(
                '#createcollabdoc-permissions-container #setpermissions-container input[type="radio"][value="public"]',
                "Select 'public' permissions for the collab doc",
            );
            ...
            casper.waitForSelector('.as-list li', function() {
                ...
                test.assertExists(
                    '#createcollabdoc-create',
                    "The 'Create document' button is present",
                );
                ...
                casper.wait(configUtil.searchWaitTime, function() {
                    test.assertVisible(
                        ...
                        'Content profile is shown after creation of collab doc',
                    );
                    test.assertSelectorHasText(
                        '#content-clip-container h1',
                        'CasperJS test document',
                        "Title matches 'CasperJS test document'",
                    );
                });
            });
        });
    ...
    var verifyCreateCollabDocValidation = function() {
        casper.waitForSelector('form#createcollabdoc-form', function() {
            ...
            test.assertExists(
                '#createcollabdoc-name-error',
                'Create collabdoc form successfully validated empty form',
            );
        });
    };
