...
define(['jquery', 'oae.core'], function($, oae) {
    return function(uid) {
        ...
        var setUpReset = function() {
            $('#createcollabdoc-modal', $rootel).on(
                'hidden.bs.modal',
                function() {
        ...
        var setUpCreateCollabDoc = function() {
            ...
            oae.api.util
                .validation()
                .validate($('#createcollabdoc-form', $rootel), validateOpts);
        };
        ...
        var setUpSetPermissions = function() {
            ...
            var $setPermissionsContainer = $(
                '#createcollabdoc-permissions-container',
                $rootel,
            );
            ...
            $(document).on(
                ...
                function(ev, data) {
                    ...
                    $('#createcollabdoc-permissions', $rootel).html(
                        data.summary,
                    );
            ...
            oae.api.content.createCollabDoc(
                ...
                function(err, data) {
                    ...
                    if (!err) {
                        ...
                        // Re-enable the form
                        $('#createcollabdoc-form *', $rootel).prop(
                            'disabled',
                            false,
                        );
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__DOCUMENT_NOT_CREATED__',
                                'createcollabdoc',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__DOCUMENT_COULD_NOT_BE_CREATED__',
                                'createcollabdoc',
                            ),
                            'error',
                        );
        ...
        var setUpCreateCollabDocModal = function() {
            ...
            $(document).on('oae.context.send.createcollabdoc', function(
                ev,
                ctx,
            ) {
                contextData = ctx;
