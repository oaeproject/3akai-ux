...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        var setUpReset = function() {
            $('#createcollabdoc-modal', $rootel).on('hidden.bs.modal', function (evt) {
                // Reset the form
        ...
        var setUpSetPermissions = function() {
            ...
            // We need to re-fetch the default visibility as the user could've selected a visibility, closed the modal and re-opened
            ...
            $(document).on('oae.setpermissions.changed.' + setPermissionsId, function(ev, data) {
                ...
                $('#createcollabdoc-permissions', $rootel).children(':not(#createcollabdoc-change-permissions)').remove();

                // Set the new one
                $('#createcollabdoc-permissions', $rootel).prepend(data.summary);
