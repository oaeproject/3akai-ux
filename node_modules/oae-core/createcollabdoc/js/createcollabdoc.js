...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid, showSettings) {
        ...
        // Variable that keeps track of the selected visibility option. By default, we use the
        // default visibility option set in the admin UI
        var visibility = oae.api.config.getValue('oae-content', 'visibility', 'collabdocs');
        ...
        var setUpReset = function() {
            $('#createcollabdoc-modal', $rootel).on('hidden', function (evt) {
                $('#createcollabdoc-form')[0].reset();
                showOverview();
            });
        };

        /**
         * Initializes the create collabdoc form and validation
         */
        ...
        var showPermissions = function() {
            ...
            $('.modal-body > div#createcollabdoc-permissions-container', $rootel).show();
        };

        /**
         * Shows the main panel of the widget
         */
        var showOverview = function() {
            ...
            $('.modal-body > div#createcollabdoc-overview-container', $rootel).show();
        };

        /**
         * Load the `setpermissions` widget into this widget. That widget will take care of permission
         * management (visibility + sharing) of the created document
         */
        var setUpSetPermissions = function() {
            ...
            $(document).on('oae.setpermissions.changed.' + setPermissionsId, function(ev, data) {
                ...
                $(data.viewers).each(function(index, viewer) {
                    // As only managers can currently edit the document, we make them
                    // managers. Later on, we'll want to make these Editors
                    managers.push(viewer.id);
                });
                // Render the sharing and visibility summary
                $('#createcollabdoc-permissions-summary', $rootel).html(data.summary);
        ...
        /**
         * Creates the collaborative document
         */
        var createCollabDoc = function() {
            ...
            oae.api.content.createCollabDoc(displayName, '', visibility, managers, [], function (err, data) {
        ...
        /**
         * Initializes the create collabdoc modal dialog
         */
        var setUpCreateCollabDocModal = function() {
            ...
            $('#createcollabdoc-modal', $rootel).on('shown', function() {
            ...
            $('#createcollabdoc-change-permissions', $rootel).on('click', showPermissions);
        };
