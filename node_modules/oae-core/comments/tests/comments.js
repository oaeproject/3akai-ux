        ...
        casper.waitForSelector('.comments-new-comment-form', function() {
            ...
            casper.fill('.comments-new-comment-form', {
                'comments-new-comment': [
                    ...
                    '',
                    'Tenant Link: [Tenant](' + configUtil().tenantUI + '/path/to/file)',
                    '',
            ...
            casper.waitForSelector('.comments-level-0', function() {
                ...
                // Verify links
                test.assertSelectorHasText('.comments-level-0 .media-body .oae-markdown p:nth-of-type(1) a', 'OAE', 'Links are correcty formatted');
                test.assertExists('.comments-level-0 .media-body .oae-markdown p:nth-of-type(1) a[href="http://oaeproject.org"]', 'Links have correct href attributes');
                test.assertExists('.comments-level-0 .media-body .oae-markdown p:nth-of-type(2) a[href="/path/to/file"]', 'Tenant links have relative href attributes');

                // Verify images
                test.assertElementCount('.comments-level-0 .media-body .oae-markdown p:nth-of-type(3) img', 1, 'Images are correcty embedded');
                test.assertExists('.comments-level-0 .media-body .oae-markdown p:nth-of-type(3) img[src="http://www.oaeproject.org/themes/oae/logo.png"]', 'Images have correct src attributes');
                test.assertExists('.comments-level-0 .media-body .oae-markdown p:nth-of-type(3) img[alt="Alternate Text"]', 'Images have correct alt attributes');
                ...
                test.assertSelectorHasText('.comments-level-0 .media-body .oae-markdown p:nth-of-type(4) em', 'Emphasized Text', 'Emphasized text is correcty formatted');
                test.assertSelectorHasText('.comments-level-0 .media-body .oae-markdown p:nth-of-type(5) strong', 'Strong Text', 'Strong text is correcty formatted');
                test.assertSelectorHasText('.comments-level-0 .media-body .oae-markdown p:nth-of-type(6) code', 'Preformatted Text', 'Preformatted text is correcty formatted');

                // Verify headings
                test.assertSelectorHasText('.comments-level-0 .media-body .oae-markdown h1', 'First Level Heading', 'Headings are correcty formatted');
                test.assertSelectorHasText('.comments-level-0 .media-body .oae-markdown h2', 'Second Level Heading', 'Headings are correcty formatted');
                test.assertSelectorHasText('.comments-level-0 .media-body .oae-markdown h3', 'Third Level Heading', 'Headings are correcty formatted');
                test.assertSelectorHasText('.comments-level-0 .media-body .oae-markdown h4', 'Fourth Level Heading', 'Headings are correcty formatted');
                test.assertSelectorHasText('.comments-level-0 .media-body .oae-markdown h5', 'Fifth Level Heading', 'Headings are correcty formatted');
                test.assertSelectorHasText('.comments-level-0 .media-body .oae-markdown h6', 'Sixth Level Heading', 'Headings are correcty formatted');

                // Verify paragraphs
                test.assertSelectorHasText('.comments-level-0 .media-body .oae-markdown p:nth-of-type(7)', 'Paragraph withline break', 'Paragraphs are correctly formatted');
                test.assertElementCount('.comments-level-0 .media-body .oae-markdown p:nth-of-type(7) br', 1, 'Line breaks are correcty embedded in paragraphs');

                // Verify sanitizing HTML
                test.assertSelectorHasText('.comments-level-0 .media-body .oae-markdown p:nth-of-type(8)', '<script>alert("XSS attack")</script>', 'Scripts are correcty escaped');
            });
        });
    };
