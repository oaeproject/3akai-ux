...
/* Main container */
#comments_mainContainer.oae-widget-content, #comments_settings.oae-widget-content {
    padding: 10px;
}
...
.comments_arrowUp {
    height: 10px;
    background: #fff url(/node_modules/oae-core/comments/images/comments_arrowup.jpg) no-repeat bottom left;
}
.comments_avatar {
    height: 35px;
    float: left;
