...
define(['jquery', 'oae.core', 'jquery.autosize'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        /**
         * Either marks a comment in the list as deleted without removing it from the list or deletes it
         * from the list when there were no replies on the comment.
         *
         * @param  {Event}      ev         Standard `oae.deletecomment.done` event
         * @param  {Comment}    comment    The comment that was deleted
         */
        var markCommentAsDeleted = function(ev, data) {
            // Replace the deleted comment with a dummy placeholder that indicates there used
            // to be a comment if it was soft-deleted
            if (data.softDeleted) {
            ...
            // Remove the deleted comment from the list if if there was no reply to it and it
        ...
        $(document).on('oae.deletecomment.done', markCommentAsDeleted);
    };
});
