...
define(['jquery', 'oae.core', 'jquery.autosize'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        // Variable used to keep track of the comment to delete
        ...
        var markCommentAsDeleted = function(comment) {
            ...
            $('li.media[data-id="' + comment.created + '"]', $rootel).replaceWith(
                oae.api.util.template().render($('#comments-comment-template', $rootel), {
                    'results': [comment],
                    'canManage': contextProfile.isManager
                })
        ...
        /**
         * Delete a comment. An item that has been properly deleted, because it had no replies, will be removed
         * from the list. A deleted item that does have replies will remain available as `This comment has been deleted`.
         */
        var deleteComment = function() {
            // Disable the delete button
            $('#deletecomment-delete', $rootel).prop('disabled', true);
            ...
            oae.api.comment.deleteComment(contextProfile.id, contextProfile.resourceType, commentToDelete, function(err, softDeleted) {
                ...
                $('#deletecomment-delete', $rootel).prop('disabled', false);
                ...
                if (err) {
                    ...
                    if (softDeleted) {
                        ...
                        infinityScroll.removeItems(commentToDelete);
                    }
                }
        ...
        /**
         * Initialize the delete comment modal dialog
         */
        var setUpDeleteComment = function() {
            $rootel.on('click', '.comments-delete-button', function() {
                // Keep track of the id of the comment that needs to be deleted
                commentToDelete = $(this).attr('data-id');
