...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
         ...
         *
         * @param  {Number}    commentId    The id of the comment which needs to be deleted
         */
        ...
        var setUpDeleteCommentModal = function() {
            // Keep track of the clicked comment
            var clickedCommentId;

            $rootel.on('click', '.comments-delete-button', function() {
                // Remember which comment was clicked
                clickedCommentId = $(this).attr('data-id');
            ...
            $rootel.on('click', '#deletecomment-delete', function() {
                deleteComment(clickedCommentId);
            });
        };
