...
<div id="comments-comment-template"><!--
    {for comment in results}
        ...
        <li class="media comments-level-${commentLevel} {if !comment.body} deleted{/if}" data-id="${comment.commentId}" data-key="${comment.created}">
            <div class="comments-thumbnail">
            ...
            <div class="media-body">
                ...
                {else}
                    <div class="pull-right">
                        {if !oae.data.me.anon}
                            <button type="button" class="btn btn-link comments-reply-button" data-id="${comment.commentId}" title="__MSG__REPLY_TO_THIS_COMMENT__">
                                <span class="oae-aural-text">__MSG__REPLY_TO_THIS_COMMENT__</span>
                                <i class="icon-reply"></i>
                            </button>
                        {/if}
                        {if canManage || comment.createdBy.id === oae.data.me.id}
                            <button type="button" class="btn btn-link comments-delete-button" data-id="${comment.commentId}" title="__MSG__DELETE_COMMENT__">
                    ...
                    <div class="media hide comments-reply-container">
                        ...
                        <div class="media-body">
                            <form class="comments-new-reply-form" data-replyTo="${comment.commentId}">
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea placeholder="__MSG__YOUR_COMMENT__"  class="required"></textarea>
                                    </div>
