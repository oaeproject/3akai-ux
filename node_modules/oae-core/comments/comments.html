            ...
            <div class="media-body">
                ...
                {else}
                    ...
                    <div class="media hide comments-reply-container">
                        ...
                        <div class="media-body">
                            <form class="comments-new-reply-form" data-replyTo="${comment.created}" role="form">
                                <div class="form-group">
                                    <label for="comments-new-reply-${comment.created}" class="control-label oae-aural-text">__MSG__YOUR_COMMENT__</label>
                                    <textarea id="comments-new-reply-${comment.created}" placeholder="__MSG__YOUR_COMMENT__" class="form-control required maxlength-long"></textarea>
                                </div>
