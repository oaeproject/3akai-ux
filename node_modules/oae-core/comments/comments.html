...
<div id="comments-reply-template"><!--
    <form class="comments-new-reply-form" data-replyTo="${created}" role="form">
        <div class="form-group">
            <label for="comments-new-reply-${created}" class="control-label oae-aural-text">__MSG__YOUR_COMMENT__</label>
            <textarea id="comments-new-reply-${created}" placeholder="__MSG__YOUR_COMMENT__" class="form-control required maxlength-long"></textarea>
        </div>
