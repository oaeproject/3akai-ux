            ...
            <form class="comments-new-comment-form">
                <div class="control-group">
                    <div class="controls">
                        ...
                        <textarea id="comments-new-comment" placeholder="__MSG__YOUR_COMMENT__" class="required"></textarea>
                    </div>
                </div>
                    ...
                    <div class="media hide comments-reply-container">
                        ...
                        <div class="media-body">
                            <form class="comments-new-reply-form" data-replyTo="${comment.created}">
                                <div class="control-group">
                                    <div class="controls">
                                        <label for="comments-new-reply-${comment_index}" class="oae-aural-text">__MSG__YOUR_COMMENT__</label>
                                        <textarea id="comments-new-reply-${comment_index}" placeholder="__MSG__YOUR_COMMENT__"  class="required"></textarea>
                                    </div>
                                </div>
