            ...
            <form class="comments-new-comment-form">
                <div class="control-group">
                    <div class="controls">
                        ...
                        <textarea id="comments-new-comment" name="comments-new-comment" placeholder="__MSG__YOUR_COMMENT__" class="required maxlength-long"></textarea>
                    </div>
                </div>
                            ...
                            <form class="comments-new-reply-form" data-replyTo="${comment.created}">
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <textarea id="comments-new-reply-${comment.created}" placeholder="__MSG__YOUR_COMMENT__" class="required maxlength-long" name="comments-new-reply"></textarea>
                                    </div>
                                </div>
