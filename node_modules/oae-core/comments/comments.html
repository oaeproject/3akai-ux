                ...
                {else}
                    ...
                    <h4 class="media-heading">
                        {if comment.createdBy.profilePath}
                            <a href="${comment.createdBy.profilePath|replaceProfilePath}">
                        ...
                        <div class="media-body">
                            <form class="comments-new-reply-form" data-replyTo="${comment.created}">
                                <div class="form-group">
                                    ...
                                    <textarea id="comments-new-reply-${comment.created}" class="required maxlength-long form-control" placeholder="__MSG__YOUR_COMMENT__"></textarea>
                                </div>
