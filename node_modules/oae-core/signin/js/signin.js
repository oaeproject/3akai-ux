...
define(['jquery','oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        /**
         * Determine if the signup action should be shown in the signin widget. If we are already
         * on the signup page, the "Sign Up" action should not be available
         */
        var showSignUp = function() {
            return ($('body.oae-page-signup').length === 0);
        };
