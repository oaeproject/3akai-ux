    ...
    return function(uid) {
        ...
        var unfollow = function() {
            ...
            var unfollowUser = function(userId) {
                ...
                $('ul li[data-id="' + userId + '"] .fa-spinner', $rootel).show();

                oae.api.follow.unfollow(userId, function(err) {
                    // Hide the progress indicator
                    $('ul li[data-id="' + userId + '"] .fa-spinner', $rootel).hide();
                    if (err) {
                        // If there is an error, show the warning icon
                        $('ul li[data-id="' + userId + '"] .fa fa-exclamation-triangle', $rootel).show();
                        errCount++;
                    } else {
                        // If there is no error, show the success icon
                        $('ul li[data-id="' + userId + '"] .fa fa-check', $rootel).show();
                    }
