    ...
    return function(uid) {
        ...
        var finishUnfollow = function(errCount) {
            ...
            var notificationTitle = oae.api.util
                .template()
                .render(
                    $('#unfollow-notification-title-template', $rootel),
                    resultData,
                );
            var notificationBody = oae.api.util
                .template()
                .render(
                    $('#unfollow-notification-body-template', $rootel),
                    resultData,
                );
        ...
        var setUpUnfollowModal = function() {
            ...
            $(document).on('oae.list.sendSelection.unfollow', function(
                ev,
                selected,
            ) {
