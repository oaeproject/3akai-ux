    ...
    return function (uid) {
        ...
        var setUpReset = function() {
            $('#createcollabsheet-modal', $rootel).on('hidden.bs.modal', function() {
                ...
                // Reset the form
                var $form = $('#createcollabsheet-form', $rootel);
                $form[0].reset();
         ...
         */
        var setUpCreateCollabSheet = function() {
            var validateOpts = {
        ...
        var setUpSetPermissions = function() {
            ...
            var $setPermissionsContainer = $('#createcollabsheet-permissions-container', $rootel);
        ...
        var createCollabSheet = function() {
            ...
            var displayName = $.trim($('#createcollabsheet-name', $rootel).val());
         ...
         */
        var setUpCreateCollabSheetModal = function() {
