...
IMAGE_UPLOAD_FAILED = The image could not be successfully uploaded.
INVALID_IMAGE = Invalid image.
PICTURE_IS_TOO_SMALL = Picture is too small.
PICTURE_YOU_TRIED_TO_UPLOAD_IS_TOO_LARGE = The picture you tried to upload is too large. The picture can be maximum 10MB in size.
