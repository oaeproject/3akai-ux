            ...
            var fileuploadOptions = {
                ...
                'add': function(ev, data) {
                    ...
                    // Don't allow images over 10MB
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate('__MSG__INVALID_IMAGE__', 'changepic'),
                            oae.api.i18n.translate('__MSG__PICTURE_YOU_TRIED_TO_UPLOAD_IS_TOO_LARGE__', 'changepic'),
                            'error'
                        );
                ...
                'error': function(ev, data) {
                    oae.api.util.notification(
                        oae.api.i18n.translate('__MSG__IMAGE_NOT_UPLOADED__', 'changepic'),
                        oae.api.i18n.translate('__MSG__IMAGE_UPLOAD_FAILED__', 'changepic'),
                        'error'
                    );
                    reset();
                    showPlaceHolder();
