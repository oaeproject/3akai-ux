...
define(['jquery', 'oae.core', 'jquery.jcrop', 'jquery.fileupload', 'jquery.iframe-transport'], function($, oae) {
    ...
    return function(uid) {
        ...
        // Holds the context the widget is in. e.g. group profile
        ...
        /**
         * Shows the previously selected profile picture or default icon in a dropzone
         */
         ...
         * @param  {Object}   crd.x        The point x from where to start cropping
         * @param  {Object}   crd.y        The point y from where to start cropping
         * @param  {Object}   crd.width    Width of the selected area to be cropped
         */
        ...
        /**
         * Sends the cropping coordinates to the backend and receives the `me` or group
         * data in response. Sends out an `oae.changepic.finished` event and
        ...
        var setUpUploadPicture = function() {
            ...
            var fileuploadOptions = {
                ...
                'drop': showUploadingPicture,
                'change': showUploadingPicture,
