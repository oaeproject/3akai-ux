...
define(
    ...
    function($, oae) {
        return function(uid) {
            ...
            var useIframeTransport =
                !$.support.xhrFileUpload && !$.support.xhrFormDataFileUpload;
            ...
            var showPlaceHolder = function() {
                ...
                oae.api.util.template().render(
                    $('#changepic-profile-picture-template', $rootel),
                    {
            ...
            var showCroppingArea = function(data) {
                ...
                oae.api.util.template().render(
                    $('#changepic-jcrop-template', $rootel),
                    {
                ...
                $('#changepic-jcrop', $rootel).on('load', function(
                    ev,
                    b,
                    c,
                    d,
                    ...
                    if (
                        ev.currentTarget.naturalWidth < 200 ||
                        ev.currentTarget.naturalHeight < 200
                    ) {
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__PROFILE_PICTURE_IS_TOO_SMALL__',
                                'changepic',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__PROFILE_PICTURE_YOU_TRIED_TO_UPLOAD_IS_TOO_SMALL__',
                                'changepic',
                            ),
                            'error',
                        );
                        ...
                        $('#changepic-modal', $rootel).removeClass(
                            'changepic-initial-view',
                        );

                        // Show the cropping area
                        $(
                            '#changepic-form #changepic-jcrop-container',
                            $rootel,
                        ).show();
            ...
            var showUploadingPicture = function() {
                ...
                if (useIframeTransport) {
                    ...
                    $(
                        '#changepic-uploading-container .fa-spinner',
                        $rootel,
                    ).show();
                } else {
                    // Show the upload progress bar
                    $(
                        '#changepic-uploading-container .progress',
                        $rootel,
                    ).show();
                }
            };
            ...
            var calculateCoordinates = function(crd) {
                var naturalWidth = $('#changepic-jcrop', $rootel)[0]
                    .naturalWidth;
                var naturalHeight = $('#changepic-jcrop', $rootel)[0]
                    .naturalHeight;
            ...
            var setPicture = function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__PROFILE_PICTURE_UPDATED__',
                                'changepic',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__PROFILE_PICTURE_SUCCESSFULLY_UPDATED__',
                                'changepic',
                            ),
                        );
                    },
                    error: function() {
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__PROFILE_PICTURE_NOT_UPDATED__',
                                'changepic',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__PROFILE_PICTURE_COULD_NOT_BE_UPDATED__',
                                'changepic',
                            ),
                            'error',
                        );
            ...
            var setUpUploadPicture = function() {
                $(
                    '.changepic-dropzone-content i.fa-' +
                        contextData.resourceType,
                    $rootel,
                ).removeClass('hide');
                ...
                var fileuploadOptions = {
                    ...
                    add: function(ev, data) {
                        ...
                        if (!validType) {
                            oae.api.util.notification(
                                oae.api.i18n.translate(
                                    '__MSG__INVALID_PROFILE_PICTURE__',
                                    'changepic',
                                ),
                                oae.api.i18n.translate(
                                    '__MSG__SELECT_A_VALID_PROFILE_PICTURE__',
                                    'changepic',
                                ),
                                'error',
                            );
                            ...
                            oae.api.util.notification(
                                ...
                                oae.api.i18n.translate(
                                    '__MSG__PROFILE_PICTURE_YOU_TRIED_TO_UPLOAD_IS_TOO_LARGE__',
                                    'changepic',
                                ),
                                'error',
                            );
                    ...
                    error: function(ev, data) {
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__PROFILE_PICTURE_NOT_UPLOADED__',
                                'changepic',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__PROFILE_PICTURE_UPLOAD_FAILED__',
                                'changepic',
                            ),
                            'error',
                        );
            ...
            var reset = function() {
                ...
                $('#changepic-modal', $rootel).addClass(
                    'changepic-initial-view',
                );
