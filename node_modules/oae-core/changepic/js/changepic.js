...
define(['jquery', 'oae.core', 'jquery.jcrop', 'jquery.fileupload', 'jquery.iframe-transport'], function($, oae) {
    ...
    return function(uid) {
         ...
         * completion. Sends out an `oae.changepic.update` event and
        ...
        var setUpJCrop = function() {
            $('#changepic-jcrop', $rootel).Jcrop({
                ...
                'bgOpacity': 0.4,
                'bgColor': '#FFF',
                'keySupport': false, // https://github.com/tapmodo/Jcrop/issues/20
                'minSize': [50, 50],
        ...
        var setUpChangePicModal = function() {
            ...
            // Update modal when picture is changed
            $(document).on('oae.changepic.update', function(ev, ctx) {
                contextData = ctx;
            });
        };
