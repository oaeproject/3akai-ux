    ...
    return function(uid) {
        ...
        var showCroppingArea = function(data) {
            ...
            $('#changepic-jcrop', $rootel).on('load', function(ev, b,c,d) {
                // If the image is smaller than 162x162 we reject it
                if (ev.currentTarget.naturalWidth < 162 || ev.currentTarget.naturalHeight < 162) {
                    ...
                    // Remove the initial view class to the modal
