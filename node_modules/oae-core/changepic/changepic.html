    ...
    <div id="changepic-dropzone" class="well">
        {if pictureUrl}
            <div class="oae-tile changepic-dropzone-content">
                <img src="${pictureUrl}&${oae.api.util.generateId()}" alt="__MSG__PROFILE_PICTURE__"/>
            </div>
        {else}
            <div class="oae-tile changepic-dropzone-content">
...
<div id="changepic-jcrop-template"><!--
    <img src="${pictureUrl}&${oae.api.util.generateId()}" alt="__MSG__UPLOADED_PICTURE__" id="changepic-jcrop"/>
--></div>
