...
<!-- MODAL -->
<div id="changepic-modal" class="changepic-initial-view modal hide fade" tabindex="-1" role="dialog" aria-labelledby="changepic-modal-title" aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&#215;</button>
        <h3 id="changepic-modal-title">__MSG__PROFILE_PICTURE__</h3>
    </div>
    <form id="changepic-form">
        <div class="modal-body">
            <!-- HANDLING OF PICTURE UPLOAD -->
            <div id="changepic-pic-container" class="text-center"><!-- --></div>

            <!-- PICTURE IS BEING UPLOADED -->
            <div id="changepic-uploading-container" class="hide">
        ...
        <div class="modal-footer hide">
            ...
            <button type="button" id="changepic-set" class="btn btn-primary pull-right">__MSG__SET_PICTURE__</button>
        </div>
    </form>
</div>
    ...
    <div id="changepic-dropzone" class="well">
        {if pictureUrl}
            <div class="oae-tile changepic-dropzone-content">
                <img src="${pictureUrl}&${Math.round(Math.random() * 10000000)}" alt="__MSG__PROFILE_PICTURE__"/>
            </div>
        {else}
            <div class="oae-tile changepic-dropzone-content">
...
<div id="changepic-jcrop-template"><!--
    <img src="${pictureUrl}&${Math.round(Math.random() * 10000000)}" alt="__MSG__PROFILE_PICTURE__" id="changepic-jcrop"/>
--></div>
