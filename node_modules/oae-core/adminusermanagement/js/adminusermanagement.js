...
define(['exports', 'jquery', 'underscore', 'oae.core'], function(exports, $, _, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var renderUserManagement = function() {
            oae.api.util.template().render($('#adminusermanagement-template', $rootel), null, $('#adminusermanagement-container', $rootel));
        };
        ...
        var getUserList = function() {
            ...
            $('#adminusermanagement-search-query', $rootel).val(query);

            // Set up the list actions
            var initialContent = null;
            if (!query) {
                initialContent = oae.api.util.template().render($('#adminusermanagement-list-actions-template', $rootel));
            }
            ...
            infinityScroll = $('.oae-list', $rootel).infiniteScroll('/api/search/general', {
                ...
                'q': query,
                'resourceTypes': 'user',
                'tenantAlias': widgetData.context.alias
            }, '#adminusermanagement-list-template', {
                ...
                'emptyListProcessor': function() {
                    //TODO
                    oae.api.util.template().render($('#adminusermanagement-noresults-template', $rootel), {
                        'query': query
                    }, $('.oae-list', $rootel));
                }
            });
         ...
         */
        var search = function() {
            var query = $('#adminusermanagement-search-query', $(this)).val();
        ...
        var addBinding = function() {
            // Set up search event
            $rootel.on('submit', '#adminusermanagement-search-form', search);
         ...
         */
        var initAdminUserManagement = function() {
            addBinding();
