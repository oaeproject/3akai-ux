<!-- CSS -->
<link rel="stylesheet" type="text/css" href="/node_modules/oae-core/relatedcontent/css/relatedcontent.css" />
                ...
                {for i in relatedContent.results}
                    {if i['sakai:pooled-content-file-name'] && relatedcontent_index < 10 && i['_path'] !== content.data["_path"]}
                        ...
                        <div class="relatedcontent_content {if i_index == relatedContent.results.length - 1} last{/if} oae-draggable-container" data-canshare="${canShare}" data-scope="content" data-entityid="${i["_path"]}" {if sakai.api.Content.Collections.isCollection(i)} data-collection="true" {/if} data-href="/content#p={if i['sakai:pooled-content-file-name']}${i['_path']}/${i['sakai:pooled-content-file-name']|safeOutput}" title="${i['sakai:pooled-content-file-name']|safeOutput}"{else}${i['_path']}{/if}">
                            ...
                            <a href="/content#p=${i['_path']|encodeForURL}/${i['sakai:pooled-content-file-name']|safeOutput}" title="${i['sakai:pooled-content-file-name']|safeOutput}">
                                {if thumbnail}
                            ...
                            <div class="relatedcontent_content_right">
                                <a class="oae-regular-light-links threedots_text" href="/content#p={if i['sakai:pooled-content-file-name']}${i['_path']|encodeForURL}/${i['sakai:pooled-content-file-name']|safeOutput}" title="${i['sakai:pooled-content-file-name']|safeOutput}"{else}${i['_path']|encodeForURL}" title="${i['_path']}"{/if}>
                                ...
                                {if i.commentcount}
                                    <span class="relatedcontent_comments">
                                        ...
                                        <a href="/content#p={if i['sakai:pooled-content-file-name']}${i['_path']|encodeForURL}/${i['sakai:pooled-content-file-name']|safeOutput}" title="${i['sakai:pooled-content-file-name']|safeOutput}"{else}${i['_path']|encodeForURL}" title="${i['_path']}"{/if}" id="entity_comments_link">${i.commentcount} {if i.commentcount == 1} comment{else} comments{/if}</a>
                                    </span>
                                {/if}
                            </div>
...
<!-- JAVASCRIPT -->
<script type="text/javascript" src="/node_modules/oae-core/relatedcontent/javascript/relatedcontent.js"></script>
