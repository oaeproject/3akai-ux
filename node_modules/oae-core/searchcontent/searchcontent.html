...
<div class="searchcontent_widget" id="searchcontent_widget">
    <div class="searchcontent_content_main">
        ...
        <div class="searchcontent_results_faceted">
            ...
            <span id="searchcontent_result_content_I_manage" style="display:none;">__MSG__CONTENT_I_CAN_MANAGE__</span>
            <span id="searchcontent_result_content_I_m_a_viewer_of" style="display:none;">__MSG__CONTENT_SHARED_WITH_ME__</span>
        </div>
        <div id="searchcontent_results" class="oae-container searchcontent_results oae-search-results">
            <!-- SEARCH RESULTS -->
            <div id="results_page1" class="results_container results_container_sub">
                <!-- CONTENT -->
                <div class="oae-container results_part">
                    <!-- CONTAINER FOR THE RESULTS -->
                    <ul id="searchcontent_results_container" class="oae-search-results-container"></ul>
                </div>
                <div id="searchcontent_noresults_template"><!--
                    <li class="oae-no-results-container">
                        ...
                        <p>__MSG__NO_RESULTS_DESCRIPTION_SEARCH__ {if !sakai.data.me.user.anon} <a href="#" class="oae-regular-links sakai_add_content_overlay">__MSG__ADD_CONTENT__</a>{/if}</p>
                    </li>
                --></div>
            </div>
        </div>
...
<!-- JAVASCRIPT -->
<script type="text/javascript" src="/node_modules/oae-core/searchcontent/javascript/searchcontent.js"></script>
