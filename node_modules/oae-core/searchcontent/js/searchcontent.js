...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        var handleEmptyResultList = function() {
            oae.api.util.template().render($('#searchcontent_noresults_template'), null, $('#searchcontent_results_container'));
        };
        ...
        var search = function() {
            ...
            infinityScroll = $('#searchcontent_results_container').infiniteScroll('/api/search/general', {
                'limit': 12,
