...
define(['jquery', 'oae/api/oae.core', 'require', '/node_modules/oae-core/contentpreview/lib/document-viewer/assets/viewer.js'], function($, oae, require) {

    return function(uid, showSettings, widgetData) {

        require(['/node_modules/oae-core/contentpreview/lib/document-viewer/assets/viewer.js'], function() {
        ...
        var renderDocumentPreview = function() {
            var pdfDoc = {
                'id': widgetData.contentId,
                'title': widgetData.displayName,
                'pages': widgetData.previews.pageCount,
                'resources': {
                    'pdf': '/api/content/' + widgetData.contentId + '/download',
                    'page': {
                        'image': '/api/content/' + widgetData.contentId + '/previews/page.{page}.{size}.png?signature=' + widgetData.signature.signature + '&expires=' + widgetData.signature.expires + '&lastmodified=' + widgetData.signature.lastModified
                    }
                }
            };
            DV.load(pdfDoc, {
