            ...
            <div id="discussion_create_new_topic" style="display:none;">
                <form>
                    <div class="s3d-form-field-wrapper">
                        <label for="discussion_create_new_topic_title" class="s3d-bold s3d-input-label s3d-input-label-above">__MSG__TOPIC_TITLE__</label>
                        <input type="text" id="discussion_create_new_topic_title" name="discussion_topic_title" class="required s3d-input-full-width"/>
                        <label for="discussion_create_new_topic_message_text" class="s3d-bold s3d-input-label s3d-input-label-above">__MSG__MESSAGE_TEXT__</label>
                        <textarea id="discussion_create_new_topic_message_text" class="required s3d-input-full-width" rows="6" name="discussion_topic_text" placeholder="__MSG__ENTER_YOUR_MESSAGE__"></textarea>
                    </div>
...
<div id="discussion_no_initial_topic_template"><!--
    {if settings.addtopic == true}
        ...
        <div class="fl-force-right discussion_not_changeable" style="display:none">(__MSG__ERROR_NOT_CHANGEABLE__)</div>
...
<div id="discussion_topic_reply_template"><!--
    <form class="discussion_{if edit === true}edit{else}reply{/if}_form s3d-form-field-wrapper">
        {if quoted}
            ...
            <textarea id="discussion_topic_quoted_text" class="required s3d-input-full-width" rows="4" name="quoted_text" title="__MSG__QUOTED_TEXT__">${quotedMessage|safeOutput}</textarea>
        {/if}
        <label for="discussion_topic_reply_text" class="s3d-bold s3d-input-label s3d-input-label-above">
            __MSG__MESSAGE_TEXT__
        </label>
        <textarea id="discussion_topic_reply_text" class="required  s3d-input-full-width" rows="6" name="message_text" placeholder="__MSG__ENTER_YOUR_MESSAGE__">{if edit == true}${body}{/if}</textarea>
        <div class="fl-force-right">
            {if edit == true}
...
<div id="discussion_topic_newly_posted_reply_template"><!--
    <div class="s3d-highlight_area_background s3d-highlight_area_background_rounded" id="${post.message["sakai:id"]}">
...
<div id="discussion_list_topics_template"><!--
    ...
    {for topic in postData}
        <div id="discussion_post_${topic.post["sakai:id"]}" class="discussion_topic_container">
            ...
            <div class="s3d-highlight_area_background s3d-highlight_area_background_rounded" id="${topic.post["sakai:id"]}">
                <div class="discussion_entity_container">
            ...
            <div class="discussion_topic_replies_container" style="display:none;">
                {for reply in topic.replies}
                    <div class="{if reply.post["sakai:deleted"] && reply.post["sakai:deleted"] == "true"}s3d-highlight_area_background discussion_deleted_reply{else}s3d-highlight_area_background{/if} s3d-highlight_area_background_rounded" id="${reply.post["sakai:id"]}">
                        <div class="discussion_entity_container">
    ...
    <div class="s3d-widget-content">
        <div id="discussion_tab_content">
            ...
            <div class="fl-force-right">
                ...
                <button type="button" class="s3d-button s3d-overlay-action-button" id="discussion_settings_submit">__MSG__SAVE_SETTINGS__</button>
                <hr class="fl-push fl-hidden"/>
            </div>
        </div>
    </div>
