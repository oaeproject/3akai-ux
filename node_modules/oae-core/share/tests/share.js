casper.test.begin('Widget - Share', function(test) {
    ...
    var verifyOpenLibraryShare = function() {
        casper.waitForSelector('li.oae-list-actions + li .oae-list-grid-item input[type="checkbox"]', function() {
            ...
            test.assertExists('#contentlibrary-widget .oae-list-options button.oae-trigger-share:not([disabled])', 'The share button is enabled');
            ...
            casper.waitForSelector('#share-container', function() {
                test.assertExists('#share-container', 'The share popover opens after trigger');
            });
        });
    };
    ...
    var verifyLibraryShareElements = function() {
        ...
        test.assertExists('form#share-form button#share-cancel', 'The share cancel button is present');
    };
