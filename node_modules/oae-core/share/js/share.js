...
define(['jquery', 'oae.core'], function($, oae) {
    return function(uid) {
                    ...
                    shareFunction(resources[done], targetIds, function(err) {
                        ...
                        if (done === resources.length) {
                            ...
                            var data = {
                                ...
                                mylibrary: _.contains(
                                    targetIds,
                                    oae.data.me.id,
                                ),
                                resourceType: resourceType,
                                resourceSubType:
                                    selectedResources[0].resourceSubType,
                            };
                            ...
                            var notificationTitle = oae.api.util
                                ...
                                .render(
                                    $(
                                        '#share-notification-title-template',
                                        $rootel,
                                    ),
                                    data,
                                );
                            var notificationBody = oae.api.util
                                ...
                                .render(
                                    $(
                                        '#share-notification-body-template',
                                        $rootel,
                                    ),
                                    data,
                                );
        ...
        var autoSuggestChanged = function() {
            $('#share-save', $rootel).prop(
                'disabled',
                oae.api.util.autoSuggest().getSelection($rootel).length
                    ? false
                    : true,
            );
        };
        ...
        var getContext = function() {
            ...
            if ($trigger.attr('data-id')) {
                ...
                $(document).on('oae.context.send.share', function(ev, data) {
                    ...
                    $(document).on('oae.list.sendSelection.share', function(
                        ev,
                        data,
                    ) {
