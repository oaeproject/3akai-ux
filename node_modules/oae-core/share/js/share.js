...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        // The element that triggered the popover
        var $trigger = null;
        ...
        var toggleSharePopover = function() {
            $('.oae-trigger-share').popover('hide');
        };
        ...
        var setUpShare = function() {
            ...
            $rootel.on('click', '#share-cancel', toggleSharePopover);
        };
        ...
        var setUpSharePopover = function() {
            $('.oae-trigger-share').on('click', function() {
                $trigger = $(this);
            });

            // When the popover is shown retrieve the context and set up the autosuggest
            $('.oae-trigger-share').on('shown.bs.popover', function () {
                ...
                $('.oae-trigger-share')[0].style.webkitTransform = 'scale(1)';
                getContext();
                setUpShare();
            });

            // Initialize the popover
            $('.oae-trigger-share').popover({
                'container': $rootel,
