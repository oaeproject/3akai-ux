...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        var setUpShare = function() {
            $rootel.off('click').on('click', '#share-save', function() {
                ...
                var done = 0;
                var share = function() {
                    shareFunction(resources[done], principals, function() {
                        done++;
                        if (done === resources.length) {
                            /*!
                             * TODO: The share action will return an error everytime all of the selected
                             ...
                             * with a good way of tracking the successes/errors
                             */
                            // Render and show the success notification
                            var data = {
                            ...
                            oae.api.util.notification(notificationTitle, notificationBody);
        ...
        var getContext = function() {
            ...
            // as a ghost item, otherwise we always do. After that, we request the selected items from the current list
                ...
                $(document).on('oae.context.send.share', function(ev, data) {
                    ...
                    $(document).on('oae.list.sendSelection', function(ev, data) {
