...
<div class="share-widget hide">
    <div id="share-popover-template"><!--
        <div id="share-container">
            <input type="text" id="share-autosuggest" placeholder="__MSG__ENTER_NAME_HERE__"/>
            <div class="modal-footer">
                <button type="button" id="share-cancel" class="btn btn-link pull-left">__MSG__CANCEL__</button>
                <button type="button" id="share-save" class="btn btn-primary pull-right" disabled="true">__MSG__SHARE__</button>
            </div>
        </div>
    --></div>
