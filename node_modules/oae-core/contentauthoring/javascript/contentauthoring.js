...
require(['jquery', 'underscore', 'sakai/sakai.api.core', 'jquery-ui'], function($, _, sakai) {
    ...
    sakai_global.contentauthoring = function(tuid, showSettings, widgetData) {
        ...
        $rootel.on('keyup', '#contentauthoring_row_menu', function() {
            ...
            if (!$('.oae-dropdown-hassubnav ul button:focus, #contentauthoring_row_menu_add:focus', $(this)).length) {
        ...
        $('#contentauthoring_widget_settings', $rootel).on('click', '.oae-dialog-close', sakai_global.contentauthoring.widgetCancel);
        ...
        sakai.api.Widgets.widgetLoader.insertWidgets('oae-page-main-content');
