...
define(
    ['jquery', 'oae.core', 'jquery.fileupload', 'jquery.iframe-transport'],
    function($, oae) {
        return function(uid, showSettings) {
            ...
            var reset = function() {
                ...
                $('#uploadnewversion-browse-button', $rootel).removeClass(
                    'oae-focus',
                );
            };
                ...
                if (data.files.length !== 1) {
                    oae.api.util.notification(
                        oae.api.i18n.translate(
                            '__MSG__VERSION_NOT_UPLOADED__',
                            'uploadnewversion',
                        ),
                        oae.api.i18n.translate(
                            '__MSG__ONLY_A_SINGLE_FILE_MAY_BE_UPLOADED__',
                            'uploadnewversion',
                        ),
                        'error',
                    );
                    ...
                    !data.files[0].name ||
                    (!useIframeTransport && data.files[0].size <= 0)
                ) {
                    oae.api.util.notification(
                        oae.api.i18n.translate(
                            '__MSG__VERSION_NOT_UPLOADED__',
            ...
            var setUpNewVersionInput = function(ev, context) {
                ...
                $('#uploadnewversion-input', $rootel).fileupload(
                    fileuploadOptions,
                );
            };
            ...
            var uploadNewVersion = function() {
                ...
                oae.api.content.uploadNewVersion(
                    $('#uploadnewversion-input', $rootel),
                    selectedFile,
                    function(err, updatedContent) {
                        ...
                        if (err) {
                            oae.api.util.notification(
                                ...
                                oae.api.i18n.translate(
                                    '__MSG__VERSION_NOT_SUCCESSFULLY_UPLOADED__',
                                    'uploadnewversion',
                                ),
                                'error',
                            );
                            ...
                            oae.api.util.notification(
                                oae.api.i18n.translate(
                                    '__MSG__VERSION_UPLOADED__',
                                    'uploadnewversion',
                                ),
                                oae.api.i18n.translate(
                                    '__MSG__VERSION_SUCCESSFULLY_UPLOADED__',
                                    'uploadnewversion',
                                ),
                            );
                        }
            ...
            var initUploadNewVersionModal = function() {
                ...
                $(document).on(
                    'oae.context.send.uploadnewversion',
                    setUpNewVersionInput,
                );

                // Reset the widget when it's fully hidden
                $('#uploadnewversion-modal', $rootel).on(
                    'hidden.bs.modal',
                    reset,
                );
            };
