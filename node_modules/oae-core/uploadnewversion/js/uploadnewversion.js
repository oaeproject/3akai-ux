        ...
        var checkValidFile = function(ev, data) {
            ...
            if (data.files.length !== 1) {
                oae.api.util.notification(
                    ...
                    oae.api.i18n.translate('__MSG__ONLY_SINGLE_FILES_MAY_BE_UPLOADED__', 'uploadnewversion'),
                    'error'
                );
            ...
            // A valid file name must be provided
                ...
                oae.api.util.notification(
                    oae.api.i18n.translate('__MSG__VERSION_NOT_UPLOADED__', 'uploadnewversion'),
                    oae.api.i18n.translate('__MSG__COULD_NOT_IDENTIFY_FILE__', 'uploadnewversion'),
                    'error'
                );

            // The file must have content
            } else if (!useIframeTransport && data.files[0].size <= 0) {
                oae.api.util.notification(
                    oae.api.i18n.translate('__MSG__VERSION_NOT_UPLOADED__', 'uploadnewversion'),
                    oae.api.i18n.translate('__MSG__COULD_NOT_FIND_FILE_CONTENTS__', 'uploadnewversion'),
                    'error'
                );
