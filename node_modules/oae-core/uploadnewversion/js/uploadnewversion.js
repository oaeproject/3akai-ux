...
define(['jquery', 'oae.core', 'jquery.fileupload', 'jquery.iframe-transport', 'bootstrap.modal'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var uploadNewVersion = function() {
            ...
            oae.api.content.createNewVersion($('#uploadnewversion-form-input', $rootel), selectedFile, function(error) {
