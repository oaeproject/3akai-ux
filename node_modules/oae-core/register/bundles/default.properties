...
I_AGREE_TO_THE_TERMS_AND_CONDITIONS = I agree to the <a href="${tcLink}" role="button" id="register-terms-and-conditions" class="oae-plain-link" tabindex="0">Terms and Conditions</a>
LASTNAME = Last name:
