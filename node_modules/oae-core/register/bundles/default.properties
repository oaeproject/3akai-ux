...
I_AGREE_TO_THE_TERMS_AND_CONDITIONS = I agree to the <button id="register-terms-and-conditions" class="btn btn-link oae-plain-link" type="button">Terms and Conditions</button>
LASTNAME = Last name:
