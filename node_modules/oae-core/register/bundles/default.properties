BACK = Back
CAPTCHA_ERROR = Captcha validation failed. Please enter the challenge words below.
CREATE_ACCOUNT = Create account
CREATE_ACCOUNT_INVALIDCHAR = Username contains an invalid character
FIRSTNAME = First name:
I_AGREE_TO_THE_TERMS_AND_CONDITIONS = I agree to the <button id="register-terms-and-conditions" class="btn btn-link oae-plain-link" type="button" class="btn btn-link">Terms and Conditions</button>
LASTNAME = Last name:
