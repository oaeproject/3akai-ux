    ...
    return function(uid, showSettings) {
        ...
        var setUpTermsAndConditions = function() {
            ...
            $rootel.on('click', '#register-continue-signup', function() {
                // Show the register form and hide the Terms and Conditions
                showRegisterForm();
                // Accept the terms automatically as they've been read
         ...
         *
         * Fake button elements are elements tagged with [role="button"] and class .btn For example:
         *
         *     <span role='button' class='btn btn-link' tabindex='0'>Button Text</span>.
         *
         ...
         *
         * @param {Element|String}    elem   An Element/jQuery collection/Element selector string. Fake buttons will be enabled under the element(s) specified.
         */
        var enableFakeButtonsUnder = function(elem) {
            $(elem).on('keypress', 'span.btn[role=button]', function(ev) {
                // Intercept space and return key presses and trigger click events (as real buttons would)
