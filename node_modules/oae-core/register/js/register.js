...
define(['jquery', 'underscore', 'oae.core'], function($, _, oae) {
    ...
    return function(uid, showSettings) {
         ...
         */
        var setUpTriggerListener = function() {
        ...
        /**
         * Simple wrapper around all the init functions.
         * This is so we can optionally load the recaptcha library.
         */
        ...
        // It doesn't matter if recaptcha is enabled or disabled.
        // We need to be able to listen to trigger events.
        // Waiting till the recaptcha library has loaded would result in missing
        // the trigger event.
        setUpTriggerListener();

        if (recaptchaEnabled) {
            require(['//www.google.com/recaptcha/api/js/recaptcha_ajax.js'], startInit);
        } else {
            startInit();
        }
