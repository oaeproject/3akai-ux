...
define(['jquery', 'underscore', 'oae.core', 'markdown'], function($, _, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var setUpReCaptcha = function() {
            if (recaptchaEnabled) {
                $('#register-captcha', $rootel).addClass('col-md-7');
                $('#register-accept-and-create-container', $rootel).addClass('col-md-5');
                ...
                $('#register-accept-and-create-container', $rootel).addClass('col-md-12');
            }
        };
