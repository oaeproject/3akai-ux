                ...
                if (previousUsername !== username) {
                    ...
                    if (username.length > 2 && username.indexOf(' ') === -1) {
                        isUserNameAvailable(function(available) {
                            ...
                            available ? $('#register-username').addClass('register-username-available') : $('#register-username').removeClass('register-username-available');
                        });
                    } else {
                        $('#register-username').removeClass('register-username-available');
                    }
                }
            });
        };
