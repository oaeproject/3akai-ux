                    ...
                    'usernameavailable': {
                        'method': function(value, element) {
                            ...
                            isUserNameAvailable(value, function(available) {
                                ...
                                if (available) {
                                    $('#register-username-available', $rootel).removeClass('fa fa-times').addClass('fa fa-check');
                                } else {
                                    $('#register-username-available', $rootel).removeClass('fa fa-check').addClass('fa fa-times');
                                }
                            });
                            return response;
                        },
