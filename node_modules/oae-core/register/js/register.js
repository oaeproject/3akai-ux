...
define(['jquery', 'underscore', 'oae.core', '//www.google.com/recaptcha/api/js/recaptcha_ajax.js'], function($, _, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var setUpReCaptcha = function() {
            if (recaptchaEnabled) {
                var captchaContainer = $('#register-captcha-container')[0];
        ...
        var showRecaptchaError = function() {
            ...
            $('#register-captcha').addClass('error');
            $('#register-captcha-error').show();
        };
        ...
        var hideRecaptchaError = function() {
            ...
            $('#register-captcha-error').hide();
            $('#register-captcha').removeClass('error');
        };
        ...
        var setUpUsernameCheck = function() {
            ...
            $('#register-username').on('keyup blur', function() {
                ...
                if (previousUsername !== username) {
                    ...
                    if (username.length > 2 && username.indexOf(' ') === -1) {
                        isUserNameAvailable(username, function(available) {
                            ...
                            if (available) {
                                $('#register-username-available').removeClass('icon-remove').addClass('icon-ok');
                            } else {
                                $('#register-username-available').removeClass('icon-ok').addClass('icon-remove');
                            }
                        });
                    } else {
                        $('#register-username-available').removeClass('icon-ok').addClass('icon-remove');
         ...
         * @returns {Boolean}                            When no callback is provided, this function will be synchronous and will return whether or not the username is available
         */
        ...
        setUpValidation = function() {
            var validateOpts = {
                ...
                'messages': {
                    ...
                    'password': {
                        ...
                        'minlength': oae.api.i18n.translate('__MSG__YOUR_PASSWORD_SHOULD_BE_AT_LEAST_SIX_CHARACTERS_LONG__', 'register')
                    },
                    'password_repeat': {
                        'required': oae.api.i18n.translate('__MSG__PLEASE_REPEAT_YOUR_PASSWORD__', 'register'),
                        'passwordmatch': oae.api.i18n.translate('__MSG__THIS_PASSWORD_DOES_NOT_MATCH_THE_FIRST_ONE__', 'register')
                    }
                },
                'methods': {
                    'validusername': {
            ...
            oae.api.util.validation().validate($('#register-form'), validateOpts);
        };
