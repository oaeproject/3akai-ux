...
define(['jquery', 'underscore', 'oae.core'], function($, _, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var setUpValidation = function() {
            var validateOpts = {
                ...
                'messages': {
                    ...
                    'termsandconditions': {
                        'required': oae.api.i18n.translate('__MSG__PLEASE_AGREE_TO_THE_T&C__', 'register')
                    }
                },
                'methods': {
                    'validusername': {
        ...
        var createUser = function() {
            ...
            // If the tenant requires the terms and conditions to be accepted add it on the additionalOptions object
            if (oae.api.config.getValue('oae-principals', 'termsAndConditions', 'enabled') === true) {
                additionalOptions.acceptedTC = $('#register-accept-terms-and-conditions').is(':checked');
            }
        ...
        var initRegister = function() {
            $(document).on('click', '.oae-trigger-register', function() {
                // Show the register form and hide the terms
            ...
            if (oae.api.config.getValue('oae-principals', 'termsAndConditions', 'enabled') === true) {
                ...
                $rootel.on('click', '#register-terms-and-conditions', function() {
                    ...
                    oae.api.widget.insertWidget('termsandconditions', termsandconditionsId, $('#register-terms-and-conditions-container .well', $rootel), true);
