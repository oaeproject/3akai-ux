    ...
    return function(uid, showSettings) {
        ...
        var setUpReCaptcha = function() {
            if (recaptchaEnabled) {
                ...
                $('#register-captcha-create-container', $rootel).addClass('register-captcha-create-has-captcha');
            } else {
        ...
        var createUser = function() {
            ...
            oae.api.user.createUser(values.username, values.password, displayName, additionalOptions, values.recaptchaChallenge, values.recaptchaResponse, null, function(err, createdUser) {
                if (err) {
                    if (recaptchaEnabled) {
                        // Refresh reCaptcha
                        Recaptcha.reload();
