    ...
    return function(uid, showSettings) {
        ...
        var setUpReCaptcha = function() {
            if (recaptchaEnabled) {
                ...
                $('#register-form .row:last-child').addClass('register-row-height');
            } else {
        ...
        var setUpTermsAndConditions = function() {
            ...
            if (termsAndConditionsEnabled) {
                oae.api.util.template().render($('#register-accept-and-create-template', $rootel), null, $('#register-accept-and-create-container', $rootel));
