<!-- CSS -->
<link  rel="stylesheet" type="text/css" href="/node_modules/oae-core/newaddcontent/css/newaddcontent.css" />

<!-- CONTAINER -->
<div id="newaddcontent_container" class="oae-dialog oae-dialog-container">
    ...
    <div id="newaddcontent_container_newitem">
        <div id="newaddcontent_container_newitem_fields">
            ...
            <div id="newaddcontent_upload_content_template" class="newaddcontent_newitem_container" style="display:none;">
                <label for="newaddcontent_file_upload" class="oae-force-left" id="newaddcontent_upload_a_file_label">__MSG__UPLOAD_A_FILE__</label>
                <form id="newaddcontent_upload_content_form" class="newaddcontent_form" method="POST" enctype="multipart/form-data">
                    <span class="newaddcontent_fileinput_button oae-overlay-button oae-button oae-force-left">
                        <span>__MSG__BROWSE__</span>
                        <input type="file" id="newaddcontent_file_upload" name="files[]" size="38"/>
                    </span>
                </form>
                <div id="newaddcontent_upload_content_fields" class="newaddcontent_form oae-push">
                    ...
                    <button type="button" class="oae-button oae-header-button newaddcontent_container_newitem_add_to_list newaddcontent_container_newitem_add_to_list_upload_new_content" disabled="disabled">__MSG__ADD__</button>
                </div>
            </div>
            ...
            <div id="newaddcontent_add_document_template" class="newaddcontent_newitem_container" style="display:none;">
                ...
                <form id="newaddcontent_add_document_form" class="newaddcontent_form">
                    <div class="oae-form-field-wrapper">
                        <label for="newaddcontent_add_document_title" class="oae-input-label oae-input-label-above">__MSG__NAME_DOCUMENT__</label>
                        <input type="text" id="newaddcontent_add_document_title" name="newaddcontent_add_document_title" class="required oae-error-calculate"/>

                        <label for="newaddcontent_add_document_description" class="oae-input-label oae-input-label-above">__MSG__DESCRIPTION__</label>
                        <textarea id="newaddcontent_add_document_description" placeholder="__MSG__ENTER_A_DESCRIPTION__"></textarea>

                        <div class="autosuggest_wrapper">
                            <label for="newaddcontent_add_document_tags" class="oae-input-label oae-input-label-above">__MSG__TAGS_AND_CATEGORIES__</label>
                            <button type="button" class="oae-link-button oae-bold list_categories">__MSG__LIST_CATEGORIES__</button>
                            <input type="text" id="newaddcontent_add_document_tags"/>
                        </div>

                        <label for="newaddcontent_add_document_permissions" class="oae-input-label oae-input-label-above">__MSG__WHO_CAN_SEE_IT__</label>
                    ...
                    <button type="button" class="oae-button oae-header-button newaddcontent_container_newitem_add_to_list" disabled="disabled">__MSG__ADD__</button>
                </form>
            </div>
            ...
            <div id="newaddcontent_add_existing_template" class="newaddcontent_newitem_container" style="display:none;">
                <div class="oae-search-container">
                    <input type="text" maxlength="255" title="__MSG__SEARCH_THROUGH_EXISTING_CONTENT__" class="oae-search-inputfield newaddcontent_existingitems_search" placeholder="__MSG__SEARCH_THROUGH_EXISTING_CONTENT__"/>
                    <button type="button" class="oae-button oae-overlay-button oae-search-button" id="newaddcontent_existing_search_button">
                    ...
                    <div id="newaddcontent_existingitems_list_container">
                        <div id="newaddcontent_existingitems_list_container_actions">
                            <div class="oae-force-left">
                                <input type="checkbox" id="newaddcontent_existingitems_list_container_actions_checkall" class="oae-force-left"/>
                                <label for="newaddcontent_existingitems_list_container_actions_checkall" id="newaddcontent_existingitems_list_container_actions_checkall_label" class="oae-aural-text">__MSG__SELECT_ALL__</label>
                            </div>
                            <div class="oae-force-right">
                                <select id="newaddcontent_existingitems_list_container_actions_sort" class="oae-force-right">
                                ...
                                <label for="newaddcontent_existingitems_list_container_actions_sort" id="newaddcontent_existingitems_list_container_actions_sort_label" class="oae-force-right">__MSG__SORT_BY__</label>
                            </div>
                        </div>
            ...
            <div id="newaddcontent_add_link_template" class="newaddcontent_newitem_container" style="display:none;">
                <form id="newaddcontent_add_link_form" class="newaddcontent_form oae-form-field-wrapper">
                    <label for="newaddcontent_add_link_url" class="oae-input-label oae-input-label-above">__MSG__PASTE_LINK_URL_ADDRESS__</label>
                    <input type="text" id="newaddcontent_add_link_url" name="newaddcontent_add_link_url" class="appendhttp url required oae-error-calculate"/>

                    <label for="newaddcontent_add_link_title" class="oae-input-label oae-input-label-above">__MSG__TITLE__</label>
                    <input type="text" id="newaddcontent_add_link_title"/>

                    <label for="newaddcontent_add_link_description" class="oae-input-label oae-input-label-above">__MSG__DESCRIPTION__</label>
                    <textarea id="newaddcontent_add_link_description" placeholder="__MSG__ENTER_A_DESCRIPTION__"></textarea>

                    <div class="autosuggest_wrapper">
                        <label for="newaddcontent_add_link_tags" class="oae-input-label oae-input-label-above">__MSG__TAGS_AND_CATEGORIES__</label>
                        <button type="button" class="oae-link-button oae-bold list_categories">__MSG__LIST_CATEGORIES__</button>
        ...
        <button type="button" id="newaddcontent_container_newitem_raquo_right" class="oae-button newaddcontent_container_newitem_add_to_list" disabled="disabled" title="__MSG__ADD__"></button>
    </div>

    <div id="newaddcontent_container_selecteditems">
        <h2 id="newaddcontent_container_selecteditems_header" class="oae-bold">__MSG__COLLECTED_ITEMS__</h2>
    ...
    <div id="newaddcontent_container_actions">
        ...
        <button type="button" class="oae-button oae-overlay-action-button newaddcontent_container_start_upload" disabled="disabled">__MSG__DONE_ADD_COLLECTED__</button>
    </div>
...
<div id="newaddcontent_copyright_template"><!--
    <label for="newaddcontent_upload_content_copyright">__MSG__COPYRIGHT_COLON__</label>
...
<div id="newaddcontent_selecteditems_edit_data_template" style="display:none;"><!--
    ...
    <div id="newaddcontent_selecteditems_edit_data_fields">
        ...
        <form class="newaddcontent_form oae-form-field-wrapper" id="newaddcontent_selecteditems_edit_data_form">
            <label for="newaddcontent_selecteditems_edit_data_title">__MSG__TITLE__</label>
            <input type="text" id="newaddcontent_selecteditems_edit_data_title" value="${item["name"]|safeOutput}" class="required"/>
            <label for="newaddcontent_selecteditems_edit_data_description">__MSG__DESCRIPTION__</label>
            <textarea id="newaddcontent_selecteditems_edit_data_description" placeholder="__MSG__EDIT_DESCRIPTION__">${item["description"]|safeOutput}</textarea>
            <div class="autosuggest_wrapper">
    ...
    <div id="newaddcontent_selecteditems_edit_data_actions">
        <button type="button" class="oae-button oae-header-button newaddcontent_container_newitem_save_changes">__MSG__SAVE__</button>
    </div>
--></div>
...
<div id="newaddcontent_selecteditems_edit_permissions_template" style="display:none;"><!--
    ...
    <div id="newaddcontent_selecteditems_edit_data_fields">
        ...
        <form class="newaddcontent_form">
            ...
            <label for="newaddcontent_selecteditems_edit_permissions_copyright">__MSG__COPYRIGHT_COLON__</label>
            <select id="newaddcontent_selecteditems_edit_permissions_copyright">
            {for cr in copyright.types}
                <option value="${cr_index}" {if item["copyright"] === cr_index} selected="selected"{/if}>${sakai.api.i18n.getValueForKey(cr.title, "newaddcontent")}</option>
            {/for}
            </select>
        </form>
    </div>
    <div id="newaddcontent_selecteditems_edit_permissions_actions">
        <button type="button" id="" class="oae-button oae-header-button newaddcontent_container_newitem_save_changes">__MSG__SAVE__</button>
    </div>
--></div>
...
<div id="newaddcontent_selecteditems_template" style="display:none;"><!--
    {macro listContent(item)}
        <li id="newaddcontent_selecteditems_${item_index}">
            <a href="#" class="newaddcontent_selecteditems_remove" title="__MSG__REMOVE__ ${item["name"]}"></a>
            <div class="${item.css_class} newaddcontent_selecteditems_icon"></div>
            {if item.type !== "existing"}
                <span class="newaddcontent_selecteditems_title">${sakai.api.Util.applyThreeDots(item["name"], 100)}</span>
                <span class="newaddcontent_selecteditems_actions">
                    <button type="button" class="oae-link-button oae-bold newaddcontent_selecteditems_actions_edit">__MSG__EDIT_DETAILS__</button>
                    <span class="newaddcontent_selecteditems_split">|</span>
                    <button type="button" class="oae-link-button oae-bold newaddcontent_selecteditems_actions_permissions">__MSG__ADD_PERMISSIONS__</button>
                </span>
            {else}
                {if $.inArray(currentSelectedLibrary, item["sakai:pooled-content-viewer"]) !== -1 || $.inArray(currentSelectedLibrary, item["sakai:pooled-content-manager"]) !== -1}
                    <span class="newaddcontent_selecteditems_title newaddcontent_selecteditems_title_gotit">${sakai.api.Util.applyThreeDots(item["name"], 100)} (__MSG__GOT_IT__)</span>
                ...
                {elseif item.canshare === 'false' && currentSelectedLibrary !== me.userid}
                    <span class="newaddcontent_selecteditems_title newaddcontent_selecteditems_title_gotit">${sakai.api.Util.applyThreeDots(item["name"], 100)} (__MSG__SHARING_DISABLED__)</span>
                {else}
                    <span class="newaddcontent_selecteditems_title">${sakai.api.Util.applyThreeDots(item["name"], 100)}</span>
                {/if}
            {/if}
...
<!-- JAVASCRIPT -->
<script type="application/javascript" src="/node_modules/oae-core/newaddcontent/javascript/newaddcontent.js"></script>