        ...
        <div id="newaddcontent_container_newitem_fields">
            ...
            <div id="newaddcontent_add_document_template" class="newaddcontent_newitem_container" style="display:none;">
                ...
                <form id="newaddcontent_add_document_form" class="newaddcontent_form">
                    <div class="oae-form-field-wrapper">
                        ...
                        <input type="text" id="newaddcontent_add_document_title" name="newaddcontent_add_document_title" class="required"/>
            ...
            <div id="newaddcontent_add_link_template" class="newaddcontent_newitem_container" style="display:none;">
                <form id="newaddcontent_add_link_form" class="newaddcontent_form oae-form-field-wrapper">
                    ...
                    <input type="text" id="newaddcontent_add_link_url" name="newaddcontent_add_link_url" class="appendhttp url required"/>
