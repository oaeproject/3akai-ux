                ...
                if (currPage < widgetData.previews.pageCount && !inTimeOut){
                    ...
                    $.ajax({
                        ...
                        'success':function(data){
                            ...
                            var content = $('#page-' + currPage.toString()).annotator();
                            content.annotator('addPlugin', 'Store', {
                                ...
                                urls: {
                                    ...
                                    create:  'annotations/' + widgetData.latestRevisionId + '/' + currPage.toString(),
                                    read:    'annotations/' + widgetData.latestRevisionId + '/' + currPage.toString() + '/:id',
                                    update:  'annotations/' + widgetData.latestRevisionId + '/' + currPage.toString() + '/:id',
