...
define(['require', 'jquery', 'oae.core'], function(require, $, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        // Maximum text file size to render previews for
        var maxTextPreviewSize = 1048576; // 1MB
        ...
        var renderTextPreview = function() {
            $.ajax({
                ...
                'success': function(data) {
                    oae.api.util.template().render($('#filepreview-text-template', $rootel), {'content': data}, $('#filepreview-container', $rootel));
                }
            });
        };
        ...
        var initFilePreview = function() {
            ...
            } else if (widgetData.mime === 'text/plain' && widgetData.size <= maxTextPreviewSize)  {
                renderTextPreview();
            } else if (widgetData.mime === 'text/x-markdown' && widgetData.size <= maxTextPreviewSize) {
