...
define(['require', 'jquery', 'videojs', 'oae.core'], function(require, $, videojs, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        /**
         * Render a preview of a video file
         */
        var renderVideoPreview = function() {
            oae.api.util.template().render($('#filepreview-video-template', $rootel), {
                'content': widgetData,
                'isAudio': widgetData.mime.substring(0, 6).toLowerCase() === 'audio/'
            }, $('#filepreview-container', $rootel));
            videojs('filepreview-video-player', {'controls': true, 'autoplay': false, 'preload': 'auto', 'fluid': true, 'poster': widgetData.previews.mediumUrl});
        };
        ...
        var setUpFilePreview = function() {
            ...
            if (widgetData.mime.substring(0, 6).toLowerCase() === 'image/') {
                renderImagePreview();
            } else if (widgetData.previews.video) {
                renderVideoPreview();
