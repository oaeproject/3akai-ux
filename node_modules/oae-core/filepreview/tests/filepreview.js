...
casper.test.begin('Widget - File preview', function(test) {
     ...
     * @param  {String}    documentURL    The URL to a collaborative document
     */
    var verifyCollabDocPreview = function(user, documentURL) {
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        casper.waitFor(function() {
            ...
            var content1Profile = null;
            var content2Profile = null;
            var collabdocProfile = null;

            casper.then(function() {
                contentUtil().createFile(null, null, null, function(_content1Profile) {
                    content1Profile = _content1Profile;
                    contentUtil().createFile('tests/casperjs/data/sample-video.mp4', null, null, function(_content2Profile) {
                        content2Profile = _content2Profile;
                        collabDocUtil().createCollabDoc(null, null, function(_collabdocProfile) {
            ...
            casper.waitFor(function() {
                return content1Profile !== null && content2Profile !== null && collabdocProfile !== null;
            }, function() {
                // Verify image previews
                casper.then(function() {
                    casper.echo('# Verify image preview elements present', 'INFO');
                    casper.thenOpen(configUtil().tenantUI + content1Profile.profilePath);
                    casper.then(function() {
                        verifyFilePreview();
                    });
                });
                ...
                casper.then(function() {
                    ...
                    casper.thenOpen(configUtil().tenantUI + content2Profile.profilePath);
                    casper.then(function() {
                        verifyVideoPreview();
                    });
                });
                ...
                casper.then(function() {
                    ...
                    casper.thenOpen(configUtil().tenantUI + collabdocProfile.profilePath);
                    casper.then(function() {
                        verifyCollabDocPreview(user2, configUtil().tenantUI + collabdocProfile.profilePath);
                    });
                });
