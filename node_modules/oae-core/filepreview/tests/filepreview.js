...
casper.test.begin('Widget - File preview', function(test) {
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        casper.then(function() {
            casper.echo('# Verify image preview elements present', 'GREEN_BAR');
        ...
        casper.then(function() {
            casper.echo('# Verify video preview elements present', 'GREEN_BAR');
        ...
        casper.then(function() {
            casper.echo('# Verify collaborative document preview elements present', 'GREEN_BAR');
