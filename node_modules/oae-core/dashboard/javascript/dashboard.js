        ...
        var showDashboard = function() {
            ...
            if (isValid) {
                ...
                if (isEditable) {
                    ...
                    $('.oae-contentpage-title button.settings', $rootel).focus(hoverIn);
                    $('.oae-contentpage-title button.settings', $rootel).blur(hoverOut);
                  ...
                  $('#settings_hide', $rootel).off('click').click(function(ev) {
                      var el = $('#' + currentSettingsOpen.split('_')[1] + '_container', $rootel);
                      if (el.css('display') === 'none') {
                          el.parent().find('.oae-widget-titlebar').removeClass('hiddenwidget');
                          el.show();
                      } else {
                          el.parent().find('.oae-widget-titlebar').addClass('hiddenwidget');
                          el.hide();
                      }
                      saveState();
                      $('#widget_settings_menu', $rootel).hide();
                 ...
                 */
                  ...
                  $('.oae-widget-titlebar', $rootel).css('cursor', 'default');
                }
