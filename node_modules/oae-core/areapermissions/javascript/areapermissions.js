        ...
        var determineContentManager = function() {
         ...
         var addBinding = function() {
             $('#areapermissions_container').on('click', areapermissionsSelectable, function() {
                 $('#areapermissions_see_container .oae-outer-shadow-container').addClass('areapermissions_unselected_rbt');
                 $(areapermissionsSelectable).parent().removeClass('oae-outer-shadow-container');
