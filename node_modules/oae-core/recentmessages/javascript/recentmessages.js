            ...
            if (response === 'NOT_CONNECTED') {
                ...
                for(var item in response.results) {
                    if (response.results.hasOwnProperty(item)) {
                        response.results[item]['sakai:subject'] = sakai.api.Util.applyThreeDots(response.results[item]['sakai:subject'], $('.recentmessages_widget .oae-widget-content').width() - 130, {max_rows: 1,whole_word: false}, 'oae-bold');
