...
casper.test.begin('Widget - Create discussion', function(test) {
    ...
    var openCreateDiscussion = function() {
        ...
        casper.waitForSelector('#me-clip-container .oae-clip', function() {
            casper.waitForSelector(
                '.oae-clip-secondary .oae-clip-content > button',
                function() {
                    casper.click(
                        '.oae-clip-secondary .oae-clip-content > button',
                    );
                    test.assertExists(
                        '.oae-trigger-creatediscussion',
                        'create discussion trigger exists',
                    );
                    ...
                    casper.waitForSelector(
                        ...
                        function() {
                            test.assertVisible(
                                ...
                                'create discussion pane is showing after trigger',
                            );
                            casper.click(
                                '.oae-clip-secondary .oae-clip-content > button',
                            );
    ...
    var verifyCreatediscussion = function(user2Id) {
        ...
        test.assertExists(
            'form#creatediscussion-form',
            'The create discussion form is present',
        );
        test.assertExists(
            '#creatediscussion-name',
            'The discussion name field is present',
        );
        test.assertExists(
            '#creatediscussion-topic',
            'The discussion topic field is present',
        );
        // Fill the form
        casper.fill(
            'form#creatediscussion-form',
        ...
        test.assertExists(
            ...
            "The 'change permissions' button is present",
        );
        ...
        test.assertExists(
            '#creatediscussion-permissions-container #setpermissions-container input[type="radio"]',
            "The 'change permissions' radio button group is present",
        );
        test.assertExists(
            '#creatediscussion-permissions-container .as-selections input',
            "The 'share' input field is present",
        );
        // Select the public permission
        casper.click(
            '#creatediscussion-permissions-container #setpermissions-container input[type="radio"][value="public"]',
            "Select 'public' permissions for the discussion",
        );
        // Verify the update button is present
        test.assertExists(
            '#setpermissions-savepermissions',
            "The 'Update' button is present",
        );
        ...
        casper.waitForSelector('.as-list li', function() {
            ...
            casper.waitForSelector('#discussion-clip-container h1', function() {
                test.assertVisible(
                    ...
                    'Discussion profile is shown after creation of discussion',
                );
                test.assertSelectorHasText(
                    '#discussion-clip-container h1',
                    'Testing tools',
                    "Title matches 'Testing tools'",
                );
            });
        });
    };
    ...
    var verifyCreatediscussionValidation = function() {
        casper.waitForSelector('form#creatediscussion-form', function() {
            ...
            test.assertExists(
                '#creatediscussion-topic-error',
                'Successfully validated empty topic',
            );
            ...
            // Verify that an error label is shown
            test.assertExists(
                '#creatediscussion-name-error',
                'Successfully validated empty title',
            );
        });
    };
