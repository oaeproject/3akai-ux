...
casper.test.begin('Widget - Create discussion', function(test) {
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        casper.then(function() {
            casper.echo('# Verify open create discussion modal', 'GREEN_BAR');
            verifyOpenCreateDiscussion();
        });

        // Create a discussion
        casper.then(function() {
            casper.echo('# Verify create discussion', 'GREEN_BAR');
        ...
        casper.thenOpen(configUtil().tenantUI + '/me', function() {
            casper.echo('# Verify create discussion validation', 'GREEN_BAR');
