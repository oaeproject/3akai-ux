...
define(['jquery', 'oae.core'], function($, oae) {
    return function(uid) {
        ...
        var setUpReset = function() {
            $('#creatediscussion-modal', $rootel).on(
                'hidden.bs.modal',
                function() {
                    // Reset the form
        ...
        var setUpCreateDiscussion = function() {
            ...
            oae.api.util
                .validation()
                .validate($('#creatediscussion-form', $rootel), validateOpts);
        };
        ...
        var setUpSetPermissions = function() {
            ...
            var $setPermissionsContainer = $(
                '#creatediscussion-permissions-container',
                $rootel,
            );
            ...
            $(document).on(
                ...
                function(ev, data) {
                    ...
                    $('#creatediscussion-permissions', $rootel).html(
                        data.summary,
                    );
        ...
        var createDiscussion = function() {
            ...
            var displayName = $.trim(
                $('#creatediscussion-name', $rootel).val(),
            );
            var discussionTopic = $.trim(
                $('#creatediscussion-topic', $rootel).val(),
            );

            oae.api.discussion.createDiscussion(
                displayName,
                discussionTopic,
                visibility,
                [],
                ...
                function(err, data) {
                    ...
                    if (!err) {
                        ...
                        // Re-enable the form
                        $('#creatediscussion-form *', $rootel).prop(
                            'disabled',
                            true,
                        );
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__DISCUSSION_NOT_CREATED__',
                                'creatediscussion',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__DISCUSSION_COULD_NOT_BE_CREATED__',
                                'creatediscussion',
                            ),
                            'error',
                        );
        ...
        var setUpCreateDiscussionModal = function() {
            ...
            $(document).on('oae.context.send.creatediscussion', function(
                ev,
                ctx,
            ) {
                contextData = ctx;
