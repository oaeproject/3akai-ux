...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        var visibility = oae.api.config.getValue('oae-discussions', 'visibility', 'discussions');
        ...
        var setUpReset = function() {
            $('#creatediscussion-modal', $rootel).on('hidden', function (evt) {
                $('#creatediscussion-form')[0].reset();
                showOverview();
            });
        };
         ...
         * management (visibility + sharing) of the created discussion
         */
        var setUpSetPermissions = function() {
            ...
            $(document).on('oae.setpermissions.changed.' + setPermissionsId, function(ev, data) {
                ...
                $('#creatediscussion-permissions-summary', $rootel).html(data.summary);
        ...
        var createDiscussion = function() {
            ...
            console.log(oae.api.discussion.createDiscussion);
            console.log(displayName);

            oae.api.discussion.createDiscussion(displayName, '', visibility, [], viewers, function (err, data) {
        ...
        /**
         * Initializes the create discussion modal dialog
         */
        var setUpCreateDiscussionModal = function() {
            ...
            $('#creatediscussion-modal', $rootel).on('shown', function() {
            ...
            $('#creatediscussion-change-permissions', $rootel).on('click', showPermissions);
        };
