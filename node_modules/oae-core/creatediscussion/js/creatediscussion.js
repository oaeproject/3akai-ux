...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        var setUpReset = function() {
            $('#creatediscussion-modal', $rootel).on('hidden.bs.modal', function (evt) {
                // Reset the form
        ...
        var setUpSetPermissions = function() {
            ...
            $(document).on('oae.setpermissions.changed.' + setPermissionsId, function(ev, data) {
                ...
                $('#creatediscussion-permissions', $rootel).children(':not(#creatediscussion-change-permissions)').remove();

                // Set the new one
                $('#creatediscussion-permissions', $rootel).prepend(data.summary);
