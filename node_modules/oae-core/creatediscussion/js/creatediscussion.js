    ...
    return function (uid) {
        ...
        var setUpCreateDiscussionModal = function() {
            $(document).on('click', '.oae-trigger-creatediscussion', function() {
                ...
                // IE9 and 10 have issues with placeholder text that is on a hidden element. See https://github.com/oaeproject/3akai-ux/pull/2906 for details
                $('#creatediscussion-topic', $rootel).prop('placeholder', oae.api.i18n.translate('__MSG__WHAT_WOULD_YOU_LIKE_TO_DISCUSS__', 'creatediscussion'));
            });
