...
define(['jquery', 'oae/api/oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var renderImagePreview = function() {
            oae.api.util.renderTemplate($('#documentviewer_image_template', $rootel), widgetData, $('#documentviewer_preview', $rootel));
        };

        var renderLinkPreview = function() {
            oae.api.util.renderTemplate($('#documentviewer_html_template', $rootel), widgetData, $('#documentviewer_preview', $rootel));
        };
