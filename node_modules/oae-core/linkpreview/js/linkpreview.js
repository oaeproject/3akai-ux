    ...
    return function(uid, showSettings, widgetData) {
        ...
        var renderDefaultPreview = function() {
            ...
            // Embed the link as an iframe
                ...
                // Adjust overflow handling for mobile webkit. Only
                // works for mobile browsers, not viewport widths,
                // so this can't be done with media queries in style
                // sheets.
                if (oae.api.util.isHandheldDevice()) {
                    $('#linkpreview-container', $rootel).addClass('linkpreview-mobile');
                }
            }
        };
