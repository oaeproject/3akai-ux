...
define(['jquery', 'oae.core', 'underscore', 'jquery.oembed'], function($, oae, _) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var renderIframePreview = function() {
            ...
            // Only embed text, html, and types that the browser has plugins to support
            var supportedTypes = _.union(_.pluck(navigator.mimeTypes, 'type'), ['text/html', 'text/plain']);
            var supported = widgetData.previews.targetType && _.contains(supportedTypes, widgetData.previews.targetType.split(';')[0]);
