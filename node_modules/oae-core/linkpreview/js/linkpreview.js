...
define(['jquery', 'oae.core', 'jquery.oembed'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        /**
         * In case the current link doesn't match any of the oEmbed providers, we create a standard
         * iFrame and embed it.
         */
        var renderDefaultPreview = function() {
            if (widgetData.previews.embeddable) {
                oae.api.util.template().render($('#linkpreview-iframe-template', $rootel), {'link': widgetData.link}, $('#linkpreview-container'), $rootel);
            } else {
                oae.api.util.template().render($('#linkpreview-default-template', $rootel), {'link': widgetData}, $('#linkpreview-container'), $rootel);
            }
        };
