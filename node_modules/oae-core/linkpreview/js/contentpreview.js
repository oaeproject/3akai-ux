...
define(['jquery', 'oae.core', '../lib/document-viewer/assets/viewer.js'], function($, oae, DV) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var renderDefault = function() {
            oae.api.util.template().render($('#contentpreview-default-template', $rootel), {'content': widgetData}, $('#contentpreview-preview', $rootel));
        };
        ...
        var renderImagePreview = function() {
            oae.api.util.template().render($('#contentpreview-image-template', $rootel), {'content': widgetData}, $('#contentpreview-preview', $rootel));
        };
        ...
        var renderDocumentPreview = function() {
            // TODO
            oae.api.util.template().render($('#contentpreview-document-template', $rootel), null, $('#contentpreview-preview', $rootel));
            ...
            DV.load(doc, {
                'container': '#' + uid + ' #contentpreview-document',
                'width': '100%',
                'height': 700,
                'sidebar': false,
                'text': false
        ...
        var renderLinkPreview = function() {
            oae.api.util.template().render($('#contentpreview-html-template', $rootel), widgetData, $('#contentpreview-preview', $rootel));
        };
        ...
        var renderCollaborativeDocument = function() {
            oae.api.widget.insertWidget('etherpad', null, $('#contentpreview-preview', $rootel), null, widgetData);
        };
