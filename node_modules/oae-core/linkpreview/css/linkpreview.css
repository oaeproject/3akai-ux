...
#linkpreview-container #linkpreview-image-container,
...
/* For mobile browsers only (not media-query based view size), we add additional rules to allow scrolling */
#linkpreview-container.linkpreview-mobile #linkpreview-iframe-container {
    border: 1px solid #ccc;    /* wrapping div obscures box-shadow */
    overflow: auto;
}
