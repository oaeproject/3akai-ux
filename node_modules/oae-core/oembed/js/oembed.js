...
define(['jquery', 'oae.core', 'jquery.oembed'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var init = function() {
            ...
            oae.api.util.template().render('#oembed-template', {'link': widgetData.link}, $('#oembed-container'));

            // Embed the link
        	$('#oembed-template').oembed(widgetData.link, {
                includeHandle: false,
                ...
                afterEmbed: function() {
	                ...
	                $('iframe').load(function() {
	                    ...
	                    var width = parseInt($('iframe').attr('width')) || maxWidth;
	                    var height = parseInt($('iframe').attr('height')) || maxHeight;
