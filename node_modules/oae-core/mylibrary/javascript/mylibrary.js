...
require(['jquery', 'sakai/sakai.api.core'], function($, sakai) {
    ...
    sakai_global.mylibrary = function(tuid, showSettings, widgetData, state) {
        ...
        var $mylibrary_result_count = $('.oae-search-result-count', $rootel);
        var $mylibrary_show_grid = $('.oae-listview-grid', $rootel);
        var $mylibrary_show_list = $('.oae-listview-list', $rootel);
        ...
        var showLibraryContent = function() {
            ...
            mylibrary.infinityScroll = $mylibrary_items.infinitescroll(sakai.config.URL.POOLED_CONTENT_SPECIFIC_USER.replace('__USERID__', mylibrary.contextId),
                ...
                if (total && query && query !== '*') {
                    ...
                    $mylibrary_result_count.children('.oae-search-result-count-label').text(resultLabel);
                    $mylibrary_result_count.children('.oae-search-result-count-count').text(total);
                }
        ...
        var handleHashChange = function(e) {
            ...
            if (ls === 'list') {
                $('#mylibrary_items', $rootel).removeClass('oae-search-results-grid');
                $mylibrary_show_list.addClass('selected');
                $mylibrary_show_list.children().addClass('selected');
                mylibrary.listStyle = 'list';
            } else if (ls === 'grid') {
                $('#mylibrary_items', $rootel).addClass('oae-search-results-grid');
                $('.oae-listview-options', $rootel).find('div').removeClass('selected');
