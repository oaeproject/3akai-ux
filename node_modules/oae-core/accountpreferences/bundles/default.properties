...
PRIVACY_CHANGED_BODY = You have successfully updated your privacy settings
CHANGING_PRIVACY_FAILED = Privacy settings update failed
CHANGING_PRIVACY_FAILED_BODY = A problem occurred when trying to change your privacy settings. Please try again.
PREFERENCES_CHANGED = Preferences settings updated
PREFERENCES_CHANGED_BODY = You have successfully updated your preferences settings
CHANGING_PREFERENCES_FAILED = Preferences settings update failed
CHANGING_PREFERENCES_FAILED_BODY = A problem occurred when trying to change your preferences settings. Please try again.