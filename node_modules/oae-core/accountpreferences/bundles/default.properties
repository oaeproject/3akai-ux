...
NON_LOCAL_ACCOUNT_PASSWORD_CANNOT_BE_CHANGED_IN_OAE = A non-local account password cannot be updated here.
...
WRONG_CURRENT_PASSWORD_PROVIDED = Wrong current password provided.
