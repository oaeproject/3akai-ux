...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var accountPreferencesTab = '#accountpreferences_preferences_tab';
        var accountPrivacyTab = '#accountpreferences_privacy_tab';
        var accountPasswordTab = '#accountpreferences_password_tab';
        var currentTab = accountPreferencesTab;
        var currentContainer = preferencesContainer;

        var preferencesContainer = '#accountpreferences_preferences_container';
        var privacyContainer = '#accountpreferences_privacy_container';
        var passwordContainer = '#accountpreferences_password_container';

        var accountPreferencesPrivacyPublic = '#accountpreferences_privacy_public';
        var accountPreferencesPrivacyLoggedin = '#accountpreferences_privacy_loggedin';
        var accountPreferencesPrivacyPrivate = '#accountpreferences_privacy_private';

        var timezoneSelect = "select#time_zone";
        var languageSelect = "select#pass_language";

        // ERROR AND MESSAGES
        var accountpreferencesPasswordErrorMessageBlock = '#accountpreferences_password_error_message_block';
        var accountpreferencesPrivacyErrorMessageBlock = '#accountpreferences_privacy_error_message_block';
        var accountpreferencesPreferencesErrorMessageBlock = '#accountpreferences_preferences_error_message_block';

        var errorPassNotEqual = '#accountpreferences_error_passNotEqual';
        var errorIncorrectPass = '#accountpreferences_error_incorrectPass';
        var errorFailChangePass = '#accountpreferences_error_failChangePass';
        var errorFailChangePassBody = '#accountpreferences_error_failChangePassBody';
        var errorInvalidPass = '.accountpreferences_error_invalidPass';
        var errorPassSame = '#accountpreferences_error_passSame';
        var errorFailChangeEmail = '#accountpreferences_error_failChangeEmail';
        var errorFailChangeEmailBody = '#accountpreferences_error_failChangeEmailBody';
        var errorFailChangePrivacy = '#accountpreferences_error_failChangePrivacy';
        var errorFailChangePrivacyBody = '#accountpreferences_error_failChangePrivacyBody';
        var errorFailChangePreferences = '#accountpreferences_error_failChangePreferences';
        var errorFailChangePreferencesBody = '#accountpreferences_error_failChangePreferencesBody';
        
        var messagePassChanged = '#accountpreferences_message_passChanged';
        var messagePassChangedBody = '#accountpreferences_message_passChangedBody';
        var messageEmailChanged = '#accountpreferences_message_emailChanged';
        var messageEmailChangedBody = '#accountpreferences_message_emailChangedBody';
        var messagePrivacyChanged = '#accountpreferences_message_privacyChanged';
        var messagePrivacyChangedBody = '#accountpreferences_message_privacyChangedBody';
        var messagePreferencesChanged = '#accountpreferences_message_preferencesChanged';
        var messagePreferencesChangedBody = '#accountpreferences_message_preferencesChangedBody';

        var passwordForm = '#accountpreferences_password_change';
        ...
        // PASSWORD TAB
        var currentPassword = '#curr_pass';
        var newPassword = '#new_pass';
        var retypePassword = '#retype_pass';
        ...
        var hidePasswordError = function(){
            ...
            $(errorInvalidPass+'[item=current_password]').hide();
            $(errorInvalidPass+'[item=new_password]').hide();
            $(errorInvalidPass+'[item=retype_password]').hide();
        ...
        var checkSaveButtonEnableDisable = function(){
            ...
            {
                $('#accountpreferences_submit').prop("disabled", true);
                $('#accountpreferences_submit').addClass("disabled");
            }
            else
            {
                $('#accountpreferences_submit').prop("disabled", false);
                $('#accountpreferences_submit').removeClass("disabled");
            }
        };
        /**
        ...
        var addChangeSaveEventListeners = function(){
            ...
            $(retype_pass).bind('input',function(){
                passwordTabHasChanged = true;
                checkSaveButtonEnableDisable();
            });
        };
         ...
         */
        var getVisibility = function(){return currentUser.visibility;};
        /**
         ...
         */
        var getLocale = function(){return currentUser.locale;};
        /**
         * Function : setLocale 
         ...
         */
        var getTimezone = function(){return currentUser.timezone;};
        /**
        ...
        var saveUserSettings = function(){
            if(preferencesTabHasChanged)
            {
                if(!savePreferencesSettings(checkSaveButtonEnableDisable))
                    return false;    
            }
            if(privacyTabHasChanged)
            {
                if(!savePrivacySettings(checkSaveButtonEnableDisable))
                    return false;  
            }
            if(passwordTabHasChanged)
            {
                ...
                if($(passwordForm).valid())
                {
                    ...
                    if(!savePasswordSettings(checkSaveButtonEnableDisable))
                        return false;  
                }   
                else{
                    $(currentTab).parent('li').removeClass(tabActive);
        ...
        var savePrivacySettings = function(callback){
            ...
            oae.api.user.updateUser(data, function(success, data) {
                if (success === null) {
                    ...
                    privacyTabHasChanged = false;
                    console.log(privacyTabHasChanged);
        ...
        /**
         * Function : cancelChangedValues
         * Cancel all the values after clicking the cancel button
         * Only the values of the current tab will be canceled
         * Load all the saved values of the user for the current tab
         * Check if the save button must be disabled or enabled
         */
        var cancelChangedValues = function(){
            switch(currentTab){
                case accountPreferencesTab: 
                    preferencesTabHasChanged = false; 
                    setLocale();
                    setTimezone();
                    hidePreferencesErrorMessages();
                    break;
                case accountPrivacyTab: 
                    privacyTabHasChanged = false; 
                    setVisibility();
                    hidePrivacyErrorMessages();
                    break;
                case accountPasswordTab: 
                    passwordTabHasChanged = false; 
                    clearPasswordFields();
                    hidePasswordErrorMessages();
                    break; 
        ...
        var doInit = function() {
            ...
            $(preferencesContainer).show();
            loadUserSettings();
            $("#accountpreferences_container").hide();
            $('#accountpreferences_cancel').on('click',cancelChangedValues);
            $('#accountpreferences_submit').on('click',saveUserSettings);
            ...
            $('#btnAccount').on('click', function(){
                $("#accountpreferences_container").toggle();    
            });
            $('#closeAccountPreferences').on('click',function(){
                $("#accountpreferences_container").hide();
            });
            $(document).mouseup(function (e)
            {
                var container = $("#accountpreferences_container");
