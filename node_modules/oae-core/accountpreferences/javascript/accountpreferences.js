...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var hidePasswordError = function(){
            ...
            //$(errorInvalidPass+'[item=current-password]').hide();
            //$(errorInvalidPass+'[item=new-password]').hide();
            //$(errorInvalidPass+'[item=retype-password]').hide();
