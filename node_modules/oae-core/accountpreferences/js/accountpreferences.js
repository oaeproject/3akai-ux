...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
         ...
         *
         * @returns {Boolean}       Returns false to avoid native form submission
         */
        var changePassword = function() {
            ...
            oae.api.user.changePassword(oldPassword, newPassword, function(err) {
                if (err) {
        ...
        /**
         * Updates the profile preferences for timezone and locale
         *
         * @returns {Boolean}       Returns false to avoid native form submission
         */
        ...
        /**
         * Set up the validation on the account preferences form, including the error messages
         */
        setUpValidation = function() {
            // Validate the password form
            oae.api.util.validation().validate($('#accountpreferences-password-form', $rootel), {
                'rules': {
                ...
                'messages': {
                    'accountpreferences-new-password': {
                        ...
                        'minlength': oae.api.i18n.translate('__MSG__YOUR_PASSWORD_SHOULD_BE_AT_LEAST_SIX_CHARACTERS_LONG__', 'accountpreferences')
                    },
                    'accountpreferences-retype-password': {
                        'required': oae.api.i18n.translate('__MSG__PLEASE_REPEAT_YOUR_PASSWORD__', 'accountpreferences'),
                        'passwordmatch': oae.api.i18n.translate('__MSG__THIS_PASSWORD_DOES_NOT_MATCH_THE_FIRST_ONE__', 'accountpreferences')
                    }
                },
            ...
            oae.api.util.validation().validate($('#accountpreferences-preferences-form', $rootel), {
                'submitHandler': updatePreferences
            });
        };

        /**
         * Submits the currently visible form in the UI
         */
        var submitForm = function() {
            $('form:visible', $rootel).submit();
        };

        /**
         * Sets the default preferences for the user
         */
        ...
        var setUpAccountPreferencesModal = function() {
            ...
            $('#accountpreferences-save', $rootel).on('click', submitForm);
        };
