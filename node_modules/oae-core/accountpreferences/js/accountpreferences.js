...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var reset = function() {
            // Reset all the forms
            $.each($('form', $rootel), function(i, form) {
                // Reset the form
                $(form)[0].reset();
        ...
        /**
         * Shows the user's current timezone and locale in the preferences view by selecting
        ...
        /**
         * Render the language preferences. The i18n debug language is only shown to administrators.
         */
        var renderLanguage = function() {
            oae.api.util.template().render($('#accountpreferences-language-template', $rootel), oae.data.me, $('#accountpreferences-language', $rootel));
        };
