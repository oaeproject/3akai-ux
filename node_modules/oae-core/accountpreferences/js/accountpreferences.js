                ...
                if (err) {
                    if (err.code === 400) {
                        ...
                        oae.api.util.notification(
                            ...
                            oae.api.i18n.translate('__MSG__NON_LOCAL_ACCOUNT_PASSWORD_CANNOT_BE_CHANGED_IN_OAE__', 'accountpreferences'),
                            'error'
                        );
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate('__MSG__PASSWORD_NOT_UPDATED__', 'accountpreferences'),
                            oae.api.i18n.translate('__MSG__WRONG_CURRENT_PASSWORD_PROVIDED__', 'accountpreferences'),
                            'error'
                        );
                    } else {
