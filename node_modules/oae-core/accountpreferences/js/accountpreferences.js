...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
         ...
         * the correct choice from the dropdown.
         */
        ...
        /**
         * Render the list of available languages. The i18n debug language will only be shown to administrators.
         */
        var setUpAvailableLanguages = function() {
