<!-- CSS -->
<link rel="stylesheet" type="text/css" href="/node_modules/oae-core/accountpreferences/css/accountpreferences.css" />

<!-- CONTAINER -->
<div style="display:none" id="accountpreferences_container" class="oae-dialog oae-dialog-container">
    <div class="oae-dialog-close jqmClose"></div>
    <div class="accountpreferences_header">
        <h1 id="accountpreferences_title" class="oae-dialog-header">__MSG__WIDGET_TITLE__</h1>
    ...
    <div class="oae-container-flex">
        <div class="oae-fix oae-centered accountpreferences">
            <!-- CONTENT -->
            <div class="email" id="accountpreferences_changeEmailContainer" style="display:none;" role="tabpanel">
                <form id="accountpreferences_email_change" class="preferences-form">
                    <h2>__MSG__EMAIL_COLON__</h2>
                    <div class="accountpreferences_section_wrap_email accountpreferences_section_border">
                        <div id="accountpreferences_section_email">
                            <div class="form-item oae-form-field-wrapper">
                                <label for="accountpreferences_email">__MSG__EMAIL_COLON__</label>
            ...
            <div class="privacysettings" id="accountpreferences_changePrivacyContainer" style="display:none;" role="tabpanel">
                <form id="accountpreferences_privacy_change" class="preferences-form">
                    <h2>__MSG__PRIVACY_SETTINGS_COLON__</h2>
                    <div class="accountpreferences_section_privacy accountpreferences_section_border">
                        ...
                        <div class="accountpreferences_privacy_selection_container">
                            <div class="accountpreferences_unselected_rbt accountpreferences_selectable">
                                ...
                                <label class="oae-bold" for="accountpreferences_privacy_public"><span class="label_icon globe"></span>__MSG__VISIBLE_TO_ANYONE__</label>
                            </div>
                            <div class="accountpreferences_unselected_rbt accountpreferences_selectable">
                                <input type="radio" value="everyone" id="accountpreferences_privacy_everyone" name="accountpreferences_privacy_radio">
                                <label class="oae-bold" for="accountpreferences_privacy_everyone"><span class="label_icon small_institution"></span>__MSG__VISIBLE_TO_LOGGED__</label>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="regional" id="accountpreferences_preferContainer" role="tabpanel">
                <form id="accountpreferences_preferences_form" class="preferences-form" method="POST" action="#">
                    <div class="accountpreferences_section_wrap" id="accountpreferences_langloc_settings" style="display:none">
                        <h2>__MSG__ACCOUNT_PREFERENCES_COLON__</h2>
                    ...
                    <div class="accountpreferences_section_wrap">
                        ...
                        <div class="accountpreferences_section accountpreferences_section_border" id="accountpreferences_section_autotagging">
                            <div>
                                ...
                                <div id="accountpreferences_section_autotagging_buttons" class="oae-button oae-header-button">
            ...
            <div class="save-preferences">
                <button type="button" class="oae-link-button oae-bold accountpreferences_cancel">__MSG__CANCEL__</button>
                <button type="submit" id="accountpreferences_submit" class="oae-button oae-overlay-action-button">__MSG__SAVE_CHANGES__</button>
            </div>
        </div>
    </div>
</div>
...
<!-- JAVASCRIPT -->
<script type="text/javascript" src="/node_modules/oae-core/accountpreferences/js/accountpreferences.js"></script>
