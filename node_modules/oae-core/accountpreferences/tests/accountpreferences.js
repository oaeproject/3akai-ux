casper.test.comment('Account Preferences');
...
var verifyOpenAccountPreferences = function() {
    ...
    casper.test.assertExists('.oae-trigger-accountpreferences', 'Account preferences trigger exists');
    casper.click('.oae-trigger-accountpreferences');
    casper.wait(1000, function() {
        casper.test.assertVisible('#accountpreferences-modal', 'Account preferences pane is showing after trigger');
        casper.click('#me-clip-container .oae-clip-content > button');
    });
};
...
var verifyChangeTimezoneAndLanguage = function() {
    ...
    casper.test.assertExists('form#accountpreferences-preferences', 'The preferences form is present');
    // Fill in the form
    ...
    casper.test.assertExists('form#accountpreferences-preferences button[type="submit"]', 'Preferences form has a submit button');
    // Submit the form
    ...
    casper.waitForSelector('#oae-notification-container .alert', function() {
        casper.test.assertDoesntExist('#oae-notification-container .alert.alert-error', 'Preferences form successfully submitted and stored');
    ...
    // Verify the changes
    casper.test.assertField('accountpreferences-timezone', 'Pacific/Guam', 'Timezone is the one expected');
    casper.test.assertField('accountpreferences-language', 'fr_FR', 'Language is the one expected');
};
...
var verifyChangePassword = function() {
    ...
    // Check if form exists
    casper.test.assertExists('form#accountpreferences-password', 'The password form is present');
    // Fill in the form
    ...
    // Check if submit button exists
    casper.test.assertExists('form#accountpreferences-password button[type="submit"]', 'Password form has a submit button');
    // Submit the form
    casper.click('form#accountpreferences-password button[type="submit"]', 'Submit the form');
    // Wait for a notification to show and verify it is not an error
    casper.waitForSelector('#oae-notification-container .alert', function() {
        casper.test.assertDoesntExist('#oae-notification-container .alert.alert-error', 'Password form successfully submitted and stored');
    });
};
...
var verifyFormValidation = function() {
    ...
    casper.waitForSelector('#oae-notification-container .alert', function() {
        casper.test.assertExists('#oae-notification-container .alert.alert-error', 'Password form successfully validated empty form');
    });
    ...
    // Wait for a notification to show and verify it is an error
    casper.waitForSelector('#oae-notification-container .alert', function() {
        casper.test.assertExists('#oae-notification-container .alert.alert-error', 'Password form successfully validated incorrect current password');
    });
    ...
    // Wait for a notification to show and verify it is an error
    casper.waitForSelector('#oae-notification-container .alert', function() {
        casper.test.assertExists('#oae-notification-container .alert.alert-error', 'Password form successfully validated non-matching retyped password');
    });
};
...
casper.start('http://cam.oae.com/', function() {
    ...
    // Open the accountpreferences dialog
    casper.then(function() {
        casper.echo('Verify open account preferences dialog', 'INFO');
