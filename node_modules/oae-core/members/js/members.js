...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var getMembers = function() {
            ...
            $('#members-search-query', $rootel).val(query);
            ...
            if (query) {
                url = '/api/search/members/'  + widgetData.context.id;
            }
        ...
        var search = function(ev) {
            var query = $('#members-search-query', $(this)).val();
            ...
            // Most browsers will display `/group/.../members`, IE9 will be display `/group/...#members` however.
            // The cleanUrl in the History.js state will always be `/group/.../members`.
