...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        /**
         * Set up the list options header for the members list. This list never has any actions available.
         */
        var setUpListOptionsHeader = function() {
            oae.api.util.template().render($('#members-list-options-template', $rootel), null, $('#members-list-options', $rootel));
        };
