casper.test.begin('Widget - Members', function(test) {
    ...
    var verifyMembersSearch = function(user) {
        ...
        casper.waitForSelector('.oae-list .alert-info', function() {
            test.assertExists('.oae-list .alert-info', 'No results are returned for \'adfasdf\' and a message is shown');
    ...
    var verifyMembersElements = function() {
        ...
        test.assertExists('#members-widget .oae-list-options', 'The list options are present');
        // Verify list options contain a switch view button
        test.assertExists('#members-widget .oae-list-options button[data-type="oae-list-compact"]', 'The \'Compact\' list view button is present');
        test.assertExists('#members-widget .oae-list-options button[data-type="oae-list-details"]', 'The \'Details\' list view button is present');
        test.assertExists('#members-widget .oae-list-options button[data-type="oae-list-grid"]', 'The \'Grid\' list view button is present');
        // Verify list options contain a search field
        test.assertExists('#members-widget .oae-list-options #members-search-query', 'The search box is present');
    };
