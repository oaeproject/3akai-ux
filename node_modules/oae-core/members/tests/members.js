...
casper.test.begin('Widget - Members', function(test) {
    ...
    var verifyMembersElements = function() {
        ...
        test.assertExists('#members-widget .oae-list li:first-child .oae-trigger-manageaccess-add', 'The first list item has a \'Add members\' trigger');
        // Verify add members button triggers manageaccess widget
        casper.click('#members-widget .oae-list li:first-child .oae-trigger-manageaccess-add');
        ...
        // Verify dummy list item has add members button
        test.assertExists('#members-widget .oae-list li:first-child .oae-trigger-manageaccess', 'The first list item has a \'Manage access\' trigger');
        // Verify add members button triggers manageaccess widget
        casper.click('#members-widget .oae-list li:first-child .oae-trigger-manageaccess');
        casper.waitForSelector('#manageaccess-modal', function() {
