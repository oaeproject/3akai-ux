...
casper.test.begin('Widget - Members', function(test) {
        ...
        casper.waitForSelector('.oae-list .alert-info', function() {
            ...
            casper.waitForSelector('.oae-list li', function() {
                ...
                test.assertSelectorHasText(
                    ...
                    user.displayName,
                    "The returned user has the name '" + user.displayName + "'",
                );
                // Reset the form
                casper.fill(
                    'form.form-search',
    ...
    var verifyMembersViewMode = function() {
        ...
        // Verify compact list
        casper.click(
            '#members-widget .oae-list-header-actions button[data-type="oae-list-compact"]',
        );
        test.assertExists(
            '.oae-list.oae-list-compact',
            'Members can be switched to compact view',
        );
        // Verify details list
        casper.click(
            '#members-widget .oae-list-header-actions button[data-type="oae-list-details"]',
        );
        test.assertExists(
            '.oae-list.oae-list-details',
            'Members can be switched to details view',
        );
        // Switch back to grid view
        casper.click(
            '#members-widget .oae-list-header-actions button[data-type="oae-list-grid"]',
        );
        test.assertExists(
            '.oae-list.oae-list-grid',
            'Members can be switched to grid view',
        );
    };
    ...
    var verifyMembersElements = function() {
        ...
        test.assertExists(
            '#members-widget .oae-list li:first-child',
            'Initial dummy list item is present',
        );
        // Verify dummy list item has add members button
        test.assertExists(
            '#members-widget .oae-list li:first-child .group-trigger-manageaccess-add',
            "The first list item has a 'Add members' trigger",
        );
        ...
        casper.waitForSelector('#manageaccess-modal', function() {
            test.assertExists(
                '#manageaccess-modal #manageaccess-modal-title',
                'The manageaccess widget can be triggered to add members',
            );
            casper.click('#manageaccess-modal .close');
        });
        // Verify dummy list item has add members button
        test.assertExists(
            '#members-widget .oae-list li:first-child .group-trigger-manageaccess',
            "The first list item has a 'Manage access' trigger",
        );
        // Verify add members button triggers manageaccess widget
        casper.click(
            '#members-widget .oae-list li:first-child .group-trigger-manageaccess',
        ...
        casper.waitForSelector('#manageaccess-modal', function() {
            test.assertExists(
                '#manageaccess-modal #manageaccess-modal-title',
                'The manageaccess widget can be triggered to manage access',
            );
            casper.click('#manageaccess-modal .close');
        });
        // Verify list options are there
        test.assertExists(
            '#members-widget .oae-list-header-actions',
        ...
        test.assertExists(
            '#members-widget .oae-list-header-search .oae-list-header-search-query',
