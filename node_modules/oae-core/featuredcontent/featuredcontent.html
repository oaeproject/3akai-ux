<!-- CSS -->
<link rel="stylesheet" type="text/css" href="/node_modules/oae-core/featuredcontent/css/featuredcontent.css" />
...
<div id="featuredcontent_main_template"><!--
    ...
    {macro actionbuttons(item, sakai)}
        <div class="featuredcontent_content_actions s3d-draggable-hidden">
            <button{if sakai.data.me.anon} style="visibility:hidden;"{/if} class="s3d-link-button s3d-action-icon s3d-actions-addtolibrary featuredcontent_content_actions_addtolibrary savecontent_trigger" data-entityid="${item["_path"]}" title="__MSG__ADD_TO__">
    ...
    {else}
        <div class="s3d-no-results-container">
            ...
            <div class="s3d-no-results-icon s3d-no-results-content"></div><p>__MSG__NO_RESULTS_DESCRIPTION_FEATUREDCONTENT__ {if !sakai.data.me.anon} <a href="/create" class="s3d-regular-links">__MSG__ADD_REAL_CONTENT__</a>{/if}</p>
        </div>
    {/if}
...
<div id="featuredcontent_category_other_template"><!--
    <div class="s3d-widget-container">
        ...
        {forelse}
            <div class="s3d-no-results-container">
                <div class="s3d-no-results-arrow-up"></div>
                <div class="s3d-no-results-icon s3d-no-results-content"></div><p>__MSG__NO_RESULTS_DESCRIPTION_FEATUREDCONTENT__ {if !sakai.data.me.anon} <button class="s3d-link-button sakai_add_content_overlay">__MSG__ADD_REAL_CONTENT__</button>{/if}</p>
            </div>
        {/for}
        </ul>
...
<!-- JAVASCRIPT -->
<script type="text/javascript" src="/node_modules/oae-core/featuredcontent/javascript/featuredcontent.js"></script>