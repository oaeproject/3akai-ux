...
casper.test.begin('Widget - Preferences', function(test) {
    ...
    var openPreferences = function() {
        casper.waitForSelector(
            ...
            function() {
                ...
                test.assertExists(
                    '.oae-trigger-preferences',
                    'Preferences trigger exists',
                );
                ...
                casper.waitUntilVisible('#preferences-modal', function() {
                    ...
                    test.assertVisible(
                        '#preferences-account',
                        'Preferences pane is showing after trigger',
                    );
                    casper.click(
                        '#me-clip-container .oae-clip-content > button',
                    );
    ...
    var verifyChangeEmailAndLanguage = function() {
        ...
        test.assertExists(
            'form#preferences-account',
            'The account form is present',
        );
        // Fill in the form
        casper.fill(
            'form#preferences-account',
        ...
        test.assertExists(
            'form#preferences-account button[type="submit"]',
            'Account form has a submit button',
        );
        // Submit the form
        ...
        casper.waitForSelector(
            ...
            function() {
                test.assertDoesntExist(
                    ...
                    'Account form successfully submitted and stored',
                );
        ...
        test.assertField(
            ...
            'fr_FR',
            'Language is the one expected',
        );
        test.assertEval(function() {
            return $(
                'input[name="preferences-email-group"][value="weekly"]',
            ).is(':checked');
    ...
    var verifyChangePassword = function(user) {
        ...
        casper.click(
            'a[href="#preferences-password"]',
            'Switch to password tab',
        );
        // Check if form exists
        test.assertExists(
            'form#preferences-password',
        ...
        // Check if submit button exists
        test.assertExists(
            'form#preferences-password button[type="submit"]',
            'Password form has a submit button',
        );
        // Submit the form
        casper.click(
            'form#preferences-password button[type="submit"]',
        ...
        casper.waitForSelector(
            ...
            function() {
                test.assertDoesntExist(
                    '#oae-notification-container .alert.alert-error',
                    'Password form successfully submitted and stored',
                );
                casper.click('#oae-notification-container .close');
    ...
    var verifyFormValidation = function() {
        ...
        casper.waitForSelector(
            ...
            function() {
                test.assertExists(
                    '#oae-notification-container .alert.alert-error',
                    'Password form successfully validated empty form',
                );
            },
        );
        ...
        casper.waitForSelector(
            ...
            function() {
                test.assertExists(
                    '#oae-notification-container .alert.alert-error',
                    'Password form successfully validated incorrect current password',
                );
            },
        );
        ...
        casper.waitForSelector(
            ...
            function() {
                test.assertExists(
                    '#oae-notification-container .alert.alert-error',
                    'Password form successfully validated non-matching retyped password',
                );
            },
        );
    };
    ...
    casper.start(configUtil.tenantUI, function() {
        ...
        userUtil.createUsers(1, function(user1) {
            ...
            casper.then(function() {
                casper.waitForSelector(
                    '#me-clip-container .oae-trigger-preferences',
                    function() {
                ...
                casper.waitForSelector(
                    ...
                    function() {
                        ...
                        casper.thenEvaluate(function() {
                            require('oae.core').data.me.authenticationStrategy =
                                'cas';
                        });
                        casper.then(openPreferences);
                        casper.then(function() {
                            ...
                            test.assertNotVisible(
                                '#preferences-tab-password',
                                'The password tab is hidden',
                            );
                        });
                    },
                );
