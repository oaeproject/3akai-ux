...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var reset = function() {
            ...
            // Reset the widget to the main view
            $('#preferences-main-container', $rootel).show();
            $('#preferences-modal-title').text(oae.api.i18n.translate('__MSG__MY_PREFERENCES__', 'preferences'));

            // Show the first tab
            $('#preferences-tab-container ul li:first-child a').click();
        };
            ...
            oae.api.authentication.changePassword(oldPassword, newPassword, function(err) {
                if (err) {
                    if (err.code === 400) {
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate('__MSG__PASSWORD_NOT_UPDATED__'),
                            oae.api.i18n.translate('__MSG__PASSWORD_UPDATE_FAILED__', 'preferences'),
                            'error'
                        );
                    }
                } else {
                    ...
                    oae.api.util.notification(
                        ...
                        oae.api.i18n.translate('__MSG__PASSWORD_SUCCESSFULLY_UPDATED__', 'preferences')
                    );
                }
            });
            ...
            oae.api.user.updateUser(profile, function(err) {
                if (err) {
                    ...
                    oae.api.util.notification(
                        ...
                        oae.api.i18n.translate('__MSG__PREFERENCES_UPDATE_FAILED__', 'preferences'),
                        'error'
                    );
                } else {
                    // Hide the modal after saving
                    ...
                    oae.api.util.notification(
                        ...
                        oae.api.i18n.translate('__MSG__PREFERENCES_SUCCESSFULLY_UPDATED__', 'preferences')
                    );
        ...
        /**
         * Set up validation for every preferences form. This will validate and submit the forms or
        ...
        setUpValidation = function() {
            ...
            oae.api.util.validation().validate($('#preferences-account', $rootel), {
        ...
        var setUpPreferences = function() {
            ...
            oae.api.util.template().render($('#preferences-emailpreferences-template', $rootel), null, $('#preferences-emailpreferences-container', $rootel));
        };

        /**
         * Sets up the preferences modal
         */
