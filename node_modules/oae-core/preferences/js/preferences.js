...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        /**
         * Render the list of available languages, the email preferences and select the
         * user's current locale in the dropdowns. The i18n debug language will only be
