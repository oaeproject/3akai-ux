    ...
    sakai_global.popularcontent = function(tuid, showSettings) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.results.length; i++) {
                        ...
                        item['name'] = sakai.api.Util.applyThreeDots(data.results[i]['sakai:pooled-content-file-name'], $('.popularcontent_widget').width() - 80, {max_rows: 1,whole_word: false}, 'oae-bold');
                        content.push(item);
                    }
        ...
        var doInit = function() {
            if (! sakai.api.Widgets.isOnDashboard(tuid)) {
                ...
                $('#popularcontent_widget').addClass('oae-widget oae-widget');
            }
