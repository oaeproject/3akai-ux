...
<div class="recentmemberships_widget">
       ...
       <div class="recentmemberships_add_container">
           <div id="recentmemberships_no_results_container" style="display:none;">
                <div class="s3d-no-results-container">
                    ...
                    <p>__MSG__NO_RESULTS_DESCRIPTION_RECENTMEMBERSHIPS__ <a class="s3d-regular-links" href="/create#l=group" class="s3d-regular-links">__MSG__CREATE_ONE__</a></p>
                </div>
            </div>
       </div>
            ...
            <div id="recentmemberships_item_template"><!--
                <div class="recentmemberships_item_img fl-force-left">
                    <a href="/~${groups[0].id}" title="${groups[0].displayLinkTitle}">
                        <img class="s3d-icon-50" src="${sakai.api.Groups.getProfilePicture(groups[0])}" alt="__MSG__PROFILE_PICTURE_FOR__ ${groups[0]["name"]}"/>
                    </a>
                </div>
                <div class="recentmemberships_item_info">
                    <p class="recentmemberships_item_title">
                        <a class="recentmemberships_item_link s3d-widget-links s3d-bold" href="/~${groups[0].id}">
                            ${groups[0]["name"]}
                        </a>
                    </p>
    ...
    <div id="recentmemberships_item_member_template"><!--
        {if member}
            <div class="recentmemberships_item_related_info">
                <p class="recentmemberships_item_meta_data">__MSG__RECENTLY_CONNECTED_TO__ <span class="s3d-bold">${group["sakai:group-title"]}</span></p>
    ...
    <div id="recentmemberships_latest_content_template"><!--
        {if content}
            <div class="recentmemberships_item_related_info s3d-draggable-container" data-canshare="${content.canShare}" data-scope="content" data-entityid="${content["_path"]}" {if sakai.api.Content.Collections.isCollection(content)} data-collection="true" {/if}>
                <p class="recentmemberships_item_meta_data">__MSG__LATEST_CONTENT_TO__ <span class="s3d-bold">${group["sakai:group-title"]}</span></p>
                <div class="fl-force-left">
