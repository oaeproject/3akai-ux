...
casper.test.begin('Widget - Tenant Landing Page', function(test) {
    ...
    var verifyLandingPage = function() {
        ...
        test.assertExists(
            '.tenantlandingpage-widget > .visible-xs',
            'Extra small landing page is present',
        );
        test.assertExists(
            '.tenantlandingpage-widget > .visible-sm',
            'Small landing page is present',
        );
        test.assertExists(
            '.tenantlandingpage-widget > .visible-md',
            'Medium landing page is present',
        );
        test.assertExists(
            '.tenantlandingpage-widget > .visible-lg',
            'Large landing page is present',
        );
    };
