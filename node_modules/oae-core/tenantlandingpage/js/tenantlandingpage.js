...
require(['jquery','oae.core'], function($, oae) {
    ...
    var renderLandingPage = function() {
        $.ajax({
            ...
            'success': function(blocks) {
                ...
                oae.api.util.template().render($('#tenantlandingpage-template'), {'blocks': blocks}, $('#tenantlandingpage'));
                ...
                $.each(blocks, function(blockIndex, block) {
                    if (block.titleColor) {
                        $('.tenantlandingpage-block-' + blockIndex).find(':header').css('color', block.titleColor);
                    }
                });
    ...
    var setUpSearch = function() {
        $(document).on('submit', '.tenantlandingpage-search-form', function() {
    ...
    var setUpVideo = function() {
        ...
        $('.tenantlandingpage-video-launch').on('click', function() {
            ...
            // Render the video
            oae.api.util.template().render($('#tenantlandingpage-video-template'), {'videoURL': url}, $videoContainer);
        });
    };
    ...
    var repositionPlayVideo = function() {
        ...
        var $videos = $('.tenantlandingpage-block-video');
        if ($videos.length) {
            var visible = false;
