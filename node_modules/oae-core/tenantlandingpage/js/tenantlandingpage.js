    ...
    return function(uid, showSettings, widgetData) {
        ...
        var renderLandingPage = function() {
            $.ajax({
                ...
                success: function(blocks) {
                    ...
                    // tenant
                    var encodedDisplayName = oae.api.util
                        .security()
                        .encodeForHTML(oae.data.me.tenant.displayName);
                    ...
                    oae.api.util
                        .template()
                        .render(
                            $('#tenantlandingpage-template', $rootel),
                            { blocks: blocks },
                            $('.tenantlandingpage-widget', $rootel),
                        );
                    ...
                    $.each(blocks, function(blockIndex, block) {
                        if (block.titleColor) {
                            $('.tenantlandingpage-block-' + blockIndex, $rootel)
                                .find(':header')
                                .css('color', block.titleColor);
                        }
                    });
        ...
        var setUpSearch = function() {
            $rootel.on('submit', '.tenantlandingpage-search-form', function() {
                var query = $.trim(
                    $('.tenantlandingpage-search-query', $(this)).val(),
                );
                ...
                window.location =
                    '/search/' + oae.api.util.security().encodeForURL(query);
                return false;
            });
        };
        ...
        var setUpVideo = function() {
            ...
            $('.tenantlandingpage-video-launch', $rootel).on(
                'click',
                function() {
                    ...
                    oae.api.util
                        .template()
                        .render(
                            $('#tenantlandingpage-video-template', $rootel),
                            { videoURL: url },
                            $videoContainer,
                        );
                },
        ...
        var repositionPlayVideo = function() {
            ...
            $('.tenantlandingpage-block-video', $rootel).each(function(
                videoIndex,
                video,
            ) {
                var $video = $(video);
