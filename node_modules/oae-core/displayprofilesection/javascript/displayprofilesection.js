...
define(['jquery', 'underscore', 'oae/api/oae.core'], function($, _, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var handleSave = function(err) {
            if (!err) {
                oae.api.util.showNotification('', $profile_message_form_successful.text() , 'info');
            } else {
                sakai.api.Util.notification.show('', $profile_error_form_error_server.text() , 'error');
        ...
        var saveValues = function(overwrite) {
            ...
            // TODO: Trigger event so that names already in the DOM get updated.
        ...
        var addEmptySection = function( sectionConfig, template ) {
            ...
            var sectionHTML = oae.api.util.renderTemplate( template, {
        ...
        var renderEmptySection = function() {
            ...
            var sectionKey = 'THIS_PERSON_HASNT_ADDED_' + sectionName.toUpperCase();
            if ( oae.api.i18n.translate( sectionKey, 'displayprofilesection') !== sectionKey ) {
                messageKey = sectionKey;
            }
            var emptyHTML = oae.api.util.renderTemplate( $displayprofilesection_view_no_results_template, {
                'userId': userId,
        ...
        var renderMultiSection = function( template, sectionConfig, data ) {
            ...
            var multHTML = oae.api.util.renderTemplate( multiTemplate, {
                'sectionName': sectionName,
                'sectionConfig': sectionConfig
            });
        ...
        var renderSection = function(err, data ) {
            ...
            if (!err) {
                ...
                if ( sectionConfig ) {
                    ...
                    var headerHTML = oae.api.util.renderTemplate( $displayprofilesection_header_template, {
                        'pageTitle': pageTitle
                    });
                    ...
                    // Simple sections are fairly straightforward
                        ...
                        if (editing || data) {
                            ...
                            var bodyHTML = oae.api.util.renderTemplate( template, {
                                'sectionName': sectionName,
                                'sectionConfig': sectionConfig,
                                'data': data,
                                'unique': false,
        ...
        var init = function() {
            editing = userId && userId === oae.data.me.userId;
