...
ACCEPT_REQUEST_FAIL = The request could not be accepted.
ACCEPT_REQUEST_SUCCESS = Request accepted
...
REQUEST_HAS_BEEN_SUCCESSFULLY_ACCEPTED = The request has been successfully accepted.
REQUEST_HAS_BEEN_SUCCESSFULLY_REJECTED = The request has been successfully rejected.
REQUESTS_JOIN_GROUP = You have some requests to join group in pending
RESEND = Resend
