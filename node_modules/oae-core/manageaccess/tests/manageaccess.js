        ...
        casper.then(function() {
            contentUtil().createLink(null, null, null, function(link) {
                casper.thenOpen(configUtil().tenantUI + link.profilePath, function() {
                    casper.then(function() {
                        casper.echo('# Verify open manage access modal', 'GREEN_BAR');
                        verifyOpenManageAccessModal();
                    });

                    casper.then(function() {
                        casper.echo('# Verify manage access elements', 'GREEN_BAR');
                        verifyManageAccessElements();
                    });

                    casper.then(function() {
                        casper.echo('# Verify access can be edited', 'GREEN_BAR');
                        casper.wait(configUtil().searchWaitTime, function() {
                    ...
                    casper.then(function() {
                        casper.echo('# Verify at least one manager is present', 'GREEN_BAR');
