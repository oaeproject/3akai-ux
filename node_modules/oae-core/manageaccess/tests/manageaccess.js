...
casper.test.begin('Widget - Manage access', function(test) {
    ...
    var verifyOpenManageAccessModal = function() {
        casper.waitForSelector('#content-clip-container .oae-clip-content > button', function() {
            ...
            casper.waitForSelector('button.oae-trigger-manageaccess', function() {
                test.assertExists('button.oae-trigger-manageaccess', 'The manage access trigger is present');
                casper.click('button.oae-trigger-manageaccess');
