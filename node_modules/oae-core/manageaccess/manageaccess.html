            ...
            <form role="form">
                ...
                <div class="modal-body">
                    <div id="manageaccess-overview">
                        ...
                        <div id="manageaccess-overview-requests" class="hide">
                            <h4>
                                <button type="button" id="manageaccess-see-requests" class="btn btn-sm"><i class="fa fa-envelope"></i>  __MSG__SEE_REQUESTS_JOIN_GROUP__</button>
                                <span id="manageaccess-overview-shared-title">__MSG__REQUESTS_JOIN_GROUP__</span>
                            </h4>
                        </div>
                    </div>
                    <div id="manageaccess-visibility" class="hide"><!-- --></div>
                    <div id="manageaccess-share" class="hide"><!-- --></div>
                    <div id="manageaccess-requests" class="hide">
                        <h4>__MSG__PENDING_REQUESTS__</h4>
                        <div id="manageaccess-requests-well" class="well">
                            <ul id="manageaccess-requests-container" class="oae-list oae-list-compact manageaccess-requests-selected"><!-- --></ul>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <div id="manageaccess-requests-footer" class="hide">
                        <button type="button" class="manageaccess-cancel btn btn-link">__MSG__CANCEL__</button>
                    </div>
                </div>
            </form>
...
<div id="manageaccess-requests-selected-template"><!--
    {macro manageaccessListItemActions()}
        <div class="form-group">
            <label for="manageaccess-${member.id}-role" class="sr-only">__MSG__SELECT_ROLE_FOR_USER__</label>
            <select id="manageaccess-${member.id}-role" class="form-control" data-id="${member.id}">
        ...
        <button type="button" title="__MSG__REJECT_REQUEST__" class="btn btn-link oae-listitem-reject" data-id="${member.id}">
            <i class="fa fa-times"><span class="sr-only">__MSG__REJECT_REQUEST__</span></i>
        </button>
        <button type="button" title="__MSG__ACCEPT_REQUEST__" class="btn btn-link oae-listitem-accept" data-id="${member.id}">
            <i class="fa fa-check"><span class="sr-only">__MSG__ACCEPT_REQUEST__</span></i>
        </button>
    {/macro}
