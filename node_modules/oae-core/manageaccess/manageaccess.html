            ...
            <form role="form">
                ...
                <div class="modal-body">
                    <div id="manageaccess-overview">
                        ...
                        <h4>
                            <button type="button" id="manageaccess-share-add-more" class="btn btn-sm"><i class="icon-plus-sign"></i> __MSG__ADD_MORE__</button>
...
<div id="manageaccess-members-template"><!--
    {macro manageaccessListItemActions()}
        ...
        <button type="button" title="__MSG__REMOVE_MEMBER__" class="btn btn-link manageaccess-remove" data-id="${member.id}">
            <i class="icon-remove"><span class="sr-only">__MSG__REMOVE_MEMBER__</span></i>
        </button>
    {/macro}
