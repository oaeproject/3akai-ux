            ...
            <form role="form">
                ...
                <div class="modal-body">
                    <div id="manageaccess-overview">
                        ...
                        <div id="manageaccess-overview-requests" class="hide">
                            <h4>
                                <a id="manageaccess-see-requests" class="pointer"> <span id="manageaccess-see-requests-title">__MSG__REQUESTS_JOIN_GROUP__</span> </a>
                            </h4>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <div id="manageaccess-requests-footer" class="hide">
                        <button type="button" class="manageaccess-back btn btn-link">__MSG__BACK__</button>
                    </div>
                </div>
            </form>
        </div>
