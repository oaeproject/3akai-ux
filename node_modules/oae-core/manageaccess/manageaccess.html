...
<div id="manageaccess-members-template"><!--
    {macro manageaccessListItemActions()}
        <div class="form-group">
            <label for="manageaccess-${member.id}-role" class="oae-aural-text">__MSG__SELECT_ROLE_FOR_USER__</label>
        ...
        <button type="button" title="__MSG__REMOVE_MEMBER__" class="close" data-id="${member.id}">&#215;</button>
    {/macro}

    {for member in results}
        {var memberName = oae.api.util.security().encodeForHTMLAttribute(member.displayName)}
        ${listItem(member, false, false, null, manageaccessListItemActions)}
    {/for}
--></div>
