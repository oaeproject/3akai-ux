                ...
                <div class="modal-body">
                    <div id="manageaccess-overview">
                        ...
                        <div id="manageaccess-overview-shared" class="well">
                            <div class="manageaccess-overview-header">__MSG__ACTIVE_MEMBERS__</div>
                        ...
                        <div id="manageaccess-overview-invitations" class="well hide">
                            <div class="manageaccess-overview-header">__MSG__PENDING_INVITATIONS__</div>
...
<div id="manageaccess-overview-selected-template"><!--
    {macro manageaccessListItemActions()}
        {if member.resourceType === 'email' && member.beenInvited}
            <button type="button" title="Resend" class="btn manageaccess-invitation-resend" data-email="${member.id|encodeForHTMLAttribute}">Resend</button>
        {/if}
