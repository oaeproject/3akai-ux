            ...
            <form role="form">
                ...
                <div class="modal-body">
                    <div id="manageaccess-overview">
                        ...
                        <h4>
                            <button type="button" id="manageaccess-share-add-more" class="btn btn-sm pull-right"><i class="icon-plus-sign"></i> __MSG__ADD_MORE__</button>
    ...
    {for member in results}
        <li data-id="${member.profile.id}">
            <div class="oae-list-compact-item">
                <div class="clearfix oae-listitem oae-listitem-compact">
