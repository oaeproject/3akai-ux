            ...
            <form role="form">
                ...
                <div class="modal-body">
                    <div id="manageaccess-overview">
                        ...
                        <div id="manageaccess-overview-shared" class="well manageaccess-overview-expanded">
                            <a class="manageaccess-overview-header" title="__MSG__TOGGLE_ACTIVE_MEMBERS__" href="#">
                                <i class="fa"></i>__MSG__ACTIVE_MEMBERS__</h5>
                            </a>
                        ...
                        <div id="manageaccess-overview-invitations" class="well hide">
                            <a class="manageaccess-overview-header" title="__MSG__TOGGLE_PENDING_INVITATIONS__" href="#">
                                <i class="fa"></i>__MSG__PENDING_INVITATIONS__</h5>
                            </a>
