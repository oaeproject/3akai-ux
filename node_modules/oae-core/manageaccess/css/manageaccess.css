...
@media (max-width: 480px) {
    ...
    #manageaccess-modal #manageaccess-overview-selected > li .oae-listitem-actions {
        /* We need to give the actions full width available, but that will cause it to wrap
           beneath the thumbnail. Since we have a static height (77px), we can reliably pull
           it back up to the desired line and align it with the metadata */
        margin-top: -31px;
        width: 100%;
    }
