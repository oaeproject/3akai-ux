...
#manageaccess-modal #manageaccess-overview-shared > div.manageaccess-overview-header,
#manageaccess-modal #manageaccess-overview-invitations > div.manageaccess-overview-header {
    color: #333;
    display: block;
    font-size: 15px;
    font-weight: bold;
