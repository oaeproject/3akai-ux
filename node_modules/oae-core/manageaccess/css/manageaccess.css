...
#manageaccess-modal #manageaccess-overview-shared > a.manageaccess-overview-header,
#manageaccess-modal #manageaccess-overview-invitations > a.manageaccess-overview-header {
    color: #333;
    display: block;
    font-size: 15px;
    font-weight: bold;
...
#manageaccess-modal #manageaccess-overview-shared > a.manageaccess-overview-header i.fa,
#manageaccess-modal #manageaccess-overview-invitations > a.manageaccess-overview-header i.fa {
    margin-right: 10px;
    position: relative;
    top: 2px;
}

#manageaccess-modal #manageaccess-overview-shared > a.manageaccess-overview-header i.fa:before,
#manageaccess-modal #manageaccess-overview-invitations > a.manageaccess-overview-header i.fa:before {
    content: "\f0da";
}

#manageaccess-modal #manageaccess-overview-shared.manageaccess-overview-expanded > a.manageaccess-overview-header i.fa:before,
#manageaccess-modal #manageaccess-overview-invitations.manageaccess-overview-expanded > a.manageaccess-overview-header i.fa:before {
    content: "\f0d7";
}
...
#manageaccess-modal .well.manageaccess-overview-expanded .manageaccess-overview-selected {
    font-size: 16px;
    max-height: 240px;
    overflow: auto;
...
#manageaccess-modal #manageaccess-overview-selected-shared-container > li:only-child .oae-listitem-actions .manageaccess-remove {
    display: none;
}
