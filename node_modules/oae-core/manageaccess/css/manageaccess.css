...
@media (max-width: 479px) {
    ...
    #manageaccess-modal .manageaccess-overview-selected > li .oae-listitem .oae-listitem-metadata > h3 {
        position: absolute;
        top: -4px;
        width: 100%;
    }
...
@media (max-width: 550px) {
    .ie-lt10 #manageaccess-modal .manageaccess-overview-selected > li .oae-listitem-actions > .btn.manageaccess-invitation-resend {
        display: none;
    }

    /* .jeditable-field unfortunately has a width specification using !important, so we need to
       override it with our own !important here. We can allow more width because we wrap the actions
       to a new line */
    .ie-lt10 #manageaccess-modal .manageaccess-overview-selected > li .oae-listitem .oae-listitem-metadata > h3,
    .ie-lt10 #manageaccess-modal .manageaccess-overview-selected > li .oae-listitem .oae-listitem-metadata > h3 .jeditable-field,
    .ie-lt10 #manageaccess-modal .manageaccess-overview-selected > li .oae-listitem .oae-listitem-metadata > small {
