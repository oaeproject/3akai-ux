...
define(['jquery', 'oae.core', 'jquery.autosuggest'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var appendNewMembers = function(members) {
            ...
            oae.api.util.template().render($('#manageaccess-members-template', $rootel), groupData.members, $('.oae-list', $rootel));
        };
        ...
        var getMembers = function() {
            ...
            infinityScroll = $('.oae-list', $rootel).infiniteScroll(url, {
                ...
                'postProcessor': function(data) {
                    ...
                    groupData.members.results.push(data.results);
                    return data;
                }
            });
        };
                ...
                oae.api.group.updateGroup(groupData.id, {
                    ...
                    if (visibilityErr || membersErr) {
                        oae.api.util.notification(
                            oae.api.i18n.translate('__MSG__GROUP_PERMISSIONS_NOT_SAVED__'),
                            oae.api.i18n.translate('__MSG__GROUP_PERMISSIONS_COULD_NOT_BE_SAVED__'),
                            'error'
                        );
                    // Show a success notification and close the dialog when the members and visibility have been updated
                    } else {
                        oae.api.util.notification(
                            oae.api.i18n.translate('__MSG__GROUP_PERMISSIONS_SAVED__'),
                            oae.api.i18n.translate('__MSG__GROUP_PERMISSIONS_SUCCESSFULLY_SAVED__'),
                            'info'
                        );
                        $(window).trigger('done.manageaccess.oae');
