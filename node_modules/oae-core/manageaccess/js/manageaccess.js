...
define(['jquery', 'oae.core', 'jquery.autosuggest'], function($, oae) {
    ...
    return function(uid) {
            ...
            saveVisibility(function(visibilityErr) {
                ...
                saveMembers(function(membersErr) {
                    ...
                    if (visibilityErr || membersErr) {
                        oae.api.util.notification(widgetData.messages.accessnotupdated, widgetData.messages.accesscouldnotbeupdated, 'error');
                    // Show a success notification and close the dialog when the members and visibility have been updated
                    } else {
                        oae.api.util.notification(widgetData.messages.accessupdated, widgetData.messages.accesssuccessfullyupdated);
                        $(document).trigger('done.manageaccess.oae', widgetData.contextProfile);
        ...
        /**
         * Renders the add members view.
         * Includes an autosuggest to add new members.
         */
         ...
         * @param  {Object}  data.contextProfile  The context profile
         * @param  {Object}  data.messages        The translated messages to use inside of the widget
         * @param  {Object}  data.roles           The available roles for members
         */
        var initManageAccess = function(ev, data) {
            ...
            $('#manageaccess-overview-shared-title', $rootel).text(oae.api.i18n.translate(widgetData.messages.members, 'manageaccess'));
