...
define(['jquery', 'oae.core', 'jquery.jeditable'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var renderModules = function() {
            ...
            _.each(widgetData.configurationSchema, function(module, moduleName) {
            ...
            oae.api.util.template().render($('#admin-modules-template', $rootel), {
                'schema': schema,
            ...
            }, $('#admin-modules-container', $rootel));
        };
        ...
        var addBinding = function() {
            // Modules toggle
            $rootel.on('click', '.admin-module-configuration-toggle-button', toggleContainer);
            // Change config values
            $rootel.on('submit', '.admin-module-configuration-form', updateConfiguration);
