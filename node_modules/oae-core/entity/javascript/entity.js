...
require(['jquery', 'sakai/sakai.api.core'], function($, sakai) {
    ...
    sakai_global.entity = function(tuid, showSettings) {
        ...
        var entityUserDropdown = '#entity_user_image.oae-dropdown-menu';
        var entityGroupDropdown = '#entity_group_image.oae-dropdown-menu';
            ...
            switch(context.type) {
                case 'user_me':
                    ...
                    $(entityUserDropdown).hover(function() {
                        var $li = $(this);
                        var $subnav = $li.children('.oae-dropdown-container');
                        ...
                        var $li = $(this);
                        $li.children('.oae-dropdown-container').hide();
                    });
        ...
        var toggleDropdownList = function() {
            $(entityChangeImage).nextAll('.oae-dropdown-list').toggle();
            $(entityChangeImage).toggleClass('clicked');
            $(entityChangeImage).nextAll('.oae-dropdown-list').css('top', $('.entity_profile_picture_down_arrow').position().top + 62);
        };
        ...
        var setupCountAreaBindings = function() {
            ...
            $('.ew_permissions').off('click').on('click', function(e) {
                e.preventDefault();
                if ($(this).parents('.oae-dropdown-list').length || $(e.target).hasClass('oae-dropdown-list-arrow-up')) {
        ...
        $(window).on('sakai.entity.init', function(ev, context, type, data) {
            ...
            $('.entity_owns_actions_container .ew_permissions').on('hover', function() {
                var $dropdown = $(this).find('.oae-dropdown-list');
            ...
            sakai.api.Util.hideOnClickOut('.entity_user_avatar_menu.oae-dropdown-list,.entity_group_avatar_menu.oae-dropdown-list', entityChangeImage, toggleDropdownList);
