...
SHARE_WITH_MEMBERS_OF_FOLDER = All the members of <strong>${context2}</strong> will have rights on it.
VISIBILITY_CONTENT_INHERIT_PLURAL = It will inherit privacy of the folder.
VISIBILITY_CONTENT_INHERIT_SINGULAR = It will inherit privacy of the folder.
...
VISIBILITY_DISCUSSION_INHERIT_SINGULAR = It will inherit privacy of the folder.
