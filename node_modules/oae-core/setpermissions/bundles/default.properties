...
PERMISSIONS_LOODLE_CONTEXT1_CONTEXT2_PLURAL = These loodles will be added to <strong>${context1}</strong> and <strong>${context2}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_CONTEXT2_SHARE_1_PLURAL = These loodles will be added to <strong>${context1}</strong> and <strong>${context2}</strong> and shared with <strong>${share1}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_CONTEXT2_SHARE_1_SINGULAR = This loodle will be added to <strong>${context1}</strong> and <strong>${context2}</strong> and shared with <strong>${share1}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_CONTEXT2_SHARE_2_PLURAL = These loodles will be added to <strong>${context1}</strong> and <strong>${context2}</strong> and shared with <strong>${share1}</strong> and <strong>${share2}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_CONTEXT2_SHARE_2_SINGULAR = This loodle will be added to <strong>${context1}</strong> and <strong>${context2}</strong> and shared with <strong>${share1}</strong> and <strong>${share2}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_CONTEXT2_SHARE_3_PLURAL = These loodles will be added to <strong>${context1}</strong> and <strong>${context2}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong> and <strong>${share3}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_CONTEXT2_SHARE_3_SINGULAR = This loodle will be added to <strong>${context1}</strong> and <strong>${context2}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong> and <strong>${share3}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_CONTEXT2_SHARE_4_PLURAL = These loodles will be added to <strong>${context1}</strong> and <strong>${context2}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong>, <strong>${share3}</strong> and <strong>1 other</strong>.
PERMISSIONS_LOODLE_CONTEXT1_CONTEXT2_SHARE_4_SINGULAR = This loodle will be added to <strong>${context1}</strong> and <strong>${context2}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong>, <strong>${share3}</strong> and <strong>1 other</strong>.
PERMISSIONS_LOODLE_CONTEXT1_CONTEXT2_SHARE_5+_PLURAL = These loodles will be added to <strong>${context1}</strong> and <strong>${context2}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong>, <strong>${share3}</strong> and <strong>${shareOther} others</strong>.
PERMISSIONS_LOODLE_CONTEXT1_CONTEXT2_SHARE_5+_SINGULAR = This loodle will be added to <strong>${context1}</strong> and <strong>${context2}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong>, <strong>${share3}</strong> and <strong>${shareOther} others</strong>.
PERMISSIONS_LOODLE_CONTEXT1_CONTEXT2_SINGULAR = This loodle will be added to <strong>${context1}</strong> and <strong>${context2}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_PLURAL = These loodles will be added to <strong>${context1}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_SHARE_1_PLURAL = These loodles will be added to <strong>${context1}</strong> and shared with <strong>${share1}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_SHARE_1_SINGULAR = This loodle will be added to <strong>${context1}</strong> and shared with <strong>${share1}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_SHARE_2_PLURAL = These loodles will be added to <strong>${context1}</strong> and shared with <strong>${share1}</strong> and <strong>${share2}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_SHARE_2_SINGULAR = This loodle will be added to <strong>${context1}</strong> and shared with <strong>${share1}</strong> and <strong>${share2}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_SHARE_3_PLURAL = These loodles will be added to <strong>${context1}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong> and <strong>${share3}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_SHARE_3_SINGULAR = This loodle will be added to <strong>${context1}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong> and <strong>${share3}</strong>.
PERMISSIONS_LOODLE_CONTEXT1_SHARE_4_PLURAL = These loodles will be added to <strong>${context1}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong>, <strong>${share3}</strong> and <strong>1 other</strong>.
PERMISSIONS_LOODLE_CONTEXT1_SHARE_4_SINGULAR = This loodle will be added to <strong>${context1}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong>, <strong>${share3}</strong> and <strong>1 other</strong>.
PERMISSIONS_LOODLE_CONTEXT1_SHARE_5+_PLURAL = These loodles will be added to <strong>${context1}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong>, <strong>${share3}</strong> and <strong>${shareOther} others</strong>.
PERMISSIONS_LOODLE_CONTEXT1_SHARE_5+_SINGULAR = This loodle will be added to <strong>${context1}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong>, <strong>${share3}</strong> and <strong>${shareOther} others</strong>.
PERMISSIONS_LOODLE_CONTEXT1_SINGULAR = This loodle will be added to <strong>${context1}</strong>.
