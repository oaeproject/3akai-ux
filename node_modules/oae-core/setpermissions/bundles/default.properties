...
PERMISSIONS_DISCUSSION_CONTEXT_SINGULAR = This discussion will be added to <strong>${mylibrary}</strong> and <strong>${context}</strong>.
PERMISSIONS_DISCUSSION_SINGULAR = This discussion will be added to <strong>${mylibrary}</strong>.
PERMISSIONS_DISCUSSION_SHARE_1_SINGULAR=This discussion will be added to <strong>${mylibrary}</strong> and shared with <strong>${share1}</strong>.
PERMISSIONS_DISCUSSION_SHARE_1_CONTEXT_SINGULAR = This discussion will be added to <strong>${mylibrary}</strong> and <strong>${context}</strong> and shared with <strong>${share1}</strong>.
PERMISSIONS_DISCUSSION_SHARE_2_SINGULAR = This discussion will be added to <strong>${mylibrary}</strong> and shared with <strong>${share1}</strong> and <strong>${share2}</strong>.
PERMISSIONS_DISCUSSION_SHARE_2_CONTEXT_SINGULAR = This discussion will be added to <strong>${mylibrary}</strong> and <strong>${context}</strong> and shared with <strong>${share1}</strong> and <strong>${share2}</strong>.
PERMISSIONS_DISCUSSION_SHARE_3_SINGULAR = This discussion will be added to <strong>${mylibrary}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong> and <strong>${share3}</strong>.
PERMISSIONS_DISCUSSION_SHARE_3_CONTEXT_SINGULAR = This discussion will be added to <strong>${mylibrary}</strong> and <strong>${context}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong> and <strong>${share3}</strong>.
PERMISSIONS_DISCUSSION_SHARE_4_SINGULAR = This discussion will be added to <strong>${mylibrary}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong>, <strong>${share3}</strong> and <strong>1 other</strong>.
PERMISSIONS_DISCUSSION_SHARE_4_CONTEXT_SINGULAR = This discussion will be added to <strong>${mylibrary}</strong> and <strong>${context}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong>, <strong>${share3}</strong> and <strong>1 other</strong>.
PERMISSIONS_DISCUSSION_SHARE_5+_CONTEXT_SINGULAR = This discussion will be added to <strong>${mylibrary}</strong> and <strong>${context}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong>, <strong>${share3}</strong> and <strong>${shareOther} others</strong>.
PERMISSIONS_DISCUSSION_SHARE_5+_SINGULAR = This discussion will be added to <strong>${mylibrary}</strong> and shared with <strong>${share1}</strong>, <strong>${share2}</strong>, <strong>${share3}</strong> and <strong>${shareOther} others</strong>.
