...
define(['jquery', 'oae.core', 'jquery.autoSuggest'], function($, oae) {
    ...
    return function(uid, showSettings) {
         ...
         *
         * @returns  {Object[]}   viewers   An array of objects containing the id and displayName of the principal to share with
         */
         ...
         * @returns  {String}           Returns the translated string associated to the type of items handled by the widget (e.g. `links` or `file`)
         */
