...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
         ...
         */
        var savePermissionsChange = function(folderMembers, callback) {
        ...
        var getFolderMembers = function(folderId, callback) {
            ...
            // Get all members of the folder 
            oae.api.folder.getMembers(folderId, null, null, function(err, members) {
                if (err) {
                    return callback(err);
                };

                // Get out the creator of this resource because he will get right manager anyway
        ...
        var setUpSetPermissionsModal = function() {
            ...
            $(document).on('oae.context.send.setpermissions.' + uid, function(ev, data) {
                ...
                getFolderMembers(pageContext.id, function(err, folderMembers) {
                    ...
                    setUpAutoSuggest(folderMembers, function(err) {
                        if (err) {
                            return err;
                        }

                        savePermissionsChange(folderMembers);
                    });
                });
            });
