...
<div id="setpermissions-summary-template"><!--
    ...
    {elseif viewers.length === 1}
        {var share1 = viewers[0].displayName|encodeForHTML}
        {if count === 1}
    ...
    {elseif viewers.length === 2}
        {var share1 = viewers[0].displayName|encodeForHTML}
        {var share2 = viewers[1].displayName|encodeForHTML}
        {if count === 1}
    ...
    {elseif viewers.length === 3}
        {var share1 = viewers[0].displayName|encodeForHTML}
        {var share2 = viewers[1].displayName|encodeForHTML}
        {var share3 = viewers[2].displayName|encodeForHTML}
        {if count === 1}
    ...
    {elseif visibility === 'loggedin'}
        {var tenant = 'Cambridge University'}
        {if count === 1}
