...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var handleEmptyResultList = function() {
            $('#library_create', $rootel).hide();
            oae.api.util.template().render($('#library_noresults_template'), null, $('.oae-list', $rootel));
        };
        ...
        var setUpAnon = function() {
            if (oae.data.me.anon) {
                $('.oae-list-options-toggle').attr('disabled', 'disabled');
            }
        }
