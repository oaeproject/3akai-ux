...
define(['jquery', 'oae/api/oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var addBinding = function() {
            ...
            $rootel.on('submit', '#library_search_form', function() {
        ...
        var doInit = function() {
            ...
            var isGroupManager = (sakai_global && sakai_global.group && sakai_global.group.isManager);
            if (widgetData.principalId === oae.data.me.userId || isGroupManager) {
                $('#library_create').show();
            }
        };
