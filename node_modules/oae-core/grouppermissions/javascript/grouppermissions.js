    ...
    return function(uid, showSettings) {
        ...
        var showWarning = function() {
            ...
            if (visibility === newVisibilityVal || visibilityindex[newVisibilityVal] > visibilityindex[visibility]) {
                ...
                $('#grouppermissions_warning_container_text').html(oae.api.util.template().render($('#grouppermissions_warning_container_text_template'), {
        ...
        var handleEmptyResultList = function() {
            oae.api.util.template().render($('#grouppermissions_members_noresults_template'), null, $('.oae-list', $rootel));
        };
        ...
        var renderContainer = function() {
            ...
            oae.api.util.template().render($('#grouppermissions_group_template'), {
                'group': groupData,
