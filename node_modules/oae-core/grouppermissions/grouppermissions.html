        ...
        <li class="oae-list-item" data-key="${p.profile.id}" data-id="${p.profile.id}" data-original-role="${p.role}">
            ...
            <div class="oae-list-item-left">
                <div class="oae-list-item-left-inner">
                    ...
                    <a href="${p.profile.profilePath}" class="oae-force-left oae-threedots grouppermissions_member_name" title="${p.profile.displayName|encodeForHTMLAttribute}">${p.profile.displayName|encodeForHTML}</a>
