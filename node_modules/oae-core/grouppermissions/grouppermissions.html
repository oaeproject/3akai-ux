         ...
         <li class="oae-list-item" data-key="${p.profile.id}" data-id="${p.profile.id}" data-original-role="${p.role}" data-resource-type="${resourceType}">
            ...
            <div class="oae-list-item-left">
                <div class="oae-list-item-left-inner">
                    ...
                    <button data-sakai-entityid="${p.profile.id}" class="oae-link-button oae-action-icon oae-actions-delete" type="button" displayName="Remove ${p.profile.displayName|safeUserInput}"></button>
