            ...
            <form id="creategroup-form" role="form">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="creategroup-name" name="creategroup-name" class="form-control required maxlength-short" placeholder="__MSG__WHAT_DO_YOU_WANT_TO_CALL_YOUR_GROUP__"/>
                    </div>
