            ...
            <form id="creategroup-form" role="form">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="creategroup-name" class="control-label"><h4>__MSG__GROUP_NAME__</h4></label>
                        <input type="text" id="creategroup-name" class="form-control required maxlength-short" placeholder="__MSG__WHAT_DO_YOU_WANT_TO_CALL_YOUR_GROUP__"/>
                    </div>
