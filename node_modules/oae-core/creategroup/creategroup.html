...
<!-- MODAL -->
<div id="creategroup-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="creategroup-modal-title" aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&#215;</button>
        <h3 id="creategroup-modal-title">__MSG__CREATE_GROUP__</h3>
    </div>
    <form id="creategroup-form" class="control-group">
        <div class="modal-body">
            <label for="creategroup-title"><h4>__MSG__GROUP_TITLE__</h4></label>
            <div class="controls">
                <input type="text" id="creategroup-title" class="required" placeholder="__MSG__WHAT_DO_YOU_WANT_TO_CALL_YOUR_GROUP__"/>
            </div>
            <div id="creategroup-visibility-container"><!-- --></div>
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-link pull-left" data-dismiss="modal">__MSG__CANCEL__</button>
            <button type="submit" class="btn btn-primary pull-right">__MSG__CREATE_GROUP__</button>
        </div>
    </form>
</div>

<div id="creategroup-visibility-template"><!--
    <h4>__MSG__VISIBILITY__</h4>
    <div class="oae-visibility-choice-container row-fluid">
        <label for="oae-visibility-private" class="span4 {if visibility === 'private'} checked{/if}">
            <i class="icon-ok hide"></i>
            <div class="oae-visibility-choice well pull-left text-center">
        ...
        <label for="oae-visibility-loggedin" class="span4 {if visibility === 'loggedin'} checked{/if}">
            <i class="icon-ok hide"></i>
            <div class="oae-visibility-choice well pull-left text-center">
            ...
            <small>${oae.data.me.tenant.displayName|encodeForHTML}</small>
        </label>
        <label for="oae-visibility-public" class="span4 {if visibility === 'public'} checked{/if}">
            <i class="icon-ok hide"></i>
            <div class="oae-visibility-choice well pull-left text-center">
