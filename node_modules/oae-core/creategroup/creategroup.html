...
<div id="creategroup-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="creategroup-modal-title" aria-hidden="true">
    ...
    <form id="creategroup-form" class="control-group">
        <div class="modal-body">
            ...
            <div class="controls">
                <input type="text" id="creategroup-name" class="required" placeholder="__MSG__WHAT_DO_YOU_WANT_TO_CALL_YOUR_GROUP__"/>
            </div>
    ...
    <div class="oae-visibility-choice-container row-fluid">
        ...
        <label for="oae-visibility-loggedin" class="span4 text-center">
            <div class="oae-visibility-choice well pull-left text-center {if visibility === 'loggedin'} checked{/if}">
                ...
                <span>${oae.data.me.tenant.displayName|safeUserInput}</span>
            </div>
            <i class="icon-ok hide"></i>
