        ...
        casper.waitForSelector('#me-clip-container .oae-clip', function() {
            casper.waitForSelector(
                ...
                function() {
                    ...
                    test.assertExists(
                        '.oae-trigger-creategroup',
                        'Create group trigger exists',
                    );
                    casper.click('.oae-trigger-creategroup');
                    casper.waitUntilVisible('#creategroup-modal', function() {
                        test.assertVisible(
                            '#creategroup-modal',
                            'Create group pane is showing after trigger',
                        );
                        casper.click(
                            '.oae-clip-secondary .oae-clip-content > button',
                        );
    ...
    var verifyCreateGroup = function() {
        casper.waitForSelector('form#creategroup-form', function() {
            ...
            test.assertExists(
                ...
                'The create group form is present',
            );
            test.assertExists(
                '#creategroup-name',
                'The group name field is present',
            );
            // Fill the form
            casper.fill(
                'form#creategroup-form',
            ...
            test.assertExists(
                'form#creategroup-form button[type="submit"]',
                "The 'Create group' button is present",
            );
            ...
            casper.waitForSelector('#group-clip-container h1', function() {
                test.assertVisible(
                    ...
                    'Group profile is shown after creation of the group',
                );
                test.assertSelectorHasText(
                    '#group-clip-container h1',
                    'CasperJS test group',
                    "Title matches 'CasperJS test group'",
                );
            });
        });
    };
    ...
    var verifyCreateGroupValidation = function() {
        casper.waitForSelector('form#creategroup-form', function() {
            ...
            test.assertExists(
                ...
                'Create group form successfully validated empty form',
            );
        });
    };
