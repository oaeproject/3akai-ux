...
CREATING_YOUR_GROUP = Creating your <span class="oae-lowercase">${type}</span>
...
MEMBERSHIP_COLON = Membership:
PROCESSING_GROUP = Won't be long, please wait while we get it all organized for you
SUGGESTED_URL_COLON = Suggested URL:
