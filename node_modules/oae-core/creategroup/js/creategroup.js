    ...
    return function(uid) {
        ...
        var setUpVisibility = function() {
            oae.api.util.template().render(
                $('#creategroup-visibility-template', $rootel),
                {
                    ...
                    if (!err) {
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__GROUP_NOT_CREATED__',
                                'creategroup',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__GROUP_COULD_NOT_BE_CREATED__',
                                'creategroup',
                            ),
                            'error',
                        );
        ...
        var setUpValidation = function() {
            oae.api.util
                .validation()
                .validate($('#creategroup-form', $rootel), {
