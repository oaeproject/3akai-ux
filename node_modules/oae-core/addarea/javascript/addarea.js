...
require(['jquery', 'sakai/sakai.api.core', 'underscore'], function($, sakai, _) {
    ...
    sakai_global.addarea = function(tuid, showSettings) {
        ...
        var handleSearch = function(ev) {
            if (ev.keyCode === 13 || $(ev.currentTarget).hasClass('oae-search-button') || $(ev.currentTarget).hasClass('addarea_existing_sort')) {
                if ($('.addarea_existing_container:visible').data('doc-type') !== 'existing_currentlyviewing') {
                    $('.addarea_existing_bottom').html('');
                    getAllExistingSakaiDocs($('.addarea_existing_container:visible').find('.oae-search-inputfield').val(), $('.addarea_existing_container:visible').data('doc-type') === 'existing_mylibrary');
                } else {
                    $('.addarea_existing_bottom').html('');
                    getCurrentlyViewingDocs($('.addarea_existing_container:visible').find('.oae-search-inputfield').val());
                }
            }
        };
        ...
        var addBinding = function() {
            ...
            $('.oae-search-button', $rootel).click(handleSearch);
