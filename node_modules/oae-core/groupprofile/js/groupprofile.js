    ...
    return function(uid, showSettings, widgetData) {
        ...
        var setUpHeader = function() {
            ...
            oae.api.util
                .template()
                .render(
                    $('#groupprofile-header-template', $rootel),
                    { action: action },
                    $('#groupprofile-header-container', $rootel),
                );
        };
        ...
        var setUpDescription = function() {
            oae.api.util
                .template()
                .render(
                    $('#groupprofile-description-template', $rootel),
                    { contextProfile: contextProfile },
                    $('#groupprofile-description-container', $rootel),
                );
        };
        ...
        var setUpMembers = function() {
            ...
            oae.api.util
                .template()
                .render(
                    $('#groupprofile-members-template', $rootel),
                    data,
                    $('#groupprofile-members-container', $rootel),
                );
        };
         ...
         */
        $(document).on('oae.context.update', function(
            ev,
            updatedContextProfile,
        ) {
