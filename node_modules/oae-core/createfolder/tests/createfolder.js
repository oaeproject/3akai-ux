...
casper.test.begin('Widget - Create folder', function(test) {
        ...
        casper.waitForSelector('#me-clip-container .oae-clip', function() {
            casper.waitForSelector(
                ...
                function() {
                    ...
                    test.assertExists(
                        '.oae-trigger-createfolder',
                        'create folder trigger exists',
                    );
                    ...
                    casper.waitForSelector(
                        ...
                        function() {
                            test.assertVisible(
                                '#createfolder-modal',
                                'create folder pane is showing after trigger',
                            );
                            casper.click(
                                '.oae-clip-secondary .oae-clip-content > button',
                            );
    ...
    var verifyCreatefolder = function(user2Id) {
        ...
        test.assertExists(
            'form#createfolder-form',
            'The create folder form is present',
        );
        test.assertExists(
            '#createfolder-name',
            'The folder name field is present',
        );
        // Fill the form
        casper.fill(
            'form#createfolder-form',
        ...
        test.assertExists(
            '#createfolder-permissions-container #setpermissions-container input[type="radio"]',
            "The 'change permissions' radio button group is present",
        );
        test.assertExists(
            '#createfolder-permissions-container .as-selections input',
            "The 'share' input field is present",
        );
        // Select the public permission
        casper.click(
            '#createfolder-permissions-container #setpermissions-container input[type="radio"][value="public"]',
            "Select 'public' permissions for the folder",
        );
        ...
        casper.evaluate(function(user2Id) {
            $('#createfolder-permissions-container .as-selections input').val(
                user2Id,
            );
        }, user2Id);
        ...
        casper.waitForSelector('.as-list li', function() {
            ...
            test.assertExists(
                '#createfolder-create',
                "The 'Create folder' button is present",
            );
            ...
            casper.waitForSelector('#folder-clip-container h1', function() {
                test.assertVisible(
                    ...
                    'Folder profile is shown after creation of folder',
                );
                test.assertSelectorHasText(
                    '#folder-clip-container h1',
                    'Testing tools',
