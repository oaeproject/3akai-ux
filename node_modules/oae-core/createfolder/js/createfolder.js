...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        var visibility = oae.api.config.getValue('oae-collections', 'visibility', 'collection');
         ...
         * management (visibility + sharing) of the created folder
         */
        var setUpSetPermissions = function() {
            ...
            // We need to re-fetch the default visibility as the user could have selected a visibility, closed the modal and re-opened
            visibility = oae.api.config.getValue('oae-collections', 'visibility', 'collection');
        ...
        var createFolder = function() {
            ...
            oae.api.folder.createFolder(displayName, null, visibility, [], members, function (err, data) {
