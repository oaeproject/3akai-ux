...
define(['jquery', 'oae.core'], function($, oae) {
    return function(uid) {
        ...
        var setUpCreateFolder = function() {
            ...
            oae.api.util
                .validation()
                .validate($('#createfolder-form', $rootel), validateOpts);
        };
        ...
        var setUpSetPermissions = function() {
            ...
            var $setPermissionsContainer = $(
                '#createfolder-permissions-container',
                $rootel,
            );
            ...
            $(document).on(
                ...
                function(ev, data) {
                    ...
                    _.each(data.selectedPrincipalItems, function(
                        selectedPrincipalItem,
                    ) {
                    ...
                    if (!err) {
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__FOLDER_NOT_CREATED__',
                                'createfolder',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__FOLDER_COULD_NOT_BE_CREATED__',
                                'createfolder',
                            ),
                            'error',
                        );
