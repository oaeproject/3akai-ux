                    ...
                    <div id="addtofolder-tab-container">
                        <ul class="nav nav-tabs" role="tablist">
                            <li id="addtofolder-tab-mylibrary" role="presentation">
                                <a href="#addtofolder-mylibrary-container" data-toggle="tab" role="tab">__MSG__MY_LIBRARY__</a>
                            </li>
                            <li id="addtofolder-tab-mygroups" role="presentation">
                                <a href="#addtofolder-mygroups-container" data-toggle="tab" data-type="followers" role="tab">__MSG__MY_GROUPS__</a>
                            </li>
                        </ul>
                    </div>

                    <div class="tab-content">
                        <div id="addtofolder-mylibrary-container" class="tab-pane">
                            <div id="addtofolder-mylibrary"><!-- --></div>
                        </div>
                        <div id="addtofolder-mygroups-container" class="tab-pane"><!-- TODO --></div>
                    </div>
                </div>
...
<div id="addtofolder-folders-template"><!--
    {for folder in results}
        <label for="addtofolder-myfolders-${folder.id}">
            <div class="oae-list-compact-item">
                <div class="clearfix oae-listitem oae-pill">
                    <input type="radio" id="addtofolder-myfolders-${folder.id}" name="addtofolder-myfolders" value="${folder.id}" class="sr-only" tabindex="0"/>
