                    ...
                    <div class="tab-content">
                        <div id="addtofolder-mylibrary" class="tab-pane">
                            <div class="addtofolder-scrollcontainer">
                                <ul id="addtofolder-mylibrary-list" class="oae-list"><!-- --></ul>
                            </div>
                        </div>
                        <div id="addtofolder-mygroups" class="tab-pane">
                            ...
                            <div id="addtofolder-group-list-container" class="addtofolder-scrollcontainer">
                                <ul id="addtofolder-group-list" class="oae-list"><!-- --></ul>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- TODO: Remove {if group} statement once the memberships no longer returns `null` entries -->
<div id="addtofolder-groups-template"><!--
    {for group in results}
        {if group}
            <li data-id="${group.id}">
                <a href="${group.profilePath}">
                    <div class="oae-list-compact-item">
                        <div class="clearfix oae-listitem">
                            ...
                            <div class="oae-listitem-actions">
                                <i class="fa fa-chevron-right">
                                    <span class="sr-only">__MSG__TODO__</span>
                                </i>
                            </div>
                            <div class="oae-listitem-metadata">
