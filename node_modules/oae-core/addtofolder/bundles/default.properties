...
LOODLE_ADDED_FOLDER_FAIL = The loodle could not be added to the folder ${folderLink}.
LOODLE_ADDED_FOLDER_SUCCESS = The loodle has been successfully added to the folder ${folderLink}.
