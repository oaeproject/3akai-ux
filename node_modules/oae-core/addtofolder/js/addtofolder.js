...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        var setUpFolders = function(contextId) {
            ...
            foldersInfinityScroll = $('.oae-list', $visibleList).infiniteScroll(url, {
                'limit': 8
        ...
        var setUpAddToFolder = function() {
            $('#addtofolder-form', $rootel).on('submit', function() {
                // Extract the id of the selected folder
                var selectedFolder = $('.tab-pane.active input[type=radio]:checked', $rootel).attr('value');
        ...
        var setUpSelectFolder = function() {
            ...
            $('#addtofolder-form', $rootel).on('change', function() {
                ...
                // actually the element that has focus
