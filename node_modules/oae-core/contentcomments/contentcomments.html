...
<div id="contentcomments_mainContainer" class="s3d-widget-container" style="display:none;">
    <h2 class="s3d-contentpage-title">__MSG__COMMENTS__</h2>
    ...
    <div id="contentcomments_userCommentContainer_template" style="display:none"><!--
        ...
        <div class="contentcomments_fillInCommentTopContainer s3d-form-field-wrapper">
            <form>
                <label style="display:none" for="contentcomments_txtMessage">__MSG__ENTER_A_COMMENT__</label>
                <textarea id="contentcomments_txtMessage" name="contentcomments_txtMessage" class="required s3d-error-calculate contentcomments_inputFields" cols="10" placeholder="__MSG__ENTER_A_COMMENT__" title="__MSG__ENTER_A_COMMENT__"></textarea>
                <div class="dialog_buttons contentcomments_dialog_buttons right">
                    <button id="contentcomments_postComment" type="submit" class="s3d-button s3d-overlay-button comment_postCommentTopBottom">__MSG__COMMENT__</button>
                </div>
            </form>
        </div>
    --></div>
        ...
        <div class="contentcomments_comment {if comments.length == 1} last first {elseif i_index == comments.length - 1} first{elseif i_index == 0} last{/if}">
            ...
            <div class="contentcomments_topCommentBar">
                <div class="contentcomments_posterData s3d-regular-links">
                    {if i.user.fullName}
                        <span class="contentcomments_posterDataName s3d-regular-links"><a href="/~${i.user.uid}">${i.user.fullName}</a></span>
                    {else}
                        <span class="contentcomments_posterDataName s3d-gray s3d-regular-links">__MSG__UNDISCLOSED_USER__</span>
                    {/if}
