...
define(['jquery', 'oae.core', 'jquery.timeago'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        // TODO: Use the getContext functionality once the upload branch has been merged
        ...
        /**
         * When a reply or comment is made the comment object is constructed and added to the UI.
         *
        ...
        var constructAndAppendComment = function(err, comment) {
            // Top level comment
            if (!comment.replyTo) {
                // Insert the comment at the beginning of the list after the comment box
         ...
         */
         var createComment = function(form) {
            ...
            var $commentField = $(form).find('textarea');
        ...
        /**
         * Creates a comment, resets and hides the comment form
         */
        ...
        /**
         * Set up the validation on the comment and reply forms.
         * Only initializes validation on the forms that haven't been initialized yet.
         */
        var setUpValidation = function() {
            ...
            $.each($('.contentcomments-new-reply-form[novalidate!="novalidate"]', $rootel), function(i, form) {
        ...
        var setUpReplyComment = function() {
            $rootel.on('click', '.contentcomments-reply-button', function() {
                $(this).parent().siblings('.contentcomments-reply-container').toggle();
            });
        };
        ...
        /**
         * Prepends the textarea that allows creation of new top level comments to the list of comments
         */
        ...
        var setUpInfiniteScroll = function() {
            ...
            infinityScroll = $('#contentcomments-content-container', $rootel).infiniteScroll('/api/content/' + contentProfile.id + '/comments', null, $('#contentcomments-comment-template'), {
                'postProcessor': function(data) {
                    ...
                    data.defaultUser = {'resourceType': 'user'};
                    return data;
                },
