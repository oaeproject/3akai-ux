...
define(['jquery', 'oae/api/oae.core', 'jquery-plugins/jquery.timeago'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        if (!oae.data.me.anon) {
            ...
            if (oae.data.me.mediumPicture) {
                $('#contentcomments_new_comment_container .contentcomments_entity_image', $rootel).attr('src', oae.data.me.mediumPicture);
            }
        }
         ...
         */
         var setUpCreateComment = function() {
             ...
             $rootel.on('click', '#contentcomments_post_comment', function() {
                ...
                oae.api.content.createComment(contentProfile.contentId, comment, null, constructAndAppendComment);
        ...
        var setUpReplyComment = function() {
            ...
            $rootel.on('click', '.contentcomments_post_reply', function() {
                ...
                oae.api.content.createComment(contentProfile.contentId, comment, replyTo, constructAndAppendComment);
            });
        };
