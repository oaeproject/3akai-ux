    ...
    return function(uid, showSettings) {
        ...
        var constructAndAppendComment = function(comment, replyTo, level) {
            ...
            if (!replyTo) {
                ...
                $('div[data-commentid="' + replyTo + '"]').next().after(oae.api.util.renderTemplate('#contentcomments_comment_template', {
                    comments: comment.results,
                    canManage: true
                }));
            }
        ...
        var getComments = function(page) {
            ...
            $.ajax({
                'url': 'node_modules/oae-core/contentcomments/dummy/' + page + '.json',
                'success': function(data) {
                    renderComments(JSON.parse(data));
                },
                'error': function(err) {
