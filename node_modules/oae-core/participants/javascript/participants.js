...
require(['jquery', 'sakai/sakai.api.core'], function($, sakai) {
    ...
    sakai_global.participants = function(tuid, showSettings, widgetData) {
        ...
        var participantsShowGrid = $('.oae-listview-grid', rootel);
        var participantsShowList = $('.oae-listview-list', rootel);
        ...
        var handleHashChange = function() {
            ...
            if (ls === 'list') {
                $('#participants_list_container_list', rootel).removeClass('oae-search-results-grid');
                ...
                $('#participants_list_container_list', rootel).addClass('oae-search-results-grid');
            }
        ...
        var addBinding = function() {
            ...
            $('.participants_widget .oae-search-button').off('click').on('click', function() {
                currentPage = 1;
