...
<div class="participants_widget">
    ...
    <button type="button" id="participants_manage" class="oae-button oae-large-button dark oae-hidden group_permissions_trigger">__MSG__MANAGE_PARTICIPANTS__</button>
