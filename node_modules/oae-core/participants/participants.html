...
<div id="participants_list_template" style="display: none;"><!--
    {for p in results}
        ...
        {var thumbnailUrl = p.profile.mediumPicture || '/ui/img/entities/user_icon_large.png'}
        {var mediumThumbnailUrl = p.profile.mediumPicture || '/ui/img/entities/user_icon_medium.png'}
        ...
        <li class="oae-list-item" {if !p.id} data-key="${p.profile.id}"{/if}>
            ...
            <div class="oae-list-item-banner" style="display: none;">
                <div>
                    <a class="oae-threedots" href="/user/${participantId}" title="${displayName|safeUserInput}">${displayName|safeUserInput}</a>
