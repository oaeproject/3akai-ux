    ...
    {for p in results}
        <li class="oae-list-item">
            ...
            <div class="oae-list-item-banner" style="display: none;">
                <div>
                    <a class="oae-threedots" href="/user/${p.id}" title="${p.title}">${p.title}</a>
                </div>
            </div>
            <div class="oae-list-item-left">
                <img src="${thumbnailUrl}" alt="${p.title}" class="oae-list-item-profile-picture grid"/>
                <div class="oae-list-item-left-inner">
                    {if !oae.data.me.anon}
                        <input type="checkbox" name="${p.id}_chk" id="${p.id}_chk" data-id="${p.id}" class="oae-force-left"/>
                    {/if}
                    <label for="${p.id}_chk" class="oae-threedots">
                        <img src="${mediumThumbnailUrl}" alt="${p.title}" class="oae-list-item-profile-picture"/>
                        <img src="${smallThumbnailUrl}" alt="${p.title}" class="oae-list-item-small-picture"/>
                        <a class="oae-threedots" href="/user/${p.id}" title="${p.title}">${p.title}</a>
                    </label>
