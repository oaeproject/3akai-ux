        ...
        <li id="${participant.id}" class="s3d-list-item s3d-search-result">
            ...
            <div class="s3d-search-result-right">
                ...
                <a href="/~${participant.id|safeURL}#l=library" class="s3d-regular-light-links participants_list_participant_details">
                    <span class="s3d-aural-text">${participant.name|safeOutput} __MSG__HAS__ </span>${participant.content} {if participant.content === 1} __MSG__CONTENT_ITEM__{else} __MSG__CONTENT_ITEMS__{/if}
                </a>
                ...
                {if participant.type === "user"}
                    <a href="/~${participant.id|safeURL}#l=contacts" class="s3d-regular-light-links participants_list_participant_details">
                        <span class="s3d-aural-text">${participant.name|safeOutput} __MSG__HAS__ </span>${participant.contacts} {if participant.contacts === 1} __MSG__CONTACT__{else} __MSG__CONTACTS__{/if}
                    </a>
                    <span class="participants_list_participant_divider s3d-search-result-detail-separator"><span>|</span></span>
                    <a href="/~${participant.id|safeURL}#l=memberships" class="s3d-regular-light-links participants_list_participant_details">
                        <span class="s3d-aural-text">${participant.name|safeOutput} __MSG__HAS__ </span>${participant.memberships} {if participant.memberships === 1} __MSG__MEMBERSHIP__{else} __MSG__MEMBERSHIPS__{/if}
                    </a>
                {else}
                    <a href="/~${participant.id|safeURL}#l=participants" class="s3d-regular-light-links participants_list_participant_details">
                        <span class="s3d-aural-text">${participant.name|safeOutput} __MSG__HAS__ </span>${participant.membersCount} {if participant.membersCount === 1} __MSG__PARTICIPANT__{else} __MSG__PARTICIPANTS__{/if}
                    </a>
                {/if}
            </div>
        </li>
