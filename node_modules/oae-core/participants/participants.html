...
<div class="participants_widget">
    ...
    <button type="button" id="participants_manage" class="oae-button oae-large-button oae-trigger-grouppermissions dark" style="display: none;">__MSG__MANAGE_PARTICIPANTS__</button>
