...
define(['jquery', 'oae/api/oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var buildParticipantsModel = function(feedType, data) {
            if (feedType !== 'list' && feedType !== 'search') {
                // The best we can do is return the data as-is, but it might not be pretty
                return data;
            }
            ...
            for (var i = 0; i < data.results.length; i++) {
                ...
                if (feedType === 'list') {
                    newData.results.push({
                        ...
                        'largePictureUrl': p.profile.mediumPicture || '/ui/img/entities/user_icon_large.png',
                        'mediumPictureUrl': p.profile.mediumPicture || '/ui/img/entities/user_icon_medium.png',
                        'smallPictureUrl': '/ui/img/entities/user_icon.png',
                        'role': p.role
                    });
                    ...
                    newData.results.push({
                        'participantId': p.id,
                        'displayName': p.title,
                        'largePictureUrl': p.thumbnailUrl || '/ui/img/entities/user_icon_large.png',
                        'mediumPictureUrl': p.thumbnailUrl || '/ui/img/entities/user_icon_medium.png',
                        'smallPictureUrl': '/ui/img/entities/user_icon.png'
                    });
                }
            }
