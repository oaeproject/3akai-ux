...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var handleEmptyResultList = function() {
            oae.api.util.template().render($('#participants-noresults-template'), null, $('.oae-list', $rootel));
        };
        ...
        var getMembers = function() {
            ...
            if (widgetData.canManage) {
                initialContent = oae.api.util.template().render($('#participants-list-actions-template', $rootel));
            }
        ...
        /**
         * Extract the search query from the current URL and load the initial members list.
        ...
        var addBinding = function() {
            // Set up search event
            $rootel.on('submit', '#participants-search-form', search);
