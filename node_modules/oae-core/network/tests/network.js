...
casper.test.begin('Widget - Network', function(test) {
    ...
    /**
     * Verify that current user has the single, specified follower
     */
    ...
    /**
     * Verify that current user's following network includes the specified user
     */
    var verifyUserHasFollowing = function(user) {
        // Give infinite scroll time to process (first child is "Find people")
            ...
            casper.then(function() {
                ...
                followUtil().follow(user2.id, function() {
                    ...
                    casper.then(function() {
                        ...
                        // Verify user 1 is in user 2's network as a follower
                        casper.thenOpen(configUtil().tenantUI + '/me/network', function() {
                        ...
                        casper.then(function() {
                            ...
                            followUtil().follow(user1.id, function() {
                                // Verify user 2's network shows the user is following user 1
                                casper.thenOpen(configUtil().tenantUI + '/me/network', function() {
                                    casper.waitForSelector('#network-widget .nav li a[href="#network-following"]', function() {
