...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var getFollowing = function() {
            ...
            $('#network-list-options-search-query', $rootel).val(query);
        ...
        var setUpListOptionsHeader = function() {
            // Determine which actions should be available to the user viewing the list
         ...
         */
        var search = function() {
            var query = $('#network-list-options-search-query', $(this)).val();
        ...
        var addBinding = function() {
            // Set up search event
            $rootel.on('submit', '#network-list-options .form-search', search);
