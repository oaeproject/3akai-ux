...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
         ...
         */
        var search = function() {
            var query = $('#network-search-query', $(this)).val();
            ...
            // Most browsers will display `/me/network`, IE9 will be display `/me#network` however.
            // The cleanUrl in the History.js state will always be `/me/network`.
        ...
        var setUpListOptions = function() {
            if (oae.data.me.anon) {
                ...
                oae.api.util.template().render($('#network-list-options-actions-template', $rootel), {
        ...
        var getFollowing = function() {
            ...
            $('#network-search-query', $rootel).val(query);
        ...
        var addBinding = function() {
            // Set up search event
            $rootel.on('submit', '#network-search-form', search);
