...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        /**
         * Fetches the search query from the History.js state and fills the search-query box with it
         */
        var getAndFillSearchQuery = function() {
        ...
        var getFollowing = function() {
            ...
            var query = getAndFillSearchQuery();
        ...
        var setUpListOptionsHeader = function() {
            ...
            oae.api.util.template().render($('#network-list-options-template', $rootel), {'actions': actions}, $('#network-list-options', $rootel));
        };
