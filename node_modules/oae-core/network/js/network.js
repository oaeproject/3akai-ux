...
define(['jquery', 'oae.core', 'jquery.history'], function($, oae) {
    return function(uid, showSettings, widgetData) {
        ...
        var getFollowing = function() {
            ...
            if (widgetData.canManage && !query) {
                initialContent = oae.api.util
                    .template()
                    .render($('#network-list-actions-template', $rootel));
            }

            // Set up the infinite scroll for the users followed by the current user
            followingInfinityScroll = $(
                '#network-following .oae-list',
                $rootel,
            ).infiniteScroll(
                url,
                {
                ...
                '#following-template',
                {
                    ...
                    emptyListProcessor: function() {
                        oae.api.util.template().render(
                            $('#network-following-noresults-template', $rootel),
                            {
                                query: query,
                            },
        ...
        var getFollowers = function() {
            ...
            followersInfinityScroll = $(
                '#network-followers .oae-list',
                $rootel,
            ).infiniteScroll(
                url,
                {
                ...
                '#followers-template',
                {
                    ...
                    emptyListProcessor: function() {
                        oae.api.util.template().render(
                            $('#network-followers-noresults-template', $rootel),
                            {
                                query: query,
                            },
        ...
        var setUpListHeader = function() {
            ...
            oae.api.util
                .template()
                .render(
                    $('#network-list-header-template', $rootel),
                    { actions: listHeaderActions },
                    $('#network-list-header', $rootel),
                );
        };
