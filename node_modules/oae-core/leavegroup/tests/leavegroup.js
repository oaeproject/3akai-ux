...
casper.test.begin('Widget - Leave group', function(test) {
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        casper.waitFor(function() {
            ...
            var group1Profile = null;
            var group2Profile = null;

            // Create a group to test with
            casper.then(function() {
                groupUtil().createGroup([], [], function(_group1Profile) {
                    group1Profile = _group1Profile;
                    groupUtil().createGroup([], [user2.id], function(_group2Profile) {
                        group2Profile = _group2Profile;
                    });
                });
            });

            casper.waitFor(function() {
                return group1Profile !== null && group2Profile !== null;
            }, function() {
                casper.thenOpen(configUtil().tenantUI + '/me/groups', function() {
                    ...
                    casper.then(function() {
                        ...
                        verifyOpenLeaveGroup(group1Profile.id);
                    });
