casper.test.begin('Widget - Leave group', function(test) {
    ...
    var verifyOpenLeaveGroup = function(groupID) {
        casper.waitForSelector('li.oae-list-actions + li', function() {
            ...
            test.assertExists('.oae-list-header-actions-actions .oae-trigger-leavegroup:not([disabled])', 'The leave group trigger exists and is enabled');
            casper.click('.oae-list-header-actions-actions .oae-trigger-leavegroup');
