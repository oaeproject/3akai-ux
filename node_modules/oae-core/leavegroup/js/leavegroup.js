            ...
            var leaveGroup = function(groupId) {
                ...
                oae.api.group.leaveGroup(groupId, function(err, data) {
                    ...
                    // the modal if all groups have been left successfully.
                        ...
                        var notificationTitle = oae.api.util.template().render($('#leavegroup-notification-title-template', $rootel), {
                            'errCount': errCount,
                            'groups': groupsToLeave
                        });

                        var notificationBody = oae.api.util.template().render($('#leavegroup-notification-body-template', $rootel), {
                            'errCount': errCount,
                            'groups': groupsToLeave
                        });
