...
define(['jquery', 'underscore', 'oae.core'], function($, _, oae) {
    ...
    return function(uid, showSettings) {
            ...
            var leaveGroup = function(groupId) {
                ...
                oae.api.group.leaveGroup(groupId, function(err, data) {
                    ...
                    // the modal if all groups have been left successfully.
                        ...
                        var notificationTitle = oae.api.i18n.translate('__MSG__LEAVE_GROUP__', 'leavegroup');

                        oae.api.util.notification(notificationTitle, notification, errCount ? 'error' : 'success');
        ...
        var setUpLeaveGroupModal = function() {
            $(document).on('oae.list.sendSelection', function(ev, groupData) {
                groupsToLeave = groupData.data;
                // Show the modal
