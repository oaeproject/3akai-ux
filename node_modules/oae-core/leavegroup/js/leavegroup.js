    ...
    return function(uid, showSettings) {
        ...
        var renderGroupList = function() {
            oae.api.util.template().render(
                $('#leavegroup-list-template', $rootel),
                {
        ...
        var finishLeaveGroup = function(errCount) {
            ...
            var notificationTitle = oae.api.util
                .template()
                .render(
                    $('#leavegroup-notification-title-template', $rootel),
                    resultData,
                );
            var notificationBody = oae.api.util
                .template()
                .render(
                    $('#leavegroup-notification-body-template', $rootel),
                    resultData,
                );
        ...
        var setUpLeaveGroupModal = function() {
            ...
            $(document).on('oae.list.sendSelection.leavegroup', function(
                ev,
                data,
            ) {
