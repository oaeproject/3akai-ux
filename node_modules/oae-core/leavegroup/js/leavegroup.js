    ...
    return function(uid, showSettings) {
        ...
        var leaveGroups = function() {
            ...
            var leaveGroup = function(groupId) {
                ...
                $('ul li[data-id="' + groupId + '"] .fa-spinner', $rootel).show();

                // Leave the group
                oae.api.group.leaveGroup(groupId, function(err, data) {
                    // Hide the progress indicator
                    $('ul li[data-id="' + groupId + '"] .fa-spinner', $rootel).hide();
                    if (err) {
                        // If there is an error, show the warning icon
                        $('ul li[data-id="' + groupId + '"] .fa fa-exclamation-triangle', $rootel).show();
                        errCount++;
                    } else {
                        // If there is no error, show the success icon
                        $('ul li[data-id="' + groupId + '"] .fa fa-check', $rootel).show();
                    }
