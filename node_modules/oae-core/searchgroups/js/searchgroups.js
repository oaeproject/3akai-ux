...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        var handleEmptyResultList = function() {
            oae.api.util.template().render($('#searchgroups_noresults_template'), null, $('#searchgroups_results_container'));
        };
        ...
        var search = function() {
            ...
            infinityScroll = $('#searchgroups_results_container').infiniteScroll('/api/search/general', {
                'limit': 12,
                'resourceTypes': 'group',
                'q': $.bbq.getState('q')
