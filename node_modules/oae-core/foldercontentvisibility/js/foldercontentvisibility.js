...
define(['jquery', 'oae.core'], function($, oae) {
    return function(uid) {
        ...
        var updateFolderContentVisibility = function() {
            ...
            $('#foldercontentvisibility-overview *', $rootel).prop(
                'disabled',
                true,
            );

            // Update the visibility of the items in the folder
            oae.api.folder.updateFolderContentVisibility(
                contextProfile.id,
                contextProfile.visibility,
                    ...
                    if (!err) {
                        ...
                        if (failedContent && failedContent.length > 0) {
                            oae.api.util.template().render(
                                $(
                                    '#foldercontentvisibility-failed-template',
                                    $rootel,
                                ),
                                {
                                ...
                                $(
                                    '#foldercontentvisibility-failed-container',
                                    $rootel,
                                ),
                            );
                            $(
                                '#foldercontentvisibility-overview',
                                $rootel,
                            ).hide();
                            $(
                                '#foldercontentvisibility-failed',
                                $rootel,
                            ).show();
                            ...
                            oae.api.util.notification(
                                oae.api.i18n.translate(
                                    '__MSG__FOLDER_CONTENT_VISIBILITY_UPDATED__',
                                    'foldercontentvisibility',
                                ),
                                oae.api.i18n.translate(
                                    '__MSG__FOLDER_CONTENT_VISIBILITY_UPDATE_SUCCESS__',
                                    'foldercontentvisibility',
                                ),
                            );
                        }
                        ...
                        oae.api.util.notification(
                            oae.api.i18n.translate(
                                '__MSG__FOLDER_CONTENT_VISIBILITY_NOT_UPDATED__',
                                'foldercontentvisibility',
                            ),
                            oae.api.i18n.translate(
                                '__MSG__FOLDER_CONTENT_VISIBILITY_UPDATE_FAIL__',
                                'foldercontentvisibility',
                            ),
                            'error',
                        );
        ...
        var setUpReset = function() {
            $('#foldercontentvisibility-modal', $rootel).on(
                'hidden.bs.modal',
                function(ev) {
        ...
        var setUpFolderContentVisibilityModal = function() {
            $(document).on('oae.trigger.foldercontentvisibility', function(
                ev,
                ctx,
            ) {
                ...
                oae.api.util.template().render(
                    $('#foldercontentvisibility-update-template', $rootel),
                    {
            ...
            $rootel.on(
                'click',
                '#foldercontentvisibility-update',
