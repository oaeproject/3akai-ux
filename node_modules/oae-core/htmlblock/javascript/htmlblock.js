    ...
    sakai_global.htmlblock = function(tuid, showSettings, widgetData) {
        ...
        var loadTinyMCE = function() {
            if (window['tinyMCE']) {
                tinyMCE.init({
                    ...
                    content_css: '/dev/css/sakai/main.css,/dev/css/sakai/sakai.editor.css,/node_modules/oae-core/htmlblock/css/htmlblock.css',
                ...
                $('.contentauthoring_cell_element_actions', $containingCell).addClass('oae-force-hidden');
            }
        };
        ...
        var initTinyMCE = function(ui) {
            ...
            setTimeout(function() {
                ...
                updateHeight();
                $('.contentauthoring_cell_element_actions', $containingCell).removeClass('oae-force-hidden').hide();
            }, 1000);
            startAutoSave();
        };
