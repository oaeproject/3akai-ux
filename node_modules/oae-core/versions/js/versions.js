...
define(['jquery', 'oae.core', 'storyjs-embed'], function($, oae) {
    ...
    return function(uid) {
        ...
        /**
         * Parses the version data into a format the timeline plugin understands
         *
        ...
        var parseVersionsIntoTimeline = function(versions) {
            ...
            timelineData = {
                'timeline': {
                    ...
                    'date': [] // All version objects go into the date array.
                }
            };

            // Loop over all returned versions to create a timeline object for them
        ...
        var getVersions = function() {
            $.ajax({
                'url': '/api/content/' + contentContext.id + '/revisions?limit=25', // TODO: revise the plugin to add paging
                'success': function(data) {
                    // Parse the version into a data format that the timeline understands.
        ...
        var setUpVersionsModal = function() {
            ...
            $('#versions-modal', $rootel).on('shown', function () {
                // Receive the content profile information and get the versions of the content
