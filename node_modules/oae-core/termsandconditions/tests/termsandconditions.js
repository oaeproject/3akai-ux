...
casper.test.begin('Widget - Terms and Conditions', function(test) {
    ...
    var verifyMarkdownRendering = function() {
        ...
        casper.waitForSelector(
            '#termsandconditions-modal .modal-body .well',
            function() {
                test.assertExists(
                    '#termsandconditions-modal .modal-body .well img[alt="OAE"]',
                    'Terms and conditions markdown renders properly',
                );
            },
        );
    };
    ...
    var openTermsAfterChange = function(user) {
        casper.waitForSelector(
            ...
            function() {
                test.assertExists(
                    '#termsandconditions-modal .modal-body .alert.alert-info',
                    'The terms and conditions changed notification is present',
                );
                test.assertExists(
                    '#termsandconditions-modal .modal-body .well',
                    'The terms and conditions are shown in the register modal',
                );
                test.assertExists(
                    '#termsandconditions-modal .modal-footer form[action="/api/auth/logout"] button',
                    'The terms and conditions have a cancel button',
                );
                test.assertExists(
                    '#termsandconditions-modal .modal-footer #termsandconditions-accept',
                    'The terms and conditions have an accept button',
                );
                ...
                casper.waitForSelector('#topnavigation-signin', function() {
                    test.assertExists(
                        ...
                        'The user is logged out when choosing to not accept the terms and conditions',
                    );
                        ...
                        function() {
                            ...
                            casper.wait(configUtil.modalWaitTime, function() {
                                ...
                                casper.then(function() {
                                    casper.wait(
                                        configUtil.searchWaitTime,
                                        function() {
                                            test.assertDoesntExist(
                                                '#termsandconditions-modal.in',
                                                'The user can continue using the system after accepting the changed terms and conditions',
                                            );
                                        },
                                    );
                                });
    ...
    var openTermsRegister = function() {
        casper.waitForSelector(
            '#topnavigation-left > button.oae-trigger-register',
            function() {
                casper.click(
                    '#topnavigation-left > button.oae-trigger-register',
                );
                casper.wait(configUtil.searchWaitTime, function() {
                    test.assertExists(
                        '#register-modal input#register-accept-terms-and-conditions',
                        'The terms and conditions accepted checkbox is present',
                    );
                    test.assertExists(
                        '#register-modal a#register-terms-and-conditions',
                        'The terms and conditions are accessible through the register widget',
                    );
                    casper.click(
                        '#register-modal a#register-terms-and-conditions',
                    );
                    casper.waitForSelector(
                        '#register-modal .modal-body .well',
                        function() {
                            test.assertExists(
                                '#register-modal .modal-body .well',
                                'The terms and conditions are shown in the register modal',
                            ...
                            test.assertExists(
                                '#register-modal .modal-footer #register-continue-signup',
                                'The terms and conditions have a back button',
                            );
                        },
                    );
                });
    ...
    var openTermsFooter = function() {
        casper.waitForSelector(
            '#footer-container button.oae-trigger-termsandconditions',
            function() {
                test.assertExists(
                    '#footer-container button.oae-trigger-termsandconditions',
                    'Terms and conditions trigger exists in the footer',
                );
                casper.click(
                    '#footer-container button.oae-trigger-termsandconditions',
                );
                ...
                casper.wait(configUtil.searchWaitTime, function() {
                    test.assertVisible(
                        ...
                        'The terms and conditions modal is shown after trigger',
                    );
                    test.assertExists(
                        '#termsandconditions-modal .modal-body .well',
                        'The terms and conditions are shown in the modal',
                    );
                    test.assertExists(
                        '#termsandconditions-modal .modal-footer button[data-dismiss="modal"]',
                        'The terms and conditions have a close button',
                    );
                });
            },
        );
    ...
    casper.start(configUtil.tenantUI, function() {
        ...
        userUtil.createUsers(1, function(user1) {
            ...
            casper.then(function() {
                ...
                adminUtil.writeConfig(
                    configUtil.tenantAlias,
                    {
                        'oae-principals/termsAndConditions/text/default':
                            '![OAE](/shared/oae/img/oae-logo.png) Changed terms and conditions',
                    },
                    function() {
                        userUtil.doLogOut();
                    },
