...
casper.test.begin('Widget - Terms and Conditions', function(test) {
    ...
    casper.start(configUtil().tenantUI, function() {
        ...
        casper.then(function() {
            casper.echo('# Verify terms and conditions modal', 'GREEN_BAR');
            verifyOpenTermsFooter();
        });

        // Verify the terms and conditions are shown in the register widget
        casper.then(function() {
            casper.echo('# Verify the terms and conditions are shown in the register widget', 'GREEN_BAR');
            verifyOpenTermsRegister();
        });

        // Verify markdown rendering
        casper.then(function() {
            casper.echo('# Verify markdown rendering', 'GREEN_BAR');
            verifyMarkdownRendering();
        });

        // Verify the terms and conditions are shown after a change is made to them
        casper.then(function() {
            casper.echo('# Verify the terms and conditions are shown after a change is made to them', 'GREEN_BAR');
