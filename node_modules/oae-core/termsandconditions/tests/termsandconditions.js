casper.test.begin('Widget - Terms and Conditions', function(test) {
     ...
     */
    var verifyOpenTermsAfterChange = function(user) {
        casper.waitForSelector('#termsandconditions-modal .modal-body .well', function() {
            ...
            test.assertExists('#termsandconditions-modal .modal-footer #termsandconditions-cancel', 'The terms and conditions have a cancel button');
            ...
            casper.click('#termsandconditions-modal .modal-footer #termsandconditions-cancel');
            casper.waitForSelector('#topnavigation-signin', function() {
                ...
                userUtil().doLogIn(user, configUtil().defaultUserPassword);
                ...
                casper.waitForSelector('#termsandconditions-modal .modal-body .well', function() {
                    ...
                    casper.thenOpen(configUtil().tenantUI, function() {
                        casper.wait(1000, function() {
                            test.assertDoesntExist('#termsandconditions-modal .modal-body .alert.alert-info', 'The user can continue using the system after accepting the changed terms and conditions');
                        });
                    });
                });
            });
     ...
     */
    var verifyOpenTermsRegister = function() {
        casper.waitForSelector('#topnavigation-left > button.oae-trigger-register', function(){
            ...
            casper.wait(3000, function() {
                ...
                test.assertExists('#register-modal button#register-terms-and-conditions', 'The terms and conditions are accessible through the register widget');
                casper.click('#register-modal button#register-terms-and-conditions');
     ...
     */
    var verifyOpenTermsFooter = function() {
        ...
        casper.then(function() {
            ...
            casper.thenOpen(configUtil().adminUI, function() {
                casper.waitForSelector('#admin-login-form', function() {
                    ...
                    casper.then(function() {
                        verifyOpenTermsAfterChange(user1.username);
                    });
                });
            });
        });
