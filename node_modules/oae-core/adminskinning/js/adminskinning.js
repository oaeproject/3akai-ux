...
define(['jquery', 'oae.core', 'jquery.spectrum'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var loadSkin = function() {
            ...
            if (widgetData.context.isTenantOnGlobalAdminServer || !widgetData.context.isGlobalAdminServer) {
                $.ajax({
                    ...
                    'success': function(data) {
                        ...
                        oae.api.util.template().render($('#admin-skinning-template', $rootel), data, $('#admin-skinning-container', $rootel));
        ...
        var addBinding = function() {
            // Revert skin value
            $rootel.on('click', '.admin-skinning-revert', revertSkinValue);
            // Change skin
            $rootel.on('submit', '#admin-skinning-form', applySkinChanges);
        };

        /**
         * Initialize the skinning related functionality
         */
        var initAdminSkinning = function() {
            addBinding();
            loadSkin();
        };
