<!-- CSS -->
<link rel="stylesheet" type="text/css" href="/node_modules/oae-core/inserter/css/inserter.css" />
    ...
    <div id="inserter_collector">
        ...
        <div id="inserter_collection_content_container">
            ...
            <div class="s3d-search-container">
                <form id="inserter_collection_content_search_form">
                    ...
                    <button title="__MSG__SUBMIT_SEARCH__" class="s3d-button s3d-overlay-button s3d-search-button" type="submit">
...
<div id="inserter_init_prescroll_template"><!--
    <ul>
        <li data-collection-id="library" class="s3d-droppable-container" data-dropevent="sakai.inserter.dropevent" data-scope="content">
            ...
            <div class="inserter_item_count_container fl-force-right">${sakai.data.me.profile.counts.contentCount || 0}</div>
...
<div id="inserter_collection_content_template"><!--
    {for item in items}
        ...
        <li class="s3d-draggable-container s3d-droppable-container" id="${item._path}" data-content-id="${item._path}" data-dropevent="sakai.inserter.dropevent" data-collection-id="${collection}" data-canshare="${canShare}">
            {if item.hasPreview}
...
<div id="inserter_no_results_template" style="display:none;"><!--
    {if search}
        <div class="s3d-no-results-container s3d-droppable-container" data-collection-id="${collection}" data-dropevent="sakai.inserter.dropevent" data-scope="content">
            ...
            <p>__MSG__SEARCH_DIDNT_RETURN_RESULTS__</p>
        </div>
    {else}
        <div class="s3d-no-results-container s3d-droppable-container" data-collection-id="${collection}" data-dropevent="sakai.inserter.dropevent" data-scope="content">
            <div class="s3d-no-results-icon s3d-no-results-search-content less-margin"></div>
            <p>__MSG__COLLECTION_DOESNT_CONTAIN_ITEMS__</p>
        </div>
    {/if}
--></div>
...
<!-- JAVASCRIPT -->
<script type="text/javascript" src="/node_modules/oae-core/inserter/javascript/inserter.js"></script>
