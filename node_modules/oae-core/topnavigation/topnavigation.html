...
<div id="topnavigation_container" class="oae-centered" role="navigation" aria-label="__MSG__TOPNAV_ARIA_LABEL__">
    ...
    <div id="topnavigation_right" class="oae-force-right">
        ...
        <div id="topnavigation_search" class="oae-search oae-force-right" role="search" aria-label="__MSG__TOPNAV_SEARCH_ARIA_LABEL__">
...
<div id="topnavigation_left_loggedin_template"><!--
    <ul role="menubar">
        <li class="oae-menu-dropdown">
            <a href="/me" class="oae-bold topnavigation-menu-item" role="menuitem" aria-haspopup="true">__MSG__YOU__</a>
        ...
        <li class="oae-menu-dropdown">
            ...
            <div class="oae-menu-dropdown-container oae-hidden">
                <ul role="menu" aria-hidden="true" class="oae-menu-dropdown-container-content">
                    <li><a role="menuitem" href="/search" class="oae-regular-links oae-bold">__MSG__BROWSE_ALL__</a></li>
                    <li><hr class="oae-split-line"/></li>
...
<div id="topnavigation_right_loggedin_template"><!--
    <ul role="menu" class="oae-force-right">
        <li class="oae-menu-dropdown">
            <a href="/me#" class="oae-bold oae-threedots oae-my-displayname topnavigation-menu-item" role="menuitem" aria-haspopup="true">${oae.data.me.profile.displayName|safeUserInput}</a>
            <div class="oae-menu-dropdown-container oae-hidden">
                <ul role="menu" aria-hidden="true" class="oae-menu-dropdown-container-content">
