        ...
        <div id="topnavigation-right" class="col-xs-5 text-right">
            ...
            <form id="topnavigation-search-form" class="form-inline" role="search" aria-label="__MSG__TOPNAV_SEARCH_ARIA_LABEL__">
                <div class="form-group">
                    ...
                    <input type="text" id="topnavigation-search-query" name="topnavigation-search-query" class="search-query form-control pull-left" title="__MSG__SEARCH_FOR_CONTENT_PEOPLE_GROUPS__"/>
