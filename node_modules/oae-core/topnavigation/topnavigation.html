    ...
    <div class="row-fluid">
        ...
        <div id="topnavigation-right" class="span5 text-right">
            ...
            <form id="topnavigation-search-form" class="navbar-search" role="search" aria-label="__MSG__TOPNAV_SEARCH_ARIA_LABEL__">
                ...
                <input type="text" id="topnavigation-search-query" class="search-query" name="topnavigation-search-query" title="__MSG__SEARCH_FOR_CONTENT_PEOPLE_GROUPS__"/>
    ...
    <ul class="pull-right inline topnavigation-menu-buttons">
        <li class="dropdown">
            ...
            <div id="topnavigation-signin-dropdown" class="dropdown-menu pull-right text-left {if hasLocalAuth && hasRedirectAuth} topnavigation-signin-dropdown-double {else} topnavigation-signin-dropdown-single {/if}">
                <div class="row-fluid">
                    {if hasRedirectAuth}
                        <div id="topnavigation-signin-external" class="{if hasLocalAuth && hasRedirectAuth} span6 {else} span12 {/if} text-center">
                            <ul class="inline">
                    ...
                    {/if}
                    {if hasLocalAuth}
                        <div id="topnavigation-signin-internal" class="{if hasLocalAuth && hasRedirectAuth} span6 {else} span12 {/if}">
