...
<div id="topnavigation-container" role="navigation" aria-label="__MSG__TOPNAV_ARIA_LABEL__">
    ...
    <div class="row">
        ...
        <!-- RIGHT MENU -->
        <div id="topnavigation-right" class="col-md-5 col-xs-12 clearfix">
            <div id="topnavigation-loginlogout-container" class="col-md-2 col-xs-1 pull-right"><!-- --></div>
            <!-- SEARCH -->
    ...
    <ul class="pull-right list-inline topnavigation-menu-buttons">
        <li class="dropdown">
            ...
            <div id="topnavigation-signin-dropdown" class="dropdown-menu pull-right text-left {if hasLocalAuth && hasRedirectAuth} topnavigation-signin-dropdown-double {else} topnavigation-signin-dropdown-single {/if}">
                <div class="row">
                    {if hasRedirectAuth}
                        <div id="topnavigation-signin-external" class="{if hasLocalAuth && hasRedirectAuth} col-md-6 {else} col-md-12 {/if} text-center">
                    ...
                    {/if}
                    {if hasLocalAuth}
                        <div id="topnavigation-signin-internal" class="{if hasLocalAuth && hasRedirectAuth} col-md-6 {else} col-md-12 {/if}">
                            <form id="topnavigation-signin-form" role="form">
                                <div class="form-group">
                                    <label for="topnavigation-signin-username">__MSG__USERNAME__</label>
                                ...
                                <div class="form-group">
                                    <label for="topnavigation-signin-password">__MSG__PASSWORD__</label>
