...
<div id='topnavigation_left_loggedin_template'><!--
    <ul role='menubar'>
        ...
        <li class='oae-menu-dropdown'>
            ...
            <div class='oae-menu-dropdown-container oae-hidden'>
                <ul role='menu' aria-hidden='true' class='oae-menu-dropdown-container-content'>
                    <li><a  role='menuitem' href='#' class='oae-regular-links oae-bold'>__MSG__ADD_CONTENT__</a></li>
...
<div id='topnavigation_right_loggedin_template'><!--
    <ul role='menu' class='oae-force-right'>
        <li class='oae-menu-dropdown'>
            <a href='/me#' class='oae-bold oae-threedots topnavigation-menu-item' role='menuitem' aria-haspopup='true'>${oae.api.util.security().safeUserInput(oae.data.me.profile.displayName)}</a>
            <div class='oae-menu-dropdown-container oae-hidden'>
                <ul role='menu' aria-hidden='true' class='oae-menu-dropdown-container-content'>
...
<div id='topnavigation_right_anonymous_template'><!--
    <ul role='menu' class='oae-force-right'>
        <li class='oae-menu-dropdown'>
            ...
            <div id='topnavigation_user_options_login_fields' class='oae-menu-dropdown-container oae-hidden'>
