...
<!--<div id="topnavigation-container" role="navigation" class="hide" aria-label="__MSG__TOPNAV_ARIA_LABEL__">
...
<div id="topnavigation-container" role="navigation" aria-label="__MSG__TOPNAV_ARIA_LABEL__">
    ...
    <div class="clearfix">
        ...
        <div class="col-xs-5 text-right" style="background-color: red;">3</div>
    </div>
</div>
<h1 id="topnavigation-target" class="oae-aural-text">__MSG__SKIP_MENU_TARGET__</h1>
