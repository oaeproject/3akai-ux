...
<div id="topnavigation-container" role="navigation" aria-label="__MSG__TOPNAV_ARIA_LABEL__">
    ...
    <div class="row-fluid">
        ...
        <!-- LOGO -->
        <div id="topnavigation-center" class="span2 oae-text-align-center">
            <a href="/" class="oae-institutional-logo" title="__MSG__OAE__">
                <span class="oae-aural-text">__MSG__OAE__</span>
            </a>
        </div>
        <!-- RIGHT MENU -->
        <div id="topnavigation-right" class="span5 oae-text-align-right">
            <!-- SEARCH -->
...
<div id="topnavigation-left-anonymous-template"><!--
    {if oae.api.config.getValue('oae-authentication', 'local', 'allowAccountCreation')}
        <button class="btn btn-link">__MSG__SIGN_UP__</button>
    {/if}
--></div>
...
<div id="topnavigation-right-anonymous-template"><!--
    ...
    <ul class="pull-right inline">
        <li class="dropdown">
            ...
            <div id="topnavigation-signin-dropdown" class="dropdown-menu pull-right oae-text-align-left">
                <div class="row-fluid">
                    <div class="span6 oae-text-align-center">
                        <ul class="inline">
                    ...
                    <div class="span6">
                        <form id="topnavigation-user-options-login-form">
                            <div>
                                <label for="topnavigation-login-username">__MSG__USERNAME__</label>
                                <input id="topnavigation-login-username" name="topnavigation-login-username" type="text" class="required" maxlength="255">
                            </div>
                            <div>
                                <label for="topnavigation-login-password">__MSG__PASSWORD__</label>
                                <input id="topnavigation-login-password" name="topnavigation-login-password" type="password" class="required" maxlength="255">
                            </div>
                            <div>
                                <button id="topnavigation-user-options-login-button-login" class="btn pull-right" type="submit">__MSG__SIGN_IN__</button>
                                <span class="hide" id="topnavigation-user-options-login-button-signing-in" class="pull-right">__MSG__SIGNING_IN__...</span>
                                {if oae.api.config.getValue("oae-authentication", "local", "allowAccountCreation")}
...
<!--
   <div id="topnavigation-user-options-login-fields" class="{if hasExternalAuth && hasLocalAuth}topnavigation-local-and-external {/if}">
                    <div id="topnav-3rd-party-login-container" {if !hasExternalAuth} class="hide" {/if}>
                    ...
                    <div id="topnav-local-login-container" {if !hasLocalAuth} class="hide" {/if}>
