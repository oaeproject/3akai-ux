...
<div id="topnavigation-right-anonymous-template"><!--
    ...
    <ul class="pull-right inline topnavigation-menu-buttons">
        <li class="dropdown">
            ...
            <div id="topnavigation-signin-dropdown" class="dropdown-menu pull-right text-left {if hasLocalAuth && hasExternalAuth} topnavigation-signin-dropdown-double {else} topnavigation-signin-dropdown-single {/if}">
                <div class="row-fluid">
                    {if hasExternalAuth}
                        <div id="topnavigation-signin-external" class="{if hasLocalAuth && hasExternalAuth} span6 {else} span12 {/if} text-center">
                            <ul class="inline">
                                ...
                                {if oae.api.config.getValue("oae-authentication", "cas", "enabled")}
									{var name = oae.api.config.getValue("oae-authentication","cas","name")}
                                    <li>
                                        <a class="btn-auth btn-yahoo btn-cas" href="/api/auth/cas">
                                            <div>__MSG__SIGN_IN_WITH__</div>
                                        </a>
                                    </li>
                                {/if}
                                {if oae.api.config.getValue("oae-authentication", "shibboleth", "enabled")}
									{var name = oae.api.config.getValue("oae-authentication","shibboleth","name")}
                                    <li>
                                        <a class="btn-auth btn-yahoo btn-shibboleth" href="/api/auth/shibboleth">
                                            <div>__MSG__SIGN_IN_WITH__</div>
                                        </a>
                                    </li>
                                {/if}
                    ...
                    {/if}
                    {if hasLocalAuth}
                        <div id="topnavigation-signin-internal" class="{if hasLocalAuth && hasExternalAuth} span6 {else} span12 {/if}">
                            <form id="topnavigation-signin-form">
                                <div class="control-group">
                                    <label for="topnavigation-signin-username" class="control-label">__MSG__USERNAME__</label>
                                    <input id="topnavigation-signin-username" name="topnavigation-signin-username" type="text" class="input-block-level required" maxlength="255">
                                </div>
                                <div class="control-group">
                                    <label for="topnavigation-signin-password" class="control-label">__MSG__PASSWORD__</label>
                                    <input id="topnavigation-signin-password" name="topnavigation-signin-password" type="password" class="input-block-level required" maxlength="255">
                                </div>
