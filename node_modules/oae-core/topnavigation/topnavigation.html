...
<div id="topnavigation-right-anonymous-template"><!--
    ...
    <button id="topnav-signin-link" class="btn btn-link" data-toggle="topnavigation-signin-dropdown">__MSG__SIGN_IN__</button>

    <div class="topnavigation-signin-dropdown oae-popup-white topnav-signin oae-form-field-wrapper hide">
        <div id="topnavigation-user-options-login-fields" class="{if hasExternalAuth && hasLocalAuth}topnavigation-local-and-external {/if}">
            ...
            <div id="topnav-local-login-container" {if !hasLocalAuth} class="hide" {/if}>
                <form id="topnavigation-user-options-login-form" novalidate="novalidate">
                    ...
                    <button id="topnavigation-user-options-login-button-login" class="oae-button oae-overlay-button pull-right" type="submit">Sign in</button>
