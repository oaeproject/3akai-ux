        ...
        <div id="topnavigation-right" class="col-xs-5 text-right">
            ...
            <form id="topnavigation-search-form" class="form-inline" role="search" aria-label="__MSG__TOPNAV_SEARCH_ARIA_LABEL__">
                <div class="form-group">
                    ...
                    <button type="submit" id="topnavigation-search-icon" class="btn btn-link pull-left" rel="tooltip" data-placement="bottom" data-title="__MSG__SEARCH__">
...
<div id="topnavigation-left-loggedin-template"><!--
    <ul class="list-inline" role="menubar">
        <li>
            <a href="/me" class="btn btn-link" role="menuitem" rel="tooltip" data-placement="bottom" data-original-title="__MSG__HOME__">
                <i class="fa fa-home"><span class="sr-only">__MSG__HOME__</span></i>
            </a>
        </li>
        <li id="topnavigation-notifications-container">
            <button type="button" class="btn btn-link oae-trigger-notifications" role="menuitem" rel="tooltip" data-placement="bottom" data-title="__MSG__NOTIFICATIONS__">
    ...
    <ul class="list-inline" role="menubar">
        ...
        <li>
            <form action="/api/auth/logout" method="POST">
                <button type="submit" class="btn btn-link" rel="tooltip" data-placement="bottom" data-title="__MSG__SIGN_OUT__">
