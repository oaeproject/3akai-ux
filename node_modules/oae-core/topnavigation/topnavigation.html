            ...
            <ul role="menu">
                {for r in data.results}
                    <li>
                        ...
                        <div>
                            <a role="menuitem" tabindex="-1" href="/${r.resourceType}/${r.id}" title="${r.displayName|encodeForHTMLAttribute}" class="oae-bold oae-threedots">${r.displayName|encodeForHTML}</a>
                        </div>
                    </li>
