...
<div id="topnavigation-container" role="navigation" aria-label="__MSG__TOPNAV_ARIA_LABEL__">
    ...
    <div class="row">
        ...
        <div id="topnavigation-right" class="col-xs-5 text-right">
            <!-- SEARCH FORM -->
            <form id="topnavigation-search-form" class="form-inline topnavigation-search" role="search" aria-label="__MSG__TOPNAV_SEARCH_ARIA_LABEL__">
...
<div id="topnavigation-right-anonymous-template"><!--
    ...
    <ul class="list-inline">
        <li class="topnavigation-search topnavigation-search-button">
