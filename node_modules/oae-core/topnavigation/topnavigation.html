...
<div id="topnavigation-institutional-logo-template"><!--
    <span class="oae-institutional-logo hidden-xs visible-sm" title="${oae.data.me.tenant.displayName|encodeForHTMLAttribute}">
...
<div id="topnavigation-anonymous-template"><!--
        <div id="topnavigation-left" class="col-xs-4"></div>
        <div id="topnavigation-right" class="col-xs-8 text-right">
...
<div id="topnavigation-left-anonymous-template"><!--
    <a href="/" class="oae-institutional-logo oae-institutional-logo-left" title="${oae.data.me.tenant.displayName|encodeForHTMLAttribute}">
        <span class="sr-only">${oae.data.me.tenant.displayName|encodeForHTML}</span>
    </a>
--></div>
...
<div id="topnavigation-right-anonymous-template"><!--
    ...
    <ul class="list-inline">
        {if oae.api.config.getValue('oae-authentication', 'local', 'allowAccountCreation')}
            <li>
                <button type="button" class="btn btn-link oae-trigger-register">__MSG__CREATE_ACCOUNT__</button>
            </li>
        {/if}
        <li class="dropdown">
            {if hasSingleInstitutionalAuth}
                                    ...
                                    <div id="topnavigation-login-actions">
                                        ...
                                        {if oae.api.config.getValue("oae-authentication", "local", "allowAccountCreation")}
                                            <span>__MSG__NO_ACCOUNT_YET__
                                                <button id="topnavigation-signin-signup" type="button" class="btn btn-link oae-trigger-register">__MSG__CREATE_ACCOUNT__</button>
                                            </span>
                                        {/if}
                                    </div>
                                </form>
...
<div id="topnavigation-loggedin-template"><!--
    <div id="topnavigation-left" class="col-sm-5 col-xs-6 topnavigation-icons"></div>
    <div id="topnavigation-institutional-logo-container" class="col-sm-2 hidden-xs text-center"></div>
    <div id="topnavigation-right" class="col-sm-5 col-xs-6 text-right topnavigation-icons">
        <form action="." id="topnavigation-search-form" class="form-inline" role="search" aria-label="__MSG__TOPNAV_SEARCH_ARIA_LABEL__">
            <div class="form-group">
                <label for="topnavigation-search-query" class="control-label sr-only">__MSG__SEARCH__</label>
                <input type="text" id="topnavigation-search-query" name="topnavigation-search-query" class="search-query form-control pull-left" title="__MSG__SEARCH_FOR_CONTENT_FOLDERS_PEOPLE_GROUPS__"/>
...
<div id="topnavigation-left-loggedin-template"><!--
    <ul class="list-inline" role="menubar">
        <li>
            <a href="/" class="btn btn-link" role="menuitem" title="__MSG__HOME__">
