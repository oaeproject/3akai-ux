...
<div id="topnavigation_container" role="navigation" aria-label="__MSG__TOPNAV_ARIA_LABEL__">
    <a id="topnavigation_skip" class="oae-aural-text" href="#topnavigation_target" accesskey="__MSG__SKIP_TOP_MENU_KEY__">__MSG__SKIP_TOP_MENU__</a>
    <a id="lhnavigation_skip"  class="oae-aural-text" href="#lhnavigation_target" accesskey="__MSG__SKIP_TO_LH_MENU_KEY__">__MSG__SKIP_TO_LH_MENU__</a>
    <div id="topnavigation-scroll-to-top_container">
        <button type="button" class="oae-link-button oae-hidden" id="topnavigation-scroll-to-top" title="__MSG__SCROLL_TO_TOP__" accesskey="s"></button>
    </div>
    <div class="oae-layout-40-20-40">
        <div id="topnav-left"></div>
        <div id="topnav-center" class="oae-text-align-center">
            <a href="/">
                <img src="/ui/img/framework/oae-logo.png"/>
            </a>
        </div>
...
<div id="topnavigation-right-loggedin-template"><!--
    ...
    <a href="#" title="Account settings" class="oae-align-right">
        <div class="oae-cogwheel-icon"></div>
    </a>
    <form id="topnav-search-form" class="oae-align-right">
...
<div id="topnavigation-right-anonymous-template"><!--
    ...
    <a href="#" title="Sign in" class="oae-align-right topnav-links" id="topnav-signin-link">__MSG__SIGN_IN__</a>
    <form id="topnav-search-form" class="oae-align-right">
        <input type="text" id="topnav-search-input" class="oae-align-right"/>
    </form>
