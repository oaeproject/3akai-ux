...
<div id="topnavigation-right-anonymous-template"><!--
    <ul class="list-inline">
        ...
        <li class="topnavigation-haveaccount" class="hidden-sm">__MSG__ALREADY_HAVE_AN_ACCOUNT__</li>
        <li class="topnavigation-signin">
            <a href="#" class="btn btn-link oae-trigger-signin topnavigation-signin-action"
