...
<div id="search_template" style="display:none"><!--
    <a href="/search#l=all&q=${query|safeURL}" class="topnavigation-search-results-section-header">__MSG__SEARCH__</a>
    <ul role="menu">
       {for r in data.results}
            <li>
                ...
                <a role="menuitem" tabindex="-1" href="${r.profilePath|safeUserInput}" title="${r.displayName|safeUserInput}" class="oae-bold oae-threedots">${r.displayName|safeUserInput}</a>
            </li>
...
<div id="search_bottom_template" style="display:none;"><!--
    {if data.total}
        <a href="/search#l=all&q=${query|safeURL}" id="topnavigation_search_see_all" class="oae-button oae-overlay-button">
            __MSG__SEE_ALL__
        </a>
    {/if}
