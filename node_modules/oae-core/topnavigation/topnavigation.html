...
<div id="topnavigation-right-anonymous-template"><!--
    ...
    <ul class="pull-right inline">
        <li class="dropdown">
            ...
            <div id="topnavigation-signin-dropdown" class="dropdown-menu pull-right oae-text-align-left {if hasLocalAuth && hasExternalAuth} topnavigation-signin-dropdown-double {else} topnavigation-signin-dropdown-single {/if}">
                <div class="row-fluid">
                    {if hasExternalAuth}
                        <div class="{if hasLocalAuth && hasExternalAuth} span6 {else} span12 {/if} oae-text-align-center">
                                ...
                                <div id="topnavigation-login-actions">
                                    ...
                                    {if oae.api.config.getValue("oae-authentication", "local", "allowAccountCreation")}
                                        <span>__MSG__NO_ACCOUNT_YET__?
                                            <a href="/register">__MSG__SIGN_UP__</a>
                                        </span>
                                    {/if}
                                </div>
                            </form>
