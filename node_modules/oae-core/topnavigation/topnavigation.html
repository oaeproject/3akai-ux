...
<div id="topnavigation-container" role="navigation" aria-label="__MSG__TOPNAV_ARIA_LABEL__">
    ...
    <div class="row">
        <!-- LEFT MENU -->
        <div id="topnavigation-left" class="col-md-5 col-xs-5"><!-- --></div>
        <!-- LOGO -->
        <div id="topnavigation-center" class="col-md-2 col-xs-2 text-center">
            <a href="/" class="oae-institutional-logo" title="__MSG__OAE__">
                <span class="oae-aural-text">__MSG__OAE__</span>
            </a>
        </div>
        <!-- RIGHT MENU -->
        <div id="topnavigation-right" class="col-md-5 clearfix">
            ...
            <div class="col-md-8 pull-right">
                <form id="topnavigation-search-form" class="form-horizontal navbar-search" role="search" aria-label="__MSG__TOPNAV_SEARCH_ARIA_LABEL__">
                    <div class="form-group">
                        ...
                        <input type="text" id="topnavigation-search-query" class="visible-sm visible-md visible-lg search-query form-control pull-left" title="__MSG__SEARCH_FOR_CONTENT_PEOPLE_GROUPS__"/>
    ...
    <ul class="pull-right list-inline topnavigation-menu-buttons">
        <li class="dropdown">
            ...
            <div id="topnavigation-signin-dropdown" class="dropdown-menu pull-right text-left {if hasLocalAuth && hasRedirectAuth} topnavigation-signin-dropdown-double {else} topnavigation-signin-dropdown-single {/if}">
                <div class="row">
                    {if hasRedirectAuth}
                        <div id="topnavigation-signin-external" class="{if hasLocalAuth && hasRedirectAuth}col-xs-6 col-md-6 {else}col-xs-12 col-md-12 {/if} text-center">
                    ...
                    {/if}
                    {if hasLocalAuth}
                        <div id="topnavigation-signin-internal" class="{if hasLocalAuth && hasRedirectAuth}col-xs-6 col-md-6 {else}col-xs-12 col-md-12 {/if}">
                            <form id="topnavigation-signin-form" role="form">
                                <div class="form-group">
                                    ...
                                    <input id="topnavigation-signin-username" name="topnavigation-signin-username" type="text" class="form-control required" maxlength="255">
                                </div>
                                <div class="form-group">
...
<div id="topnavigation-left-loggedin-template"><!--
    <ul class="list-inline topnavigation-menu-buttons" role="menubar">
        ...
        <li>
            <button class="btn btn-link oae-trigger-notifications" title="__MSG__NOTIFICATIONS__" role="menuitem">
...
<div id="topnavigation-right-loggedin-template"><!--
    <button id="topnavigation-signout" class="btn btn-link pull-right" title="__MSG__SIGN_OUT__">
