    ...
    <ul role="menu">
       {for r in data.results}
            <li>
                ...
                {if !r.resourceType}
                    <a role="menuitem" tabindex="-1" href="/user/${r.id}" title="${r.title}" class="oae-bold oae-threedots">${r.title}</a>
                {elseif r.resourceType === 'group'}
                    <a role="menuitem" tabindex="-1" href="/group/${r.id}" title="${r.title}" class="oae-bold oae-threedots">${r.title}</a>
                {elseif r.resourceType === 'content'}
                    <a role="menuitem" tabindex="-1" href="/content/${r.id}" title="${r.title}" class="oae-bold oae-threedots">${r.title}</a>
                {/if}
            </li>
