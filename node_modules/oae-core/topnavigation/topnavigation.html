...
<div id="topnavigation-left-anonymous-template"><!--
    <a id="topnavigation-left-signup" href="/signup" class="btn btn-link">__MSG__SIGN_UP__</button>
--></div>

<div id="topnavigation-right-anonymous-template"><!--
    {macro externalAuth(id, strategy)}
        {var opts = new Object()}
        ${opts.data = new Object()|eat}
        ${opts.data.redirectUrl = redirectUrl|eat}
        ${opts.data.invitationToken = invitationInfo.token|eat}

        <li>
            ${authExternalButton(id, strategy, opts)}
        </li>
    {/macro}

    {var allowAccountCreation = authStrategyInfo.allowAccountCreation}
    {var enabledStrategies = authStrategyInfo.enabledStrategies}
    {var enabledExternalStrategies = authStrategyInfo.enabledExternalStrategies}
    ...
    <ul class="list-inline">
        ...
        <li class="topnavigation-haveaccount">__MSG__ALREADY_HAVE_AN_ACCOUNT__</li>
        <li>
            <a href="#" class="btn btn-link oae-trigger-signin"
                data-redirecturl="${redirectUrl}"
                data-token="${invitationInfo.token}"
                data-email="${invitationInfo.email}"
                {if hidesignup} data-hidesignup="true"{/if}>
                __MSG__SIGN_IN__
            </a>
        </li>
    </ul>
