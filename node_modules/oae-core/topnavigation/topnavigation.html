...
<div id="topnavigation-container" role="navigation" aria-label="__MSG__TOPNAV_ARIA_LABEL__">
    ...
    <div class="row">
        <!-- LEFT MENU -->
        <div id="topnavigation-left" class="col-md-5"><!-- --></div>
        <!-- LOGO -->
        <div id="topnavigation-center" class="col-md-2 text-center">
            <a href="/" class="oae-institutional-logo" title="__MSG__OAE__">
                <span class="oae-aural-text">__MSG__OAE__</span>
            </a>
        </div>
        <!-- RIGHT MENU -->
        <div id="topnavigation-right" class="col-md-5 text-right">
            <!-- SEARCH -->
