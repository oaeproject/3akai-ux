...
<div id="topnavigation-left-anonymous-template"><!--
    {if !hidesignup && !authStrategyInfo.hasSingleExternalAuth}
...
<div id="topnavigation-right-anonymous-template"><!--
    <ul class="list-inline">
        ...
        {else}
            <li class="topnavigation-haveaccount">
                <span>__MSG__ALREADY_HAVE_AN_ACCOUNT__</span>
            </li>
        {/if}
        <li>
            <button href="#" class="btn btn-link oae-trigger-signin topnavigation-signin-action"
