            ...
            <div class="col-md-8 pull-right">
                <form id="topnavigation-search-form" class="form-horizontal navbar-search" role="search" aria-label="__MSG__TOPNAV_SEARCH_ARIA_LABEL__">
                    <div class="form-group">
                        ...
                        <input type="text" id="topnavigation-search-query" class="hidden-xs hidden-sm search-query form-control pull-left" name="topnavigation-search-query" title="__MSG__SEARCH_FOR_CONTENT_PEOPLE_GROUPS__"/>
