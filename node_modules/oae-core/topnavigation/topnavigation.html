...
<div id="topnavigation-container" role="navigation" aria-label="__MSG__TOPNAV_ARIA_LABEL__">
    ...
    <div class="row">
        <!-- LEFT MENU -->
        <div id="topnavigation-left" class="col-xs-7 col-sm-5"><!-- --></div>
        <!-- LOGO -->
        ...
        <!-- RIGHT MENU -->
        <div id="topnavigation-right" class="col-xs-5 col-sm-5 col-md-5">
            ...
            <div class="col-md-8 pull-right">
                <form id="topnavigation-search-form" class="form-horizontal navbar-search" role="search" aria-label="__MSG__TOPNAV_SEARCH_ARIA_LABEL__">
                    <div class="form-group">
                        ...
                        <input type="text" id="topnavigation-search-query" class="hidden-xs search-query form-control pull-left" name="topnavigation-search-query" title="__MSG__SEARCH_FOR_CONTENT_PEOPLE_GROUPS__"/>
                        ...
                        <div id="topnavigation-signin-internal" class="{if hasLocalAuth && hasRedirectAuth}col-xs-12 col-sm-12 col-md-6 {else}col-xs-12 col-sm-12 col-md-12 {/if}">
                            <form id="topnavigation-signin-form" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="topnavigation-signin-password" name="topnavigation-signin-password" type="password" autocapitalize="off" autocorrect="off" class="form-control required" maxlength="255">
                                </div>
