...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var initRightMenu = function() {
            ...
            $('#topnavigation-right', $rootel).append(oae.api.util.template().render(template));
        };
        ...
        var setUpPushNotifications = function() {
            if (!oae.data.me.anon) {
                oae.api.push.subscribe(oae.data.me.id, 'notification', oae.data.me.signature, 'activitystreams', true, function(activity, hasBeenAggregated) {

                    // TODO: When the backend increases the notification count by aggregate, the UI should do the same
                    // This can be achieved by checking the `hasBeenAggregated` variable
                    ...
                    // Show a notification about the activity
                    if ($('.oae-trigger-notifications + .popover:visible', $rootel).length === 0) {
                        ...
                        oae.api.util.notification(null, notificationBody, 'info', activity['oae:activityId']);
                    }
                });
            }
        };
