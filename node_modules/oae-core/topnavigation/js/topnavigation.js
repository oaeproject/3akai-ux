...
define(['jquery', 'oae/api/oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var initLeftMenu = function() {
            if (oae.data.me.anon) {
                oae.api.util.renderTemplate('#topnavigation_left_anonymous_template', null, $('#topnav-left'));
            } else {
                oae.api.util.renderTemplate('#topnavigation_left_loggedin_template', null, $('#topnav-left'));
            }
        };
        ...
        var initRightMenu = function() {
            if (oae.data.me.anon) {
                oae.api.util.renderTemplate('#topnavigation_right_anonymous_template', null, $('#topnav-right'));
            } else {
                oae.api.util.renderTemplate('#topnavigation_right_loggedin_template', null, $('#topnav-right'));
            }
        };
