...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var initTopNavigation = function() {
            // If the user is anonymous the topnavigation container width needs to be adjusted
            if (oae.data.me.anon) {
                $('#topnavigation-left', $rootel).addClass('col-xs-6');
                $('#topnavigation-left', $rootel).removeClass('col-xs-7');
                $('#topnavigation-right', $rootel).addClass('col-xs-6');
                $('#topnavigation-right', $rootel).removeClass('col-xs-5');
            }
        ...
        var initRightMenu = function() {
            ...
            // Render only login/logout as the search bar will already be there
