...
define(['jquery', 'oae.core', 'activityadapter'], function($, oae, ActivityAdapter) {
    ...
    return function(uid, showSettings) {
        ...
        var initTopNavigation = function() {
            var $template = oae.data.me.anon ? $('#topnavigation-anonymous-template') : $('#topnavigation-loggedin-template');
            oae.api.util.template().render($template, null, $('#topnavigation-container .row', $rootel));
            initLeftMenu();
            initRightMenu();
            initInstitutionalLogo();

            // Search page requires unique styles
            if (window.location.pathname.indexOf('/search/') === 0) {
                $('#topnavigation-container', $rootel).addClass('topnavigation-search');                
            }
        };
