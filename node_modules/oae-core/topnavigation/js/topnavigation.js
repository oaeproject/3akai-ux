...
define(['jquery', 'oae.core', 'activityadapter'], function($, oae, ActivityAdapter) {
    ...
    return function(uid, showSettings) {
        ...
        var initRightMenu = function() {
            // Hide search on the landing and search pages
            if (_.contains(['', '/', '/index', '/search', '/search/'], document.location.pathname)) {
                $('#topnavigation-right', $rootel).addClass('topnavigation-hide-search');
            }
            if (oae.data.me.anon) {
