...
require(['jquery', 'sakai/sakai.api.core'], function($, sakai) {
    ...
    sakai_global.topnavigation = function(tuid, showSettings) {
        ...
        var navLinkDropdown = '.oae-dropdown-container';
        ...
        var renderMenu = function() {
            ...
            var skipLinkPosition = (sakai.config.enableBranding) ?
                $('.branding_widget').height() + $('.oae-navigation-container:first').height() + 'px' :
                $('.oae-navigation-container:first').height() + 'px';

            //Prepend skip links to body to ensure that they're the first tabable elements on the page
            var skipLinks = $('.oae-jump-link');
        ...
        var hideMessageInlay = function() {
            $('#topnavigation_user_messages_container .oae-dropdown-menu').hide();
        ...
        var addBinding = function() {
            ...
            sakai.api.Util.hideOnClickOut('#topnavigation_user_messages_container .oae-dropdown-menu', '', function() {
                hideMessageInlay();
            });
            ...
            $('#topnavigation_container .topnavigation_explore .oae-dropdown-menu,.topnavigation_counts_container button').keydown(function(e) {
            ...
            $('#topnavigation_container .topnavigation_right .oae-dropdown-menu').keydown(function(e) {
                var $focusElement = $(this);
                if (e.which === $.ui.keyCode.DOWN && $focusElement.hasClass('hassubnav')) {
                    $focusElement.find('div a:first').focus();
                    return false; // prevent browser page from scrolling down
            ...
            $rootel.on('focus', hasSubnav + ' a', function() {
                if ($(this).parent().hasClass('hassubnav')) {
                    ...
                    $(this).parents('.oae-dropdown-menu').children('a').addClass(topnavigationForceSubmenuDisplayTitle);
                }
            });
            ...
            $rootel.on('click', hasSubnav + ' a', function() {
                ...
                if ($(this).parents('.oae-dropdown-container').length) {
            ...
            $('.topnavigation_search .oae-search-button').on('click', handleEnterKeyInSearch);
            ...
            $('#topnavigation_search_input,#navigation_anon_signup_link,#topnavigation_user_inbox_container,.topnavigation_search .oae-search-button').on('focus',function(evt) {
                mouseOverSignIn = false;
                $(topnavUserLoginButton).trigger('mouseout');
                $('html').trigger('click');
            ...
            $rootel.on('click', ['#topnavigation_message_showall', '#topnavigation_message_readfull',
                '.no_messages .oae-no-results-container a'], hideMessageInlay);
        ...
        $rootel.on('click', '#topnavigation_messages_container', function() {
            if ($('#topnavigation_user_messages_container .oae-dropdown-menu').is(':hidden')) {
                sakai.api.Communication.getAllMessages('inbox', false, false, 1, 0, '_created', 'desc', function(success, data) {
                    ...
                    var $messageContainer = $('#topnavigation_user_messages_container .oae-dropdown-menu');
