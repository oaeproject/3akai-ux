...
casper.test.begin('Widget - Top navigation', function(test) {
    ...
    var verifyAnonymousTopNavigation = function() {
        casper.waitForSelector('.oae-trigger-register', function() {
            ...
            test.assertExists(
                '.oae-trigger-register',
                "The 'Sign up' button is present",
            );
            // Verify that the institutional logo is present
            test.assertExists(
                '.oae-institutional-logo',
                'The institutional logo is present',
            );
            // Verify that the search box is present
            test.assertExists(
                'form#topnavigation-search-form',
                'The search form is present',
            );
            test.assertExists(
                'form#topnavigation-search-form input#topnavigation-search-query',
                'The search input field is present',
            );
            test.assertExists(
                'form#topnavigation-search-form button[type="submit"]',
                'The search submit button is present',
            );
            ...
            test.assertExists(
                'form#topnavigation-signin-form',
                'The sign in form is present after click on sign in button',
            );
            test.assertExists(
                'form#topnavigation-signin-form #topnavigation-signin-username',
                'The username field is present',
            );
            test.assertExists(
                'form#topnavigation-signin-form #topnavigation-signin-password',
                'The password field is present',
            );
            test.assertExists(
                'form#topnavigation-signin-form button[type="submit"]',
                'The form submit button is present',
            );
            test.assertExists(
                'form#topnavigation-signin-form button.oae-trigger-register',
                "The 'Sign up' link is present",
            );
            // Verify that there is a container for external log in options
            test.assertExists(
                '#topnavigation-signin-external',
                'The external log in container is present',
            );
    ...
    var verifyLogin = function(user) {
        ...
        test.assertExists(
            '#topnavigation-signin-username',
            'Successfully validated empty form - username',
        );
        test.assertExists(
            '#topnavigation-signin-password',
            'Successfully validated empty form - password',
        );
        ...
        test.assertExists(
            '#topnavigation-signin-password',
            'Successfully validated form without password',
        );
        ...
        test.assertExists(
            '#topnavigation-signin-username',
            'Successfully validated form without username',
        );
        ...
        test.assertExists(
            '#topnavigation-signin-username',
            'Successfully validated form with incorrect credentials',
        );
        ...
        casper.waitForSelector('#me-clip-container h1', function() {
            test.assertExists(
                ...
                'Successfully logged in through the top navigation',
            );
        });
    };
    ...
    var verifyLoggedInTopNavigation = function() {
        casper.waitForSelector('#topnavigation-left', function() {
            ...
            test.assertExists(
                '#topnavigation-left a[href="/"]',
                "The 'Home' button is present",
            );
            // Verify that the notifications button is present
            test.assertExists(
                '#topnavigation-left button.oae-trigger-notifications',
                "The 'Notifications' button is present",
            );
            // Verify that the search box is present
            test.assertExists(
                'form#topnavigation-search-form',
            ...
            test.assertExists(
                '#topnavigation-right form[action="/api/auth/logout"] button',
            ...
            casper.waitForSelector('#topnavigation-signin', function() {
                test.assertDoesntExist(
                    'button#topnavigation-signout',
                    'Successfully logged out through the top navigation',
                );
            });
        });
    };
    ...
    var verifyTopNavigationSearch = function() {
        ...
        casper.waitForSelector('#search-query', function() {
            ...
            test.assertEquals(
                casper.getCurrentUrl().split('/')[4],
                'Apereo OAE',
                "The search query 'Apereo OAE' is showing on the search page",
            );
        });
    };
