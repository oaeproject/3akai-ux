    ...
    sakai_global.searchall = function(tuid, showSettings) {
        ...
        var searchConfig = {
            ...
            global: {
                ...
                text: '#form .oae-search-inputfield',
                searchButton: '#form .oae-search-button'
            },
            results: {
                container: search + '_results_container',
                resultsContainer: search + '_results',
                resultsContainerAnonClass: 'oae-search-results-anon',
        ...
        var doSearch = function() {
            ...
            infinityScroll = $(searchConfig.results.container).infinitescroll(url, {
                ...
                if (total === 1) {
                    $(searchConfig.global.numberFound, $rootel).next('span.oae-aural-text').text(
