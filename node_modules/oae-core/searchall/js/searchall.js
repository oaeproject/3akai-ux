...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        var handleEmptyResultList = function() {
            oae.api.util.template().render($('#searchall_noresults_template'), null, $('#searchall_results_container'));
        };
        ...
        var search = function() {
            ...
            infinityScroll = $('#searchall_results_container').infiniteScroll('/api/search/general', {
                'limit': 12,
                'q': $.bbq.getState('q')
