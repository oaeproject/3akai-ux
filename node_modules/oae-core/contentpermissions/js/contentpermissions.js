...
define(['jquery', 'underscore', 'oae/api/oae.core', 'jquery-plugins/jquery.autoSuggest.sakai-edited'], function($, _, oae) {
    return function(uid, showSettings) {
        ...
        var saveMembers = function() {
            ...
            // If there are changes save them.
                ...
                oae.api.content.updateMembers(contentData.contentId, newRoles, function(err) {
                    if (err) {
        ...
        var doSave = function() {
            ...
            if (newVisibilityVal !== contentData.visibility) {
                oae.api.content.updateContent(contentData.contentId, { 'visibility': newVisibilityVal }, function(err) {
                    if (err) {
        ...
        var showWarning = function() {
            ...
            if (visibility === newVisibilityVal || visibilityindex[newVisibilityVal] > visibilityindex[visibility]) {
                ...
                $('#contentpermissions_warning_container_text').html(oae.api.util.renderTemplate('#contentpermissions_warning_container_text_template', {
        ...
        var setupAutoSuggest = function(page) {
            ...
            $("#contentpermissions_members_autosuggest", $rootel).autoSuggest("/api/search/general/user/", {
        ...
        var handleEmptyResultList = function() {
            oae.api.util.renderTemplate($('#contentpermissions_members_noresults_template'), null, $('.oae-list', $rootel));
        };
        ...
        var renderContainer = function() {
            ...
            oae.api.util.renderTemplate('#contentpermissions_content_template', {
                'content': contentData,
            ...
            infinityScroll = $('#contentpermissions_members_list', $rootel).infiniteScroll('/api/content/' + contentData.contentId + '/members', {
                'limit': 12,
