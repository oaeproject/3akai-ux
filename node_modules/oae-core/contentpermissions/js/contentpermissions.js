        ...
        var setupAutoSuggest = function(page) {
            ...
            $('#contentpermissions_members_autosuggest', $rootel).autoSuggest('/api/search/general', {
                ...
                'retrieveComplete': function(data) {
                    ...
                    // TODO: The entire autosuggest component should be wrapped in an API function
                    //       that should take care of initializing the autosuggest and formatting the results
                    for (var i = 0; i < data.results.length; i++) {
                        data.results[i].id = oae.api.util.security().safeUserInput(data.results[i].id);
                        data.results[i].displayName = oae.api.util.security().safeUserInput(data.results[i].displayName);
                    }
                    return data.results;
                },
