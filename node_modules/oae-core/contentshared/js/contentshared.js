    ...
    return function(uid) {
        ...
        var getMembers = function() {
            ...
            infinityScroll = $('.oae-list', $rootel).infiniteScroll(url, {
                'limit': 8
            }, '#contentshared-sharedwith-template', {
                'scrollContainer': $('#contentshared-shared-container', $rootel),
        ...
        var initContentShared = function() {
            ...
            $(document).on('oae.context.send.contentshared', function(ev, contextData) {
