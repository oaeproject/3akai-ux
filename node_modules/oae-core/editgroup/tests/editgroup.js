...
casper.test.begin('Widget - Edit group', function(test) {
    ...
    var verifyOpenEditGroup = function() {
        casper.waitForSelector('#group-clip-container .oae-clip-content > button', function() {
            ...
            casper.waitForSelector('button.oae-trigger-editgroup', function() {
                test.assertExists('button.oae-trigger-editgroup', 'The edit group trigger is present');
                casper.click('button.oae-trigger-editgroup');
