...
casper.test.begin('Widget - Edit group', function(test) {
    ...
    var openEditGroup = function() {
        casper.waitForSelector(
            ...
            function() {
                ...
                casper.waitForSelector(
                    'button.group-trigger-editgroup',
                    function() {
                        test.assertExists(
                            'button.group-trigger-editgroup',
                            'The edit group trigger is present',
                        );
                        casper.click('button.group-trigger-editgroup');
                        casper.waitUntilVisible('#editgroup-modal', function() {
                            test.assertVisible(
                                '#editgroup-modal',
                                'Edit group pane is showing after trigger',
                            );
                            casper.click(
                                '#group-clip-container .oae-clip-content > button',
                            );
    ...
    var verifyEditGroupFormElements = function() {
        ...
        casper.waitForSelector('#editgroup-modal', function() {
            test.assertExists(
                'form#editgroup-form',
                'The edit group form is present',
            );
            test.assertExists(
                'form#editgroup-form #editgroup-name',
                'The edit group name field is present',
            );
            test.assertExists(
                'form#editgroup-form #editgroup-description',
                'The edit group description field is present',
            );
            test.assertExists(
                'form#editgroup-form .oae-large-options-container input[name="oae-joinable-group"]',
                'The editgroup joinable options are present',
            );
            test.assertExists(
                'form#editgroup-form button[type="submit"]',
                'The edit group form submit button is present',
            );
        });
    };
    ...
    var verifyEditGroupFormValidation = function() {
        casper.waitForSelector('#editgroup-modal', function() {
            ...
            test.assertVisible(
                '#editgroup-name-error',
                'Verify validating empty form, name error',
            );
            ...
            test.assertVisible(
                '#editgroup-name-error',
                'Verify validating form without name',
            );
        });
    };
        ...
        casper.waitForSelector(
            ...
            function() {
                test.assertDoesntExist(
                    ...
                    'The group details were successfully saved',
                );
                test.assertSelectorHasText(
                    '#group-clip-container h1',
                    'New group name',
                    "The group was successfully renamed to 'New group name'",
                );
            },
        );
    };
