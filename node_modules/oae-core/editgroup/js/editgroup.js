    ...
    return function(uid) {
        ...
        var editGroup = function() {
            ...
            var params = {
                ...
                'joinable': $('.oae-visibility-choice-container input[type="radio"]:checked', $rootel).val()
            };
        ...
        var setUpValidation = function() {
            oae.api.util.template().render($('#editgroup-elements-template', $rootel), {
                'group': groupProfile
            }, $('#editgroup-elements-container', $rootel));
