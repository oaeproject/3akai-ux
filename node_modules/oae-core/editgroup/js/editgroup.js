...
define(['jquery', 'oae.core'], function($, oae) {
    return function(uid) {
        ...
        var setUpEditGroup = function() {
            ...
            oae.api.util
                .validation()
                .validate($('#editgroup-form', $rootel), validateOpts);
        };
        ...
        var editGroup = function() {
            ...
            // Edit the group
            oae.api.group.updateGroup(groupProfile.id, params, function(
                err,
                data,
            ) {
                if (!err) {
                    ...
                    oae.api.util.notification(
                        oae.api.i18n.translate(
                            '__MSG__GROUP_EDITED__',
                            'editgroup',
                        ),
                        oae.api.i18n.translate(
                            '__MSG__GROUP_EDIT_SUCCESS__',
                            'editgroup',
                        ),
                        'success',
                    );
                    ...
                    oae.api.util.notification(
                        oae.api.i18n.translate(
                            '__MSG__GROUP_NOT_EDITED__',
                            'editgroup',
                        ),
                        oae.api.i18n.translate(
                            '__MSG__GROUP_EDIT_FAIL__',
                            'editgroup',
                        ),
                        'error',
                    );
        ...
        var setUpReset = function() {
            $('#editgroup-modal').on(
                ...
                function() {
                    ...
                    // Enable the form
                    $('#editgroup-form *', $rootel).prop('disabled', false);
                    $('#editgroup-form button[type="submit"]', $rootel).prop(
                        'disabled',
                        true,
                    );
                },
