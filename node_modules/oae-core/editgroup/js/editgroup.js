...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        var setUpEditGroupModal = function() {
            ...
            $('#editgroup-form', $rootel).on(oae.api.util.getInputChangeEventNames(), function() {
