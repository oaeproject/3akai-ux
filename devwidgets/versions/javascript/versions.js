...
require(["jquery", "sakai/sakai.api.core"], function($, sakai){
    ...
    sakai_global.versions = function(tuid, showSettings){
        ...
        var renderVersions = function(success, data){
            debug.log(data);
        ...
        var getVersions = function(){
            sakai.api.Server.loadJSON(contentPath + "/pageContent.versions.json", renderVersions);
        };
        ...
        $(window).bind("init.versions.sakai", function(){
            doInit();
        });
