...
require(["jquery", "sakai/sakai.api.core"], function($, sakai) {
    ...
    /**
     * @name sakai_global.uploadcontent
     *
     * @class uploadcontent
     *
     * @description
     ...
     */
    sakai_global.uploadcontent = function(tuid, showSettings){
        ...
        var saveLink = function(link){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    document.location = "/content#p=" + sakai.api.Util.encodeURIComponentI18n(this.url);
        ...
        sakai_global.uploadcontent.init = function(data){

            // Check for valid parameters
            if(!data || typeof data !== "object"){

                // If the parameters aren't valid, log an error message
                debug.warn("Upload Content widget - sakai_global.uploadcontent.init - the supplied data parameter is invalid: '" + data + "'");
