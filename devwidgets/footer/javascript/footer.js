...
sakai.footer = function(tuid,placement,showSettings){
    ...
    var showDebugInfo = function(container) {
        ...
        debug_text += " UX git: <a href='http://github.com/oszkarnagy/3akai-ux/tree/v_0.1.0_release'>v_0.1.0_release</a>";
        debug_text += " | KERNEL git: <a href='http://github.com/ieb/open-experiments/tree/0.2' target='_blank'>0.2</a>";
