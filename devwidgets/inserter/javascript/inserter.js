...
require(['jquery', 'sakai/sakai.api.core'], function($, sakai) {
    ...
    sakai_global.inserter = function (tuid, showSettings) {
         ...
         * @param collectionId {String} The id of the collection to increase the count of (cached variable)
         ...
         * @param ev {Object} Click event generated by clicking a collection list item
         */
         ...
         * @param collectionId {String} ID of the collection to add the items to
         * @param collectedCollections {Array} Array of collected collection IDs
         * @param collectedContent {Array} Array of collected content IDs
         */
