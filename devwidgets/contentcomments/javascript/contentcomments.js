            ...
            if (allowPost && body !== "") {
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        // Add an acitivty
                        sakai.api.Activity.createActivity("/p/" + sakai_global.content_profile.content_data.data["jcr:name"], "content", "default", {"sakai:activityMessage": "__MSG__CONTENT_ADDED_COMMENT__"}, function(activityData, success){
                            if (success) {
