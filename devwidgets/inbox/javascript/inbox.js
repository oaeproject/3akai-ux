...
require(["jquery", "sakai/sakai.api.core"], function($, sakai) {
    ...
    sakai_global.inbox = function(tuid, showSettings, widgetData, state) {
        ...
        var showReply = function() {
            ...
            var replyText = sakai.api.i18n.getValueForKey("REPLY", "inbox");
            ...
            $(window).trigger("initialize.sendmessage.sakai", [currentMessage.replyAll, $inbox_show_message_reply_fields, handleReplyFinished, messageSubject, null, true, currentMessage.id, replyText]);
