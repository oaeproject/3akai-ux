    ...
    sakai_global.contentmetadata = function(tuid, showSettings){
        ...
        var renderTags = function(mode){
            ...
            if (mode === "edit") {
                ...
                sakai.api.Util.AutoSuggest.setupTagAndCategoryAutosuggest($contentmetadataAutosuggestElt , {retrieveLimit:5,scrollHeight:"none"}, $( ".list_categories", $contentmetadataTagsContainer ), sakai_global.content_profile.content_data.data["sakai:tags"] );
