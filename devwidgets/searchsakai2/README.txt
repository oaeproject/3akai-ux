...
2) In your new directory, remove the README.txt file and change all occurences
   of searchsakai2 in filenames and the files themselves to the id of your widget.
   ...
   and, you should no longer be able to find occurences of searchsakai2 within your
   mywidget directory.
