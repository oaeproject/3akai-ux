                ...
                for (var i in data.results) {
                    if (data.results.hasOwnProperty(i)) {
                        ...
                        var tempFile = {
                            ...
                            "url": "/content#p=" + sakai.api.Util.encodeURIComponentI18n(data.results[i]["_path"]) + "/" + sakai.api.Util.encodeURIComponentI18n(data.results[i]["sakai:pooled-content-file-name"]),
                            "css_class": mimeType
                        };
                        files.push(tempFile);
                    }
