...
require(["jquery", "sakai/sakai.api.core"], function($, sakai) {
    ...
    sakai_global.siterecentactivity = function(tuid, showSettings){
        ...
        sakai_global.siterecentactivity.addRecentActivity = function(activityitem){
            ...
            if($.isPlainObject(activityitem)){
                ...
                var callback = function(){
                    ...
                    sakai_global.siterecentactivity.recentactivity.items.push(activityitem);
                ...
                sakai_global.siterecentactivity.getRecentActivity(callback);
        ...
        sakai_global.siterecentactivity.render();
