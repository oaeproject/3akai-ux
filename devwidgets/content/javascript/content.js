...
require(["jquery", "sakai/sakai.api.core"], function($, sakai) {
    ...
    /**
     * @name sakai_global.content
     *
     * @class content
     *
     * @description
     * The 'Content' widget shows the most recent content item, 
     * including its latest comment and one related content item
     *
     * @version 0.0.1
     * @param {String} tuid Unique id of the widget
     * @param {Boolean} showSettings Show the settings of the widget or not
     */
    sakai_global.content = function(tuid, showSettings) {
        ...
        var contentItemTemplate = "#content_item_template";
        var contentItem = ".content_item";
        ...
        var handleContentData = function(success, data) {
            if(success) {
                ...
                $(contentItem, rootel).html(sakai.api.Util.TemplateRenderer(contentItemTemplate,contentjson));
            }
        };
