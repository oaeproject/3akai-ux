...
sakai.discussion = function(tuid, placement, showSettings) {
	...
	/**
	 * Attaches a click handler to the element representing the supplied post
	 * object and then recurses down through the post's replies thus attaching
	 * handlers to their elements also. The elements in question are the ones
	 * generated by the compact view template. The handler renders the appropriate
	 * post and positions the current post cursor.
	 *
	 * @param {Object} post The parent post to whose element we want to attach a click handler
