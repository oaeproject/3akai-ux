    ...
    sakai_global.contentpermissions = function(tuid, showSettings){
        ...
        var showWarning = function(){
            ...
            if (visibility === newVisibilityVal || visibilityindex[newVisibilityVal] > visibilityindex[visibility] || newVisibilityVal === "selected"){
                ...
                sakai.api.Util.bindDialogFocus($("#contentpermissions_warning_container"), function(){$("#contentpermissions_warning_container").jqmHide();});
        ...
        var initializeOverlay = function(){
            ...
            sakai.api.Util.bindDialogFocus($("#contentpermissions_container"), function(){$("#contentpermissions_container").jqmHide();});
