...
function onLoad() {
  ...
  var piAngiosperms = Timeplot.createPlotInfo({id: "angiosperms", dataSource: dsAngiosperms, timeGeometry: tg2, valueGeometry: g5,
    lineColor: "rgba(204, 61, 122, 1)", dotColor: "rgba(204, 61, 122, 0.3)", showValues: false, fillColor: "rgba(204, 61, 122, 0.3)", fillGradient: false});
  ...
  var piCO2 = Timeplot.createPlotInfo({id: "co2", dataSource: dsCO2, timeGeometry: tg1, valueGeometry: g3,
    lineColor: "#8A2E5C", dotColor: "#8A2E5C", showValues: false, valuesBorder: "#8A2E5C", valuesColour: "#8A2E5C", valuesText: "#ffffff"});
  ...
  var piO2 = Timeplot.createPlotInfo({id: "o2", dataSource: dsO2, timeGeometry: tg1, valueGeometry: g7,
    lineColor: "#CC6699", dotColor: "#CC6699", showValues: false, valuesBorder: "#008888", valuesColour: "#00ffff"});
  var piPaleotemp = Timeplot.createPlotInfo({id: "paleotemp", dataSource: dsPaleotemp, timeGeometry: tg1, valueGeometry: g10,
    lineColor: "#9966CC", dotColor: "#9966CC", showValues: false, roundValues: false, valuesBorder: "#006666", valuesColour: "#00cccc", valuesRight: false});
  ...
  var piIceage = Timeplot.createPlotInfo({id: "iceage", eventSource: esIceage, timeGeometry: tg1, lineColor: "#66CCCC", bubbleWidth: 300, bubbleHeight: 100});
  ...
  toggler1.addPlot("CO2", "http://www.ensemble.ac.uk/dev/plants/timeplot/data/CO2data.txt", piCO2, dsCO2, ",", esCO2, "txt", "#6666CC", source[1], true);
  toggler1.addPlot("O2", "http://www.ensemble.ac.uk/dev/plants/timeplot/data/O2data.txt", piO2, dsO2, ",", esO2, "txt", "#00ffff", source[0], true);
  toggler1.addPlot("paleotemp", "http://www.ensemble.ac.uk/dev/plants/timeplot/data/paleotemp.txt", piPaleotemp, dsPaleotemp, ",", esPaleotemp, "txt", "#006666", source[2], true);
  toggler1.addPlot("iceage", "http://www.ensemble.ac.uk/dev/plants/timeplot/data/iceage.xml",piIceage, null,"",esIceage,"xml", "#abcdef", source[3]);
 
  toggler2.addPlots("anggympte", [
    BN.Toggle.createItem("http://www.ensemble.ac.uk/dev/plants/timeplot/data/Angiosperms.txt", piAngiosperms, dsAngiosperms, ",", esAngiosperms, "txt"),
    BN.Toggle.createItem("http://www.ensemble.ac.uk/dev/plants/timeplot/data/Gymnosperms.txt", piGymnosperms, dsGymnosperms, ",", esGymnosperms, "txt"), 
    BN.Toggle.createItem("http://www.ensemble.ac.uk/dev/plants/timeplot/data/Pteridophytes.txt", piPteridophytes, dsPteridophytes, ",", esPteridophytes, "txt")], "#000000", source[4]);
  toggler2.addPlot("impevents", "http://www.ensemble.ac.uk/dev/plants/timeplot/data/ImpEvents.xml", piImpEvents, null, "", esImpEvents, "xml", "#0000ff", source[10]);
  toggler2.addPlot("plantspec", "http://www.ensemble.ac.uk/dev/plants/timeplot/data/PlantSpecies.xml", piPlantSpecies, null, "", esPlantSpecies, "xml", "#99FF00", source[7]);
  toggler2.addPlot("massex", "http://www.ensemble.ac.uk/dev/plants/timeplot/data/MassExtinctions.xml",piMassExtinctions, null,"",esMassExtinctions,"xml","#ff0000", source[8]);
  toggler2.addPlot("lifecycle", "http://www.ensemble.ac.uk/dev/plants/timeplot/data/lifecycle.xml",piLifeCycle, null,"",esLifeCycle,"xml","#00c000",source[9]);
  toggler2.addPlot("Insects", "http://www.ensemble.ac.uk/dev/plants/timeplot/data/Insects.txt", piInsects, dsInsects, ",", esInsects,"txt", "#F3A05A", source[11]);
  toggler2.addPlot("Tetrapods", "http://www.ensemble.ac.uk/dev/plants/timeplot/data/Tetrapods.txt", piTetrapods, dsTetrapods, ",", esTetrapods,"txt", "#CCFF66", source[12]);
  toggler2.addPlot("Major Groups", "http://www.ensemble.ac.uk/dev/plants/timeplot/data/MajorGroups.xml", piMajorGroups, null, "", esMajorGroups,"xml", "#CCFF66", source[13]);
