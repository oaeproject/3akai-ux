...
(function($) {
        ...
        return this.each(function() {
            ...
            if (embedAction) {
                ...
                settings.onEmbed = function(oembedData) {
                    $.fn.oembed.insertCode(
                        this,
                        settings.embedMethod,
                        oembedData,
                    );
                };
            }
            ...
            if (resourceURL !== null && resourceURL !== undefined) {
                        ...
                        var ajaxopts = $.extend(
                            {
                                ...
                                success: function(data) {
                                    ...
                                    provider = $.fn.oembed.getOEmbedProvider(
                                        data['long-url'],
                                    );
                                    ...
                                    if (provider !== null) {
                                        ...
                                        settings.onProviderNotFound.call(
                                            container,
                                            resourceURL,
                                        );
                                    }
                ...
                if (!!settings.fallback === false) {
                    provider =
                        provider.name.toLowerCase() === 'opengraph'
                            ? null
                            : provider;
                }
                if (provider !== null) {
            ...
            var ajaxopts = $.extend(
                {
                    ...
                    success: function(data) {
                        ...
                        if (
                            ...
                            for (
                                var i = 0, l = data.query.results.meta.length;
                                i < l;
                                i++
                            ) {
                                var name =
                                ...
                                meta[name.toLowerCase()] =
                                    data.query.results.meta[i].content;
                            }
                            if (
                            ...
                            if (
                                ...
                                for (
                                    var i = 0,
                                        l = data.query.results.link.length;
                                    i < l;
                                    i++
                                ) {
                                    if (
                                        data.query.results.link[
                                            i
                                        ].hasOwnProperty('rel')
                                    ) {
                                        if (
                                            data.query.results.link[i].rel ==
                                            'apple-touch-icon'
                                        ) {
                                            if (
                                                data.query.results.link[
            ...
            if (embedProvider.embedtag.tag !== '') {
                ...
                if (tag == 'iframe') {
                    code
                        .attr(
                            'scrolling',
                            embedProvider.embedtag.scrolling || 'no',
                        )
                        .attr(
                            'frameborder',
                            embedProvider.embedtag.frameborder || '0',
                        );
                }
            ...
            case 'append':
                ...
                if (settings.maxWidth) {
                    ...
                    if (post_width < settings.maxWidth) {
                        var iframe_width_orig = $(
                            'iframe',
                            oembedContainer,
                        ).width();
                        var iframe_height_orig = $(
                            'iframe',
                            oembedContainer,
                        ).height();
                        var ratio = iframe_width_orig / post_width;
                        $('iframe', oembedContainer).width(
                            iframe_width_orig / ratio,
                        );
                        $('iframe', oembedContainer).height(
                            iframe_height_orig / ratio,
                        );
                    } else {
                        if (settings.maxWidth) {
                            $('iframe', oembedContainer).width(
    ...
    $.fn.oembed.getGenericCode = function(url, oembedData) {
        var title =
            oembedData.title && oembedData.title !== null
                ? oembedData.title
                : url;
        ...
        for (var i = 0; i < $.fn.oembed.providers.length; i++) {
            for (
                ...
                var regExp = new RegExp(
                    $.fn.oembed.providers[i].urlschemes[j],
                    'i',
                );
            ...
            if (extraSettings.useYQL == 'xml') {
                extraSettings.yql = {
                    ...
                    url: function(externalurl) {
                        return (
                            this.apiendpoint + '?format=xml&url=' + externalurl
                        );
                    },
                ...
                extraSettings.yql = {
                    ...
                    url: function(externalurl) {
                        return (
                            this.apiendpoint + '?format=json&url=' + externalurl
                        );
                    },
                    datareturn: function(results) {
                        if (
     ...
     */
    $.fn.updateOEmbedProvider = function(
        name,
        type,
        urlschemesarray,
        apiendpoint,
            ...
            if ($.fn.oembed.providers[i].name === name) {
                ...
                if (extraSettings !== null) {
                    ...
                    for (var property in extraSettings) {
                        if (
                            property !== null &&
                            extraSettings[property] !== null
                        ) {
                            $.fn.oembed.providers[i][property] =
                                extraSettings[property];
                        }
                    }
                }
            }
    ...
    $.fn.oembed.providers = [
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//www.xtranormal.com/xtraplayr/$1/$2',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'video',
            ['scivee.tv/node/.+'],
            '//www.scivee.tv/flash/embedCast.swf?',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'video',
            ['veoh.com/watch/.+'],
            '//www.veoh.com/swf/webplayer/WebPlayer.swf?version=AFrontend.5.7.0.1337&permalinkId=$1&player=videodetailsembedded&videoAutoPlay=0&id=anonymous',
            {
                templateRegex: /.*watch\/([^\?]+).*/,
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//media.mtvnservices.com/mgid:moses:video:gametrailers.com:$2',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//player.ordienetworks.com/flash/fodplayer.swf?',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//www.collegehumor.com/moogaloop/moogaloop.swf?clip_id=$1&use_node_id=true&fullscreen=1',
            {
                templateRegex: /.*video\/([^\/]+).*/,
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'video',
            ['metacafe\\.com/watch/.+'],
            '//www.metacafe.com/fplayer/$1/$2.swf',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//static.bambuser.com/r/player.swf?vid=$1',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'video',
            ['twitvid\\.com/.+'],
            '//www.twitvid.com/embed.php?guid=$1&autoplay=0',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'video',
            ['embedr\\.com/playlist/.+'],
            '//embedr.com/swf/slider/$1/425/520/default/false/std?',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//api.minoto-video.com/services/oembed.json',
            { useYQL: 'json' },
        ),
        new $.fn.oembed.OEmbedProvider(
            'animoto',
            'video',
            ['animoto.com/play/.+'],
            '//animoto.com/services/oembed',
        ),
        new $.fn.oembed.OEmbedProvider(
            'hulu',
            'video',
            ['hulu\\.com/watch/.*'],
            '//www.hulu.com/api/oembed.json',
        ),
        new $.fn.oembed.OEmbedProvider(
            'ustream',
            'video',
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'video',
            ['nfb\\.ca/film/.+'],
            '//www.nfb.ca/remote/services/oembed/',
            { useYQL: 'json' },
        ),
        new $.fn.oembed.OEmbedProvider(
            'qik',
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//clikthrough.com/services/oembed',
        ),
        new $.fn.oembed.OEmbedProvider(
            'Kinomap',
            'video',
            ['kinomap\\.com/.+'],
            '//www.kinomap.com/oembed',
        ),
        new $.fn.oembed.OEmbedProvider(
            'VHX',
            'video',
            ['vhx.tv/.+'],
            '//vhx.tv/services/oembed.json',
        ),
        new $.fn.oembed.OEmbedProvider(
            'bambuser',
            'video',
            ['bambuser.com/.+'],
            '//api.bambuser.com/oembed/iframe.json',
        ),
        new $.fn.oembed.OEmbedProvider(
            'justin.tv',
            'video',
            ['justin.tv/.+'],
            '//api.justin.tv/api/embed/from_url.json',
            { useYQL: 'json' },
        ),
        new $.fn.oembed.OEmbedProvider(
            'vine',
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//boxofficebuz.com/embed/$1/$2',
            {
                templateRegex: [
                    /.*boxofficebuz\.com\/embed\/(\w+)\/([\w*\-*]+)/,
                ],
                embedtag: { tag: 'iframe', width: 480, height: 360 },
            },
        ),
        new $.fn.oembed.OEmbedProvider(
            ...
            'video',
            [
                'clipsyndicate\\.com/video/play/.+',
                'clipsyndicate\\.com/embed/iframe?.+',
            ],
            '//eplayer.clipsyndicate.com/embed/iframe?pf_id=1&show_title=0&va_id=$1&windows=1',
            {
                templateRegex: [
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'video',
            ['coub\\.com/.+'],
            '//www.coub.com/embed/$1?muted=false&autostart=false&originalSize=false&hideTopBar=false&noSiteButtons=false&startWithHD=false',
            {
                templateRegex: [
                    /.*coub\.com\/embed\/(\w+)\?*.*/,
                    /.*coub\.com\/view\/(\w+).*/,
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//snagplayer.video.dp.discovery.com/$1/snag-it-player.htm?auto=no',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'video',
            ['telly\\.com/.+'],
            '//www.telly.com/embed.php?guid=$1&autoplay=0',
            {
                templateRegex: [
                    /.*telly\.com\/embed\.php\?guid=(\w+).*/,
                    /.*telly\.com\/(\w+).*/,
                ],
                embedtag: { tag: 'iframe', width: 480, height: 360 },
            },
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'video',
            ['viddy\\.com/.+'],
            '//www.viddy.com/embed/video/$1',
            {
                templateRegex: [
                    /.*viddy\.com\/embed\/video\/(\.*)/,
                    /.*viddy\.com\/video\/(\.*)/,
                ],
                embedtag: { tag: 'iframe', width: 480, height: 360 },
                nocache: 1,
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//www.worldstarhiphop.com/embed/$1',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'video',
            ['zapiks\\.fr/.+'],
            '//www.zapiks.fr/index.php?action=playerIframe&media_id=$1&autoStart=fals',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//shoudio.com/api/oembed',
        ),
        new $.fn.oembed.OEmbedProvider(
            'mixcloud',
            'rich',
            ['mixcloud.com/.+'],
            '//www.mixcloud.com/oembed/',
            { useYQL: 'json' },
        ),
        new $.fn.oembed.OEmbedProvider(
            'rdio.com',
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            null,
            {
                yql: {
                    ...
                    url: function(externalurl) {
                        return (
                            '//skitch.com/oembed/?format=json&url=' +
                            externalurl
                        );
                    },
                    datareturn: function(data) {
                        return $.fn.oembed.getPhotoCode(
                            data.json.url,
                            data.json,
                        );
                    },
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'photo',
            ['dribbble.com/shots/.+'],
            '//api.dribbble.com/shots/$1?callback=?',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//www.achewood.com/comic.php?date=$1',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'photo',
            ['fotokritik\\.com/.+'],
            '//www.fotokritik.com/embed/$1',
            {
                templateRegex: [
                    /.*fotokritik\.com\/embed\/(\w+).*/,
                    /.*fotokritik\.com\/(\w+).*/,
                ],
                embedtag: { tag: 'iframe', width: 480, height: 360 },
                nocache: 1,
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//gmep.org/oembed.json',
        ),
        new $.fn.oembed.OEmbedProvider(
            'urtak',
            'rich',
            ['urtak.com/(u|clr)/.+'],
            '//oembed.urtak.com/1/oembed',
        ),
        new $.fn.oembed.OEmbedProvider(
            'cacoo',
            'rich',
            ['cacoo.com/.+'],
            '//cacoo.com/oembed.json',
        ),
        new $.fn.oembed.OEmbedProvider(
            'dailymile',
            'rich',
            ['dailymile.com/people/.*/entries/.*'],
            '//api.dailymile.com/oembed',
        ),
        new $.fn.oembed.OEmbedProvider(
            'dipity',
            'rich',
            ['dipity.com/timeline/.+'],
            '//www.dipity.com/oembed/timeline/',
            { useYQL: 'json' },
        ),
        new $.fn.oembed.OEmbedProvider(
            'sketchfab',
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'rich',
            ['popplet.com/app/.*'],
            '//popplet.com/app/Popplet_Alpha.swf?page_id=$1&em=1',
            {
                templateRegex: /.*#\/([^\/]+).*/,
                embedtag: {
                    width: 460,
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'rich',
            ['pearltrees.com/.*'],
            '//cdn.pearltrees.com/s/embed/getApp?',
            {
            ...
            null,
            {
                ...
                template: function(wm, tourid) {
                    ...
                    return (
                        "<div id='" +
                        tourid +
                        "' class='tourwrist-tour-embed direct'></div> <script type='text/javascript' src='//tourwrist.com/tour_embed.js'></script>"
                    );
                },
            },
        ),
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'rich',
            ['meetup\\.(com|ps)/.+'],
            '//api.meetup.com/oembed',
        ),
        new $.fn.oembed.OEmbedProvider(
            'ebay',
            'rich',
            ['ebay\\.*'],
            '//togo.ebay.com/togo/togo.swf?2008013100',
            {
                ...
                embedtag: {
                    ...
                    height: 300,
                    flashvars:
                        'base=//togo.ebay.com/togo/&lang=en-us&mode=normal&itemid=$2&query=$1',
                },
            },
        ),
        new $.fn.oembed.OEmbedProvider(
            ...
            'rich',
            ['wikipedia.org/wiki/.+'],
            '//$1.wikipedia.org/w/api.php?action=parse&page=$2&format=json&section=0&callback=?',
            {
                ...
                templateData: function(data) {
                    ...
                    return (
                        '<div id="content"><h3><a class="nav-link" href="//en.wikipedia.org/wiki/' +
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'rich',
            ['imdb.com/title/.+'],
            '//www.imdbapi.com/?i=$1&callback=?',
            {
                templateRegex: /.*\/title\/([^\/]+).*/,
                templateData: function(data) {
                    if (!data.Title) return false;
                    return (
                        '<div id="content"><h3><a class="nav-link" href="//imdb.com/title/' +
                        data.imdbID +
                        '/">' +
                        data.Title +
                        '</a> (' +
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'rich',
            ['livejournal.com/'],
            '//ljpic.seacrow.com/json/$2$4?jsonp=?',
            {
                ...
                templateData: function(data) {
                    ...
                    return (
                        '<div><img src="' +
                        data.image +
                        '" align="left" style="margin-right: 1em;" /><span class="oembedall-ljuser"><a href="//' +
                        data.username +
                        '.livejournal.com/profile"><img src="//www.livejournal.com/img/userinfo.gif" alt="[info]" width="17" height="17" /></a><a href="//' +
                        data.username +
                        '.livejournal.com/">' +
                        data.username +
                        '</a></span><br />' +
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//c.circuitbee.com/build/r/schematic-embed.html?id=$1',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'rich',
            ['jsfiddle.net/[^/]+/?'],
            '//jsfiddle.net/$1/embedded/result,js,resources,html,css/?',
            {
                templateRegex: /.*net\/([^\/]+).*/,
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//www.timetoast.com/flash/TimelineViewer.swf?passedTimelines=$1',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'rich',
            ['pastebin\\.com/[\\S]{8}'],
            '//pastebin.com/embed_iframe.php?i=$1',
            {
                templateRegex: /.*\/(\S{8}).*/,
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//api.stackoverflow.com/1.1/questions/$1?body=true&jsonp=?',
            {
                ...
                templateData: function(data) {
                    ...
                    var out =
                        ...
                        q.view_count +
                        ' view(s)</div></div>' +
                        '<div class="oembedall-summary"><h3><a class="oembedall-question-hyperlink" href="//stackoverflow.com/questions/' +
                        q.question_id +
                        '/">' +
                        q.title +
                        '</a></h3>' +
                    ...
                    for (i in q.tags) {
                        out +=
                            '<a title="" class="oembedall-post-tag" href="//stackoverflow.com/questions/tagged/' +
                            q.tags[i] +
                            '">' +
                            q.tags[i] +
                            '</a>';
                    ...
                    out +=
                        '</div><div class="oembedall-fr"><div class="oembedall-user-info"><div class="oembedall-user-gravatar32"><a href="//stackoverflow.com/users/' +
                        q.owner.user_id +
                        '/' +
                        q.owner.display_name +
                        '">' +
                        '<img width="32" height="32" alt="" src="//www.gravatar.com/avatar/' +
                        q.owner.email_hash +
                        '?s=32&amp;d=identicon&amp;r=PG"></a></div><div class="oembedall-user-details">' +
                        '<a href="//stackoverflow.com/users/' +
                        q.owner.user_id +
                        '/' +
                        q.owner.display_name +
                        '">' +
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'rich',
            ['gigapan\\.org/[-.\\w@]+/\\d+'],
            '//gigapan.org/gigapans/$1/options/nosnapshots/iframe/flash.html',
            {
                templateRegex: /.*\/(\d+)\/?.*/,
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'rich',
            ['scribd\\.com/.+'],
            '//www.scribd.com/embeds/$1/content?start_page=1&view_mode=list',
            {
                templateRegex: /.*doc\/([^\/]+).*/,
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            null,
            {
                ...
                template:
                    '<script async type="text/javascript" charset="utf-8" src="//static.polldaddy.com/p/$1.js"></script>',
                nocache: 1,
            },
        ),
        new $.fn.oembed.OEmbedProvider(
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            '//maps.google.com/maps?t=m&q=$1&output=embed',
            {
        ...
        new $.fn.oembed.OEmbedProvider(
            ...
            'rich',
            ['polarb\\.com/.+'],
            'https://assets-polarb-com.a.ssl.fastly.net/api/v4/publishers/unknown/embedded_polls/iframe?poll_id=$1',
            {
        ...
        new $.fn.oembed.OEmbedProvider('opengraph', 'rich', ['.*'], null, {
            yql: {
                ...
                datareturn: function(results) {
                    ...
                    if (results['og:video']) {
                        var embed = $(
                            '<embed src="' + results['og:video'] + '"/>',
                        );
                        embed
                            .attr(
                                'type',
                                results['og:video:type'] ||
                                    'application/x-shockwave-flash',
                            )
                            .css('max-height', settings.maxHeight || 'auto')
                            .css('max-width', settings.maxWidth || 'auto');
