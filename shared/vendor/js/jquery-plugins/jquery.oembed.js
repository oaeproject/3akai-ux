...
(function ($) {
    ...
    $.fn.oembed.providers = [
        ...
        new $.fn.oembed.OEmbedProvider("polar", "rich", ["polarb\\.com/.+"], "https://assets-polarb-com.a.ssl.fastly.net/api/v4/publishers/unknown/embedded_polls/iframe?poll_id=$1", {templateRegex: /.*polarb\.com\/polls\/(\w+).*/, embedtag: {tag: 'iframe', width: 480, height: 360 }, nocache: 1}),
