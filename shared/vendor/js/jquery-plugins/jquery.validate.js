...
define(["jquery", "../shared/oae/api/oae.api.i18n"], function($, i18n) {
	(function() {		
		$.extend($.fn, {
		...
		$.extend($.validator, {
			...
			prototype: {
				...
				init: function() {
					...
					i18n.translate('__MSG__PLEASE_ENTER_YOUR_PASSWORD__');
					console.log('after init validate');
						...
						range: function( value, element, param ) {
							...
							email: function(value, element) {
								...
								url: function(value, element) {
									...
									return this.optional(element) || regEx.test(value) || regEx.test('http://' + value);
								},
