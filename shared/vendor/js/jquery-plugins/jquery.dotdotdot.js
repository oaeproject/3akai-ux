...
(function($, undef) {
    ...
    $.fn.dotdotdot = function(o) {
        ...
        if (!(opts.lastCharacter.remove instanceof Array)) {
            opts.lastCharacter.remove =
                $.fn.dotdotdot.defaultArrays.lastCharacter.remove;
        }
        if (!(opts.lastCharacter.noEllipsis instanceof Array)) {
            opts.lastCharacter.noEllipsis =
                $.fn.dotdotdot.defaultArrays.lastCharacter.noEllipsis;
        }
    ...
    function ellipsis($elem, $d, $i, o, after) {
        ...
        $elem
            ...
            .each(function() {
                ...
                if (
                    typeof e == 'undefined' ||
                    (e.nodeType == 3 && $.trim(e.data).length == 0)
                ) {
                    return true;
                } else if ($e.is(noty)) {
                    $elem.append($e);
    ...
    function ellipsisElement($e, $d, $i, o, after) {
        ...
        while (startPos <= endPos && !(startPos == 0 && endPos == 0)) {
            ...
            setTextContent(
                e,
                textArr.slice(0, midPos + 1).join(separator) + o.ellipsis,
            );
        ...
        if (
            position != -1 &&
            !(textArr.length == 1 && textArr[0].length == 0)
        ) {
            txt = addEllipsis(
                textArr.slice(0, position + 1).join(separator),
                o,
            );
            ...
            var afterLength =
                after && after.closest($w).length ? after.length : 0;
