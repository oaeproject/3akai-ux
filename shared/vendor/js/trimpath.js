...
(function() {
    ...
    TrimPath.parseTemplate_etc.statementDef = {
        ...
        for: {
            ...
            prefixFunc: function(stmtParts, state, tmplName, etc) {
                ...
                return [
                    ...
                    'var ',
                    iterVar,
                    '_ct = 0;', // iterVar_ct variable, added by B. Bittman
                    'for (var ',
                    iterVar,
                    '_index in ',
                    listVar,
                    ...
                    '[',
                    iterVar,
                    "_index]) == 'function') {continue;}", // IE 5.x fix from Igor Poteryaev.
        ...
        '/for': {
            delta: -1,
            prefix:
                '} }; delete __LENGTH_STACK__[__LENGTH_STACK__.length - 1];',
                ...
                if (blockrx) {
                    ...
                    if (blockMarkerEnd >= 0) {
                        ...
                        if (blockMarkerEnd - blockMarkerBeg <= 0) {
                            ...
                            blockMarker = body.substring(
                                blockMarkerBeg + 1,
                                blockMarkerEnd,
                            );
                        }

                        var blockEnd = body.indexOf(
                            blockMarker,
                            blockMarkerEnd + 1,
                        );
                        if (blockEnd >= 0) {
                            ...
                            if (blockType == 'cdata') {
                                ...
                                if (blockText != null && blockText.length > 0)
                                    // From B. Bittman, eval should not execute until process().
                                    funcText.push(
                                        '_OUT.write( (function() { ' +
                                            blockText +
                                            ' })() );',
                    ...
                    if (
                        body
                            ...
                            .search(TrimPath.parseTemplate_etc.statementTag) ==
                        0
                    )
                        break; // Found a match.
                }
    ...
    var emitSectionTextLine = function(line, funcText) {
        ...
        while (endExprPrev + endMarkPrev.length < line.length) {
            var begMark = '${',
                endMark = '}';
            var begExpr = line.indexOf(
                begMark,
                endExprPrev + endMarkPrev.length,
            ); // In "a${b}c", begExpr == 1
            if (begExpr < 0) break;
    ...
    TrimPath.processDOMTemplate = function(
        ...
        return TrimPath.parseDOMTemplate(
            elementId,
            optDocument,
            optEtc,
