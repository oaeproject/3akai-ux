        ...
        context = {
            ...
            onScriptError: function(evt) {
                ...
                if (!hasPathFallback(data.id)) {
                    return onError(
                        makeError('scripterror', 'Script error', evt, [
                            data.id,
                        ]),
                    );
                }
...
*/
        ...
        attr: function(elem, name, value) {
            ...
            if (nType !== 1 || !jQuery.isXMLDoc(elem)) {
                ...
                hooks =
                    ...
                    (jQuery.expr.match.boolean.test(name)
                        ? boolHook
                        : nodeHook);
            }
    ...
    jQuery.each(jQuery.expr.match.boolean.source.match(/\w+/g), function(
        i,
        name,
    ) {
 ...
 */
    ...
    function defaultPrefilter(elem, props, opts) {
        ...
        if (length) {
            dataShow =
                data_priv.get(elem, 'fxshow') ||
                data_priv.access(elem, 'fxshow', {});
