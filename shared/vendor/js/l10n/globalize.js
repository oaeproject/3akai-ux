...
(function(window, undefined) {
        ...
        for (;;) {
            ...
            switch (current) {
                ...
                case 'dddd':
                    ...
                    var names =
                        clength === 3 ? cal.days.namesAbbr : cal.days.names;
                ...
                case 'MMMM':
                    ...
                    ret.push(
                        cal.monthsGenitive && hasDay()
                            ? cal.monthsGenitive[
                                  clength === 3 ? 'namesAbbr' : 'names'
                              ][part]
                            : cal.months[clength === 3 ? 'namesAbbr' : 'names'][
                                  part
                              ],
                    );
                    break;
                ...
                case 'zzz':
                    ...
                    ret.push(
                        (hour <= 0 ? '+' : '-') +
                            ...
                            ':' +
                            padZeros(
                                Math.abs(value.getTimezoneOffset() % 60),
                                2,
                            ),
                    );
                    break;
    ...
    (function() {
        ...
        expandNumber = function(number, precision, formatInfo) {
            ...
            if (exponent > 0) {
                ...
                right =
                    numberString.slice(-exponent, numberString.length) + right;
    ...
    (function() {
        ...
        getMonthIndex = function(cal, value, abbr) {
            ...
            if (i < 0) {
                i = arrayIndexOf(
                    abbr ? upperMonthsGen[1] : upperMonthsGen[0],
                    value,
                );
            }
            return i;
                    ...
                    switch (current) {
                        ...
                        case 'gg':
                            ...
                            for (var i = 0, l = cal.eras.length; i < l; i++) {
                                if (
                                    eraName === cal.eras[i].name.toLowerCase()
                                ) {
                                    era = i;
                                    break;
                                }
    ...
    Globalize.addCultureInfo = function(cultureName, baseCultureName, info) {
        ...
        if (isNew) {
            this.cultures[cultureName].calendar = this.cultures[
                cultureName
            ].calendars.standard;
        }
    };
    ...
    Globalize.findClosestCulture = function(name) {
        ...
        if (!name) {
            return (
                this.cultures[this.cultureSelector] || this.cultures['default']
            );
        }
    ...
    Globalize.culture = function(cultureSelector) {
        ...
        // getter
        return (
            this.findClosestCulture(cultureSelector) || this.culture['default']
        );
    };
})(this);
