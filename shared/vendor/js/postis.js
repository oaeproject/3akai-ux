        ...
        var postis = {
                ...
                if (listenBufferForMethod) {
                    ...
                    for (var i = 0; i < listenersForMethod.length; i++) {
                        for (var j = 0; j < listenBufferForMethod.length; j++) {
                            listenersForMethod[i].call(
                                null,
                                listenBufferForMethod[j],
                            );
                        }
                    }
                }
            ...
            destroy: function(callback) {
                ...
                if (
                    ...
                    typeof windowForEventListening.removeEventListener ===
                        'function'
                ) {
                    windowForEventListening.removeEventListener(
                        'message',
                        listener,
                    );
                }
