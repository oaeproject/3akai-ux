...
define(
    ...
    function(exports, $, oae, configAPI, i18nAPI, userAPI, utilAPI) {
        ...
        const STRATEGY_GOOGLE_APPS = (exports.STRATEGY_GOOGLE_APPS =
            'googleApps');
        const STRATEGY_LDAP = (exports.STRATEGY_LDAP = 'ldap');
        const STRATEGY_LOCAL = (exports.STRATEGY_LOCAL = 'local');
        const STRATEGY_SHIBBOLETH = (exports.STRATEGY_SHIBBOLETH =
            'shibboleth');
         ...
         */
        const getStrategyInfo = (exports.getStrategyInfo = function(
            contextLabel,
        ) {
            let enabledStrategies = getEnabledStrategies(contextLabel);
            let enabledStrategyNames = _.keys(enabledStrategies);

            let hasLocalAuth = !_.chain(enabledStrategyNames)
                .intersection(STRATEGIES_LOCAL)
                .isEmpty()
                .value();
            let hasExternalAuth = !_.chain(enabledStrategyNames)
                .intersection(STRATEGIES_EXTERNAL)
                .isEmpty()
                .value();
            let hasInstitutionalAuth = !_.chain(enabledStrategyNames)
            ...
            let hasSingleInstitutionalAuth =
                hasSingleAuth && hasInstitutionalAuth;

            return {
                allowAccountCreation: configAPI.getValue(
                    'oae-authentication',
                    STRATEGY_LOCAL,
                    'allowAccountCreation',
                ),
                enabledExternalStrategies: _.pick(
                    enabledStrategies,
                    STRATEGIES_EXTERNAL,
                ),
                enabledInstitutionalStrategies: _.pick(
                    enabledStrategies,
        ...
        const strategyName = function(strategyId, contextLabel) {
            const translatedName = i18nAPI.translate(
                '__MSG__' + contextLabel + '_WITH_STRATEGY__',
                null,
                {
                    strategyName: configAPI.getValue(
                        'oae-authentication',
                        strategyId,
                        'name',
                    ),
         ...
         */
        const getAuthLoginIds = (exports.getAuthLoginIds = function(
            userId,
            callback,
        ) {
            if (!userId) {
         ...
         */
        const getEnabledStrategies = (exports.getEnabledStrategies = function(
            contextLabel,
        ) {
         ...
         */
            ...
            if (
                ...
                enabledStrategies[STRATEGY_FACEBOOK] = {
                    ...
                    icon: 'facebook',
                    name: i18nAPI.translate(
                        '__MSG__' + contextLabel + '_WITH_FACEBOOK__',
                    ),
            ...
            if (
                ...
                enabledStrategies[STRATEGY_GOOGLE] = {
                    ...
                    icon: 'google-plus',
                    name: i18nAPI.translate(
                        '__MSG__' + contextLabel + '_WITH_GOOGLE__',
                    ),
                    url: '/api/auth/google',
                };
            }
            ...
            if (
                ...
                enabledStrategies[STRATEGY_TWITTER] = {
                    ...
                    icon: 'twitter',
                    name: i18nAPI.translate(
                        '__MSG__' + contextLabel + '_WITH_TWITTER__',
                    ),
         ...
         */
        const externalLogin = (exports.externalLogin = function(
            strategyId,
            opts,
        ) {
            if (!strategyId) {
            ...
            if (!strategy) {
                throw new Error(
                    'Strategy id must be an enabled external strategy',
                );
            }
         ...
         * @throws {Error}                                  Error thrown when not all of the required parameters have been provided
         */
        const localLogin = (exports.localLogin = function(
            username,
            password,
            callback,
        ) {
        ...
        /**
         * Remove a specific tenant from the cookie where we keep track of tenants the user logged in to
         *
         * @param  {String}   currentTenant   The current tenant the user is visiting
         * @param  {Function} callback        Standard callback function
         */
        const removeLoggedInTenanciesCookie = (exports.removeLoggedInTenanciesCookie = function(
            currentTenant,
            callback,
        ) {
         ...
         * @throws {Error}                                  Error thrown when not all of the required parameters have been provided
         */
        const LDAPLogin = (exports.LDAPLogin = function(
            username,
            password,
            callback,
        ) {
         ...
         */
        const changePassword = (exports.changePassword = function(
            currentPassword,
            newPassword,
            callback,
        ) {
