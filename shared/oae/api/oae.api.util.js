...
define(['exports', 'require', 'jquery', 'underscore', 'oae.api.config', 'jquery.validate', 'trimpath', 'jquery.autosuggest'], function(exports, require, $, _, configAPI) {
    ...
    /**
     * Check if the current userAgent is a mobile browser (handheld device)
     *
     * @return  {Boolean}    check   Returns true if the user is using a mobile browser, returns false if the user uses a desktop
     */
