...
define(['exports', 'require', 'jquery', 'underscore', 'jquery.validate', 'trimpath'], function(exports, require, $, _) {
    ...
    /**
     * TODO: Can this be removed because of bootstrap ?
    ...
    /**
     * TODO: Update/Remove this documentation
     * All functionality related to setting up, showing and closing modal dialogs. This uses the Bootstrap Modal plugin behind the scenes. 
     * This will also automatically set up all of the keyboard accessibility.
     * 
     ...
     * @param  {Object}             [options]        JSON object containing options to pass to the Bootstrap Modal plugin as defined on http://twitter.github.com/bootstrap/javascript.html#modals
