...
define(
    ['exports', 'jquery', 'underscore', 'oae.api.i18n', 'mimetypes'],
    function(exports, $, _, i18nAPI, MimeTypes) {
        /**
        ...
        var createFile = (exports.createFile = function(
            ...
            if (!displayName) {
                ...
                throw new Error(
                    'A valid jquery.fileUpload container should be provided',
                );
            } else if (!file) {
                throw new Error(
                    'A valid jquery.fileUpload file object should be provided',
                );
            }
         ...
         * @throws {Error}                                  Error thrown when not all of the required parameters have been provided
         */
        var uploadNewVersion = (exports.uploadNewVersion = function(
            $fileUploadField,
            file,
            callback,
        ) {
         ...
         * @throws {Error}                            Error thrown when not all of the required parameters have been provided
         */
        var createCollabDoc = (exports.createCollabDoc = function(
            displayName,
            description,
            visibility,
            managers,
         ...
         * @throws {Error}                              Error thrown when not all of the required parameters have been provided
         */
        var restoreRevision = (exports.restoreRevision = function(
            contentId,
            revisionId,
            callback,
        ) {
         ...
         * @throws {Error}                            Error thrown when not all of the required parameters have been provided
         */
        var updateContent = (exports.updateContent = function(
            contentId,
            params,
            callback,
        ) {
         ...
         */
        var deleteContent = (exports.deleteContent = function(
            contentId,
            callback,
        ) {
            if (!contentId) {
         ...
         */
        var shareContent = (exports.shareContent = function(
            contentId,
            principals,
            callback,
        ) {
            if (!contentId) {
                ...
                throw new Error(
                    'A user or group to share with should be provided',
                );
            }
         ...
         * @throws {Error}                            Error thrown when not all of the required parameters have been provided
         */
        var deleteContentFromLibrary = (exports.deleteContentFromLibrary = function(
            principalId,
            contentId,
            callback,
        ) {
         ...
         */
        var getMimeTypeDescription = (exports.getMimeTypeDescription = function(
            contentObj,
        ) {
            // Return the mime type description, translated into the user's language
            var description = MimeTypes.getDescription(
