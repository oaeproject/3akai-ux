 ...
 */
define(['oae.api.authentication', 'oae.api.config', 'oae.api.content', 'oae.api.discussion', 'oae.api.group',
        'oae.api.i18n', 'oae.api.l10n', 'oae.api.profile', 'oae.api.user', 'oae.api.util', 'oae.api.widget'],

    function(authenticationAPI, configAPI, contentAPI, discussionAPI, groupAPI, i18nAPI, l10nAPI, profileAPI, userAPI, utilAPI, widgetAPI) {
