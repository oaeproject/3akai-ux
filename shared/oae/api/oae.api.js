...
define(['underscore', 'oae.api.admin', 'oae.api.authentication', 'oae.api.config', 'oae.api.content', 'oae.api.comment', 'oae.api.discussion', 'oae.api.folder',
        'oae.api.follow','oae.api.group', 'oae.api.i18n', 'oae.api.l10n', 'oae.api.lti', 'oae.api.meetingJitsi', 'oae.api.push', 'oae.api.transfer', 'oae.api.user', 'oae.api.tenancysearch', 'oae.api.util', 'oae.api.widget'],

    function(_, adminAPI, authenticationAPI, configAPI, contentAPI, commentAPI, discussionAPI, folderAPI, followAPI, groupAPI, i18nAPI, l10nAPI, ltiAPI, meetingJitsiAPI, pushAPI, transferAPI, userAPI, tenancySearchAPI, utilAPI, widgetAPI) {
