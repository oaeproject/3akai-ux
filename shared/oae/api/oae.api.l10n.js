...
define(
    ['exports', 'jquery', 'underscore', 'oae.api.config', 'globalize'],
    function(exports, $, _, configAPI) {
        /**
        ...
        var init = (exports.init = function(locale, callback) {
            ...
            var defaultLocale = configAPI.getValue(
                'oae-principals',
                'user',
                'defaultLanguage',
            );
            ...
            require([
                '/shared/vendor/js/l10n/cultures/globalize.culture.' +
                    locale +
                    '.js',
            ], function() {
         ...
         * @throws {Error}                      Error thrown when no date has been provided
         */
        var transformDateTime = (exports.transformDateTime = function(
            date,
            useShort,
        ) {
            if (!date) {
         ...
         */
        var transformNumber = (exports.transformNumber = function(
            number,
            decimalPlaces,
        ) {
            ...
            return Globalize.format(
                number,
                decimalPlaces !== null ? 'n' + decimalPlaces : 'n',
            );
        });
