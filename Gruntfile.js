        ...
        'requirejs': {
            'optimize': {
                'options': {
                    ...
                    'fileExclusionRegExp': /^(\.|<%= target %>|tests|tools|grunt|optimist|properties-parser|readdirp|mkdirp|underscore$|shelljs$|oae-release-tools|es6-promise|cssstyle|resolve|nwmatcher|strip-json-comments|robots\.txt)/,
                    'logLevel': 2
                }
            }
        },
