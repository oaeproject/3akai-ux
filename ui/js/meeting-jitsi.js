require(['jquery', 'oae.core'], function($, oae) {
    ...
    var baseUrl =
        '/meeting-jitsi/' + $.url().segment(2) + '/' + $.url().segment(3);
        ...
        return {
            ...
            messages: {
                accessNotUpdatedBody: oae.api.i18n.translate(
                    '__MSG__MEETING_ACCESS_COULD_NOT_BE_UPDATED__',
                ),
                accessNotUpdatedTitle: oae.api.i18n.translate(
                    '__MSG__MEETING_ACCESS_NOT_UPDATED__',
                ),
                accessUpdatedBody: oae.api.i18n.translate(
                    '__MSG__MEETING_ACCESS_SUCCESSFULLY_UPDATED__',
                ),
                accessUpdatedTitle: oae.api.i18n.translate(
                    '__MSG__MEETING_ACCESS_UPDATED__',
                ),
                ...
                publicDescription: oae.api.i18n.translate(
                    '__MSG__MEETING_PUBLIC_DESCRIPTION__',
                ),
            },
            defaultRole: 'member',
            roles: [
            ...
            api: {
                getMembersURL:
                    '/api/meeting-jitsi/' + meetingProfile.id + '/members',
    ...
    $(document).on(
        'click',
        '.meeting-jitsi-trigger-manageaccess-add',
        function() {
            $(document).trigger(
