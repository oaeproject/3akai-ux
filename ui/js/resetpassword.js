...
require(['jquery', 'oae.core'], function($, oae) {
    ...
    var resetPassword = function() {
        $(document).on('submit', '#resetpassword-input-password', function(
            event,
        ) {
            ...
            var password = $.trim(
                $('#resetpassword-new-password', $(this)).val(),
            );
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    oae.api.util.notification(
                        ...
                        oae.api.i18n.translate(
                            '__MSG__YOUR_PASSWORD_HAS_BEEN_UPDATED__',
                        ),
                    );
                ...
                error: function(data) {
                    oae.api.util.notification(
                        ...
                        oae.api.i18n.translate(
                            '__MSG__COULDNT_UPDATE_PASSWORD__',
                        ),
                    );
                },
            });
    ...
    var setUpResetPasswordValidation = function() {
        ...
        oae.api.util
            .validation()
            .validate($('#resetpassword-input-password'), validateOpts);
    };
