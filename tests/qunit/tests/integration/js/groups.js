require(
    ...
    function($, sakai) {
        ...
        var group_title = 'Sakai Group';
        var group_desc = 'Sakai Group is the best group';
        var group_new_title = 'New Sakai Group';
        var group_new_desc = 'Sakai Group will never be the best group';
        var group_new_kind = 'library';
        var user_random = 'userrandom_' + (new Date()).getTime();
        var groupTemplate = false;

        sakai.api.Groups.getTemplate('group', 'simplegroup', function(success, template) {
            if (success) {
