...
asyncTest("Send message to one person", 3, function(){
    sakai.api.Communication.sendMessage(dummyUser, dummySubject, dummyMessage, "", "", function(success, data) {
...
asyncTest("Send a reply to the message", 3, function() {
    sakai.api.Communication.sendMessage(dummyUser, dummySubject, "RE:" + dummyMessage, "", responseID, function(success, data) {
...
asyncTest("Send message to one person with a different category", 4, function(){
    ...
    sakai.api.Communication.sendMessage(dummyUser, dummySubject, dummyMessage, dummyCategory, "", function(success, data) {
