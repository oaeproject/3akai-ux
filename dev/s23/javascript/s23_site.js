...
sakai_global.s23_site = function(){
    ...
    var hideNotification = function(){
        ...
        sakai.api.Server.saveJSON("/~" + sakai.api.Util.urlSafe(sakai.data.me.user.userid)+"/private/sakai2notification", json, function(success, data){});
    };
    ...
    var init = function(){
        ...
        sakai.api.Server.loadJSON("/~" + sakai.api.Util.urlSafe(sakai.data.me.user.userid)+"/private/sakai2notification", function(success, data){
