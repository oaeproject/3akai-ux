...
(function() {
	...
	tinymce.PluginManager.requireLangPack('embedmedia');
	...
	tinymce.create('tinymce.plugins.EmbedMediaPlugin', {
		...
		init : function(ed, url) {
			...
			ed.addButton('embedmedia', {
				title : 'embedmedia.desc',
				cmd : 'mcdEmbedMedia',
				image : url + '/img/embedmedia.gif'
			});

			// Add a node change handler, selects the button in the UI when a image is selected
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('embedmedia', n.nodeName == 'IMG');
			});
		},
