            ...
            success: function(data){
                ...
                if (! status){
                    ...
                    if (totalprofile.profile.picture && $.parseJSON(totalprofile.profile.picture).name){
                        $("#add_friend_profilepicture").html(sakai.api.Security.saneHTML("<img src='/_user"+sakai.data.me.profile.path+"/public/profile/" + $.parseJSON(totalprofile.profile.picture).name + "' width='40px' height='40px'/>"));
                    } else {
