...
require(["jquery","sakai/sakai.api.core"], function($, sakai) {
    ...
    sakai_global.mysakai = function() {
        ...
        var initDashboard = function() {
            $(window).trigger("init.dashboard.sakai", ["/~" + sakai.data.me.user.userid + "/dashboardwidgets/", true, "personalportal", true]);
    ...
    sakai.api.Widgets.Container.registerForLoad("mysakai");
});
