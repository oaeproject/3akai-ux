    ...
    sakai_global.content_profile = function(){
        ...
        var addRemoveUsers = function(tuid, users, task){
            ...
            $.each(users.toAdd, function(index, user){
                ...
                if (sakai.api.Content.isUserADirectManager(sakai_global.content_profile.content_data, user)) {
                    data = {
                        ":viewer": user,
                        ":manager@Delete": user
                    };
                ...
                if (tuid === 'managers' && task === 'add') {
                    ...
                    if (sakai.api.Content.isUserADirectViewer(sakai_global.content_profile.content_data, user)) {
                        data = {
                            ":manager": user,
                            ":viewer@Delete": user
                        };
