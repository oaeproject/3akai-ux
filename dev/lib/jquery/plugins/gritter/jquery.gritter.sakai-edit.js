...
(function($){
    ...
    var Gritter = {
        ...
        _tpl_item: '<div id="gritter-item-[[number]]" class="gritter-item-wrapper [[item_class]]" style="display:none"><div class="gritter-top"></div><div class="gritter-item">[[image]]<div class="[[class_name]]">[[username]]<p role="alert">[[text]]</p></div><div style="clear:both"></div></div><div class="gritter-bottom"></div></div>',
        ...
        add: function(params){
            ...
            // We might have some issues if we don't have a text param!
            if (!params.text) {
                throw 'You need to fill out the first param: "text"';
            }
            ...
            var title_str = user ? '<span class="gritter-title">' + user + '</span>' : "";

            // String replacements on the template
            tmp = this._str_replace(['[[username]]', '[[text]]', '[[image]]', '[[number]]', '[[class_name]]', '[[item_class]]'], [title_str, text, image_str, this._item_count, class_name, item_class], tmp);
