...
define(
    ...
    var sakaiUserAPI = {
        ...
        getUser: function(userid, callback){
            var authprofileURL = "/~" + sakai.api.Util.uriCompSafe(userid) + "/public/authprofile.profile.json";
        ...
        acceptContactInvite : function(inviteFrom, callback) {
            $.ajax({
                url: "/~" + sakai.api.Util.uriCompSafe(sakaiUserAPI.data.me.user.userid) + "/contacts.accept.html",
                type: "POST",
                data: {
        ...
        ignoreContactInvite : function(inviteFrom, callback) {
            $.ajax({
                url: "/~" + sakai.api.Util.uriCompSafe(sakaiUserAPI.data.me.user.userid) + "/contacts.ignore.html",
                type: "POST",
                data: {
                    "targetUserId": inviteFrom
                },
                success: function(data){
                    ...
                    $.ajax({
                        url: "/~" + sakai.api.Util.uriCompSafe(sakaiUserAPI.data.me.user.userid) + "/contacts.remove.html",
                        type: "POST",
                        data: {
                            "targetUserId": inviteFrom
                        },
