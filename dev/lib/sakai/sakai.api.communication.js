    ...
    var sakaiCommunicationsAPI =  {
        ...
        sendMessage : function(to, meData, subject, body, category, reply, callback, sendMail, context, optionalParams) {
            ...
            var buildEmailParams = function(){
                ...
                switch(context){
                    ...
                    case "join_request":
                        ...
                        "|profilelink=" + sakai_conf.SakaiDomain + "/~" + sakai_util.uriCompSafe(meData.user.userid) + 
                    ...
                    case "contact_invitation":
                        ...
                        "|link=" + sakai_conf.SakaiDomain + "/~" + sakai_util.uriCompSafe(meData.user.userid) +"?accepttrue";
                        break;
                }
                return toSend;
            };
            ...
            var doSendMail = function(){
                ...
                // Send message
                $.ajax({
                    url: "/~" + sakai_util.uriCompSafe(meData.user.userid) + "/message.create.html",
                    type: "POST",
                    data: toSend,
        ...
        */  
        ...
        getMessage : function(id, callback){
            var url = "/~" + sakai_util.uriCompSafe(sakai_user.data.me.user.userid) + "/message/inbox/" + id + ".json";
            $.ajax({
                url: url,
                cache: false,
                async: false,
        ...
        getUnreadMessagesCountOverview : function(box, callback) {
            var url = "/~" + sakai_util.uriCompSafe(sakai_user.data.me.user.userid) + "/message.count.json?filters=sakai:messagebox,sakai:read&values=" + box + ",false&groupedby=sakai:category";
            $.ajax({
                url: url,
                cache: false,
                success: function(data){
