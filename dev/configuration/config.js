...
define(function(){
	...
	"structure": {
		"problemsets": {
			...
			"_canSubedit": true,
			"_canEdit": true,
			"_poolpath": "/~thrhrtrth/docstructure",
			"_id": "problemsets",
			"_elements": [],
			"_docref": "${pid}0"
		},
	...
	"docs": {
		...
		"${pid}2": {
			...
			"${refid}4": {
				"page": "<img id='widget_participants_${refid}5' class='widget_inline' style='display: block; padding: 10px; margin: 4px;' src='/devwidgets/participants/images/participants.png' data-mce-src='/devwidgets/participants/images/participants.png' data-mce-style='display: block; padding: 10px; margin: 4px;' border='1'><p></p>"
			},
			"${refid}5": {
				"participants": {
					"groupid": "rgeegrerg"
