...
define(function(){
	...
	"docs": {
		...
		"${pid}6": {
			...
			"${refid}16": {
				"page": "<img id='widget_mylibrary_${refid}17' class='widget_inline' style='display: block; padding: 10px; margin: 4px;' src='/devwidgets/participants/images/participants.png' data-mce-src='/devwidgets/participants/images/participants.png' data-mce-style='display: block; padding: 10px; margin: 4px;' border='1'><p></p>"
			},
			"${refid}17": {
				"mylibrary": {
					"groupid": "zfezfz"
