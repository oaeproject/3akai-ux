    ...
    while (node != null) {
        if (node.nodeType == 1) {
            ...
            var evt = new Timeline.DefaultEventSource.Event(
                ...
                node.getAttribute("isBand") == "true",
                node.hasAttribute("magnitude"),
                node.getAttribute("magnitude"),
...
Timeline.DefaultEventSource.Event = function(
        ...
        band, hasMagnitude, magnitude, track) {
    ...
    this._band = band || false;
    this._hasMagnitude = hasMagnitude || false;
...
Timeline.DefaultEventSource.Event.prototype = {
    ...
    isBandEvent:    function() { return this._band; },
    hasMagnitude:   function() { return this._hasMagnitude; },
