...
FCKConfig.Plugins.Add('autogrow', null, 'https://ctools.umich.edu/access/content/group/184d8583-09a7-45d4-8069-91de46fc2ec8/global/fck_files/plugins/');
...
//FCKConfig.FillEmptyBlocks	= false ;  //Trying a shot in the dark to fix bad autosave behavior.  What we really need is nbsp's to be treated exactly like 160s are..
//This isn't fixing it by itself, so I'll have to figure out what else is going on .
