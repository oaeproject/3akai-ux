...
(function() {
    ...
    templates['content_type'] = template(function(
        ...
        function program2(depth0, data) {
            ...
            buffer += '\n	<option value="';
            stack1 =
                typeof depth0 === functionType ? depth0.apply(depth0) : depth0;
            if (stack1 || stack1 === 0) {
                buffer += stack1;
            }
            buffer += '">';
    ...
    templates['operation'] = template(function(
        ...
        function program6(depth0, data) {
            var buffer = '',
                ...
                stack2;
            buffer += "\n            <div title='";
            stack2 = ((stack1 = depth0.description),
            typeof stack1 === functionType ? stack1.apply(depth0) : stack1);
            if (stack2 || stack2 === 0) {
                buffer += stack2;
            }
...
(function() {
    ...
    templates['param_list'] = template(function(
        ...
        function program8(depth0, data) {
            ...
            stack2 = ((stack1 = helpers.isArray || depth0.isArray),
            stack1
        ...
        if ((stack2 = helpers.name)) {
            ...
            stack2 = depth0.name;
            stack2 =
                typeof stack2 === functionType ? stack2.apply(depth0) : stack2;
        }
...
(function() {
    ...
    ResourceView = (function(_super) {
        ...
        ResourceView.prototype.render = function() {
            ...
            $('.toggleEndpointList', this.el).click(
                this.callDocs.bind(this, 'toggleEndpointListForResource'),
            );
            $('.collapseResource', this.el).click(
                this.callDocs.bind(this, 'collapseOperationsForResource'),
            );
            $('.expandResource', this.el).click(
                this.callDocs.bind(this, 'expandOperationsForResoruce'),
            );
            return this;
        };
    ...
    OperationView = (function(_super) {
        ...
        OperationView.prototype.addParameter = function(param, consumes) {
            ...
            return $('.operation-params', $(this.el)).append(
                paramView.render().el,
            );
        };
        ...
        StatusCodeView.prototype.render = function() {
            ...
            if (swaggerUi.api.models.hasOwnProperty(this.model.responseModel)) {
                responseModel = {
                    ...
                    isParam: false,
                    signature: swaggerUi.api.models[
                        this.model.responseModel
                    ].getMockSignature(),
                };
    ...
    ContentTypeView = (function(_super) {
        ...
        function ContentTypeView() {
            _ref8 = ContentTypeView.__super__.constructor.apply(
                this,
                arguments,
            );
            return _ref8;
        ...
        ContentTypeView.prototype.render = function() {
            ...
            template = this.template();
            $(this.el).html(template(this.model));
            $('label[for=contentType]', $(this.el)).text(
