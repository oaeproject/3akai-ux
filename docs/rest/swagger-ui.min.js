...
var Docs = {
    ...
    toggleEndpointListForResource: function(b) {
        var a = $(
            'li#resource_' + Docs.escapeResourceName(b) + ' ul.endpoints',
        );
        if (a.is(':visible')) {
    ...
    a.main = b(function(g, m, f, l, k) {
        ...
        function e(v, u) {
            ...
            r +=
                ...
                j(
                    ((t = ((t = v.info),
                    t == null || t === false ? t : t.title)),
                    typeof t === h ? t.apply(v) : t),
                ) +
                '</div>\n    <div class="info_description">';
            s = ((t = ((t = v.info),
            t == null || t === false ? t : t.description)),
            typeof t === h ? t.apply(v) : t);
            if (s || s === 0) {
                r += s;
            }
            ...
            s = f['if'].call(
                v,
                ((t = v.info),
                t == null || t === false ? t : t.termsOfServiceUrl),
                { hash: {}, inverse: p.noop, fn: p.program(2, d, u), data: u },
            );
            if (s || s === 0) {
                r += s;
            }
            ...
            s = f['if'].call(
                v,
                ((t = v.info), t == null || t === false ? t : t.contact),
                { hash: {}, inverse: p.noop, fn: p.program(4, q, u), data: u },
            );
            if (s || s === 0) {
                r += s;
            }
            ...
            s = f['if'].call(
                v,
                ((t = v.info), t == null || t === false ? t : t.license),
                { hash: {}, inverse: p.noop, fn: p.program(6, o, u), data: u },
            );
            if (s || s === 0) {
                r += s;
            }
        ...
        function d(u, t) {
            ...
            r +=
                ...
                j(
                    ((s = ((s = u.info),
                    s == null || s === false ? s : s.termsOfServiceUrl)),
        ...
        function o(u, t) {
            ...
            r +=
                ...
                j(
                    ((s = ((s = u.info),
                    s == null || s === false ? s : s.licenseUrl)),
                    typeof s === h ? s.apply(u) : s),
                ) +
                "'>" +
                j(
                    ((s = ((s = u.info),
                    s == null || s === false ? s : s.license)),
                    typeof s === h ? s.apply(u) : s),
                ) +
                '</a></div>';
            return r;
...
(function() {
    ...
    a.param_list = b(function(h, t, r, m, y) {
        ...
        function i(E, D) {
            ...
            B = ((C = r.isArray || E.isArray),
            C ? C.call(E, E, A) : q.call(E, 'isArray', E, A));
            if (B || B === 0) {
                z += B;
            }
            z += '\n      ';
        ...
        g = ((j = r.isArray || t.isArray),
        j ? j.call(t, t, e) : q.call(t, 'isArray', t, e));
        if (g || g === 0) {
            s += g;
        }
        ...
        g = r.each.call(
            t,
            ((j = t.allowableValues),
            j == null || j === false ? j : j.descriptiveValues),
            { hash: {}, inverse: p.noop, fn: p.program(13, w, y), data: y },
        );
        if (g || g === 0) {
            s += g;
        }
...
(function() {
    ...
    o = (function(z) {
        ...
        y.prototype.mouseEnter = function(F) {
            ...
            I.left = K;
            D.css(I);
            return $(F.currentTarget.parentNode)
                .find('#api_information_panel')
                .show();
        };
        y.prototype.mouseExit = function(A) {
            return $(A.currentTarget.parentNode)
                .find('#api_information_panel')
                .hide();
        };
        y.prototype.render = function() {
        ...
        y.prototype.handleFileUpload = function(R, I) {
            ...
            this.invocationUrl = this.model.supportHeaderParams()
                ? ((C = this.model.getHeaderParams(R)),
                  this.model.urlify(R, false))
                : this.model.urlify(R, true);
        ...
        y.prototype.showStatus = function(F) {
            ...
            if (!H) {
                ...
                if (J === 'application/json' || /\+json$/.test(J)) {
                    C = $('<code />').text(
                        JSON.stringify(JSON.parse(H), null, '  '),
                    );
                    E = $('<pre class="json" />').append(C);
                } else {
            ...
            if (
                A.highlightSizeThreshold &&
                F.data.length > A.highlightSizeThreshold
            ) {
                return G;
            } else {
