...
(function() {
    ...
    f.extend(o.prototype, k, {
        ...
        escape: function(a) {
            ...
            b = this.get(a);
            return (this._escapedAttributes[a] = f.escape(
                null == b ? '' : '' + b,
            ));
        },
        has: function(a) {
    ...
    f.extend(m.prototype, k, {
        ...
        start: function(a) {
            ...
            if (
                (b =
                    E.exec(navigator.userAgent.toLowerCase()) && (!b || 7 >= b))
            )
        ...
        _updateHash: function(a, b, c) {
            c
                ? a.replace(
                      a.toString().replace(/(javascript:|#).*$/, '') + '#' + b,
                  )
                : (a.hash = b);
        },
    });
